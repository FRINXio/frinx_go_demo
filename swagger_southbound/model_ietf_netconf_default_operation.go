...
type IetfNetconfDefaultOperation string

// List of ietf.netconf.DefaultOperation
const (
	IetfNetconfDefaultOperation_MERGE IetfNetconfDefaultOperation = "merge"
	IetfNetconfDefaultOperation_REPLACE IetfNetconfDefaultOperation = "replace"
	IetfNetconfDefaultOperation_NONE IetfNetconfDefaultOperation = "none"
)
