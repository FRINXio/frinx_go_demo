...
type NetworkTopologyNetworktopologyTopologyResponse struct {
	NetworkTopologytopology []NetworkTopologyNetworktopologyTopology `json:"network-topology:topology,omitempty"`
}
