...
type NetconfNodeTopologyNetconfnodeconnectionstatusAvailableCapabilities struct {
	// Optional.empty REF:Optional.empty
	AvailableCapability []NetconfNodeTopologyNetconfnodeconnectionstatusAvailablecapabilitiesAvailableCapability `json:"available-capability,omitempty"`
}
