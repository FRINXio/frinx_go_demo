...
type NetconfKeystoreAddprivatekeyInput struct {
	// Optional[A private key.] REF:Optional.empty
	PrivateKey []NetconfKeystorePrivatekeysPrivateKey `json:"private-key,omitempty"`
}
