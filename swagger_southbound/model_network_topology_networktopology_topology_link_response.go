...
type NetworkTopologyNetworktopologyTopologyLinkResponse struct {
	NetworkTopologylink []NetworkTopologyNetworktopologyTopologyLink `json:"network-topology:link,omitempty"`
}
