...
type IetfNetconfCopyconfigInput struct {
	Source *IetfNetconfCopyconfigInputSource `json:"source,omitempty"`
	Target *IetfNetconfCopyconfigInputTarget `json:"target,omitempty"`
}
