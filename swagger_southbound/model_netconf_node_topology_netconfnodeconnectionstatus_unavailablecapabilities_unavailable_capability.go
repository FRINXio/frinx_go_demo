...
type NetconfNodeTopologyNetconfnodeconnectionstatusUnavailablecapabilitiesUnavailableCapability struct {
	// Optional.empty REF:Optional.empty
	FailureReason *NetconfNodeTopologyFailureReasonEnumeration `json:"failure-reason,omitempty"`
	// Optional.empty REF:Optional.empty
