...
type NetworkTopologyNetworkTopologyResponse struct {
	NetworkTopologynetworkTopology *NetworkTopologyNetworkTopology `json:"network-topology:network-topology,omitempty"`
}
