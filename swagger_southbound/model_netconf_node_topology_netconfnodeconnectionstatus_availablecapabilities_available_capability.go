...
type NetconfNodeTopologyNetconfnodeconnectionstatusAvailablecapabilitiesAvailableCapability struct {
	// Optional.empty REF:Optional.empty
	Capability string `json:"capability,omitempty"`
	// Optional.empty REF:Optional.empty
	CapabilityOrigin *NetconfNodeTopologyCapabilityOriginEnumeration `json:"capability-origin,omitempty"`
}
