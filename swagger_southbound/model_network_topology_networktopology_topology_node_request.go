...
type NetworkTopologyNetworktopologyTopologyNodeRequest struct {
	NetworkTopologynode []NetworkTopologyNetworktopologyTopologyNode `json:"network-topology:node,omitempty"`
}
