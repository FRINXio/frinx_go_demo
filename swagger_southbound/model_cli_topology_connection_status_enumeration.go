...
type CliTopologyConnectionStatusEnumeration string

// List of cli.topology.ConnectionStatusEnumeration
const (
	CliTopologyConnectionStatusEnumeration_CONNECTING CliTopologyConnectionStatusEnumeration = "connecting"
	CliTopologyConnectionStatusEnumeration_CONNECTED CliTopologyConnectionStatusEnumeration = "connected"
	CliTopologyConnectionStatusEnumeration_UNABLE_TO_CONNECT CliTopologyConnectionStatusEnumeration = "unable-to-connect"
)
