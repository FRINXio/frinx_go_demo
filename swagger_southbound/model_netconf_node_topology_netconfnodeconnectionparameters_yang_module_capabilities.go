...
type NetconfNodeTopologyNetconfnodeconnectionparametersYangModuleCapabilities struct {
	// Optional[Set a list of capabilities to override capabilities provided in device's hello message. Can be used for devices that do not report any yang modules in their hello message] REF:Optional.empty
	Capability []string `json:"capability,omitempty"`
	// Optional[Whether to override or merge this list of capabilities with capabilities from device] REF:Optional.empty
