...
type NetconfNodeTopologyNetconfnodeconnectionstatusClusteredConnectionStatus struct {
	// Optional.empty REF:Optional.empty
	NetconfMasterNode string `json:"netconf-master-node,omitempty"`
	// Optional.empty REF:Optional.empty
	NodeStatus []NetconfNodeTopologyNetconfnodeconnectionstatusClusteredconnectionstatusNodeStatus `json:"node-status,omitempty"`
}
