...
type NetworkTopologyNetworktopologyTopologyTopologyTypesResponse struct {
	NetworkTopologytopologyTypes *NetworkTopologyNetworktopologyTopologyTopologyTypes `json:"network-topology:topology-types,omitempty"`
}
