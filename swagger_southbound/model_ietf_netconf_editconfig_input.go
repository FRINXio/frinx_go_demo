...
type IetfNetconfEditconfigInput struct {
	// Optional[The test option to use.] REF:Optional.empty
	TestOption *IetfNetconfTestOption `json:"test-option,omitempty"`
	// Optional[The error option to use.] REF:Optional.empty
	ErrorOption *IetfNetconfErrorOption `json:"error-option,omitempty"`
	// Optional[Inline Config content.] REF:Optional.empty
	Config string `json:"config,omitempty"`
	// Optional[The default operation to use.] REF:Optional.empty
	DefaultOperation *IetfNetconfDefaultOperation `json:"default-operation,omitempty"`
	// Optional[URL-based config content.] REF:Optional.empty
	Url string `json:"url,omitempty"`
	Target *IetfNetconfEditconfigInputTarget `json:"target,omitempty"`
}
