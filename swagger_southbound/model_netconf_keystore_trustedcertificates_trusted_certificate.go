...
type NetconfKeystoreTrustedcertificatesTrustedCertificate struct {
	// Optional[An X.509 v3 certificate structure as specified by RFC5280, encoded using the Base64 format.] REF:Optional.empty
