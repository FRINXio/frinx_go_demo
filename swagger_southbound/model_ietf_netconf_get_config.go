...
// Optional[Retrieve all or part of a specified configuration.] REF:Optional[RFC 6241, Section 7.1]
type IetfNetconfGetConfig struct {
	Output *IetfNetconfGetconfigOutput `json:"output,omitempty"`
}
