...
type NetconfNodeTopologyNetconfnodeconnectionparametersOdlHelloMessageCapabilities struct {
	// Optional[Certain devices are non-accepting of ODL's hello message.  This allows specification of a custom ODL hello message based on a list of supported capabilities.] REF:Optional.empty
