...
// Optional[Retrieve running configuration and device state information.] REF:Optional[RFC 6241, Section 7.7]
type IetfNetconfGet struct {
	Output *IetfNetconfGetOutput `json:"output,omitempty"`
}
