 ...
 * @param notificationsCreatesubscriptionInputBodyParam 


*/
func (a *NotificationsApiService) RpcNotificationsCreateSubscription(ctx context.Context, notificationsCreatesubscriptionInputBodyParam NotificationsCreatesubscriptionInputBodyparam) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/operations/notifications:create-subscription/"
	...
	// body params
	localVarPostBody = &notificationsCreatesubscriptionInputBodyParam
