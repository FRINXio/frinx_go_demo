...
type NetconfKeystoreAddtrustedcertificateInput struct {
	// Optional[A list of trusted certificate. These cerfitifcates can be used by a server to authenticate clients, or by clients to authenticate servers.] REF:Optional.empty
	TrustedCertificate []NetconfKeystoreTrustedcertificatesTrustedCertificate `json:"trusted-certificate,omitempty"`
}
