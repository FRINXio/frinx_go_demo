...
type IetfNetconfTestOption string

// List of ietf.netconf.TestOption
const (
	IetfNetconfTestOption_TEST_THEN_SET IetfNetconfTestOption = "test-then-set"
	IetfNetconfTestOption_SET IetfNetconfTestOption = "set"
	IetfNetconfTestOption_TEST_ONLY IetfNetconfTestOption = "test-only"
)
