...
type IetfNetconfGetInput struct {
	// Optional[This parameter specifies the portion of the system configuration and state data to retrieve.] REF:Optional.empty
