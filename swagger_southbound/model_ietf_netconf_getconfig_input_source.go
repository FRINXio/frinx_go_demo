...
// Optional[Particular configuration to retrieve.] REF:Optional.empty
type IetfNetconfGetconfigInputSource struct {
	...
	// Optional[The startup configuration is the config source. This is optional-to-implement on the server because not all servers will support filtering for this datastore.] REF:Optional.empty
