...
@return JournalClearJournal
*/
func (a *JournalApiService) RpcJournalClearJournal(ctx context.Context) (JournalClearJournal, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue JournalClearJournal
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/operations/journal:clear-journal/"
...
@return JournalReadJournal
*/
func (a *JournalApiService) RpcJournalReadJournal(ctx context.Context) (JournalReadJournal, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue JournalReadJournal
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/operations/journal:read-journal/"
