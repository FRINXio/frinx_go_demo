...
type NetconfNodeTopologyFailureReasonEnumeration string

// List of netconf.node.topology.FailureReasonEnumeration
const (
	NetconfNodeTopologyFailureReasonEnumeration_MISSING_SOURCE NetconfNodeTopologyFailureReasonEnumeration = "missing-source"
	NetconfNodeTopologyFailureReasonEnumeration_UNABLE_TO_RESOLVE NetconfNodeTopologyFailureReasonEnumeration = "unable-to-resolve"
)
