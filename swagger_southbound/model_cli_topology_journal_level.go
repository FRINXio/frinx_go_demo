...
type CliTopologyJournalLevel string

// List of cli.topology.JournalLevel
const (
	CliTopologyJournalLevel_COMMAND_ONLY CliTopologyJournalLevel = "command-only"
	CliTopologyJournalLevel_EXTENDED CliTopologyJournalLevel = "extended"
)
