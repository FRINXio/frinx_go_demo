...
type NetconfNodeTopologyStatusEnumeration string

// List of netconf.node.topology.StatusEnumeration
const (
	NetconfNodeTopologyStatusEnumeration_CONNECTED NetconfNodeTopologyStatusEnumeration = "connected"
	NetconfNodeTopologyStatusEnumeration_UNAVAILABLE NetconfNodeTopologyStatusEnumeration = "unavailable"
	NetconfNodeTopologyStatusEnumeration_FAILED NetconfNodeTopologyStatusEnumeration = "failed"
)
