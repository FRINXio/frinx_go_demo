...
type CliTopologyTransportTypeEnumeration string

// List of cli.topology.TransportTypeEnumeration
const (
	CliTopologyTransportTypeEnumeration_SSH CliTopologyTransportTypeEnumeration = "ssh"
	CliTopologyTransportTypeEnumeration_TELNET CliTopologyTransportTypeEnumeration = "telnet"
)
