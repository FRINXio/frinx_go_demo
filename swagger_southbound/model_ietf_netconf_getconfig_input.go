...
type IetfNetconfGetconfigInput struct {
	// Optional[Subtree or XPath filter to use.] REF:Optional.empty
	Filter string `json:"filter,omitempty"`
	Source *IetfNetconfGetconfigInputSource `json:"source,omitempty"`
}
