...
type NetconfNodeTopologyNetconfnodeconnectionstatusClusteredconnectionstatusNodeStatus struct {
	// Optional.empty REF:Optional.empty
	Node string `json:"node,omitempty"`
	// Optional.empty REF:Optional.empty
	Status *NetconfNodeTopologyStatusEnumeration `json:"status,omitempty"`
}
