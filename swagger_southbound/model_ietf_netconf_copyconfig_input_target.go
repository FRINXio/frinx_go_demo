...
// Optional[Particular configuration to copy to.] REF:Optional.empty
type IetfNetconfCopyconfigInputTarget struct {
	// Optional[The running configuration is the config target. This is optional-to-implement on the server.] REF:Optional.empty
	...
	// Optional[The URL-based configuration is the config target.] REF:Optional.empty
