...
// Optional[Device specific list of commit error patterns. The following list of patterns is checked in the input after 'commit' command is sent.] REF:Optional.empty
type CliTranslateRegistryErrorcommitpatternsDefaultCommitErrorPatterns struct {
	// Optional[Device specific commit error patterns.] REF:Optional.empty
	CommitErrorPattern []string `json:"commit-error-pattern,omitempty"`
}
