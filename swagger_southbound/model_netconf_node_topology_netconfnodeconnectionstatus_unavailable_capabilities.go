...
type NetconfNodeTopologyNetconfnodeconnectionstatusUnavailableCapabilities struct {
	// Optional.empty REF:Optional.empty
	UnavailableCapability []NetconfNodeTopologyNetconfnodeconnectionstatusUnavailablecapabilitiesUnavailableCapability `json:"unavailable-capability,omitempty"`
}
