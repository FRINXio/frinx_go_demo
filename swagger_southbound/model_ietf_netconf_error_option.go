...
type IetfNetconfErrorOption string

// List of ietf.netconf.ErrorOption
const (
	IetfNetconfErrorOption_STOP_ON_ERROR IetfNetconfErrorOption = "stop-on-error"
	IetfNetconfErrorOption_CONTINUE_ON_ERROR IetfNetconfErrorOption = "continue-on-error"
	IetfNetconfErrorOption_ROLLBACK_ON_ERROR IetfNetconfErrorOption = "rollback-on-error"
)
