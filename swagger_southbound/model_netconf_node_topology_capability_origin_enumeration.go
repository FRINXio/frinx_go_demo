...
type NetconfNodeTopologyCapabilityOriginEnumeration string

// List of netconf.node.topology.CapabilityOriginEnumeration
const (
	NetconfNodeTopologyCapabilityOriginEnumeration_USER_DEFINED NetconfNodeTopologyCapabilityOriginEnumeration = "user-defined"
	NetconfNodeTopologyCapabilityOriginEnumeration_DEVICE_ADVERTISED NetconfNodeTopologyCapabilityOriginEnumeration = "device-advertised"
)
