...
type NetconfNodeTopologyNetconfnodeconnectionparametersNonModuleCapabilities struct {
	// Optional[Set a list of non-module based capabilities to override or merge non-module capabilities provided in device's hello message. Can be used for devices that do not report or incorrectly report non-module based capabilities in their hello message] REF:Optional.empty
	Capability []string `json:"capability,omitempty"`
	// Optional[Whether to override or merge this list of non-module based capabilities with non-module based capabilities from device] REF:Optional.empty
