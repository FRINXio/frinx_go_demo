...
type FrinxOpenconfigRoutingPolicyNeighborsettopNeighborSets struct {
	// Optional[List of defined neighbor sets for use in policies.] REF:Optional.empty
	NeighborSet []FrinxOpenconfigRoutingPolicyNeighborsettopNeighborsetsNeighborSet `json:"neighbor-set,omitempty"`
}
