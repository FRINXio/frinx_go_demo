...
type FrinxOpenconfigLldpTypesChassisIdType string

// List of frinx.openconfig.lldp.types.ChassisIdType
const (
	FrinxOpenconfigLldpTypesChassisIdType_CHASSIS_COMPONENT FrinxOpenconfigLldpTypesChassisIdType = "CHASSIS_COMPONENT"
	FrinxOpenconfigLldpTypesChassisIdType_INTERFACE_ALIAS FrinxOpenconfigLldpTypesChassisIdType = "INTERFACE_ALIAS"
	FrinxOpenconfigLldpTypesChassisIdType_PORT_COMPONENT FrinxOpenconfigLldpTypesChassisIdType = "PORT_COMPONENT"
	FrinxOpenconfigLldpTypesChassisIdType_MAC_ADDRESS FrinxOpenconfigLldpTypesChassisIdType = "MAC_ADDRESS"
	FrinxOpenconfigLldpTypesChassisIdType_NETWORK_ADDRESS FrinxOpenconfigLldpTypesChassisIdType = "NETWORK_ADDRESS"
	FrinxOpenconfigLldpTypesChassisIdType_INTERFACE_NAME FrinxOpenconfigLldpTypesChassisIdType = "INTERFACE_NAME"
	FrinxOpenconfigLldpTypesChassisIdType_LOCAL FrinxOpenconfigLldpTypesChassisIdType = "LOCAL"
)
