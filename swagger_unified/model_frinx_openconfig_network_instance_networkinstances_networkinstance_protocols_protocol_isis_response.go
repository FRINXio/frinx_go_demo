...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.Isis.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsisResponse struct {
	FrinxOpenconfigNetworkInstanceisis *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsis `json:"frinx-openconfig-network-instance:isis,omitempty"`
}
