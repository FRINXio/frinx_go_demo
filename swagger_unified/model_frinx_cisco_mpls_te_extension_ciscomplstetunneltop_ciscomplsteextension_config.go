...
type FrinxCiscoMplsTeExtensionCiscomplstetunneltopCiscomplsteextensionConfig struct {
	// Optional[Determines load-sharing balancing parameters for a specified tunnel] REF:Optional.empty
	LoadShare int64 `json:"load-share,omitempty"`
}
