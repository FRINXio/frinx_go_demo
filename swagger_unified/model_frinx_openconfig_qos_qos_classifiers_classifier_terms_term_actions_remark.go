...
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermActionsRemark struct {
	// Optional[Configuration parameters relating to remarking packets.] REF:Optional.empty
	Config *FrinxOpenconfigQosQosClassifiersClassifierTermsTermActionsRemarkConfig `json:"config,omitempty"`
}
