...
// frinx.openconfig.bgp.policy.matchaspathtop.matchaspathset.Config.response
type FrinxOpenconfigBgpPolicyMatchaspathtopMatchaspathsetConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicyMatchaspathtopMatchaspathsetConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
