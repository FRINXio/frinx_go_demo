...
// frinx.openconfig.if.ip.ipv6top.ipv6.neighbors.neighbor.Config.response
type FrinxOpenconfigIfIpIpv6topIpv6NeighborsNeighborConfigResponse struct {
	FrinxOpenconfigIfIpconfig *FrinxOpenconfigIfIpIpv6topIpv6NeighborsNeighborConfig `json:"frinx-openconfig-if-ip:config,omitempty"`
}
