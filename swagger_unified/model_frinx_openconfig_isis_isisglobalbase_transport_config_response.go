...
// frinx.openconfig.isis.isisglobalbase.transport.Config.response
type FrinxOpenconfigIsisIsisglobalbaseTransportConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisglobalbaseTransportConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
