...
type FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref string

// List of frinx.openconfig.network.instance.SrcProtocolIdentityref
const (
	FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref_OSPF FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref = "frinx-openconfig-policy-types:OSPF"
	FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref_DIRECTLY_CONNECTED FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref = "frinx-openconfig-policy-types:DIRECTLY_CONNECTED"
	FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref_OSPF3 FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref = "frinx-openconfig-policy-types:OSPF3"
	FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref_STATIC FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref = "frinx-openconfig-policy-types:STATIC"
	FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref_INSTALL_PROTOCOL_TYPE FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref = "frinx-openconfig-policy-types:INSTALL_PROTOCOL_TYPE"
	FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref_ISIS FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref = "frinx-openconfig-policy-types:ISIS"
	FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref_BGP FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref = "frinx-openconfig-policy-types:BGP"
	FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref_LOCAL_AGGREGATE FrinxOpenconfigNetworkInstanceSrcProtocolIdentityref = "frinx-openconfig-policy-types:LOCAL_AGGREGATE"
)
