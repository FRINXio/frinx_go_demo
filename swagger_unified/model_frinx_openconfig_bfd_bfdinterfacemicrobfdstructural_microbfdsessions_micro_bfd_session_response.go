...
// frinx.openconfig.bfd.bfdinterfacemicrobfdstructural.microbfdsessions.MicroBfdSession.response
type FrinxOpenconfigBfdBfdinterfacemicrobfdstructuralMicrobfdsessionsMicroBfdSessionResponse struct {
	FrinxOpenconfigBfdmicroBfdSession []FrinxOpenconfigBfdBfdinterfacemicrobfdstructuralMicrobfdsessionsMicroBfdSession `json:"frinx-openconfig-bfd:micro-bfd-session,omitempty"`
}
