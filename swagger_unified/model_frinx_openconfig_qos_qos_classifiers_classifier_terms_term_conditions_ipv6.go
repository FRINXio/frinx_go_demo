...
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv6 struct {
	// Optional[Configuration data for IPv6 match fields] REF:Optional.empty
	Config *FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv6Config `json:"config,omitempty"`
}
