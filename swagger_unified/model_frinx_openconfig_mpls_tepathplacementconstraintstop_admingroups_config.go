...
type FrinxOpenconfigMplsTepathplacementconstraintstopAdmingroupsConfig struct {
	// Optional[list of references to named admin-groups of which all must be included] REF:Optional.empty
	IncludeAllGroup []string `json:"include-all-group,omitempty"`
	// Optional[list of references to named admin-groups of which one must be included] REF:Optional.empty
	IncludeAnyGroup []string `json:"include-any-group,omitempty"`
	// Optional[list of references to named admin-groups to exclude in path calculation.] REF:Optional.empty
	ExcludeGroup []string `json:"exclude-group,omitempty"`
}
