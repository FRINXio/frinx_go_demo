...
// frinx.openconfig.mpls.ldp.igplspldpsetup.Ldp.response
type FrinxOpenconfigMplsLdpIgplspldpsetupLdpResponse struct {
	FrinxOpenconfigNetworkInstanceldp *FrinxOpenconfigMplsLdpIgplspldpsetupLdp `json:"frinx-openconfig-network-instance:ldp,omitempty"`
}
