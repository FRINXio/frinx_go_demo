...
type FrinxOpenconfigLacpAggregationlacpmemberstopMembersMember struct {
	// Optional[Reference to aggregate member interface] REF:Optional.empty
	Interface_ string `json:"interface,omitempty"`
	// Optional[Indiviudal configuration of mode and period type per member interface] REF:Optional.empty
	Config *FrinxOpenconfigLacpAggregationlacpmemberstopMembersMemberConfig `json:"config,omitempty"`
}
