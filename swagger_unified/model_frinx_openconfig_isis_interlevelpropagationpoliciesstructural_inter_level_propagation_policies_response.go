...
// frinx.openconfig.isis.interlevelpropagationpoliciesstructural.InterLevelPropagationPolicies.response
type FrinxOpenconfigIsisInterlevelpropagationpoliciesstructuralInterLevelPropagationPoliciesResponse struct {
	FrinxOpenconfigNetworkInstanceinterLevelPropagationPolicies *FrinxOpenconfigIsisInterlevelpropagationpoliciesstructuralInterLevelPropagationPolicies `json:"frinx-openconfig-network-instance:inter-level-propagation-policies,omitempty"`
}
