...
type FrinxOpenconfigQosQosSchedulerpoliciesSchedulerpolicySchedulers struct {
	// Optional[List of defined QoS traffic schedulers.] REF:Optional.empty
	Scheduler []FrinxOpenconfigQosQosSchedulerpoliciesSchedulerpolicySchedulersScheduler `json:"scheduler,omitempty"`
}
