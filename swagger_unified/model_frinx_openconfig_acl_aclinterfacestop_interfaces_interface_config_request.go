...
// frinx.openconfig.acl.aclinterfacestop.interfaces.interface.Config.request
type FrinxOpenconfigAclAclinterfacestopInterfacesInterfaceConfigRequest struct {
