...
// frinx.openconfig.ospfv2.ospfv2areainterfacesstructure.interfaces.interface.mpls.igpldpsync.Config.response
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMplsIgpldpsyncConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMplsIgpldpsyncConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
