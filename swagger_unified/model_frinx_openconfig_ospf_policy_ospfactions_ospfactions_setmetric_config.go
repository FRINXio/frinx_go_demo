...
// Optional[Configuration parameters relating to setting the OSPF metric] REF:Optional.empty
type FrinxOpenconfigOspfPolicyOspfactionsOspfactionsSetmetricConfig struct {
	// Optional[Set the metric of the routes matching the policy to the value specified by this leaf.] REF:Optional.empty
	Metric int32 `json:"metric,omitempty"`
	// Optional[Specify the type of metric which is to be set by the policy] REF:Optional.empty
	MetricType *FrinxOpenconfigOspfPolicyMetricTypeEnumeration `json:"metric-type,omitempty"`
}
