...
// frinx.openconfig.qos.qosscheduler2r3ctop.tworatethreecolor.Config.request
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorConfigRequest struct {
