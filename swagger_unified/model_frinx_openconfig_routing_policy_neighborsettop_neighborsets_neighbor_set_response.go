...
// frinx.openconfig.routing.policy.neighborsettop.neighborsets.NeighborSet.response
type FrinxOpenconfigRoutingPolicyNeighborsettopNeighborsetsNeighborSetResponse struct {
	FrinxOpenconfigRoutingPolicyneighborSet []FrinxOpenconfigRoutingPolicyNeighborsettopNeighborsetsNeighborSet `json:"frinx-openconfig-routing-policy:neighbor-set,omitempty"`
}
