...
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryIpv6 struct {
	// Optional[Configuration data for IPv6 match fields] REF:Optional.empty
	Config *FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryIpv6Config `json:"config,omitempty"`
}
