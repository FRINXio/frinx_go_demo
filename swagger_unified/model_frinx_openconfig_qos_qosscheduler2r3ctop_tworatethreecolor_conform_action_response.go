...
// frinx.openconfig.qos.qosscheduler2r3ctop.tworatethreecolor.ConformAction.response
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorConformActionResponse struct {
	FrinxOpenconfigQosconformAction *FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorConformAction `json:"frinx-openconfig-qos:conform-action,omitempty"`
}
