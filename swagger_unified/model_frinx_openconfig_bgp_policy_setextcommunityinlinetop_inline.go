...
type FrinxOpenconfigBgpPolicySetextcommunityinlinetopInline struct {
	// Optional[Configuration data or inline specification of set-ext-community action] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicySetextcommunityinlinetopInlineConfig `json:"config,omitempty"`
}
