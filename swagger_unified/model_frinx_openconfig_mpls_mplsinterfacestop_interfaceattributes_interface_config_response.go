...
// frinx.openconfig.mpls.mplsinterfacestop.interfaceattributes.interface.Config.response
type FrinxOpenconfigMplsMplsinterfacestopInterfaceattributesInterfaceConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsMplsinterfacestopInterfaceattributesInterfaceConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
