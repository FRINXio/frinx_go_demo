...
// frinx.openconfig.bgp.bgpglobalbase.confederation.Config.response
type FrinxOpenconfigBgpBgpglobalbaseConfederationConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpglobalbaseConfederationConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
