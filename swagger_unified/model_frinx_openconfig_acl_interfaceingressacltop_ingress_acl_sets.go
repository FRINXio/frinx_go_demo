...
type FrinxOpenconfigAclInterfaceingressacltopIngressAclSets struct {
	// Optional[List of ingress ACLs on the interface] REF:Optional.empty
	IngressAclSet []FrinxOpenconfigAclInterfaceingressacltopIngressaclsetsIngressAclSet `json:"ingress-acl-set,omitempty"`
}
