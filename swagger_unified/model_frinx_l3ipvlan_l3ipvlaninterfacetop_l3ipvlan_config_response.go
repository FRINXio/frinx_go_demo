...
// frinx.l3ipvlan.l3ipvlaninterfacetop.l3ipvlan.Config.response
type FrinxL3ipvlanL3ipvlaninterfacetopL3ipvlanConfigResponse struct {
	FrinxL3ipvlanconfig *FrinxL3ipvlanL3ipvlaninterfacetopL3ipvlanConfig `json:"frinx-l3ipvlan:config,omitempty"`
}
