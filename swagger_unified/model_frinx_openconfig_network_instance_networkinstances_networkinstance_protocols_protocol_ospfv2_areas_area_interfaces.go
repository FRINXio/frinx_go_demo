...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2AreasAreaInterfaces struct {
	// Optional[List of interfaces which are enabled within this area] REF:Optional.empty
	Interface_ []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2AreasAreaInterfacesInterface `json:"interface,omitempty"`
}
