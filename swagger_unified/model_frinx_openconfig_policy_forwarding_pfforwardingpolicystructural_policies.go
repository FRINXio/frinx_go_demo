...
type FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPolicies struct {
	...
	Policy []FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicy `json:"policy,omitempty"`
}
