...
// frinx.openconfig.mpls.mplstop.mpls.lsps.StaticLsps.response
type FrinxOpenconfigMplsMplstopMplsLspsStaticLspsResponse struct {
	FrinxOpenconfigNetworkInstancestaticLsps *FrinxOpenconfigMplsMplstopMplsLspsStaticLsps `json:"frinx-openconfig-network-instance:static-lsps,omitempty"`
}
