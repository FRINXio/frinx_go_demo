...
// frinx.openconfig.isis.packetcountersstructural.Esh.response
type FrinxOpenconfigIsisPacketcountersstructuralEshResponse struct {
	FrinxOpenconfigNetworkInstanceesh *FrinxOpenconfigIsisPacketcountersstructuralEsh `json:"frinx-openconfig-network-instance:esh,omitempty"`
}
