...
// frinx.openconfig.network.instance.networkinstances.networkinstance.policyforwarding.Interfaces.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstancePolicyforwardingInterfacesResponse struct {
	FrinxOpenconfigNetworkInstanceinterfaces *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstancePolicyforwardingInterfaces `json:"frinx-openconfig-network-instance:interfaces,omitempty"`
}
