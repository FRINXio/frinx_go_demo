...
// frinx.openconfig.qos.qos.classifiers.Classifier.response
type FrinxOpenconfigQosQosClassifiersClassifierResponse struct {
	FrinxOpenconfigQosclassifier []FrinxOpenconfigQosQosClassifiersClassifier `json:"frinx-openconfig-qos:classifier,omitempty"`
}
