...
// frinx.evpn.evpninterfaces.Interfaces.response
type FrinxEvpnEvpninterfacesInterfacesResponse struct {
	FrinxEvpninterfaces *FrinxEvpnEvpninterfacesInterfaces `json:"frinx-evpn:interfaces,omitempty"`
}
