...
// frinx.openconfig.routing.policy.routingpolicy.policydefinitions.policydefinition.Statements.response
type FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicydefinitionStatementsResponse struct {
	FrinxOpenconfigRoutingPolicystatements *FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicydefinitionStatements `json:"frinx-openconfig-routing-policy:statements,omitempty"`
}
