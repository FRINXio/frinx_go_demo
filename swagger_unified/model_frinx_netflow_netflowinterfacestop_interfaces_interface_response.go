...
// frinx.netflow.netflowinterfacestop.interfaces.Interface.response
type FrinxNetflowNetflowinterfacestopInterfacesInterfaceResponse struct {
	FrinxNetflowinterface []FrinxNetflowNetflowinterfacestopInterfacesInterface `json:"frinx-netflow:interface,omitempty"`
}
