...
// frinx.openconfig.network.instance.networkinstances.networkinstance.mpls.lsps.ConstrainedPath.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLspsConstrainedPathResponse struct {
	FrinxOpenconfigNetworkInstanceconstrainedPath *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLspsConstrainedPath `json:"frinx-openconfig-network-instance:constrained-path,omitempty"`
}
