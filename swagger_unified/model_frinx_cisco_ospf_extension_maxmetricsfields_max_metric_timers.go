...
type FrinxCiscoOspfExtensionMaxmetricsfieldsMaxMetricTimers struct {
	// Optional.empty REF:Optional.empty
	MaxMetricTimer []FrinxCiscoOspfExtensionMaxmetricsfieldsMaxmetrictimersMaxMetricTimer `json:"max-metric-timer,omitempty"`
}
