...
// frinx.openconfig.acl.Acl.response
type FrinxOpenconfigAclAclResponse struct {
	FrinxOpenconfigAclacl *FrinxOpenconfigAclAcl `json:"frinx-openconfig-acl:acl,omitempty"`
}
