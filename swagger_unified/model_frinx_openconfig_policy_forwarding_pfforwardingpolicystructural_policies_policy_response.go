...
// frinx.openconfig.policy.forwarding.pfforwardingpolicystructural.policies.Policy.response
type FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyResponse struct {
	FrinxOpenconfigNetworkInstancepolicy []FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicy `json:"frinx-openconfig-network-instance:policy,omitempty"`
}
