...
type FrinxOpenconfigBgpPolicyBgpconditionstopBgpConditions struct {
	// Optional[Match a referenced as-path set according to the logic defined in the match-set-options leaf] REF:Optional.empty
	MatchAsPathSet *FrinxOpenconfigBgpPolicyMatchaspathtopMatchAsPathSet `json:"match-as-path-set,omitempty"`
	// Optional[Match a referenced extended community-set according to the logic defined in the match-set-options leaf] REF:Optional.empty
	MatchExtCommunitySet *FrinxOpenconfigBgpPolicyMatchextcommunitytopMatchExtCommunitySet `json:"match-ext-community-set,omitempty"`
	// Optional[Top-level container for match conditions on communities. Match a referenced community-set according to the logic defined in the match-set-options leaf] REF:Optional.empty
	MatchCommunitySet *FrinxOpenconfigBgpPolicyMatchcommunitytopMatchCommunitySet `json:"match-community-set,omitempty"`
	// Optional[Value and comparison operations for conditions based on the length of the AS path in the route update] REF:Optional.empty
	AsPathLength *FrinxOpenconfigBgpPolicyAspathlengthtopAsPathLength `json:"as-path-length,omitempty"`
	// Optional[Value and comparison operations for conditions based on the number of communities in the route update] REF:Optional.empty
	CommunityCount *FrinxOpenconfigBgpPolicyCommunitycounttopCommunityCount `json:"community-count,omitempty"`
	// Optional[Configuration data for BGP-specific policy conditions] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicyBgpconditionstopBgpconditionsConfig `json:"config,omitempty"`
}
