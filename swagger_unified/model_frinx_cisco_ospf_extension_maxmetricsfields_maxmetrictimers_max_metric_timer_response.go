...
// frinx.cisco.ospf.extension.maxmetricsfields.maxmetrictimers.MaxMetricTimer.response
type FrinxCiscoOspfExtensionMaxmetricsfieldsMaxmetrictimersMaxMetricTimerResponse struct {
	FrinxCiscoOspfExtensionmaxMetricTimer []FrinxCiscoOspfExtensionMaxmetricsfieldsMaxmetrictimersMaxMetricTimer `json:"frinx-cisco-ospf-extension:max-metric-timer,omitempty"`
}
