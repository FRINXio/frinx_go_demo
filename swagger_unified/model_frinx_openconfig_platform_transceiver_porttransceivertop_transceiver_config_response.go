...
// frinx.openconfig.platform.transceiver.porttransceivertop.transceiver.Config.response
type FrinxOpenconfigPlatformTransceiverPorttransceivertopTransceiverConfigResponse struct {
	FrinxOpenconfigPlatformTransceiverconfig *FrinxOpenconfigPlatformTransceiverPorttransceivertopTransceiverConfig `json:"frinx-openconfig-platform-transceiver:config,omitempty"`
}
