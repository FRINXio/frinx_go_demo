...
// frinx.juniper.pf.interfaces.extension.juniperpfinterfaceextensionconfig.classifiers.Exp.response
type FrinxJuniperPfInterfacesExtensionJuniperpfinterfaceextensionconfigClassifiersExpResponse struct {
	FrinxJuniperPfInterfacesExtensionexp *FrinxJuniperPfInterfacesExtensionJuniperpfinterfaceextensionconfigClassifiersExp `json:"frinx-juniper-pf-interfaces-extension:exp,omitempty"`
}
