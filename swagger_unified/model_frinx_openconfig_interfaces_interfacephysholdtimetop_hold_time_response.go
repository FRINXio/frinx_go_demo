...
// frinx.openconfig.interfaces.interfacephysholdtimetop.HoldTime.response
type FrinxOpenconfigInterfacesInterfacephysholdtimetopHoldTimeResponse struct {
	FrinxOpenconfigInterfacesholdTime *FrinxOpenconfigInterfacesInterfacephysholdtimetopHoldTime `json:"frinx-openconfig-interfaces:hold-time,omitempty"`
}
