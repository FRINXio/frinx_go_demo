...
// frinx.openconfig.isis.interlevelpropagationpoliciesstructural.interlevelpropagationpolicies.Level2ToLevel1.response
type FrinxOpenconfigIsisInterlevelpropagationpoliciesstructuralInterlevelpropagationpoliciesLevel2ToLevel1Response struct {
	FrinxOpenconfigNetworkInstancelevel2ToLevel1 *FrinxOpenconfigIsisInterlevelpropagationpoliciesstructuralInterlevelpropagationpoliciesLevel2ToLevel1 `json:"frinx-openconfig-network-instance:level2-to-level1,omitempty"`
}
