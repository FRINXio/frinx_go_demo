...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsLdpGlobal struct {
	// Optional[Top container for LDP graceful-restart attributes] REF:Optional.empty
	GracefulRestart *FrinxOpenconfigMplsLdpMplsldpgracefulrestartGracefulRestart `json:"graceful-restart,omitempty"`
	// Optional[Global LDP configuration attributes.] REF:Optional.empty
	Config *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsLdpGlobalConfig `json:"config,omitempty"`
	// Optional[Global LDP authentication] REF:Optional.empty
	Authentication *FrinxOpenconfigMplsLdpMplsldpauthenticationtopAuthentication `json:"authentication,omitempty"`
}
