...
// frinx.openconfig.bgp.bgpcommonrouteselectionoptions.RouteSelectionOptions.response
type FrinxOpenconfigBgpBgpcommonrouteselectionoptionsRouteSelectionOptionsResponse struct {
	FrinxOpenconfigNetworkInstancerouteSelectionOptions *FrinxOpenconfigBgpBgpcommonrouteselectionoptionsRouteSelectionOptions `json:"frinx-openconfig-network-instance:route-selection-options,omitempty"`
}
