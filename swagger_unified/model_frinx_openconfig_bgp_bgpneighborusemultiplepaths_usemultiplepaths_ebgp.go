...
type FrinxOpenconfigBgpBgpneighborusemultiplepathsUsemultiplepathsEbgp struct {
	// Optional[Configuration parameters relating to eBGP multipath] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpneighborusemultiplepathsUsemultiplepathsEbgpConfig `json:"config,omitempty"`
}
