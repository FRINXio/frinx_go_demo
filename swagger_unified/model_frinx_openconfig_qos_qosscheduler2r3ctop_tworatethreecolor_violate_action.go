...
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorViolateAction struct {
	// Optional[Configuration parameters relating to the action applied to violating packets.] REF:Optional.empty
	Config *FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorViolateactionConfig `json:"config,omitempty"`
}
