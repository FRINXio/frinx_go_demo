...
// Optional[This container defines ISIS Shortcuts configuration parameters] REF:Optional.empty
type FrinxOpenconfigIsisIsisshortcutsafilistAfiConfig struct {
	// Optional[Address-family type.] REF:Optional.empty
	AfiName *FrinxOpenconfigIsisAfiNameIdentityref `json:"afi-name,omitempty"`
	// Optional[Tunnel NH Type(RSVP,SR). When present it implies that nh-type shortcut is enabled for a specified AFI.] REF:Optional.empty
	NhType []FrinxOpenconfigIsisNhTypeIdentityref `json:"nh-type,omitempty"`
}
