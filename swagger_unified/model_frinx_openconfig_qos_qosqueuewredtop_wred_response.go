...
// frinx.openconfig.qos.qosqueuewredtop.Wred.response
type FrinxOpenconfigQosQosqueuewredtopWredResponse struct {
	FrinxOpenconfigQoswred *FrinxOpenconfigQosQosqueuewredtopWred `json:"frinx-openconfig-qos:wred,omitempty"`
}
