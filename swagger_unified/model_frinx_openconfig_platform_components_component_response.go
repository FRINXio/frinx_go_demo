...
// frinx.openconfig.platform.components.Component.response
type FrinxOpenconfigPlatformComponentsComponentResponse struct {
	FrinxOpenconfigPlatformcomponent []FrinxOpenconfigPlatformComponentsComponent `json:"frinx-openconfig-platform:component,omitempty"`
}
