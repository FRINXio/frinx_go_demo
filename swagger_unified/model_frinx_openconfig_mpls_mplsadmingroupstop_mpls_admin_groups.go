...
type FrinxOpenconfigMplsMplsadmingroupstopMplsAdminGroups struct {
	// Optional[configuration of value to name mapping for mpls affinities/admin-groups] REF:Optional.empty
	AdminGroup []FrinxOpenconfigMplsMplsadmingroupstopMplsadmingroupsAdminGroup `json:"admin-group,omitempty"`
}
