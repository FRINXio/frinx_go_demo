...
// Optional[A list of next-hops to be utilised for the static route being specified.] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticroutesStaticNexthopsNextHop struct {
	...
	// Optional[A reference to the index of the current next-hop. The index is intended to be a user-specified value which can be used to reference the next-hop in question, without any other semantics being assigned to it.] REF:Optional.empty
	Index string `json:"index,omitempty"`
	// Optional[Configuration parameters relating to the next-hop entry] REF:Optional.empty
	Config *FrinxOpenconfigLocalRoutingLocalstatictopStaticroutesStaticNexthopsNexthopConfig `json:"config,omitempty"`
