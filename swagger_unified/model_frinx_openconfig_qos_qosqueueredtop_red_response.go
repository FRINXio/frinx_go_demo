...
// frinx.openconfig.qos.qosqueueredtop.Red.response
type FrinxOpenconfigQosQosqueueredtopRedResponse struct {
	FrinxOpenconfigQosred *FrinxOpenconfigQosQosqueueredtopRed `json:"frinx-openconfig-qos:red,omitempty"`
}
