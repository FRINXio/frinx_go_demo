...
// frinx.openconfig.bgp.policy.setcommunityinlinetop.inline.Config.response
type FrinxOpenconfigBgpPolicySetcommunityinlinetopInlineConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicySetcommunityinlinetopInlineConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
