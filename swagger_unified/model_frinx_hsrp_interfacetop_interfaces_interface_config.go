...
type FrinxHsrpInterfacetopInterfacesInterfaceConfig struct {
	// Optional[Minimum delay on every interface up event.] REF:Optional.empty
	MinimumDelay int64 `json:"minimum-delay,omitempty"`
	// Optional[The interface-id of the interface-list set] REF:Optional.empty
	InterfaceId string `json:"interface-id,omitempty"`
	// Optional[Reload delay for first interface up event.] REF:Optional.empty
	ReloadDelay int64 `json:"reload-delay,omitempty"`
}
