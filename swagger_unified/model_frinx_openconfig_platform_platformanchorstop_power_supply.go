...
type FrinxOpenconfigPlatformPlatformanchorstopPowerSupply struct {
	// Optional[Configuration data for power supply components] REF:Optional.empty
	Config *FrinxOpenconfigPlatformPlatformanchorstopPowersupplyConfig `json:"config,omitempty"`
}
