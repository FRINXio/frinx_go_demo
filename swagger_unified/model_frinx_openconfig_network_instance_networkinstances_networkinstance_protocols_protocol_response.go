...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.Protocol.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolResponse struct {
	FrinxOpenconfigNetworkInstanceprotocol []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocol `json:"frinx-openconfig-network-instance:protocol,omitempty"`
}
