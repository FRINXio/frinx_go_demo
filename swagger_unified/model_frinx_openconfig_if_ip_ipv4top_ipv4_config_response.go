...
// frinx.openconfig.if.ip.ipv4top.ipv4.Config.response
type FrinxOpenconfigIfIpIpv4topIpv4ConfigResponse struct {
	FrinxOpenconfigIfIpconfig *FrinxOpenconfigIfIpIpv4topIpv4Config `json:"frinx-openconfig-if-ip:config,omitempty"`
}
