...
// frinx.openconfig.isis.isisglobalbase.Mpls.response
type FrinxOpenconfigIsisIsisglobalbaseMplsResponse struct {
	FrinxOpenconfigNetworkInstancempls *FrinxOpenconfigIsisIsisglobalbaseMpls `json:"frinx-openconfig-network-instance:mpls,omitempty"`
}
