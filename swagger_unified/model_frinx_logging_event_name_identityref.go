...
type FrinxLoggingEventNameIdentityref string

// List of frinx.logging.EventNameIdentityref
const (
	FrinxLoggingEventNameIdentityref_EVENT_TYPE FrinxLoggingEventNameIdentityref = "frinx-event-types:EVENT_TYPE"
	FrinxLoggingEventNameIdentityref_LINK_UP_DOWN FrinxLoggingEventNameIdentityref = "frinx-event-types:LINK_UP_DOWN"
)
