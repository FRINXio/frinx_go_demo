...
// frinx.openconfig.mpls.ldp.mplsldptargetedtop.targeted.Config.response
type FrinxOpenconfigMplsLdpMplsldptargetedtopTargetedConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsLdpMplsldptargetedtopTargetedConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
