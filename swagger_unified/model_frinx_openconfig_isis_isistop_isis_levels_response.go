...
// frinx.openconfig.isis.isistop.isis.Levels.response
type FrinxOpenconfigIsisIsistopIsisLevelsResponse struct {
	FrinxOpenconfigNetworkInstancelevels *FrinxOpenconfigIsisIsistopIsisLevels `json:"frinx-openconfig-network-instance:levels,omitempty"`
}
