...
type FrinxOpenconfigQosQosinterfaceclassifiertopClassifersClassifierConfig struct {
	// Optional[Reference to the classifier to be applied to ingress traffic on the interface] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Type of packets matched by the classifier.] REF:Optional.empty
