...
type FrinxOpenconfigPlatformPlatformcomponentpropertiestopProperties struct {
	// Optional[List of system properties for the component] REF:Optional.empty
	Property []FrinxOpenconfigPlatformPlatformcomponentpropertiestopPropertiesProperty `json:"property,omitempty"`
}
