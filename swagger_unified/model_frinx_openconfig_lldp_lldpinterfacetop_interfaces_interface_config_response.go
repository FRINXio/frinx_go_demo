...
type FrinxOpenconfigLldpLldpinterfacetopInterfacesInterfaceConfigResponse struct {
	FrinxCdpconfig *FrinxOpenconfigLldpLldpinterfacetopInterfacesInterfaceConfig `json:"frinx-cdp:config,omitempty"`
}
