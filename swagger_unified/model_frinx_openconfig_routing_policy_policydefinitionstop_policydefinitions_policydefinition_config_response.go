...
// frinx.openconfig.routing.policy.policydefinitionstop.policydefinitions.policydefinition.Config.response
type FrinxOpenconfigRoutingPolicyPolicydefinitionstopPolicydefinitionsPolicydefinitionConfigResponse struct {
	FrinxOpenconfigRoutingPolicyconfig *FrinxOpenconfigRoutingPolicyPolicydefinitionstopPolicydefinitionsPolicydefinitionConfig `json:"frinx-openconfig-routing-policy:config,omitempty"`
}
