...
type FrinxJuniperIfExtensionRpmTypes string

// List of frinx.juniper.if.extension.RpmTypes
const (
	FrinxJuniperIfExtensionRpmTypes_CLIENT FrinxJuniperIfExtensionRpmTypes = "client"
	FrinxJuniperIfExtensionRpmTypes_SERVER FrinxJuniperIfExtensionRpmTypes = "server"
	FrinxJuniperIfExtensionRpmTypes_CLIENT_DELEGATE_PROBES FrinxJuniperIfExtensionRpmTypes = "client-delegate-probes"
)
