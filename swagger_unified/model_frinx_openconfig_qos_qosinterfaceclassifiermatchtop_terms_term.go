...
// Optional[List of match terms in the classifier associated with the interface] REF:Optional.empty
type FrinxOpenconfigQosQosinterfaceclassifiermatchtopTermsTerm struct {
	// Optional[Configuration data for match terms in the classifier associated with an interface] REF:Optional.empty
	Config *FrinxOpenconfigQosQosinterfaceclassifiermatchtopTermsTermConfig `json:"config,omitempty"`
	// Optional[Reference to match term id list key] REF:Optional.empty
