...
// frinx.openconfig.bgp.policy.aspathsettop.AsPathSets.response
type FrinxOpenconfigBgpPolicyAspathsettopAsPathSetsResponse struct {
	FrinxOpenconfigBgpPolicyasPathSets *FrinxOpenconfigBgpPolicyAspathsettopAsPathSets `json:"frinx-openconfig-bgp-policy:as-path-sets,omitempty"`
}
