...
// frinx.openconfig.routing.policy.routingpolicy.policydefinitions.policydefinition.statements.statement.Actions.response
type FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicydefinitionStatementsStatementActionsResponse struct {
	FrinxOpenconfigRoutingPolicyactions *FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicydefinitionStatementsStatementActions `json:"frinx-openconfig-routing-policy:actions,omitempty"`
}
