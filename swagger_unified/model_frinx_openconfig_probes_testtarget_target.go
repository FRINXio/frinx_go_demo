...
type FrinxOpenconfigProbesTesttargetTarget struct {
	// Optional[Configuration data for the test target.] REF:Optional.empty
	Config *FrinxOpenconfigProbesTesttargetTargetConfig `json:"config,omitempty"`
}
