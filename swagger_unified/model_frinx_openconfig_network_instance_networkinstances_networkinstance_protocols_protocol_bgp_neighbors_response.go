...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.bgp.Neighbors.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpNeighborsResponse struct {
	FrinxOpenconfigNetworkInstanceneighbors *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpNeighbors `json:"frinx-openconfig-network-instance:neighbors,omitempty"`
}
