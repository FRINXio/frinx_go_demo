...
// frinx.openconfig.platform.platformanchorstop.fan.Config.response
type FrinxOpenconfigPlatformPlatformanchorstopFanConfigResponse struct {
	FrinxOpenconfigPlatformconfig *FrinxOpenconfigPlatformPlatformanchorstopFanConfig `json:"frinx-openconfig-platform:config,omitempty"`
}
