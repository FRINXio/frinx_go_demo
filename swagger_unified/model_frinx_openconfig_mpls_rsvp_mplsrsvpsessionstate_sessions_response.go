...
// frinx.openconfig.mpls.rsvp.mplsrsvpsessionstate.Sessions.response
type FrinxOpenconfigMplsRsvpMplsrsvpsessionstateSessionsResponse struct {
	FrinxOpenconfigNetworkInstancesessions *FrinxOpenconfigMplsRsvpMplsrsvpsessionstateSessions `json:"frinx-openconfig-network-instance:sessions,omitempty"`
}
