...
// frinx.openconfig.isis.isisglobalbase.mpls.IgpLdpSync.response
type FrinxOpenconfigIsisIsisglobalbaseMplsIgpLdpSyncResponse struct {
	FrinxOpenconfigNetworkInstanceigpLdpSync *FrinxOpenconfigIsisIsisglobalbaseMplsIgpLdpSync `json:"frinx-openconfig-network-instance:igp-ldp-sync,omitempty"`
}
