...
// frinx.openconfig.packet.match.transportfieldstop.Transport.response
type FrinxOpenconfigPacketMatchTransportfieldstopTransportResponse struct {
	FrinxOpenconfigNetworkInstancetransport *FrinxOpenconfigPacketMatchTransportfieldstopTransport `json:"frinx-openconfig-network-instance:transport,omitempty"`
}
