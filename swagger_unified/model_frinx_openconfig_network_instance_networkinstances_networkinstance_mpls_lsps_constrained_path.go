...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLspsConstrainedPath struct {
	// Optional[Enclosing container for tunnels] REF:Optional.empty
	Tunnels *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLspsConstrainedpathTunnels `json:"tunnels,omitempty"`
	// Optional[Enclosing container for the named explicit paths] REF:Optional.empty
	NamedExplicitPaths *FrinxOpenconfigMplsExplicitpathstopNamedExplicitPaths `json:"named-explicit-paths,omitempty"`
}
