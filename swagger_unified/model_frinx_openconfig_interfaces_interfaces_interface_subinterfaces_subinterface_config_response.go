...
// frinx.openconfig.interfaces.interfaces.interface.subinterfaces.subinterface.Config.response
type FrinxOpenconfigInterfacesInterfacesInterfaceSubinterfacesSubinterfaceConfigResponse struct {
	FrinxOpenconfigInterfacesconfig *FrinxOpenconfigInterfacesInterfacesInterfaceSubinterfacesSubinterfaceConfig `json:"frinx-openconfig-interfaces:config,omitempty"`
}
