...
// frinx.openconfig.bgp.bgpcommonglobalgroupusemultiplepaths.usemultiplepaths.Ebgp.response
type FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsEbgpResponse struct {
	FrinxOpenconfigNetworkInstanceebgp *FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsEbgp `json:"frinx-openconfig-network-instance:ebgp,omitempty"`
}
