...
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMplsConfig struct {
	// Optional[A link metric that should only be considered for traffic engineering purposes.] REF:Optional[RFC3630, §2.5.5]
	TrafficEngineeringMetric int64 `json:"traffic-engineering-metric,omitempty"`
}
