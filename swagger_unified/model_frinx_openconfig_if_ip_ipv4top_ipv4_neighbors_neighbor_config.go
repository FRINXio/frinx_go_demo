...
type FrinxOpenconfigIfIpIpv4topIpv4NeighborsNeighborConfig struct {
	// Optional[The link-layer address of the neighbor node.] REF:Optional.empty
	LinkLayerAddress string `json:"link-layer-address,omitempty"`
	// Optional[The IPv4 address of the neighbor node.] REF:Optional.empty
