...
// frinx.openconfig.probes.probes.probe.Tests.response
type FrinxOpenconfigProbesProbesProbeTestsResponse struct {
	FrinxOpenconfigProbestests *FrinxOpenconfigProbesProbesProbeTests `json:"frinx-openconfig-probes:tests,omitempty"`
}
