...
// Optional[Configuration data for policy matching on protocol instance] REF:Optional.empty
type FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchprotocolinstanceConfig struct {
	// Optional[The identifier (protocol type) of the protocol instance to match on in the local network instance.] REF:Optional.empty
	ProtocolIdentifier *FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref `json:"protocol-identifier,omitempty"`
	// Optional[The name of the protocol instance to match on in the local network instance] REF:Optional.empty
	ProtocolName string `json:"protocol-name,omitempty"`
}
