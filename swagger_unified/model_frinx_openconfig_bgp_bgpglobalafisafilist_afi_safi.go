...
type FrinxOpenconfigBgpBgpglobalafisafilistAfiSafi struct {
	...
	GracefulRestart *FrinxOpenconfigBgpBgpglobalafisafilistAfisafiGracefulRestart `json:"graceful-restart,omitempty"`
	...
	Config *FrinxOpenconfigBgpBgpglobalafisafilistAfisafiConfig `json:"config,omitempty"`
}
