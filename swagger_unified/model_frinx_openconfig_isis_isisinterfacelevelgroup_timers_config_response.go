...
// frinx.openconfig.isis.isisinterfacelevelgroup.timers.Config.response
type FrinxOpenconfigIsisIsisinterfacelevelgroupTimersConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisinterfacelevelgroupTimersConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
