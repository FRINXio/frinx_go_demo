...
// frinx.openconfig.isis.isismtlist.MultiTopology.response
type FrinxOpenconfigIsisIsismtlistMultiTopologyResponse struct {
	FrinxOpenconfigNetworkInstancemultiTopology *FrinxOpenconfigIsisIsismtlistMultiTopology `json:"frinx-openconfig-network-instance:multi-topology,omitempty"`
}
