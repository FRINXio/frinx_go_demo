...
// frinx.openconfig.qos.qosschedulertop.schedulerpolicies.schedulerpolicy.Config.request
type FrinxOpenconfigQosQosschedulertopSchedulerpoliciesSchedulerpolicyConfigRequest struct {
