...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.staticroutes.static.NextHops.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticroutesStaticNextHopsResponse struct {
	FrinxOpenconfigNetworkInstancenextHops *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticroutesStaticNextHops `json:"frinx-openconfig-network-instance:next-hops,omitempty"`
}
