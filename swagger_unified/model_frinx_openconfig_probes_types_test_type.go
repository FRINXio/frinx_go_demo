...
type FrinxOpenconfigProbesTypesTestType string

// List of frinx.openconfig.probes.types.TestType
const (
	FrinxOpenconfigProbesTypesTestType_ICMP FrinxOpenconfigProbesTypesTestType = "ICMP"
	FrinxOpenconfigProbesTypesTestType_ICMP6 FrinxOpenconfigProbesTypesTestType = "ICMP6"
	FrinxOpenconfigProbesTypesTestType_ICMP_TIMESTAMP FrinxOpenconfigProbesTypesTestType = "ICMP_TIMESTAMP"
	FrinxOpenconfigProbesTypesTestType_ICMP6_TIMESTAMP FrinxOpenconfigProbesTypesTestType = "ICMP6_TIMESTAMP"
	FrinxOpenconfigProbesTypesTestType_TCP FrinxOpenconfigProbesTypesTestType = "TCP"
	FrinxOpenconfigProbesTypesTestType_UDP FrinxOpenconfigProbesTypesTestType = "UDP"
	FrinxOpenconfigProbesTypesTestType_UDP_TIMESTAMP FrinxOpenconfigProbesTypesTestType = "UDP_TIMESTAMP"
	FrinxOpenconfigProbesTypesTestType_HTTP_GET FrinxOpenconfigProbesTypesTestType = "HTTP_GET"
	FrinxOpenconfigProbesTypesTestType_HTTP_GET_META FrinxOpenconfigProbesTypesTestType = "HTTP_GET_META"
)
