...
// Optional[Configuration parameters for BFD] REF:Optional.empty
type FrinxBfdBfdtopBfdConfig struct {
	// Optional[Interval for receiving BFD packets (in milliseconds)] REF:Optional.empty
	MinReceiveInterval int64 `json:"min-receive-interval,omitempty"`
	// Optional[Destination address for BFD sessions] REF:Optional.empty
	DestinationAddress string `json:"destination-address,omitempty"`
	// Optional[Interval for sending BFD packets (in milliseconds)] REF:Optional.empty
	MinInterval int64 `json:"min-interval,omitempty"`
	// Optional[Detection multiplier for BFD sessions] REF:Optional.empty
	Multiplier int64 `json:"multiplier,omitempty"`
	// Optional[Source address for BFD sessions. By default, IP address of interface with BFD session is used.] REF:Optional.empty
