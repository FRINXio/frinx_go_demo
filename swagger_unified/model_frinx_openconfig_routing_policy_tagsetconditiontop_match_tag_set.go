...
type FrinxOpenconfigRoutingPolicyTagsetconditiontopMatchTagSet struct {
	// Optional[Configuration data for tag-set conditions] REF:Optional.empty
	Config *FrinxOpenconfigRoutingPolicyTagsetconditiontopMatchtagsetConfig `json:"config,omitempty"`
}
