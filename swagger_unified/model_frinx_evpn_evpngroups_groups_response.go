...
// frinx.evpn.evpngroups.Groups.response
type FrinxEvpnEvpngroupsGroupsResponse struct {
	FrinxEvpngroups *FrinxEvpnEvpngroupsGroups `json:"frinx-evpn:groups,omitempty"`
}
