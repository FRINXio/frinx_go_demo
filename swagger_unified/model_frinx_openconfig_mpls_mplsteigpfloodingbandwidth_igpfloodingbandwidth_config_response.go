...
// frinx.openconfig.mpls.mplsteigpfloodingbandwidth.igpfloodingbandwidth.Config.response
type FrinxOpenconfigMplsMplsteigpfloodingbandwidthIgpfloodingbandwidthConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsMplsteigpfloodingbandwidthIgpfloodingbandwidthConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
