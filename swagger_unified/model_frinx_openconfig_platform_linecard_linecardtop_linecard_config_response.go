...
// frinx.openconfig.platform.linecard.linecardtop.linecard.Config.response
type FrinxOpenconfigPlatformLinecardLinecardtopLinecardConfigResponse struct {
	FrinxOpenconfigPlatformLinecardconfig *FrinxOpenconfigPlatformLinecardLinecardtopLinecardConfig `json:"frinx-openconfig-platform-linecard:config,omitempty"`
}
