...
type FrinxOpenconfigBgpPolicyCommunitycounttopCommunitycountConfig struct {
	// Optional[value to compare with the community count] REF:Optional.empty
	Value int64 `json:"value,omitempty"`
	// Optional[type of comparison to be performed] REF:Optional.empty
	Operator *FrinxOpenconfigPolicyTypesOperatorIdentityref `json:"operator,omitempty"`
}
