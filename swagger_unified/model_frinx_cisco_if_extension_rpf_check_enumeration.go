...
type FrinxCiscoIfExtensionRpfCheckEnumeration string

// List of frinx.cisco.if.extension.RpfCheckEnumeration
const (
	FrinxCiscoIfExtensionRpfCheckEnumeration_ANY FrinxCiscoIfExtensionRpfCheckEnumeration = "ANY"
	FrinxCiscoIfExtensionRpfCheckEnumeration_RX FrinxCiscoIfExtensionRpfCheckEnumeration = "RX"
)
