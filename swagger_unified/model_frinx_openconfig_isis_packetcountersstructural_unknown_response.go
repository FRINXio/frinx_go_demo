...
// frinx.openconfig.isis.packetcountersstructural.Unknown.response
type FrinxOpenconfigIsisPacketcountersstructuralUnknownResponse struct {
	FrinxOpenconfigNetworkInstanceunknown *FrinxOpenconfigIsisPacketcountersstructuralUnknown `json:"frinx-openconfig-network-instance:unknown,omitempty"`
}
