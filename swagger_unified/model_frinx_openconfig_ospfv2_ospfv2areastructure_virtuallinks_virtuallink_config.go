...
type FrinxOpenconfigOspfv2Ospfv2areastructureVirtuallinksVirtuallinkConfig struct {
	// Optional[The router ID of the device which terminates the remote end of the virtual link] REF:Optional.empty
