...
type FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRuleAction struct {
	// Optional[Configuration parameters relating to the forwarding rule's action.] REF:Optional.empty
	Config *FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRuleActionConfig `json:"config,omitempty"`
}
