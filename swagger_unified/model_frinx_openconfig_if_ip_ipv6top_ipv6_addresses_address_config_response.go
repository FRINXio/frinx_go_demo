...
// frinx.openconfig.if.ip.ipv6top.ipv6.addresses.address.Config.response
type FrinxOpenconfigIfIpIpv6topIpv6AddressesAddressConfigResponse struct {
	FrinxOpenconfigIfIpconfig *FrinxOpenconfigIfIpIpv6topIpv6AddressesAddressConfig `json:"frinx-openconfig-if-ip:config,omitempty"`
}
