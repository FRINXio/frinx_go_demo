...
// frinx.openconfig.bgp.policy.communitycounttop.communitycount.Config.response
type FrinxOpenconfigBgpPolicyCommunitycounttopCommunitycountConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicyCommunitycounttopCommunitycountConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
