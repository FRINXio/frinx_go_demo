...
type FrinxOpenconfigVlanVlanlogicaltopVlanConfig struct {
	// Optional[VLAN id for the subinterface -- specified inline for the case of a local VLAN.  The id is scoped to the subinterface, and could be repeated on different subinterfaces.] REF:Optional.empty
