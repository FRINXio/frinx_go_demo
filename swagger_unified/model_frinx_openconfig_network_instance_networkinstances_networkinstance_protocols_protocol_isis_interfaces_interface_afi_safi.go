...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsisInterfacesInterfaceAfiSafi struct {
	// Optional[Address-family/Subsequent Address-family list.] REF:Optional.empty
	Af []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsisInterfacesInterfaceAfisafiAf `json:"af,omitempty"`
}
