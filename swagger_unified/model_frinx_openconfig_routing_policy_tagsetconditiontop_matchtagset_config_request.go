...
// frinx.openconfig.routing.policy.tagsetconditiontop.matchtagset.Config.request
type FrinxOpenconfigRoutingPolicyTagsetconditiontopMatchtagsetConfigRequest struct {
