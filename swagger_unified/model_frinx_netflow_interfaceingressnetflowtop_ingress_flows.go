...
type FrinxNetflowInterfaceingressnetflowtopIngressFlows struct {
	// Optional[List of ingress NetFlow flows on the interface] REF:Optional.empty
	IngressFlow []FrinxNetflowInterfaceingressnetflowtopIngressflowsIngressFlow `json:"ingress-flow,omitempty"`
}
