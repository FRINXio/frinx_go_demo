...
// frinx.openconfig.bgp.bgpcommonmpallafisaficommon.PrefixLimit.request
type FrinxOpenconfigBgpBgpcommonmpallafisaficommonPrefixLimitRequest17 struct {
	FrinxOpenconfigNetworkInstanceprefixLimit *FrinxOpenconfigBgpBgpcommonmpallafisaficommonPrefixLimit `json:"frinx-openconfig-network-instance:prefix-limit,omitempty"`
}
