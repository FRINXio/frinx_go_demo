...
// frinx.openconfig.isis.packetcountersstructural.Iih.response
type FrinxOpenconfigIsisPacketcountersstructuralIihResponse struct {
	FrinxOpenconfigNetworkInstanceiih *FrinxOpenconfigIsisPacketcountersstructuralIih `json:"frinx-openconfig-network-instance:iih,omitempty"`
}
