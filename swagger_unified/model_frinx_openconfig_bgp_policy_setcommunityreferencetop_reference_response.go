...
// frinx.openconfig.bgp.policy.setcommunityreferencetop.Reference.response
type FrinxOpenconfigBgpPolicySetcommunityreferencetopReferenceResponse struct {
	FrinxOpenconfigBgpPolicyreference *FrinxOpenconfigBgpPolicySetcommunityreferencetopReference `json:"frinx-openconfig-bgp-policy:reference,omitempty"`
}
