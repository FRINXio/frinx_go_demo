...
// frinx.openconfig.bgp.policy.communitysettop.communitysets.CommunitySet.response
type FrinxOpenconfigBgpPolicyCommunitysettopCommunitysetsCommunitySetResponse struct {
	FrinxOpenconfigBgpPolicycommunitySet []FrinxOpenconfigBgpPolicyCommunitysettopCommunitysetsCommunitySet `json:"frinx-openconfig-bgp-policy:community-set,omitempty"`
}
