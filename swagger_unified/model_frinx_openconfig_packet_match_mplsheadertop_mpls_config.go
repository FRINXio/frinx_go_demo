...
// Optional[Configuration parameters relating to fields within the MPLS header.] REF:Optional.empty
type FrinxOpenconfigPacketMatchMplsheadertopMplsConfig struct {
	// Optional[The values of the MPLS traffic class (TC) bits, formerly known as the EXP bits.] REF:Optional.empty
	TrafficClass []int32 `json:"traffic-class,omitempty"`
}
