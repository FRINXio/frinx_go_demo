...
// Optional[Configured VLANs keyed by id] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceVlansVlan struct {
	// Optional[references the configured vlan-id] REF:Optional.empty
	VlanId int32 `json:"vlan-id,omitempty"`
	// Optional[Configuration parameters for VLANs] REF:Optional.empty
	Config *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceVlansVlanConfig `json:"config,omitempty"`
	// Optional[Enclosing container for list of member interfaces] REF:Optional.empty
	Members *FrinxOpenconfigVlanVlanmembersstateMembers `json:"members,omitempty"`
}
