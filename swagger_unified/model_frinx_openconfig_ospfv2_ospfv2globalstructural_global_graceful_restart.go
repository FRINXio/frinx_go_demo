...
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalGracefulRestart struct {
	// Optional[Configuration parameters relating to OSPFv2 graceful restart] REF:Optional.empty
	Config *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalGracefulrestartConfig `json:"config,omitempty"`
}
