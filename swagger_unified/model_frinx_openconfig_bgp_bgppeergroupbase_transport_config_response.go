...
// frinx.openconfig.bgp.bgppeergroupbase.transport.Config.response
type FrinxOpenconfigBgpBgppeergroupbaseTransportConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgppeergroupbaseTransportConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
