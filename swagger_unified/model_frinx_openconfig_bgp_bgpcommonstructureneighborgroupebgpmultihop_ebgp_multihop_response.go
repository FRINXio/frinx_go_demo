...
// frinx.openconfig.bgp.bgpcommonstructureneighborgroupebgpmultihop.EbgpMultihop.response
type FrinxOpenconfigBgpBgpcommonstructureneighborgroupebgpmultihopEbgpMultihopResponse struct {
	FrinxOpenconfigNetworkInstanceebgpMultihop *FrinxOpenconfigBgpBgpcommonstructureneighborgroupebgpmultihopEbgpMultihop `json:"frinx-openconfig-network-instance:ebgp-multihop,omitempty"`
}
