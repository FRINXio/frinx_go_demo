...
type FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntriesEntryConfig struct {
	// Optional[VLAN from which this MAC address was received] REF:Optional.empty
	Vlan int32 `json:"vlan,omitempty"`
	// Optional[MAC address for the dynamic or static MAC table entry] REF:Optional.empty
