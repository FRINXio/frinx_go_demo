...
// frinx.openconfig.ospfv2.ospfv2areastructure.VirtualLinks.response
type FrinxOpenconfigOspfv2Ospfv2areastructureVirtualLinksResponse struct {
	FrinxOpenconfigNetworkInstancevirtualLinks *FrinxOpenconfigOspfv2Ospfv2areastructureVirtualLinks `json:"frinx-openconfig-network-instance:virtual-links,omitempty"`
}
