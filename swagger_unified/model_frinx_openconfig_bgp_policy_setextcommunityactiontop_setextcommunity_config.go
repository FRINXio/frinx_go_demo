...
type FrinxOpenconfigBgpPolicySetextcommunityactiontopSetextcommunityConfig struct {
	// Optional[Indicates the method used to specify the extended communities for the set-ext-community action] REF:Optional.empty
	Method *FrinxOpenconfigBgpPolicyMethodEnumeration `json:"method,omitempty"`
	// Optional[Options for modifying the community attribute with the specified values.  These options apply to both methods of setting the community attribute.] REF:Optional.empty
	Options *FrinxOpenconfigBgpPolicyBgpSetCommunityOptionType `json:"options,omitempty"`
}
