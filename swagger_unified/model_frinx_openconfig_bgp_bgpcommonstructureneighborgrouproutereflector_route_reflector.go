...
type FrinxOpenconfigBgpBgpcommonstructureneighborgrouproutereflectorRouteReflector struct {
	// Optional[Configuraton parameters relating to route reflection for the BGPgroup] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpcommonstructureneighborgrouproutereflectorRoutereflectorConfig `json:"config,omitempty"`
}
