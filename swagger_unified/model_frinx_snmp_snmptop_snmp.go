...
// Optional[Enclosing container for snmp interface-specific data.] REF:Optional.empty
type FrinxSnmpSnmptopSnmp struct {
	// Optional[Configuration and operational state relating SNMP on interfaces.] REF:Optional.empty
	Interfaces *FrinxSnmpSnmpinterfacesstructuralInterfaces `json:"interfaces,omitempty"`
}
