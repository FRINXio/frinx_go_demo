...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.ospfv2.areas.Area.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2AreasAreaResponse struct {
	FrinxOpenconfigNetworkInstancearea []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2AreasArea `json:"frinx-openconfig-network-instance:area,omitempty"`
}
