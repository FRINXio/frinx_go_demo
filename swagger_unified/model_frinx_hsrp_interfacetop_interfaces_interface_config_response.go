...
// frinx.hsrp.interfacetop.interfaces.interface.Config.response
type FrinxHsrpInterfacetopInterfacesInterfaceConfigResponse struct {
	FrinxHsrpconfig *FrinxHsrpInterfacetopInterfacesInterfaceConfig `json:"frinx-hsrp:config,omitempty"`
}
