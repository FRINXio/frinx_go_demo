...
// frinx.openconfig.mpls.mplsadmingroupstop.mplsadmingroups.admingroup.Config.response
type FrinxOpenconfigMplsMplsadmingroupstopMplsadmingroupsAdmingroupConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsMplsadmingroupstopMplsadmingroupsAdmingroupConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
