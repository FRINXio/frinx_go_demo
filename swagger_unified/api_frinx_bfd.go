...
type FrinxBfdApiService service
...
*/
func (a *FrinxBfdApiService) DeleteFrinxOpenconfigInterfacesInterfacesInterfaceAggregationBfd(ctx context.Context, name string, nodeId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/config/network-topology:network-topology/network-topology:topology/unified/network-topology:node/{node-id}/yang-ext:mount/frinx-openconfig-interfaces:interfaces/frinx-openconfig-interfaces:interface/{name}/frinx-openconfig-if-aggregate:aggregation/frinx-bfd:bfd/"
...
*/
func (a *FrinxBfdApiService) DeleteFrinxOpenconfigInterfacesInterfacesInterfaceAggregationBfdConfig(ctx context.Context, name string, nodeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return FrinxBfdBfdtopBfdResponse
*/
func (a *FrinxBfdApiService) GetFrinxOpenconfigInterfacesInterfacesInterfaceAggregationBfd(ctx context.Context, name string, nodeId string) (FrinxBfdBfdtopBfdResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxBfdBfdtopBfdResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxBfdBfdtopBfdResponse
...
@return FrinxBfdBfdtopBfdConfigResponse
*/
func (a *FrinxBfdApiService) GetFrinxOpenconfigInterfacesInterfacesInterfaceAggregationBfdConfig(ctx context.Context, name string, nodeId string) (FrinxBfdBfdtopBfdConfigResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxBfdBfdtopBfdConfigResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxBfdBfdtopBfdConfigResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
*/
func (a *FrinxBfdApiService) PutFrinxOpenconfigInterfacesInterfacesInterfaceAggregationBfd(ctx context.Context, name string, frinxBfdBfdtopBfdBodyParam FrinxBfdBfdtopBfdRequest, nodeId string) (*http.Response, error) {
	var (
...
*/
func (a *FrinxBfdApiService) PutFrinxOpenconfigInterfacesInterfacesInterfaceAggregationBfdConfig(ctx context.Context, name string, frinxBfdBfdtopBfdConfigBodyParam FrinxBfdBfdtopBfdConfigRequest, nodeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
