...
// frinx.netflow.interfaceegressnetflowtop.egressflows.EgressFlow.response
type FrinxNetflowInterfaceegressnetflowtopEgressflowsEgressFlowResponse struct {
	FrinxNetflowegressFlow []FrinxNetflowInterfaceegressnetflowtopEgressflowsEgressFlow `json:"frinx-netflow:egress-flow,omitempty"`
}
