...
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryActions struct {
	// Optional[Config data for ACL actions] REF:Optional.empty
	Config *FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryActionsConfig `json:"config,omitempty"`
}
