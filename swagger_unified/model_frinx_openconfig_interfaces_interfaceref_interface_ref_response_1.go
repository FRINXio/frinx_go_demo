...
type FrinxOpenconfigInterfacesInterfacerefInterfaceRefResponse1 struct {
	FrinxOpenconfigAclinterfaceRef *FrinxOpenconfigInterfacesInterfacerefInterfaceRef `json:"frinx-openconfig-acl:interface-ref,omitempty"`
}
