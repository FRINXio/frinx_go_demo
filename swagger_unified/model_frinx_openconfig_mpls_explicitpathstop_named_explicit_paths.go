...
type FrinxOpenconfigMplsExplicitpathstopNamedExplicitPaths struct {
	// Optional[A list of explicit paths] REF:Optional.empty
	NamedExplicitPath []FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedExplicitPath `json:"named-explicit-path,omitempty"`
}
