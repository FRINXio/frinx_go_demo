...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.staticroutes.static.nexthops.NextHop.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticroutesStaticNexthopsNextHopResponse struct {
	FrinxOpenconfigNetworkInstancenextHop []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticroutesStaticNexthopsNextHop `json:"frinx-openconfig-network-instance:next-hop,omitempty"`
}
