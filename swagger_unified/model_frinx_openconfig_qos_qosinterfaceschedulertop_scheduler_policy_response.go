...
// frinx.openconfig.qos.qosinterfaceschedulertop.SchedulerPolicy.response
type FrinxOpenconfigQosQosinterfaceschedulertopSchedulerPolicyResponse struct {
	FrinxOpenconfigQosschedulerPolicy *FrinxOpenconfigQosQosinterfaceschedulertopSchedulerPolicy `json:"frinx-openconfig-qos:scheduler-policy,omitempty"`
}
