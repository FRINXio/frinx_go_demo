...
// frinx.openconfig.network.instance.policy.protocolinstancepolicytop.matchprotocolinstance.Config.response
type FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchprotocolinstanceConfigResponse struct {
	FrinxOpenconfigNetworkInstancePolicyconfig *FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchprotocolinstanceConfig `json:"frinx-openconfig-network-instance-policy:config,omitempty"`
}
