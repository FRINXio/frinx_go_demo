...
type FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceTablesTableConfig struct {
	// Optional[Reference to the protocol that the table is associated with.] REF:Optional.empty
	Protocol *FrinxOpenconfigNetworkInstanceProtocolIdentityref `json:"protocol,omitempty"`
	// Optional[The address family (IPv4, IPv6) of the table's entries] REF:Optional.empty
