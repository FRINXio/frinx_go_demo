...
type FrinxOpenconfigBgpPolicyRoutingpolicyDefinedsetsBgpDefinedSets struct {
	// Optional[Enclosing container for list of extended BGP community sets] REF:Optional.empty
	ExtCommunitySets *FrinxOpenconfigBgpPolicyExtcommunitysettopExtCommunitySets `json:"ext-community-sets,omitempty"`
	// Optional[Enclosing container for list of defined BGP community sets] REF:Optional.empty
	CommunitySets *FrinxOpenconfigBgpPolicyCommunitysettopCommunitySets `json:"community-sets,omitempty"`
	// Optional[Enclosing container for list of define AS path sets] REF:Optional.empty
	AsPathSets *FrinxOpenconfigBgpPolicyAspathsettopAsPathSets `json:"as-path-sets,omitempty"`
}
