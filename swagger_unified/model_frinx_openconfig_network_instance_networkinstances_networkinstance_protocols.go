...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocols struct {
	...
	Protocol []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocol `json:"protocol,omitempty"`
}
