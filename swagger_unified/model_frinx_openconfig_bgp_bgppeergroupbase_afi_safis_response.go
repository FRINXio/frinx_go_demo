...
// frinx.openconfig.bgp.bgppeergroupbase.AfiSafis.response
type FrinxOpenconfigBgpBgppeergroupbaseAfiSafisResponse struct {
	FrinxOpenconfigNetworkInstanceafiSafis *FrinxOpenconfigBgpBgppeergroupbaseAfiSafis `json:"frinx-openconfig-network-instance:afi-safis,omitempty"`
}
