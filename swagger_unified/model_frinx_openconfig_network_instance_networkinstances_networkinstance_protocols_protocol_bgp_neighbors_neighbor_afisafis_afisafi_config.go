...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpNeighborsNeighborAfisafisAfisafiConfig struct {
	// Optional.empty REF:Optional.empty
	FrinxBgpExtensionsoftReconfiguration *FrinxBgpExtensionSoftreconfigurationgroupSoftReconfiguration `json:"frinx-bgp-extension:soft-reconfiguration,omitempty"`
	// Optional[This leaf indicates whether the IPv4 Unicast AFI,SAFI is enabled for the neighbour or group] REF:Optional.empty
	Enabled bool `json:"enabled,omitempty"`
	// Optional[AFI,SAFI] REF:Optional.empty
	AfiSafiName *FrinxOpenconfigBgpAfiSafiNameIdentityref `json:"afi-safi-name,omitempty"`
}
