...
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMplsIgpLdpSync struct {
	// Optional[Configuration parameters relating to LDP/IG synchronization.] REF:Optional.empty
	Config *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMplsIgpldpsyncConfig `json:"config,omitempty"`
}
