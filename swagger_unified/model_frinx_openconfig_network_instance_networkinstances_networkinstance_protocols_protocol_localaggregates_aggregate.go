...
// Optional[List of aggregates] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolLocalaggregatesAggregate struct {
	// Optional[Configuration data for aggregate advertisements] REF:Optional.empty
	Config *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolLocalaggregatesAggregateConfig `json:"config,omitempty"`
	// Optional[Reference to the configured prefix for this aggregate] REF:Optional.empty
