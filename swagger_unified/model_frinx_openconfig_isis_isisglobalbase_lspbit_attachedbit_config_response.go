...
// frinx.openconfig.isis.isisglobalbase.lspbit.attachedbit.Config.response
type FrinxOpenconfigIsisIsisglobalbaseLspbitAttachedbitConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisglobalbaseLspbitAttachedbitConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
