...
// frinx.netflow.interfaceegressnetflowtop.EgressFlows.response
type FrinxNetflowInterfaceegressnetflowtopEgressFlowsResponse struct {
	FrinxNetflowegressFlows *FrinxNetflowInterfaceegressnetflowtopEgressFlows `json:"frinx-netflow:egress-flows,omitempty"`
}
