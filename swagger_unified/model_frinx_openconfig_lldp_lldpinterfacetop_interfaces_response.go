...
type FrinxOpenconfigLldpLldpinterfacetopInterfacesResponse struct {
	FrinxCdpinterfaces *FrinxOpenconfigLldpLldpinterfacetopInterfaces `json:"frinx-cdp:interfaces,omitempty"`
}
