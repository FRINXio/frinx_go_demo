...
// frinx.openconfig.platform.platformanchorstop.IntegratedCircuit.response
type FrinxOpenconfigPlatformPlatformanchorstopIntegratedCircuitResponse struct {
	FrinxOpenconfigPlatformintegratedCircuit *FrinxOpenconfigPlatformPlatformanchorstopIntegratedCircuit `json:"frinx-openconfig-platform:integrated-circuit,omitempty"`
}
