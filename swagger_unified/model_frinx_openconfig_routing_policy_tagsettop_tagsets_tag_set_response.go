...
// frinx.openconfig.routing.policy.tagsettop.tagsets.TagSet.response
type FrinxOpenconfigRoutingPolicyTagsettopTagsetsTagSetResponse struct {
	FrinxOpenconfigRoutingPolicytagSet []FrinxOpenconfigRoutingPolicyTagsettopTagsetsTagSet `json:"frinx-openconfig-routing-policy:tag-set,omitempty"`
}
