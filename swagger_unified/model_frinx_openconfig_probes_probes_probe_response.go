...
// frinx.openconfig.probes.probes.Probe.response
type FrinxOpenconfigProbesProbesProbeResponse struct {
	FrinxOpenconfigProbesprobe []FrinxOpenconfigProbesProbesProbe `json:"frinx-openconfig-probes:probe,omitempty"`
}
