...
// frinx.openconfig.platform.platformsubcomponentreftop.subcomponents.Subcomponent.response
type FrinxOpenconfigPlatformPlatformsubcomponentreftopSubcomponentsSubcomponentResponse struct {
	FrinxOpenconfigPlatformsubcomponent []FrinxOpenconfigPlatformPlatformsubcomponentreftopSubcomponentsSubcomponent `json:"frinx-openconfig-platform:subcomponent,omitempty"`
}
