...
type FrinxOpenconfigIsisIsisglobalbaseLspBit struct {
	// Optional[This container defines Overload Bit configuration.] REF:Optional.empty
	OverloadBit *FrinxOpenconfigIsisIsisglobalbaseLspbitOverloadBit `json:"overload-bit,omitempty"`
	// Optional[This container defines Attached Bit.] REF:Optional.empty
	AttachedBit *FrinxOpenconfigIsisIsisglobalbaseLspbitAttachedBit `json:"attached-bit,omitempty"`
}
