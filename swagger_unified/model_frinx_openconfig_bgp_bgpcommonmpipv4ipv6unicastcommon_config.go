...
type FrinxOpenconfigBgpBgpcommonmpipv4ipv6unicastcommonConfig struct {
	// Optional[If set to true, send the default-route to the neighbour(s)] REF:Optional.empty
	SendDefaultRoute bool `json:"send-default-route,omitempty"`
}
