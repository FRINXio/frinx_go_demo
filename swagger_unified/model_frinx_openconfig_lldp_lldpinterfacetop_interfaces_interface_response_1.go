...
// frinx.openconfig.lldp.lldpinterfacetop.interfaces.Interface.response
type FrinxOpenconfigLldpLldpinterfacetopInterfacesInterfaceResponse1 struct {
	FrinxOpenconfigLldpinterface []FrinxOpenconfigLldpLldpinterfacetopInterfacesInterface `json:"frinx-openconfig-lldp:interface,omitempty"`
}
