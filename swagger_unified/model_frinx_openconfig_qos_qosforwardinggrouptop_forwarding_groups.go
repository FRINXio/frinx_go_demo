...
type FrinxOpenconfigQosQosforwardinggrouptopForwardingGroups struct {
	...
	ForwardingGroup []FrinxOpenconfigQosQosforwardinggrouptopForwardinggroupsForwardingGroup `json:"forwarding-group,omitempty"`
}
