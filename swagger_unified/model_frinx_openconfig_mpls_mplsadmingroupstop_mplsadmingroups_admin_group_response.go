...
// frinx.openconfig.mpls.mplsadmingroupstop.mplsadmingroups.AdminGroup.response
type FrinxOpenconfigMplsMplsadmingroupstopMplsadmingroupsAdminGroupResponse struct {
	FrinxOpenconfigNetworkInstanceadminGroup []FrinxOpenconfigMplsMplsadmingroupstopMplsadmingroupsAdminGroup `json:"frinx-openconfig-network-instance:admin-group,omitempty"`
}
