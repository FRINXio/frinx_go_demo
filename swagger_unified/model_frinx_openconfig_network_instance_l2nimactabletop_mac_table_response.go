...
// frinx.openconfig.network.instance.l2nimactabletop.MacTable.response
type FrinxOpenconfigNetworkInstanceL2nimactabletopMacTableResponse struct {
	FrinxOpenconfigNetworkInstancemacTable *FrinxOpenconfigNetworkInstanceL2nimactabletopMacTable `json:"frinx-openconfig-network-instance:mac-table,omitempty"`
}
