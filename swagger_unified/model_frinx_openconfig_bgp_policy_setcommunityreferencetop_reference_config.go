...
type FrinxOpenconfigBgpPolicySetcommunityreferencetopReferenceConfig struct {
	// Optional[References a defined community set by name] REF:Optional.empty
	CommunitySetRef string `json:"community-set-ref,omitempty"`
}
