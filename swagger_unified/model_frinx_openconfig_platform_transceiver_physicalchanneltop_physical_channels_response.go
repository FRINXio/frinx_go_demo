...
// frinx.openconfig.platform.transceiver.physicalchanneltop.PhysicalChannels.response
type FrinxOpenconfigPlatformTransceiverPhysicalchanneltopPhysicalChannelsResponse struct {
	FrinxOpenconfigPlatformTransceiverphysicalChannels *FrinxOpenconfigPlatformTransceiverPhysicalchanneltopPhysicalChannels `json:"frinx-openconfig-platform-transceiver:physical-channels,omitempty"`
}
