...
// frinx.openconfig.bgp.bgpcommonrouteselectionoptions.routeselectionoptions.Config.response
type FrinxOpenconfigBgpBgpcommonrouteselectionoptionsRouteselectionoptionsConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpcommonrouteselectionoptionsRouteselectionoptionsConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
