...
// frinx.juniper.pf.interfaces.extension.juniperpfinterfaceextensionconfig.classifiers.InetPrecedence.response
type FrinxJuniperPfInterfacesExtensionJuniperpfinterfaceextensionconfigClassifiersInetPrecedenceResponse struct {
	FrinxJuniperPfInterfacesExtensioninetPrecedence *FrinxJuniperPfInterfacesExtensionJuniperpfinterfaceextensionconfigClassifiersInetPrecedence `json:"frinx-juniper-pf-interfaces-extension:inet-precedence,omitempty"`
}
