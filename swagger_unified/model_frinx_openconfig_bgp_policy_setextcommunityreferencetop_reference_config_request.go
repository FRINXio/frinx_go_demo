...
// frinx.openconfig.bgp.policy.setextcommunityreferencetop.reference.Config.request
type FrinxOpenconfigBgpPolicySetextcommunityreferencetopReferenceConfigRequest struct {
