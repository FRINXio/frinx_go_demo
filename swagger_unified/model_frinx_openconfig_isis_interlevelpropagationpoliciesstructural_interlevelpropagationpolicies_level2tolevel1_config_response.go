...
// frinx.openconfig.isis.interlevelpropagationpoliciesstructural.interlevelpropagationpolicies.level2tolevel1.Config.response
type FrinxOpenconfigIsisInterlevelpropagationpoliciesstructuralInterlevelpropagationpoliciesLevel2tolevel1ConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisInterlevelpropagationpoliciesstructuralInterlevelpropagationpoliciesLevel2tolevel1Config `json:"frinx-openconfig-network-instance:config,omitempty"`
}
