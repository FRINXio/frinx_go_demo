...
// frinx.openconfig.ospfv2.ospfv2areainterfacesstructure.interfaces.interface.mpls.IgpLdpSync.response
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMplsIgpLdpSyncResponse struct {
	FrinxOpenconfigNetworkInstanceigpLdpSync *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMplsIgpLdpSync `json:"frinx-openconfig-network-instance:igp-ldp-sync,omitempty"`
}
