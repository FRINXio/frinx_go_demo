...
// Optional[Configuration data for IPv4 match fields] REF:Optional.empty
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryIpv4Config struct {
	...
	FrinxAclExtensionsourceAddressWildcarded *FrinxAclExtensionSrcdstipv4addresswildcardedSourceAddressWildcarded `json:"frinx-acl-extension:source-address-wildcarded,omitempty"`
	...
	// Optional.empty REF:Optional.empty
	FrinxAclExtensiondestinationAddressWildcarded *FrinxAclExtensionSrcdstipv4addresswildcardedDestinationAddressWildcarded `json:"frinx-acl-extension:destination-address-wildcarded,omitempty"`
	// Optional[Destination IPv4 address prefix.] REF:Optional.empty
	DestinationAddress string `json:"destination-address,omitempty"`
	// Optional[Source IPv4 address prefix.] REF:Optional.empty
