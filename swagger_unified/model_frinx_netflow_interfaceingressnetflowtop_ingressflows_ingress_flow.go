...
// Optional[List of ingress NetFlow flows on the interface] REF:Optional.empty
type FrinxNetflowInterfaceingressnetflowtopIngressflowsIngressFlow struct {
	// Optional[Configuration data ] REF:Optional.empty
	Config *FrinxNetflowInterfaceingressnetflowtopIngressflowsIngressflowConfig `json:"config,omitempty"`
	// Optional[Reference to type list key] REF:Optional.empty
	NetflowType string `json:"netflow-type,omitempty"`
}
