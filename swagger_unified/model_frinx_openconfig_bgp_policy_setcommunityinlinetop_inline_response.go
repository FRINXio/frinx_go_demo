...
// frinx.openconfig.bgp.policy.setcommunityinlinetop.Inline.response
type FrinxOpenconfigBgpPolicySetcommunityinlinetopInlineResponse struct {
	FrinxOpenconfigBgpPolicyinline *FrinxOpenconfigBgpPolicySetcommunityinlinetopInline `json:"frinx-openconfig-bgp-policy:inline,omitempty"`
}
