...
// frinx.openconfig.policy.forwarding.pfforwardingpolicystructural.policies.policy.rules.Rule.response
type FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRuleResponse struct {
	FrinxOpenconfigNetworkInstancerule []FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRule `json:"frinx-openconfig-network-instance:rule,omitempty"`
}
