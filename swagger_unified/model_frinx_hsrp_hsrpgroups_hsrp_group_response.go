...
// frinx.hsrp.hsrpgroups.HsrpGroup.response
type FrinxHsrpHsrpgroupsHsrpGroupResponse struct {
	FrinxHsrphsrpGroup []FrinxHsrpHsrpgroupsHsrpGroup `json:"frinx-hsrp:hsrp-group,omitempty"`
}
