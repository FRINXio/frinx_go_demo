...
type FrinxCiscoIfExtensionVerifyunicastsourcereachableviatopVerifyUnicastSourceReachableVia struct {
	// Optional.empty REF:Optional.empty
	Ipv4 *FrinxCiscoIfExtensionIpv4verifyIpv4 `json:"ipv4,omitempty"`
	// Optional.empty REF:Optional.empty
	Ipv6 *FrinxCiscoIfExtensionIpv6verifyIpv6 `json:"ipv6,omitempty"`
}
