...
// frinx.openconfig.isis.isislevelgroup.trafficengineering.Config.response
type FrinxOpenconfigIsisIsislevelgroupTrafficengineeringConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsislevelgroupTrafficengineeringConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
