...
// frinx.openconfig.mpls.tetunnelp2ptop.P2pTunnelAttributes.response
type FrinxOpenconfigMplsTetunnelp2ptopP2pTunnelAttributesResponse struct {
	FrinxOpenconfigNetworkInstancep2pTunnelAttributes *FrinxOpenconfigMplsTetunnelp2ptopP2pTunnelAttributes `json:"frinx-openconfig-network-instance:p2p-tunnel-attributes,omitempty"`
}
