...
// frinx.openconfig.bgp.bgpglobalbase.GracefulRestart.response
type FrinxOpenconfigBgpBgpglobalbaseGracefulRestartResponse struct {
	FrinxOpenconfigNetworkInstancegracefulRestart *FrinxOpenconfigBgpBgpglobalbaseGracefulRestart `json:"frinx-openconfig-network-instance:graceful-restart,omitempty"`
}
