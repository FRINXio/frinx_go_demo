...
// frinx.openconfig.isis.isislevelgroup.Config.response
type FrinxOpenconfigIsisIsislevelgroupConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsislevelgroupConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
