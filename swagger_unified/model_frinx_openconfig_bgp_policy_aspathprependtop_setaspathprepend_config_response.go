...
// frinx.openconfig.bgp.policy.aspathprependtop.setaspathprepend.Config.response
type FrinxOpenconfigBgpPolicyAspathprependtopSetaspathprependConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicyAspathprependtopSetaspathprependConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
