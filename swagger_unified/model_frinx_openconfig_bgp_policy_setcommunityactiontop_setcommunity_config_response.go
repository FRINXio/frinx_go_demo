...
// frinx.openconfig.bgp.policy.setcommunityactiontop.setcommunity.Config.response
type FrinxOpenconfigBgpPolicySetcommunityactiontopSetcommunityConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicySetcommunityactiontopSetcommunityConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
