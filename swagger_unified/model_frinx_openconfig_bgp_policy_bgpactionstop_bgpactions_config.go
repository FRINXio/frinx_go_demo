...
type FrinxOpenconfigBgpPolicyBgpactionstopBgpactionsConfig struct {
	// Optional[set the local pref attribute on the route update] REF:Optional.empty
	SetLocalPref int64 `json:"set-local-pref,omitempty"`
	// Optional[set the next-hop attribute in the route update] REF:Optional.empty
	SetNextHop string `json:"set-next-hop,omitempty"`
	// Optional[set the origin attribute to the specified value] REF:Optional.empty
	SetRouteOrigin *FrinxOpenconfigBgpTypesBgpOriginAttrType `json:"set-route-origin,omitempty"`
	// Optional[set the med metric attribute in the route update] REF:Optional.empty
	SetMed string `json:"set-med,omitempty"`
}
