...
// frinx.openconfig.bgp.policy.bgpconditionstop.bgpconditions.Config.response
type FrinxOpenconfigBgpPolicyBgpconditionstopBgpconditionsConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicyBgpconditionstopBgpconditionsConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
