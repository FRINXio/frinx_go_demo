...
// frinx.openconfig.bgp.bgpglobalbase.gracefulrestart.Config.response
type FrinxOpenconfigBgpBgpglobalbaseGracefulrestartConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpglobalbaseGracefulrestartConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
