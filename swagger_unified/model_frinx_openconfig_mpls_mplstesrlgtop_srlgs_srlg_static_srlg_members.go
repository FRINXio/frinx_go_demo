...
type FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgStaticSrlgMembers struct {
	...
	MembersList []FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgStaticsrlgmembersMembersList `json:"members-list,omitempty"`
}
