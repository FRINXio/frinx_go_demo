...
// frinx.openconfig.mpls.ldp.mplsldpneighborstop.neighbors.Neighbor.response
type FrinxOpenconfigMplsLdpMplsldpneighborstopNeighborsNeighborResponse struct {
	FrinxOpenconfigNetworkInstanceneighbor []FrinxOpenconfigMplsLdpMplsldpneighborstopNeighborsNeighbor `json:"frinx-openconfig-network-instance:neighbor,omitempty"`
}
