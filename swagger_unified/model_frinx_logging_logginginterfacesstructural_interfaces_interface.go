...
// Optional[Configuration and operationals state relating to the relationship between interfaces and logging.] REF:Optional.empty
type FrinxLoggingLogginginterfacesstructuralInterfacesInterface struct {
	// Optional[Configuration parameters relating to an interface to logging binding.] REF:Optional.empty
	Config *FrinxLoggingLogginginterfacesstructuralInterfacesInterfaceConfig `json:"config,omitempty"`
	// Optional[A reference to the unique identifier for the interface being referenced by the logging.] REF:Optional.empty
