...
// frinx.openconfig.mpls.tepathplacementconstraintstop.AdminGroups.response
type FrinxOpenconfigMplsTepathplacementconstraintstopAdminGroupsResponse struct {
	FrinxOpenconfigNetworkInstanceadminGroups *FrinxOpenconfigMplsTepathplacementconstraintstopAdminGroups `json:"frinx-openconfig-network-instance:admin-groups,omitempty"`
}
