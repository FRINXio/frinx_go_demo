...
type FrinxOpenconfigBgpBgpneighborusemultiplepathsUseMultiplePaths struct {
	// Optional[Multipath configuration for eBGP] REF:Optional.empty
	Ebgp *FrinxOpenconfigBgpBgpneighborusemultiplepathsUsemultiplepathsEbgp `json:"ebgp,omitempty"`
	// Optional[Configuration parameters relating to multipath] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpneighborusemultiplepathsUsemultiplepathsConfig `json:"config,omitempty"`
}
