...
// frinx.openconfig.mpls.tetunnelbandwidthtop.bandwidth.autobandwidth.Overflow.response
type FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthOverflowResponse struct {
	FrinxOpenconfigNetworkInstanceoverflow *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthOverflow `json:"frinx-openconfig-network-instance:overflow,omitempty"`
}
