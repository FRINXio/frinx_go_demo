...
// frinx.openconfig.bfd.bfd.Interfaces.response
type FrinxOpenconfigBfdBfdInterfacesResponse struct {
	FrinxOpenconfigBfdinterfaces *FrinxOpenconfigBfdBfdInterfaces `json:"frinx-openconfig-bfd:interfaces,omitempty"`
}
