...
// frinx.openconfig.acl.inputinterfacetop.InputInterface.response
type FrinxOpenconfigAclInputinterfacetopInputInterfaceResponse struct {
	FrinxOpenconfigAclinputInterface *FrinxOpenconfigAclInputinterfacetopInputInterface `json:"frinx-openconfig-acl:input-interface,omitempty"`
}
