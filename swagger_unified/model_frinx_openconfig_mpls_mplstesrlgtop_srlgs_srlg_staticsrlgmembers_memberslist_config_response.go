...
// frinx.openconfig.mpls.mplstesrlgtop.srlgs.srlg.staticsrlgmembers.memberslist.Config.response
type FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgStaticsrlgmembersMemberslistConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgStaticsrlgmembersMemberslistConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
