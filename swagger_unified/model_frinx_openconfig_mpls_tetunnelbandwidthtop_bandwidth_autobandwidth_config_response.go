...
// frinx.openconfig.mpls.tetunnelbandwidthtop.bandwidth.autobandwidth.Config.response
type FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
