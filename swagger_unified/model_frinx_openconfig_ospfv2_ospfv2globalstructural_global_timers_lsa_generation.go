...
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersLsaGeneration struct {
	// Optional[Configuration parameters relating to the generation of LSAs by the local system] REF:Optional.empty
	Config *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersLsagenerationConfig `json:"config,omitempty"`
}
