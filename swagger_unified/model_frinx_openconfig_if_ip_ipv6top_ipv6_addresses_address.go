...
// Optional[The list of configured IPv6 addresses on the interface.] REF:Optional.empty
type FrinxOpenconfigIfIpIpv6topIpv6AddressesAddress struct {
	// Optional[Configuration data for each IPv6 address on the interface] REF:Optional.empty
	Config *FrinxOpenconfigIfIpIpv6topIpv6AddressesAddressConfig `json:"config,omitempty"`
