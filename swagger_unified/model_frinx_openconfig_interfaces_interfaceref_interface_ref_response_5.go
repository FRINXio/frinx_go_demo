...
type FrinxOpenconfigInterfacesInterfacerefInterfaceRefResponse5 struct {
	FrinxOpenconfigQosinterfaceRef *FrinxOpenconfigInterfacesInterfacerefInterfaceRef `json:"frinx-openconfig-qos:interface-ref,omitempty"`
}
