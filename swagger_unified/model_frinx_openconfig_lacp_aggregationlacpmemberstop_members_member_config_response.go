...
// frinx.openconfig.lacp.aggregationlacpmemberstop.members.member.Config.response
type FrinxOpenconfigLacpAggregationlacpmemberstopMembersMemberConfigResponse struct {
	FrinxOpenconfigLacpconfig *FrinxOpenconfigLacpAggregationlacpmemberstopMembersMemberConfig `json:"frinx-openconfig-lacp:config,omitempty"`
}
