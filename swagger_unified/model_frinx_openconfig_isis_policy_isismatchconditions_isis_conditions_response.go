...
// frinx.openconfig.isis.policy.isismatchconditions.IsisConditions.response
type FrinxOpenconfigIsisPolicyIsismatchconditionsIsisConditionsResponse struct {
