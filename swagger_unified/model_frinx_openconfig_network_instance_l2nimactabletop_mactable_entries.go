...
type FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntries struct {
	// Optional[List of learned MAC addresses] REF:Optional.empty
	Entry []FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntriesEntry `json:"entry,omitempty"`
}
