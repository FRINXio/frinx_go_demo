...
// frinx.openconfig.acl.acl.aclsets.aclset.aclentries.aclentry.transport.Config.request
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryTransportConfigRequest struct {
