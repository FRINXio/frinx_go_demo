...
// frinx.openconfig.qos.qosschedulertop.schedulerpolicies.schedulerpolicy.schedulers.scheduler.Config.response
type FrinxOpenconfigQosQosschedulertopSchedulerpoliciesSchedulerpolicySchedulersSchedulerConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosschedulertopSchedulerpoliciesSchedulerpolicySchedulersSchedulerConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
