...
// frinx.openconfig.mpls.mplstop.mpls.Global.response
type FrinxOpenconfigMplsMplstopMplsGlobalResponse struct {
	FrinxOpenconfigNetworkInstanceglobal *FrinxOpenconfigMplsMplstopMplsGlobal `json:"frinx-openconfig-network-instance:global,omitempty"`
}
