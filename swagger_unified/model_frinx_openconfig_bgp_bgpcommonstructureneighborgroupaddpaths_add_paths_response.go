...
// frinx.openconfig.bgp.bgpcommonstructureneighborgroupaddpaths.AddPaths.response
type FrinxOpenconfigBgpBgpcommonstructureneighborgroupaddpathsAddPathsResponse struct {
	FrinxOpenconfigNetworkInstanceaddPaths *FrinxOpenconfigBgpBgpcommonstructureneighborgroupaddpathsAddPaths `json:"frinx-openconfig-network-instance:add-paths,omitempty"`
}
