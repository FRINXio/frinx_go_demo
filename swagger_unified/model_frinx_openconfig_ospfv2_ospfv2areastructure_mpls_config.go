...
type FrinxOpenconfigOspfv2Ospfv2areastructureMplsConfig struct {
	// Optional[Specifies whether traffic engineering extensions should be advertised within the area] REF:Optional.empty
	TrafficEngineeringEnabled bool `json:"traffic-engineering-enabled,omitempty"`
}
