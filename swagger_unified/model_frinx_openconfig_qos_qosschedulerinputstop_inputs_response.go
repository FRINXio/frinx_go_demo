...
// frinx.openconfig.qos.qosschedulerinputstop.Inputs.response
type FrinxOpenconfigQosQosschedulerinputstopInputsResponse struct {
	FrinxOpenconfigQosinputs *FrinxOpenconfigQosQosschedulerinputstopInputs `json:"frinx-openconfig-qos:inputs,omitempty"`
}
