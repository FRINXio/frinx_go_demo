...
type FrinxOpenconfigPolicyTypesOperatorIdentityref string

// List of frinx.openconfig.policy.types.OperatorIdentityref
const (
	FrinxOpenconfigPolicyTypesOperatorIdentityref_COMPARISON FrinxOpenconfigPolicyTypesOperatorIdentityref = "frinx-openconfig-policy-types:ATTRIBUTE_COMPARISON"
	FrinxOpenconfigPolicyTypesOperatorIdentityref_LE FrinxOpenconfigPolicyTypesOperatorIdentityref = "frinx-openconfig-policy-types:ATTRIBUTE_LE"
	FrinxOpenconfigPolicyTypesOperatorIdentityref_EQ FrinxOpenconfigPolicyTypesOperatorIdentityref = "frinx-openconfig-policy-types:ATTRIBUTE_EQ"
	FrinxOpenconfigPolicyTypesOperatorIdentityref_GE FrinxOpenconfigPolicyTypesOperatorIdentityref = "frinx-openconfig-policy-types:ATTRIBUTE_GE"
)
