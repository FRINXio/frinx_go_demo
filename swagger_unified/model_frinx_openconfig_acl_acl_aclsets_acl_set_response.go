...
// frinx.openconfig.acl.acl.aclsets.AclSet.response
type FrinxOpenconfigAclAclAclsetsAclSetResponse struct {
	FrinxOpenconfigAclaclSet []FrinxOpenconfigAclAclAclsetsAclSet `json:"frinx-openconfig-acl:acl-set,omitempty"`
}
