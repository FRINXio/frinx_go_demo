...
// frinx.openconfig.bgp.bgpglobalafisafilist.afisafi.GracefulRestart.response
type FrinxOpenconfigBgpBgpglobalafisafilistAfisafiGracefulRestartResponse struct {
	FrinxOpenconfigNetworkInstancegracefulRestart *FrinxOpenconfigBgpBgpglobalafisafilistAfisafiGracefulRestart `json:"frinx-openconfig-network-instance:graceful-restart,omitempty"`
}
