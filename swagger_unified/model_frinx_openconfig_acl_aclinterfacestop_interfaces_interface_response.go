...
// frinx.openconfig.acl.aclinterfacestop.interfaces.Interface.response
type FrinxOpenconfigAclAclinterfacestopInterfacesInterfaceResponse struct {
	FrinxOpenconfigAclinterface []FrinxOpenconfigAclAclinterfacestopInterfacesInterface `json:"frinx-openconfig-acl:interface,omitempty"`
}
