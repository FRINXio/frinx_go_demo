...
type FrinxOpenconfigQosQueueTypeIdentityref string

// List of frinx.openconfig.qos.QueueTypeIdentityref
const (
	FrinxOpenconfigQosQueueTypeIdentityref_QOS_QUEUE_TYPE FrinxOpenconfigQosQueueTypeIdentityref = "frinx-openconfig-qos-types:QOS_QUEUE_TYPE"
	FrinxOpenconfigQosQueueTypeIdentityref_WRED FrinxOpenconfigQosQueueTypeIdentityref = "frinx-openconfig-qos-types:WRED"
	FrinxOpenconfigQosQueueTypeIdentityref_DROP_TAIL FrinxOpenconfigQosQueueTypeIdentityref = "frinx-openconfig-qos-types:DROP_TAIL"
	FrinxOpenconfigQosQueueTypeIdentityref_RED FrinxOpenconfigQosQueueTypeIdentityref = "frinx-openconfig-qos-types:RED"
)
