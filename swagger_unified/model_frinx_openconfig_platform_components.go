...
// Optional[Enclosing container for the components in the system.] REF:Optional.empty
type FrinxOpenconfigPlatformComponents struct {
	// Optional[List of components, keyed by component name.] REF:Optional.empty
	Component []FrinxOpenconfigPlatformComponentsComponent `json:"component,omitempty"`
}
