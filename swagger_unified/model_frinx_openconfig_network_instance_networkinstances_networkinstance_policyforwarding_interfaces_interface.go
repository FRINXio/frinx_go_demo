...
// Optional[Configuration and operationals state relating to the relationship between interfaces and policy-based forwarding rules.] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstancePolicyforwardingInterfacesInterface struct {
	// Optional[Configuration parameters relating to an interface to policy forwarding rule binding.] REF:Optional.empty
	Config *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstancePolicyforwardingInterfacesInterfaceConfig `json:"config,omitempty"`
	// Optional[A reference to the unique identifier for the interface being referenced by the policy.] REF:Optional.empty
