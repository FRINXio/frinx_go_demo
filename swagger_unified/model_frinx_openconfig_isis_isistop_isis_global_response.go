...
// frinx.openconfig.isis.isistop.isis.Global.response
type FrinxOpenconfigIsisIsistopIsisGlobalResponse struct {
	FrinxOpenconfigNetworkInstanceglobal *FrinxOpenconfigIsisIsistopIsisGlobal `json:"frinx-openconfig-network-instance:global,omitempty"`
}
