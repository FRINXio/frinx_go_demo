...
type FrinxOpenconfigIfIpIpvrrptrackingtopInterfaceTracking struct {
	// Optional[Configuration data for VRRP interface tracking] REF:Optional.empty
	Config *FrinxOpenconfigIfIpIpvrrptrackingtopInterfacetrackingConfig `json:"config,omitempty"`
}
