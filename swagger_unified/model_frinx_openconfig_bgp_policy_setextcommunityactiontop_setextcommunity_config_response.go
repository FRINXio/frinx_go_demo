...
// frinx.openconfig.bgp.policy.setextcommunityactiontop.setextcommunity.Config.response
type FrinxOpenconfigBgpPolicySetextcommunityactiontopSetextcommunityConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicySetextcommunityactiontopSetextcommunityConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
