...
// frinx.openconfig.vlan.vlanlogicaltop.vlan.Config.response
type FrinxOpenconfigVlanVlanlogicaltopVlanConfigResponse struct {
	FrinxOpenconfigVlanconfig *FrinxOpenconfigVlanVlanlogicaltopVlanConfig `json:"frinx-openconfig-vlan:config,omitempty"`
}
