...
type FrinxOpenconfigAclInterfaceegressacltopEgressAclSets struct {
	// Optional[List of egress ACLs on the interface] REF:Optional.empty
	EgressAclSet []FrinxOpenconfigAclInterfaceegressacltopEgressaclsetsEgressAclSet `json:"egress-acl-set,omitempty"`
}
