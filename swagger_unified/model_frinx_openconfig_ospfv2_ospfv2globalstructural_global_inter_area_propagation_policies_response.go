...
// frinx.openconfig.ospfv2.ospfv2globalstructural.global.InterAreaPropagationPolicies.response
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalInterAreaPropagationPoliciesResponse struct {
	FrinxOpenconfigNetworkInstanceinterAreaPropagationPolicies *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalInterAreaPropagationPolicies `json:"frinx-openconfig-network-instance:inter-area-propagation-policies,omitempty"`
}
