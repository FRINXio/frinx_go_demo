...
// frinx.openconfig.qos.qosinterfaceclassifiermatchtop.terms.Term.response
type FrinxOpenconfigQosQosinterfaceclassifiermatchtopTermsTermResponse struct {
	FrinxOpenconfigQosterm []FrinxOpenconfigQosQosinterfaceclassifiermatchtopTermsTerm `json:"frinx-openconfig-qos:term,omitempty"`
}
