...
type FrinxCiscoIfExtensionAllowConfigIdentityref string

// List of frinx.cisco.if.extension.AllowConfigIdentityref
const (
	FrinxCiscoIfExtensionAllowConfigIdentityref_DEFAULT_ FrinxCiscoIfExtensionAllowConfigIdentityref = "frinx-cisco-if-extension:RPF_ALLOW_DEFAULT"
	FrinxCiscoIfExtensionAllowConfigIdentityref_CONFIG_BASE FrinxCiscoIfExtensionAllowConfigIdentityref = "frinx-cisco-if-extension:RPF_ALLOW_CONFIG_BASE"
	FrinxCiscoIfExtensionAllowConfigIdentityref_SELF_PING FrinxCiscoIfExtensionAllowConfigIdentityref = "frinx-cisco-if-extension:RPF_ALLOW_SELF_PING"
)
