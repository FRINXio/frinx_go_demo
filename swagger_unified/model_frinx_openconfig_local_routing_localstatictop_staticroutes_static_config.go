...
type FrinxOpenconfigLocalRoutingLocalstatictopStaticroutesStaticConfig struct {
	...
	// Optional[Destination prefix for the static route, either IPv4 or IPv6.] REF:Optional.empty
