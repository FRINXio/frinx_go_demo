...
// Optional[Configuration of LDP authentication attributes] REF:Optional.empty
type FrinxOpenconfigMplsLdpMplsldpauthenticationtopAuthenticationConfig struct {
	// Optional[authenticate LDP signaling messages] REF:Optional[RFC1321 The MD5 Message-Digest Algorithm RFC5036 LDP Specification]
	AuthenticationKey string `json:"authentication-key,omitempty"`
	// Optional[Enables LDP authentication on the node.] REF:Optional.empty
