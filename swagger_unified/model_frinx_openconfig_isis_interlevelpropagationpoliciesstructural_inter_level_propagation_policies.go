...
type FrinxOpenconfigIsisInterlevelpropagationpoliciesstructuralInterLevelPropagationPolicies struct {
	// Optional[Policies relating to prefixes to be propagated from Level 1 to Level 2.] REF:Optional.empty
	Level1ToLevel2 *FrinxOpenconfigIsisInterlevelpropagationpoliciesstructuralInterlevelpropagationpoliciesLevel1ToLevel2 `json:"level1-to-level2,omitempty"`
	// Optional[Policies relating to prefixes to be propagated from Level2 to Level 1.] REF:Optional.empty
	Level2ToLevel1 *FrinxOpenconfigIsisInterlevelpropagationpoliciesstructuralInterlevelpropagationpoliciesLevel2ToLevel1 `json:"level2-to-level1,omitempty"`
}
