...
// Optional[Configuration for link-protection] REF:Optional.empty
type FrinxOpenconfigMplsRsvpMplsrsvplinkprotectionProtectionConfig struct {
	// Optional[Style of mpls frr protection desired: link, link-node, or unprotected] REF:Optional.empty
	LinkProtectionStyleRequested *FrinxOpenconfigMplsRsvpLinkProtectionStyleRequestedIdentityref `json:"link-protection-style-requested,omitempty"`
	// Optional[interval between periodic optimization of the bypass LSPs] REF:Optional.empty
	BypassOptimizeInterval int32 `json:"bypass-optimize-interval,omitempty"`
}
