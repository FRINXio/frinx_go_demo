...
// frinx.openconfig.qos.qosqueuewredtop.wred.Config.response
type FrinxOpenconfigQosQosqueuewredtopWredConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosqueuewredtopWredConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
