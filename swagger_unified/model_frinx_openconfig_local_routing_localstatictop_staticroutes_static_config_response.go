...
// frinx.openconfig.local.routing.localstatictop.staticroutes.static.Config.response
type FrinxOpenconfigLocalRoutingLocalstatictopStaticroutesStaticConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigLocalRoutingLocalstatictopStaticroutesStaticConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
