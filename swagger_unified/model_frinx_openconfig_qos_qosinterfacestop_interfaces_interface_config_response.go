...
// frinx.openconfig.qos.qosinterfacestop.interfaces.interface.Config.response
type FrinxOpenconfigQosQosinterfacestopInterfacesInterfaceConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosinterfacestopInterfacesInterfaceConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
