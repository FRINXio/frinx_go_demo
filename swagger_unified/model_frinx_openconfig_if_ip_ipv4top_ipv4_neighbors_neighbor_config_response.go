...
// frinx.openconfig.if.ip.ipv4top.ipv4.neighbors.neighbor.Config.response
type FrinxOpenconfigIfIpIpv4topIpv4NeighborsNeighborConfigResponse struct {
	FrinxOpenconfigIfIpconfig *FrinxOpenconfigIfIpIpv4topIpv4NeighborsNeighborConfig `json:"frinx-openconfig-if-ip:config,omitempty"`
}
