...
// frinx.openconfig.qos.qosscheduler1r2ctop.oneratetwocolor.exceedaction.Config.response
type FrinxOpenconfigQosQosscheduler1r2ctopOneratetwocolorExceedactionConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosscheduler1r2ctopOneratetwocolorExceedactionConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
