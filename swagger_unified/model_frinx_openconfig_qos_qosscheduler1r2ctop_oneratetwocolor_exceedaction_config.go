...
// Optional[Configuration parameters relating to exceeding packets for the 1r2c scheduler.] REF:Optional.empty
type FrinxOpenconfigQosQosscheduler1r2ctopOneratetwocolorExceedactionConfig struct {
