...
type FrinxCiscoOspfExtensionMaxmetricsfieldsMaxmetrictimersMaxmetrictimerConfig struct {
	...
	Include []FrinxCiscoOspfExtensionIncludeIdentityref `json:"include,omitempty"`
	// Optional.empty REF:Optional.empty
	Trigger *FrinxCiscoOspfExtensionTriggerIdentityref `json:"trigger,omitempty"`
