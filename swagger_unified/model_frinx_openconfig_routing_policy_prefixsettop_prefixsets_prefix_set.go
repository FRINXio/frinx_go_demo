...
// Optional[List of the defined prefix sets] REF:Optional.empty
type FrinxOpenconfigRoutingPolicyPrefixsettopPrefixsetsPrefixSet struct {
	// Optional[Reference to prefix name list key] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Enclosing container for the list of prefixes in a policy prefix list] REF:Optional.empty
	Prefixes *FrinxOpenconfigRoutingPolicyPrefixtopPrefixes `json:"prefixes,omitempty"`
	// Optional[Configuration data for prefix sets] REF:Optional.empty
	Config *FrinxOpenconfigRoutingPolicyPrefixsettopPrefixsetsPrefixsetConfig `json:"config,omitempty"`
}
