...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsisInterfacesInterfaceAfisafiAfConfig struct {
	// Optional[Subsequent address-family type.] REF:Optional.empty
	SafiName *FrinxOpenconfigIsisSafiNameIdentityref `json:"safi-name,omitempty"`
	// Optional[Address-family type.] REF:Optional.empty
	AfiName *FrinxOpenconfigIsisAfiNameIdentityref `json:"afi-name,omitempty"`
	// Optional[ISIS metric value(default=10).] REF:Optional.empty
	FrinxIsisExtensionmetric int64 `json:"frinx-isis-extension:metric,omitempty"`
