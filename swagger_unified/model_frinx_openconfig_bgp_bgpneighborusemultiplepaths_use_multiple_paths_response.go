...
// frinx.openconfig.bgp.bgpneighborusemultiplepaths.UseMultiplePaths.response
type FrinxOpenconfigBgpBgpneighborusemultiplepathsUseMultiplePathsResponse struct {
	FrinxOpenconfigNetworkInstanceuseMultiplePaths *FrinxOpenconfigBgpBgpneighborusemultiplepathsUseMultiplePaths `json:"frinx-openconfig-network-instance:use-multiple-paths,omitempty"`
}
