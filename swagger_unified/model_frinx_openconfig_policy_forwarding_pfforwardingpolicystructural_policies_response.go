...
// frinx.openconfig.policy.forwarding.pfforwardingpolicystructural.Policies.response
type FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesResponse struct {
	FrinxOpenconfigNetworkInstancepolicies *FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPolicies `json:"frinx-openconfig-network-instance:policies,omitempty"`
}
