...
type FrinxOpenconfigPlatformPlatformsubcomponentreftopSubcomponents struct {
	// Optional[List of subcomponent references] REF:Optional.empty
	Subcomponent []FrinxOpenconfigPlatformPlatformsubcomponentreftopSubcomponentsSubcomponent `json:"subcomponent,omitempty"`
}
