...
// frinx.openconfig.routing.policy.routingpolicy.policydefinitions.PolicyDefinition.response
type FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicyDefinitionResponse struct {
	FrinxOpenconfigRoutingPolicypolicyDefinition []FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicyDefinition `json:"frinx-openconfig-routing-policy:policy-definition,omitempty"`
}
