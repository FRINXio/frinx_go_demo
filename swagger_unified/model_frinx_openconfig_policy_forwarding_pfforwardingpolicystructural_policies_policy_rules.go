...
type FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRules struct {
	// Optional[A match rule for the policy. In the case that multiple criteria are specified within a single ] REF:Optional.empty
	Rule []FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRule `json:"rule,omitempty"`
}
