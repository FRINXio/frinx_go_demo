...
type FrinxOpenconfigBgpBgpcommonstructureneighborgroupaddpathsAddPaths struct {
	// Optional[Configuration parameters relating to ADD_PATHS] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpcommonstructureneighborgroupaddpathsAddpathsConfig `json:"config,omitempty"`
}
