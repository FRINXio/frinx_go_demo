...
type FrinxOpenconfigPlatformPlatformanchorstopFan struct {
	// Optional[Configuration data for fan components] REF:Optional.empty
	Config *FrinxOpenconfigPlatformPlatformanchorstopFanConfig `json:"config,omitempty"`
}
