...
type FrinxOpenconfigOspfv2Ospfv2areastructureMpls struct {
	// Optional[Configuration parameters relating to MPLS extensions for OSPFv2] REF:Optional.empty
	Config *FrinxOpenconfigOspfv2Ospfv2areastructureMplsConfig `json:"config,omitempty"`
}
