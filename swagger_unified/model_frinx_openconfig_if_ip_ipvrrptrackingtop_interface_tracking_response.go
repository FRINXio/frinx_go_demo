...
// frinx.openconfig.if.ip.ipvrrptrackingtop.InterfaceTracking.response
type FrinxOpenconfigIfIpIpvrrptrackingtopInterfaceTrackingResponse struct {
	FrinxOpenconfigIfIpinterfaceTracking *FrinxOpenconfigIfIpIpvrrptrackingtopInterfaceTracking `json:"frinx-openconfig-if-ip:interface-tracking,omitempty"`
}
