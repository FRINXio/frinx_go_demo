...
// frinx.openconfig.packet.match.ipv6protocolfieldstop.Ipv6.response
type FrinxOpenconfigPacketMatchIpv6protocolfieldstopIpv6Response struct {
	FrinxOpenconfigNetworkInstanceipv6 *FrinxOpenconfigPacketMatchIpv6protocolfieldstopIpv6 `json:"frinx-openconfig-network-instance:ipv6,omitempty"`
}
