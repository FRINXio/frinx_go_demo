...
// frinx.openconfig.acl.acl.aclsets.aclset.aclentries.aclentry.Transport.response
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryTransportResponse struct {
	FrinxOpenconfigAcltransport *FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryTransport `json:"frinx-openconfig-acl:transport,omitempty"`
}
