...
type FrinxOpenconfigBgpPolicyExtcommunitysettopExtCommunitySets struct {
	// Optional[List of defined extended BGP community sets] REF:Optional.empty
	ExtCommunitySet []FrinxOpenconfigBgpPolicyExtcommunitysettopExtcommunitysetsExtCommunitySet `json:"ext-community-set,omitempty"`
}
