...
// frinx.openconfig.bgp.bgpneighborbase.ErrorHandling.response
type FrinxOpenconfigBgpBgpneighborbaseErrorHandlingResponse struct {
	FrinxOpenconfigNetworkInstanceerrorHandling *FrinxOpenconfigBgpBgpneighborbaseErrorHandling `json:"frinx-openconfig-network-instance:error-handling,omitempty"`
}
