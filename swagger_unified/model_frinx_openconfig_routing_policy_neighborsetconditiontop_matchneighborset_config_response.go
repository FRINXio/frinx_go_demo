...
// frinx.openconfig.routing.policy.neighborsetconditiontop.matchneighborset.Config.response
type FrinxOpenconfigRoutingPolicyNeighborsetconditiontopMatchneighborsetConfigResponse struct {
	FrinxOpenconfigRoutingPolicyconfig *FrinxOpenconfigRoutingPolicyNeighborsetconditiontopMatchneighborsetConfig `json:"frinx-openconfig-routing-policy:config,omitempty"`
}
