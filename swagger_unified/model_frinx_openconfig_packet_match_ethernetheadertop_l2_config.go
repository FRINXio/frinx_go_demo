...
type FrinxOpenconfigPacketMatchEthernetheadertopL2Config struct {
	// Optional[Source IEEE 802 MAC address mask.] REF:Optional.empty
	SourceMacMask string `json:"source-mac-mask,omitempty"`
	// Optional[Destination IEEE 802 MAC address mask.] REF:Optional.empty
	DestinationMacMask string `json:"destination-mac-mask,omitempty"`
	// Optional[Source IEEE 802 MAC address.] REF:Optional.empty
	SourceMac string `json:"source-mac,omitempty"`
	// Optional[Ethertype field to match in Ethernet packets] REF:Optional.empty
	Ethertype string `json:"ethertype,omitempty"`
	// Optional[Destination IEEE 802 MAC address.] REF:Optional.empty
