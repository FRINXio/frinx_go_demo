...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsLdpGlobalConfig struct {
	// Optional[Global label switch router identifier configuration.] REF:Optional[RFC5036 LDP Specification]
	LsrId string `json:"lsr-id,omitempty"`
	// Optional[When true is specified, MPLS LDP is enabled. If false or omitted, the MPLS LDP is disabled.] REF:Optional.empty
	FrinxMplsLdpExtensionenabled bool `json:"frinx-mpls-ldp-extension:enabled,omitempty"`
}
