...
// Optional[Config data for ACL actions] REF:Optional.empty
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryActionsConfig struct {
	// Optional[Specifies the forwarding action.  One forwarding action must be specified for each ACL entry] REF:Optional.empty
	ForwardingAction *FrinxOpenconfigAclForwardingActionIdentityref `json:"forwarding-action,omitempty"`
	// Optional[action instance name] REF:Optional.empty
	FrinxAclExtensioninstanceName string `json:"frinx-acl-extension:instance-name,omitempty"`
	// Optional[Specifies the log action and destination for matched packets.  The default is not to log the packet.] REF:Optional.empty
	LogAction *FrinxOpenconfigAclLogActionIdentityref `json:"log-action,omitempty"`
}
