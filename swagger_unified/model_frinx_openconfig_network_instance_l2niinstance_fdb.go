...
type FrinxOpenconfigNetworkInstanceL2niinstanceFdb struct {
	// Optional[Table of learned or statically configured MAC addresses and corresponding VLANs in the bridge domain] REF:Optional.empty
	MacTable *FrinxOpenconfigNetworkInstanceL2nimactabletopMacTable `json:"mac-table,omitempty"`
	// Optional[Configuration parameters relating to the FDB] REF:Optional.empty
	Config *FrinxOpenconfigNetworkInstanceL2niinstanceFdbConfig `json:"config,omitempty"`
}
