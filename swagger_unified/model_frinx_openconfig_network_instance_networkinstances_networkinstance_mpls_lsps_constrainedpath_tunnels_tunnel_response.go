...
// frinx.openconfig.network.instance.networkinstances.networkinstance.mpls.lsps.constrainedpath.tunnels.Tunnel.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLspsConstrainedpathTunnelsTunnelResponse struct {
	FrinxOpenconfigNetworkInstancetunnel []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLspsConstrainedpathTunnelsTunnel `json:"frinx-openconfig-network-instance:tunnel,omitempty"`
}
