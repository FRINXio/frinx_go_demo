...
// Optional[A list of explicit paths] REF:Optional.empty
type FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedExplicitPath struct {
	// Optional[A string name that uniquely identifies an explicit path] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Enclosing container for EROs] REF:Optional.empty
	ExplicitRouteObjects *FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedexplicitpathExplicitRouteObjects `json:"explicit-route-objects,omitempty"`
	// Optional[Configuration parameters relating to named explicit paths] REF:Optional.empty
	Config *FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedexplicitpathConfig `json:"config,omitempty"`
}
