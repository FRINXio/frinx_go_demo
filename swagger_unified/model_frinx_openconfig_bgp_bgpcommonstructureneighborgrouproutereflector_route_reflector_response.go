...
// frinx.openconfig.bgp.bgpcommonstructureneighborgrouproutereflector.RouteReflector.response
type FrinxOpenconfigBgpBgpcommonstructureneighborgrouproutereflectorRouteReflectorResponse struct {
	FrinxOpenconfigNetworkInstancerouteReflector *FrinxOpenconfigBgpBgpcommonstructureneighborgrouproutereflectorRouteReflector `json:"frinx-openconfig-network-instance:route-reflector,omitempty"`
}
