...
// frinx.openconfig.acl.interfaceegressacltop.EgressAclSets.response
type FrinxOpenconfigAclInterfaceegressacltopEgressAclSetsResponse struct {
	FrinxOpenconfigAclegressAclSets *FrinxOpenconfigAclInterfaceegressacltopEgressAclSets `json:"frinx-openconfig-acl:egress-acl-sets,omitempty"`
}
