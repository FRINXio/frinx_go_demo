...
// frinx.netflow.interfaceegressnetflowtop.egressflows.egressflow.Config.request
type FrinxNetflowInterfaceegressnetflowtopEgressflowsEgressflowConfigRequest struct {
