...
// frinx.openconfig.isis.isisglobalbase.Transport.response
type FrinxOpenconfigIsisIsisglobalbaseTransportResponse struct {
	FrinxOpenconfigNetworkInstancetransport *FrinxOpenconfigIsisIsisglobalbaseTransport `json:"frinx-openconfig-network-instance:transport,omitempty"`
}
