...
// frinx.openconfig.if.ip.ipvrrptop.vrrp.vrrpgroup.Config.response
type FrinxOpenconfigIfIpIpvrrptopVrrpVrrpgroupConfigResponse struct {
	FrinxOpenconfigIfIpconfig *FrinxOpenconfigIfIpIpvrrptopVrrpVrrpgroupConfig `json:"frinx-openconfig-if-ip:config,omitempty"`
}
