...
// frinx.openconfig.ospfv2.ospfv2areainterfacesstructure.interfaces.interface.Timers.response
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceTimersResponse struct {
	FrinxOpenconfigNetworkInstancetimers *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceTimers `json:"frinx-openconfig-network-instance:timers,omitempty"`
}
