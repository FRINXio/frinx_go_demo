...
// frinx.openconfig.probes.testtarget.Target.response
type FrinxOpenconfigProbesTesttargetTargetResponse struct {
	FrinxOpenconfigProbestarget *FrinxOpenconfigProbesTesttargetTarget `json:"frinx-openconfig-probes:target,omitempty"`
}
