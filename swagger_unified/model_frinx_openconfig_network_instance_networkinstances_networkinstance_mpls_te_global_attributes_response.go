...
// frinx.openconfig.network.instance.networkinstances.networkinstance.mpls.TeGlobalAttributes.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsTeGlobalAttributesResponse struct {
	FrinxOpenconfigNetworkInstanceteGlobalAttributes *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsTeGlobalAttributes `json:"frinx-openconfig-network-instance:te-global-attributes,omitempty"`
}
