...
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv4Config struct {
	...
	FrinxQosExtensionaclRef string `json:"frinx-qos-extension:acl-ref,omitempty"`
	// Optional[Destination IPv4 address prefix.] REF:Optional.empty
	DestinationAddress string `json:"destination-address,omitempty"`
	// Optional[List of precedences valid for ipv4.] REF:Optional.empty
