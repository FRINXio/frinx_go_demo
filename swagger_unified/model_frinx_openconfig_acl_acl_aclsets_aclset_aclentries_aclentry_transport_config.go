...
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryTransportConfig struct {
	// Optional[List of TCP flags to match] REF:Optional.empty
	TcpFlags []FrinxOpenconfigPacketMatchTcpFlagsIdentityref `json:"tcp-flags,omitempty"`
	// Optional[Source port or range] REF:Optional.empty
	SourcePort string `json:"source-port,omitempty"`
	// Optional[Destination port represented by name.] REF:Optional.empty
	FrinxAclExtensiondestinationPortNamed string `json:"frinx-acl-extension:destination-port-named,omitempty"`
	// Optional[Source port represented by name.] REF:Optional.empty
	FrinxAclExtensionsourcePortNamed string `json:"frinx-acl-extension:source-port-named,omitempty"`
	// Optional[Destination port or range] REF:Optional.empty
