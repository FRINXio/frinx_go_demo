...
type FrinxOpenconfigBgpPolicySetextcommunityactiontopSetExtCommunity struct {
	// Optional[Provide a reference to an extended community set for the set-ext-community action] REF:Optional.empty
	Reference *FrinxOpenconfigBgpPolicySetextcommunityreferencetopReference `json:"reference,omitempty"`
	// Optional[Set the extended community values for the action inline with a list.] REF:Optional.empty
	Inline *FrinxOpenconfigBgpPolicySetextcommunityinlinetopInline `json:"inline,omitempty"`
	// Optional[Configuration data for the set-ext-community action] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicySetextcommunityactiontopSetextcommunityConfig `json:"config,omitempty"`
}
