...
type FrinxCiscoOspfExtensionTriggerIdentityref string

// List of frinx.cisco.ospf.extension.TriggerIdentityref
const (
	FrinxCiscoOspfExtensionTriggerIdentityref_CISCO_OSPF_EXTENSIONMAX_METRIC_ALWAYS FrinxCiscoOspfExtensionTriggerIdentityref = "frinx-cisco-ospf-extension:MAX_METRIC_ALWAYS"
	FrinxCiscoOspfExtensionTriggerIdentityref_OPENCONFIG_OSPF_TYPESMAX_METRIC_TRIGGER FrinxCiscoOspfExtensionTriggerIdentityref = "frinx-openconfig-ospf-types:MAX_METRIC_TRIGGER"
	FrinxCiscoOspfExtensionTriggerIdentityref_OPENCONFIG_OSPF_TYPESMAX_METRIC_ON_SYSTEM_BOOT FrinxCiscoOspfExtensionTriggerIdentityref = "frinx-openconfig-ospf-types:MAX_METRIC_ON_SYSTEM_BOOT"
	FrinxCiscoOspfExtensionTriggerIdentityref_CISCO_OSPF_EXTENSIONMAX_METRIC_ON_SWITCHOVER FrinxCiscoOspfExtensionTriggerIdentityref = "frinx-cisco-ospf-extension:MAX_METRIC_ON_SWITCHOVER"
)
