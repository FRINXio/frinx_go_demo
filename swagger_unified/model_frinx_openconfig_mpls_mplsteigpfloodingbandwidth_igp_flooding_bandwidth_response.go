...
// frinx.openconfig.mpls.mplsteigpfloodingbandwidth.IgpFloodingBandwidth.response
type FrinxOpenconfigMplsMplsteigpfloodingbandwidthIgpFloodingBandwidthResponse struct {
	FrinxOpenconfigNetworkInstanceigpFloodingBandwidth *FrinxOpenconfigMplsMplsteigpfloodingbandwidthIgpFloodingBandwidth `json:"frinx-openconfig-network-instance:igp-flooding-bandwidth,omitempty"`
}
