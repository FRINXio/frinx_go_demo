...
type FrinxOpenconfigOspfPolicyOspfmatchconditionsOspfConditions struct {
	// Optional[Configuration parameters relating to OSPF match conditions] REF:Optional.empty
	Config *FrinxOpenconfigOspfPolicyOspfmatchconditionsOspfconditionsConfig `json:"config,omitempty"`
}
