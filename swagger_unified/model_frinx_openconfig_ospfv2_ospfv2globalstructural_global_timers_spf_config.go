...
// Optional[Configuration parameters relating to global OSPFv2 SPF timers] REF:Optional.empty
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersSpfConfig struct {
	// Optional[The value of this leaf specifies the time between a change in topology being detected and the first run of the SPF algorithm.] REF:Optional.empty
	InitialDelay int64 `json:"initial-delay,omitempty"`
	// Optional[The value of this leaf specifies the maximum delay between a topology change being detected and the SPF algorithm running. This value is used for implementations that support increasing the wait time between SPF runs.] REF:Optional.empty
