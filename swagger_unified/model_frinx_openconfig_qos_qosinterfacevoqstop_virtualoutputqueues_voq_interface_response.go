...
// frinx.openconfig.qos.qosinterfacevoqstop.virtualoutputqueues.VoqInterface.response
type FrinxOpenconfigQosQosinterfacevoqstopVirtualoutputqueuesVoqInterfaceResponse struct {
	FrinxOpenconfigQosvoqInterface []FrinxOpenconfigQosQosinterfacevoqstopVirtualoutputqueuesVoqInterface `json:"frinx-openconfig-qos:voq-interface,omitempty"`
}
