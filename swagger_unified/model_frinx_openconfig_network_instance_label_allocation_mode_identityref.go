...
type FrinxOpenconfigNetworkInstanceLabelAllocationModeIdentityref string

// List of frinx.openconfig.network.instance.LabelAllocationModeIdentityref
const (
	FrinxOpenconfigNetworkInstanceLabelAllocationModeIdentityref_PER_PREFIX FrinxOpenconfigNetworkInstanceLabelAllocationModeIdentityref = "frinx-openconfig-network-instance-types:PER_PREFIX"
	FrinxOpenconfigNetworkInstanceLabelAllocationModeIdentityref_PER_NEXTHOP FrinxOpenconfigNetworkInstanceLabelAllocationModeIdentityref = "frinx-openconfig-network-instance-types:PER_NEXTHOP"
	FrinxOpenconfigNetworkInstanceLabelAllocationModeIdentityref_LABEL_ALLOCATION_MODE FrinxOpenconfigNetworkInstanceLabelAllocationModeIdentityref = "frinx-openconfig-network-instance-types:LABEL_ALLOCATION_MODE"
	FrinxOpenconfigNetworkInstanceLabelAllocationModeIdentityref_INSTANCE_LABEL FrinxOpenconfigNetworkInstanceLabelAllocationModeIdentityref = "frinx-openconfig-network-instance-types:INSTANCE_LABEL"
)
