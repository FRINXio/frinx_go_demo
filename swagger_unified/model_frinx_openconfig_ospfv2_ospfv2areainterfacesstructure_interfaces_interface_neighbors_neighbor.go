...
// Optional[A neighbor with which an OSPFv2 adjacency has been established within this area] REF:Optional.empty
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceNeighborsNeighbor struct {
	// Optional[Reference to the router ID of the adjacent system] REF:Optional.empty
	RouterId string `json:"router-id,omitempty"`
	// Optional[Configuration parameters relating to the adjacent system] REF:Optional.empty
	Config *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceNeighborsNeighborConfig `json:"config,omitempty"`
}
