...
// frinx.openconfig.packet.match.transportfieldstop.transport.Config.request
type FrinxOpenconfigPacketMatchTransportfieldstopTransportConfigRequest struct {
