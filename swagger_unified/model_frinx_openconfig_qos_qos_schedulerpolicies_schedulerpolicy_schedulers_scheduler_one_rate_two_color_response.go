...
// frinx.openconfig.qos.qos.schedulerpolicies.schedulerpolicy.schedulers.scheduler.OneRateTwoColor.response
type FrinxOpenconfigQosQosSchedulerpoliciesSchedulerpolicySchedulersSchedulerOneRateTwoColorResponse struct {
	FrinxOpenconfigQosoneRateTwoColor *FrinxOpenconfigQosQosSchedulerpoliciesSchedulerpolicySchedulersSchedulerOneRateTwoColor `json:"frinx-openconfig-qos:one-rate-two-color,omitempty"`
}
