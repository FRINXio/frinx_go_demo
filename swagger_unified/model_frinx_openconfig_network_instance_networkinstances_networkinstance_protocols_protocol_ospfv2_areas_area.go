...
// Optional[The OSPFv2 areas within which the local system exists] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2AreasArea struct {
	// Optional[Configuration and state parameters relating to virtual links from the source area to a remote router] REF:Optional.empty
	VirtualLinks *FrinxOpenconfigOspfv2Ospfv2areastructureVirtualLinks `json:"virtual-links,omitempty"`
	// Optional[A reference to the identifier for the area.] REF:Optional.empty
	Identifier string `json:"identifier,omitempty"`
	// Optional[Configuration and operational state parameters for OSPFv2 extensions relating to MPLS] REF:Optional.empty
	Mpls *FrinxOpenconfigOspfv2Ospfv2areastructureMpls `json:"mpls,omitempty"`
	// Optional[Enclosing container for a list of interfaces enabled within this area] REF:Optional.empty
	Interfaces *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2AreasAreaInterfaces `json:"interfaces,omitempty"`
	// Optional[Configuration parameters relating to an OSPFv2 area] REF:Optional.empty
	Config *FrinxOpenconfigOspfv2Ospfv2areastructureConfig `json:"config,omitempty"`
}
