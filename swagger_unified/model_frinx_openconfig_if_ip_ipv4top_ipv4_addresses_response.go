...
// frinx.openconfig.if.ip.ipv4top.ipv4.Addresses.response
type FrinxOpenconfigIfIpIpv4topIpv4AddressesResponse struct {
	FrinxOpenconfigIfIpaddresses *FrinxOpenconfigIfIpIpv4topIpv4Addresses `json:"frinx-openconfig-if-ip:addresses,omitempty"`
}
