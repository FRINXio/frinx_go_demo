...
type FrinxOpenconfigBgpPolicySetcommunityinlinetopInlineConfig struct {
	// Optional[Set the community values for the update inline with a list.] REF:Optional.empty
