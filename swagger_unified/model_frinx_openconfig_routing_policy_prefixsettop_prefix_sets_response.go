...
// frinx.openconfig.routing.policy.prefixsettop.PrefixSets.response
type FrinxOpenconfigRoutingPolicyPrefixsettopPrefixSetsResponse struct {
	FrinxOpenconfigRoutingPolicyprefixSets *FrinxOpenconfigRoutingPolicyPrefixsettopPrefixSets `json:"frinx-openconfig-routing-policy:prefix-sets,omitempty"`
}
