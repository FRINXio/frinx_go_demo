...
// frinx.openconfig.qos.qosscheduleroutputtop.output.Config.response
type FrinxOpenconfigQosQosscheduleroutputtopOutputConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosscheduleroutputtopOutputConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
