...
// frinx.openconfig.platform.port.portbreakouttop.breakoutmode.Config.request
type FrinxOpenconfigPlatformPortPortbreakouttopBreakoutmodeConfigRequest struct {
