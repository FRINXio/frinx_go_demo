...
// frinx.openconfig.isis.isisglobalbase.lspbit.OverloadBit.response
type FrinxOpenconfigIsisIsisglobalbaseLspbitOverloadBitResponse struct {
	FrinxOpenconfigNetworkInstanceoverloadBit *FrinxOpenconfigIsisIsisglobalbaseLspbitOverloadBit `json:"frinx-openconfig-network-instance:overload-bit,omitempty"`
}
