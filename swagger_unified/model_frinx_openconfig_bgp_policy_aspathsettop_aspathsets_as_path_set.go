...
// Optional[List of defined AS path sets] REF:Optional.empty
type FrinxOpenconfigBgpPolicyAspathsettopAspathsetsAsPathSet struct {
	...
	Config *FrinxOpenconfigBgpPolicyAspathsettopAspathsetsAspathsetConfig `json:"config,omitempty"`
}
