...
// frinx.openconfig.mpls.mplsinterfacestop.InterfaceAttributes.response
type FrinxOpenconfigMplsMplsinterfacestopInterfaceAttributesResponse struct {
	FrinxOpenconfigNetworkInstanceinterfaceAttributes *FrinxOpenconfigMplsMplsinterfacestopInterfaceAttributes `json:"frinx-openconfig-network-instance:interface-attributes,omitempty"`
}
