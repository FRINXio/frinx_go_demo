...
type FrinxOpenconfigBgpPolicyMatchaspathtopMatchAsPathSet struct {
	// Optional[Configuration data for match conditions on AS path set] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicyMatchaspathtopMatchaspathsetConfig `json:"config,omitempty"`
}
