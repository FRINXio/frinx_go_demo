...
// Optional[An interface associated with the network instance] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceInterfacesInterface struct {
	// Optional[Configuration parameters relating to the associated interface] REF:Optional.empty
	Config *FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceInterfacesInterfaceConfig `json:"config,omitempty"`
	// Optional[A reference to an identifier for this interface which acts as a key for this list] REF:Optional.empty
