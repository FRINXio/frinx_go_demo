...
type FrinxOpenconfigPacketMatchTcpFlagsIdentityref string

// List of frinx.openconfig.packet.match.TcpFlagsIdentityref
const (
	FrinxOpenconfigPacketMatchTcpFlagsIdentityref_PSH FrinxOpenconfigPacketMatchTcpFlagsIdentityref = "frinx-openconfig-packet-match-types:TCP_PSH"
	FrinxOpenconfigPacketMatchTcpFlagsIdentityref_URG FrinxOpenconfigPacketMatchTcpFlagsIdentityref = "frinx-openconfig-packet-match-types:TCP_URG"
	FrinxOpenconfigPacketMatchTcpFlagsIdentityref_SYN FrinxOpenconfigPacketMatchTcpFlagsIdentityref = "frinx-openconfig-packet-match-types:TCP_SYN"
	FrinxOpenconfigPacketMatchTcpFlagsIdentityref_RST FrinxOpenconfigPacketMatchTcpFlagsIdentityref = "frinx-openconfig-packet-match-types:TCP_RST"
	FrinxOpenconfigPacketMatchTcpFlagsIdentityref_FLAGS FrinxOpenconfigPacketMatchTcpFlagsIdentityref = "frinx-openconfig-packet-match-types:TCP_FLAGS"
	FrinxOpenconfigPacketMatchTcpFlagsIdentityref_ACK FrinxOpenconfigPacketMatchTcpFlagsIdentityref = "frinx-openconfig-packet-match-types:TCP_ACK"
	FrinxOpenconfigPacketMatchTcpFlagsIdentityref_CWR FrinxOpenconfigPacketMatchTcpFlagsIdentityref = "frinx-openconfig-packet-match-types:TCP_CWR"
	FrinxOpenconfigPacketMatchTcpFlagsIdentityref_ECE FrinxOpenconfigPacketMatchTcpFlagsIdentityref = "frinx-openconfig-packet-match-types:TCP_ECE"
	FrinxOpenconfigPacketMatchTcpFlagsIdentityref_FIN FrinxOpenconfigPacketMatchTcpFlagsIdentityref = "frinx-openconfig-packet-match-types:TCP_FIN"
)
