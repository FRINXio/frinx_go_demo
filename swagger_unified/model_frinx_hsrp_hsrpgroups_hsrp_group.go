...
// Optional[List of HSRP groups, keyed by address-family, virtual router id] REF:Optional.empty
type FrinxHsrpHsrpgroupsHsrpGroup struct {
	// Optional[References the configured virtual router id for this HSRP group] REF:Optional.empty
	VirtualRouterId int64 `json:"virtual-router-id,omitempty"`
	// Optional[Configuration data for the HSRP group] REF:Optional.empty
	Config *FrinxHsrpHsrpgroupsHsrpgroupConfig `json:"config,omitempty"`
	// Optional[The prefix contained within the Extended Prefix LSA is an IPv4 unicast prefix] REF:Optional.empty
