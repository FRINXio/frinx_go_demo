...
type FrinxOpenconfigMplsProtectionStyleRequestedIdentityref string

// List of frinx.openconfig.mpls.ProtectionStyleRequestedIdentityref
const (
	FrinxOpenconfigMplsProtectionStyleRequestedIdentityref_LINK_PROTECTION_REQUIRED FrinxOpenconfigMplsProtectionStyleRequestedIdentityref = "frinx-openconfig-mpls-types:LINK_PROTECTION_REQUIRED"
	FrinxOpenconfigMplsProtectionStyleRequestedIdentityref_LINK_NODE_PROTECTION_REQUESTED FrinxOpenconfigMplsProtectionStyleRequestedIdentityref = "frinx-openconfig-mpls-types:LINK_NODE_PROTECTION_REQUESTED"
	FrinxOpenconfigMplsProtectionStyleRequestedIdentityref_PROTECTION_TYPE FrinxOpenconfigMplsProtectionStyleRequestedIdentityref = "frinx-openconfig-mpls-types:PROTECTION_TYPE"
	FrinxOpenconfigMplsProtectionStyleRequestedIdentityref_UNPROTECTED FrinxOpenconfigMplsProtectionStyleRequestedIdentityref = "frinx-openconfig-mpls-types:UNPROTECTED"
)
