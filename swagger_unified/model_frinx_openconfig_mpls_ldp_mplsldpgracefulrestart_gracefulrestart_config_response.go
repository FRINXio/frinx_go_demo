...
// frinx.openconfig.mpls.ldp.mplsldpgracefulrestart.gracefulrestart.Config.response
type FrinxOpenconfigMplsLdpMplsldpgracefulrestartGracefulrestartConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsLdpMplsldpgracefulrestartGracefulrestartConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
