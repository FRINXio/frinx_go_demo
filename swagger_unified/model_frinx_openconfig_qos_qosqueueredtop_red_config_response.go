...
// frinx.openconfig.qos.qosqueueredtop.red.Config.response
type FrinxOpenconfigQosQosqueueredtopRedConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosqueueredtopRedConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
