...
// frinx.openconfig.qos.qosinterfaceschedulertop.schedulerpolicy.Config.response
type FrinxOpenconfigQosQosinterfaceschedulertopSchedulerpolicyConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosinterfaceschedulertopSchedulerpolicyConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
