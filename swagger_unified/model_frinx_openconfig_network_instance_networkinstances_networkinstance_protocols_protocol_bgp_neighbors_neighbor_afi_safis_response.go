...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.bgp.neighbors.neighbor.AfiSafis.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpNeighborsNeighborAfiSafisResponse struct {
	FrinxOpenconfigNetworkInstanceafiSafis *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpNeighborsNeighborAfiSafis `json:"frinx-openconfig-network-instance:afi-safis,omitempty"`
}
