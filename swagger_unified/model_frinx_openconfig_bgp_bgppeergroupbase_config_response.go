...
// frinx.openconfig.bgp.bgppeergroupbase.Config.response
type FrinxOpenconfigBgpBgppeergroupbaseConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgppeergroupbaseConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
