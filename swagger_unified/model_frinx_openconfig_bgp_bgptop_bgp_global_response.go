...
// frinx.openconfig.bgp.bgptop.bgp.Global.response
type FrinxOpenconfigBgpBgptopBgpGlobalResponse struct {
	FrinxOpenconfigNetworkInstanceglobal *FrinxOpenconfigBgpBgptopBgpGlobal `json:"frinx-openconfig-network-instance:global,omitempty"`
}
