...
// frinx.openconfig.isis.isislevelgroup.SystemLevelCounters.response
type FrinxOpenconfigIsisIsislevelgroupSystemLevelCountersResponse struct {
	FrinxOpenconfigNetworkInstancesystemLevelCounters *FrinxOpenconfigIsisIsislevelgroupSystemLevelCounters `json:"frinx-openconfig-network-instance:system-level-counters,omitempty"`
}
