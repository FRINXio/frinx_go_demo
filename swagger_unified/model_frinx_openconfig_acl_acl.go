...
// Optional[Top level enclosing container for ACL model config and operational state data] REF:Optional.empty
type FrinxOpenconfigAclAcl struct {
	// Optional[Enclosing container for the list of interfaces on which ACLs are set] REF:Optional.empty
	Interfaces *FrinxOpenconfigAclAclinterfacestopInterfaces `json:"interfaces,omitempty"`
	// Optional[Access list entries variables enclosing container] REF:Optional.empty
	AclSets *FrinxOpenconfigAclAclAclSets `json:"acl-sets,omitempty"`
	// Optional[Global config data for ACLs] REF:Optional.empty
	Config *FrinxOpenconfigAclAcltopAclConfig `json:"config,omitempty"`
}
