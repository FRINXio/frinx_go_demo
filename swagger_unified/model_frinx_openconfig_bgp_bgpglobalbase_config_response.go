...
// frinx.openconfig.bgp.bgpglobalbase.Config.response
type FrinxOpenconfigBgpBgpglobalbaseConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpglobalbaseConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
