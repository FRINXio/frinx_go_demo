...
type FrinxOpenconfigIsisOverloadbitgroupResetTriggers struct {
	// Optional[This list describes ISIS Overload reset trigger reasons.] REF:Optional.empty
	ResetTrigger []FrinxOpenconfigIsisOverloadbitgroupResettriggersResetTrigger `json:"reset-trigger,omitempty"`
}
