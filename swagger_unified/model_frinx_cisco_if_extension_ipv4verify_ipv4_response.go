...
// frinx.cisco.if.extension.ipv4verify.Ipv4.response
type FrinxCiscoIfExtensionIpv4verifyIpv4Response struct {
	FrinxCiscoIfExtensionipv4 *FrinxCiscoIfExtensionIpv4verifyIpv4 `json:"frinx-cisco-if-extension:ipv4,omitempty"`
}
