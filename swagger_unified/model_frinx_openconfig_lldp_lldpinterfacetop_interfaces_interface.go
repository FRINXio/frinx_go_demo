...
// Optional[List of interfaces on which LLDP is enabled / available] REF:Optional.empty
type FrinxOpenconfigLldpLldpinterfacetopInterfacesInterface struct {
	// Optional[Reference to the list key] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Configuration data for LLDP on each interface] REF:Optional.empty
	Config *FrinxOpenconfigLldpLldpinterfacetopInterfacesInterfaceConfig `json:"config,omitempty"`
}
