...
// Optional[Per-interface configuration and state parameters for BFD.] REF:Optional.empty
type FrinxOpenconfigBfdBfdInterfacesInterface struct {
	// Optional[Parameters relating to the BFD peers which are seen over this interface.] REF:Optional.empty
	Peers *FrinxOpenconfigBfdBfdinterfacepeerstructuralPeers `json:"peers,omitempty"`
	// Optional[Parameters relating to micro-BFD sessions associated with the interface.] REF:Optional.empty
	MicroBfdSessions *FrinxOpenconfigBfdBfdinterfacemicrobfdstructuralMicroBfdSessions `json:"micro-bfd-sessions,omitempty"`
	// Optional[A reference to an identifier for the interface on which BFD is enabled.] REF:Optional.empty
	Id string `json:"id,omitempty"`
	// Optional[Configuration parameters for BFD on the specified interface.] REF:Optional.empty
	Config *FrinxOpenconfigBfdBfdInterfacesInterfaceConfig `json:"config,omitempty"`
