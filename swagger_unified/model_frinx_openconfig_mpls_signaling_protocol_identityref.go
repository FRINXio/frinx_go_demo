...
type FrinxOpenconfigMplsSignalingProtocolIdentityref string

// List of frinx.openconfig.mpls.SignalingProtocolIdentityref
const (
	FrinxOpenconfigMplsSignalingProtocolIdentityref_PROTOCOL FrinxOpenconfigMplsSignalingProtocolIdentityref = "frinx-openconfig-mpls-types:PATH_SETUP_PROTOCOL"
	FrinxOpenconfigMplsSignalingProtocolIdentityref_SR FrinxOpenconfigMplsSignalingProtocolIdentityref = "frinx-openconfig-mpls-types:PATH_SETUP_SR"
	FrinxOpenconfigMplsSignalingProtocolIdentityref_LDP FrinxOpenconfigMplsSignalingProtocolIdentityref = "frinx-openconfig-mpls-types:PATH_SETUP_LDP"
	FrinxOpenconfigMplsSignalingProtocolIdentityref_RSVP FrinxOpenconfigMplsSignalingProtocolIdentityref = "frinx-openconfig-mpls-types:PATH_SETUP_RSVP"
)
