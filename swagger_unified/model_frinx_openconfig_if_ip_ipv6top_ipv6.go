...
type FrinxOpenconfigIfIpIpv6topIpv6 struct {
	// Optional[Enclosing container for address list] REF:Optional.empty
	Addresses *FrinxOpenconfigIfIpIpv6topIpv6Addresses `json:"addresses,omitempty"`
	// Optional[Configuration and operational state parameters relating to router advertisements.] REF:Optional.empty
	RouterAdvertisement *FrinxOpenconfigIfIpIpv6topIpv6RouterAdvertisement `json:"router-advertisement,omitempty"`
	// Optional[Top-level config data for the IPv6 interface] REF:Optional.empty
	Config *FrinxOpenconfigIfIpIpv6topIpv6Config `json:"config,omitempty"`
	// Optional[Top-level container for setting unnumbered interfaces. Includes reference the interface that provides the address information] REF:Optional.empty
	Unnumbered *FrinxOpenconfigInterfacesSubunnumberedtopUnnumbered `json:"unnumbered,omitempty"`
	// Optional[Enclosing container for list of IPv6 neighbors] REF:Optional.empty
	Neighbors *FrinxOpenconfigIfIpIpv6topIpv6Neighbors `json:"neighbors,omitempty"`
}
