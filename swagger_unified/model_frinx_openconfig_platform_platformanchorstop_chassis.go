...
type FrinxOpenconfigPlatformPlatformanchorstopChassis struct {
	// Optional[Configuration data for chassis components] REF:Optional.empty
	Config *FrinxOpenconfigPlatformPlatformanchorstopChassisConfig `json:"config,omitempty"`
}
