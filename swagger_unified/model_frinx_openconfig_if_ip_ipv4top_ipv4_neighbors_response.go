...
// frinx.openconfig.if.ip.ipv4top.ipv4.Neighbors.response
type FrinxOpenconfigIfIpIpv4topIpv4NeighborsResponse struct {
	FrinxOpenconfigIfIpneighbors *FrinxOpenconfigIfIpIpv4topIpv4Neighbors `json:"frinx-openconfig-if-ip:neighbors,omitempty"`
}
