...
// frinx.evpn.evpntop.evpn.Config.response
type FrinxEvpnEvpntopEvpnConfigResponse struct {
	FrinxEvpnconfig *FrinxEvpnEvpntopEvpnConfig `json:"frinx-evpn:config,omitempty"`
}
