...
// Optional[Top-level container for QoS data related to the egress interface] REF:Optional.empty
type FrinxOpenconfigQosQosinterfaceoutputtopOutput struct {
	...
	// Optional[Configuration data for QoS on the egress interface] REF:Optional.empty
	Config *FrinxOpenconfigQosQosinterfaceoutputtopOutputConfig `json:"config,omitempty"`
