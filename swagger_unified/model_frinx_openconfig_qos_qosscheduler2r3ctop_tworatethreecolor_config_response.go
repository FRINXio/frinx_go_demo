...
// frinx.openconfig.qos.qosscheduler2r3ctop.tworatethreecolor.Config.response
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
