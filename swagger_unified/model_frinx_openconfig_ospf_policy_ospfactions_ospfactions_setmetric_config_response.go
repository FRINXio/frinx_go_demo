...
// frinx.openconfig.ospf.policy.ospfactions.ospfactions.setmetric.Config.response
type FrinxOpenconfigOspfPolicyOspfactionsOspfactionsSetmetricConfigResponse struct {
	FrinxOpenconfigOspfPolicyconfig *FrinxOpenconfigOspfPolicyOspfactionsOspfactionsSetmetricConfig `json:"frinx-openconfig-ospf-policy:config,omitempty"`
}
