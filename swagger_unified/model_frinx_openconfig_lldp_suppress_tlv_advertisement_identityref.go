...
type FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref string

// List of frinx.openconfig.lldp.SuppressTlvAdvertisementIdentityref
const (
	FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref_SYSTEM_NAME FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref = "frinx-openconfig-lldp-types:SYSTEM_NAME"
	FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref_PORT_DESCRIPTION FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref = "frinx-openconfig-lldp-types:PORT_DESCRIPTION"
	FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref_LLDP_TLV FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref = "frinx-openconfig-lldp-types:LLDP_TLV"
	FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref_SYSTEM_CAPABILITIES FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref = "frinx-openconfig-lldp-types:SYSTEM_CAPABILITIES"
	FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref_MANAGEMENT_ADDRESS FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref = "frinx-openconfig-lldp-types:MANAGEMENT_ADDRESS"
	FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref_SYSTEM_DESCRIPTION FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref = "frinx-openconfig-lldp-types:SYSTEM_DESCRIPTION"
	FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref_PORT_ID FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref = "frinx-openconfig-lldp-types:PORT_ID"
	FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref_CHASSIS_ID FrinxOpenconfigLldpSuppressTlvAdvertisementIdentityref = "frinx-openconfig-lldp-types:CHASSIS_ID"
)
