...
type FrinxOpenconfigMplsMplsinterfacestopInterfaceattributesInterfaceConfig struct {
	// Optional[Enable MPLS forwarding on this interface] REF:Optional.empty
	MplsEnabled bool `json:"mpls-enabled,omitempty"`
	// Optional[Indentifier for the MPLS interface] REF:Optional.empty
