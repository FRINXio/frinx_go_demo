...
// frinx.snmp.snmpinterfaceconfig.EnabledTrapForEvent.response
type FrinxSnmpSnmpinterfaceconfigEnabledTrapForEventResponse struct {
	FrinxSnmpenabledTrapForEvent []FrinxSnmpSnmpinterfaceconfigEnabledTrapForEvent `json:"frinx-snmp:enabled-trap-for-event,omitempty"`
}
