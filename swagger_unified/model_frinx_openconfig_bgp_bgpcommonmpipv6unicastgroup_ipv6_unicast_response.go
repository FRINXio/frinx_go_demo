...
// frinx.openconfig.bgp.bgpcommonmpipv6unicastgroup.Ipv6Unicast.response
type FrinxOpenconfigBgpBgpcommonmpipv6unicastgroupIpv6UnicastResponse struct {
	FrinxOpenconfigNetworkInstanceipv6Unicast *FrinxOpenconfigBgpBgpcommonmpipv6unicastgroupIpv6Unicast `json:"frinx-openconfig-network-instance:ipv6-unicast,omitempty"`
}
