...
// Optional[Configuration and operationals state relating to the relationship between interfaces and SNMP.] REF:Optional.empty
type FrinxSnmpSnmpinterfacesstructuralInterfacesInterface struct {
	// Optional[Configuration parameters relating to an interface to SNMP binding.] REF:Optional.empty
	Config *FrinxSnmpSnmpinterfacesstructuralInterfacesInterfaceConfig `json:"config,omitempty"`
	// Optional[A reference to the unique identifier for the interface being referenced by the SNMP.] REF:Optional.empty
