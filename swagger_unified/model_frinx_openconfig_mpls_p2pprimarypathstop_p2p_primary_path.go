...
type FrinxOpenconfigMplsP2pprimarypathstopP2pPrimaryPath struct {
	// Optional[List of p2p primary paths for a tunnel] REF:Optional.empty
	P2pPrimaryPath []FrinxOpenconfigMplsP2pprimarypathstopP2pprimarypathP2pPrimaryPath `json:"p2p-primary-path,omitempty"`
}
