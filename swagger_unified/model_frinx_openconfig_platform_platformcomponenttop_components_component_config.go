...
type FrinxOpenconfigPlatformPlatformcomponenttopComponentsComponentConfig struct {
	// Optional[Device name for the component -- this will not be a configurable parameter on many implementations] REF:Optional.empty
