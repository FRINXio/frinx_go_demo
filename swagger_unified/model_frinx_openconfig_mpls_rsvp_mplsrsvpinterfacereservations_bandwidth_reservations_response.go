...
// frinx.openconfig.mpls.rsvp.mplsrsvpinterfacereservations.BandwidthReservations.response
type FrinxOpenconfigMplsRsvpMplsrsvpinterfacereservationsBandwidthReservationsResponse struct {
	FrinxOpenconfigNetworkInstancebandwidthReservations *FrinxOpenconfigMplsRsvpMplsrsvpinterfacereservationsBandwidthReservations `json:"frinx-openconfig-network-instance:bandwidth-reservations,omitempty"`
}
