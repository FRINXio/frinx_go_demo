...
type FrinxOpenconfigInterfacesInterfacerefInterfaceRefResponse2 struct {
	FrinxOpenconfigBfdinterfaceRef *FrinxOpenconfigInterfacesInterfacerefInterfaceRef `json:"frinx-openconfig-bfd:interface-ref,omitempty"`
}
