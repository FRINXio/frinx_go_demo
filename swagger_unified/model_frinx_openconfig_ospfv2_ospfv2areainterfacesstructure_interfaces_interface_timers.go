...
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceTimers struct {
	// Optional[Configuration parameters for OSPFv2 timers on the interface] REF:Optional.empty
	Config *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceTimersConfig `json:"config,omitempty"`
}
