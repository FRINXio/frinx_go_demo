...
// frinx.openconfig.routing.policy.prefixsettop.prefixsets.prefixset.Config.response
type FrinxOpenconfigRoutingPolicyPrefixsettopPrefixsetsPrefixsetConfigResponse struct {
	FrinxOpenconfigRoutingPolicyconfig *FrinxOpenconfigRoutingPolicyPrefixsettopPrefixsetsPrefixsetConfig `json:"frinx-openconfig-routing-policy:config,omitempty"`
}
