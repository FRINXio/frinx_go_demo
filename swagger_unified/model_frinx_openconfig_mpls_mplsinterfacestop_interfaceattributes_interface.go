...
type FrinxOpenconfigMplsMplsinterfacestopInterfaceattributesInterface struct {
	// Optional[Configuration parameters related to MPLS interfaces:] REF:Optional.empty
	Config *FrinxOpenconfigMplsMplsinterfacestopInterfaceattributesInterfaceConfig `json:"config,omitempty"`
