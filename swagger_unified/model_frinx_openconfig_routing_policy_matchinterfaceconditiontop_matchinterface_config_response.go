...
// frinx.openconfig.routing.policy.matchinterfaceconditiontop.matchinterface.Config.response
type FrinxOpenconfigRoutingPolicyMatchinterfaceconditiontopMatchinterfaceConfigResponse struct {
	FrinxOpenconfigRoutingPolicyconfig *FrinxOpenconfigRoutingPolicyMatchinterfaceconditiontopMatchinterfaceConfig `json:"frinx-openconfig-routing-policy:config,omitempty"`
}
