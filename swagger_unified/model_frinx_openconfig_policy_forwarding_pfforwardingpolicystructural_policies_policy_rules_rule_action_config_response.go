...
// frinx.openconfig.policy.forwarding.pfforwardingpolicystructural.policies.policy.rules.rule.action.Config.response
type FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRuleActionConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRuleActionConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
