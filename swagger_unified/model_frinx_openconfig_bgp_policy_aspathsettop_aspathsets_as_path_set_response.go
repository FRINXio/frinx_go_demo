...
// frinx.openconfig.bgp.policy.aspathsettop.aspathsets.AsPathSet.response
type FrinxOpenconfigBgpPolicyAspathsettopAspathsetsAsPathSetResponse struct {
	FrinxOpenconfigBgpPolicyasPathSet []FrinxOpenconfigBgpPolicyAspathsettopAspathsetsAsPathSet `json:"frinx-openconfig-bgp-policy:as-path-set,omitempty"`
}
