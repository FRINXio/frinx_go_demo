...
// frinx.openconfig.network.instance.networkinstancetop.networkinstances.networkinstance.TableConnections.response
type FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceTableConnectionsResponse struct {
	FrinxOpenconfigNetworkInstancetableConnections *FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceTableConnections `json:"frinx-openconfig-network-instance:table-connections,omitempty"`
}
