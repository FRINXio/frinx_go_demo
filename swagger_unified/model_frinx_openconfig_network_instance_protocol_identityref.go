...
type FrinxOpenconfigNetworkInstanceProtocolIdentityref string

// List of frinx.openconfig.network.instance.ProtocolIdentityref
const (
	FrinxOpenconfigNetworkInstanceProtocolIdentityref_OSPF FrinxOpenconfigNetworkInstanceProtocolIdentityref = "frinx-openconfig-policy-types:OSPF"
	FrinxOpenconfigNetworkInstanceProtocolIdentityref_DIRECTLY_CONNECTED FrinxOpenconfigNetworkInstanceProtocolIdentityref = "frinx-openconfig-policy-types:DIRECTLY_CONNECTED"
	FrinxOpenconfigNetworkInstanceProtocolIdentityref_OSPF3 FrinxOpenconfigNetworkInstanceProtocolIdentityref = "frinx-openconfig-policy-types:OSPF3"
	FrinxOpenconfigNetworkInstanceProtocolIdentityref_STATIC FrinxOpenconfigNetworkInstanceProtocolIdentityref = "frinx-openconfig-policy-types:STATIC"
	FrinxOpenconfigNetworkInstanceProtocolIdentityref_INSTALL_PROTOCOL_TYPE FrinxOpenconfigNetworkInstanceProtocolIdentityref = "frinx-openconfig-policy-types:INSTALL_PROTOCOL_TYPE"
	FrinxOpenconfigNetworkInstanceProtocolIdentityref_ISIS FrinxOpenconfigNetworkInstanceProtocolIdentityref = "frinx-openconfig-policy-types:ISIS"
	FrinxOpenconfigNetworkInstanceProtocolIdentityref_BGP FrinxOpenconfigNetworkInstanceProtocolIdentityref = "frinx-openconfig-policy-types:BGP"
	FrinxOpenconfigNetworkInstanceProtocolIdentityref_LOCAL_AGGREGATE FrinxOpenconfigNetworkInstanceProtocolIdentityref = "frinx-openconfig-policy-types:LOCAL_AGGREGATE"
)
