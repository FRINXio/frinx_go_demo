...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.bgp.neighbors.Neighbor.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpNeighborsNeighborResponse struct {
	FrinxOpenconfigNetworkInstanceneighbor []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpNeighborsNeighbor `json:"frinx-openconfig-network-instance:neighbor,omitempty"`
}
