...
// frinx.openconfig.probes.Probes.response
type FrinxOpenconfigProbesProbesResponse struct {
	FrinxOpenconfigProbesprobes *FrinxOpenconfigProbesProbes `json:"frinx-openconfig-probes:probes,omitempty"`
}
