...
// frinx.openconfig.qos.qos.classifiers.classifier.terms.term.conditions.Ipv6.response
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv6Response struct {
	FrinxOpenconfigQosipv6 *FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv6 `json:"frinx-openconfig-qos:ipv6,omitempty"`
}
