...
type FrinxOpenconfigBgpPolicyMatchextcommunitytopMatchExtCommunitySet struct {
	// Optional[Configuration data for match conditions on extended communities] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicyMatchextcommunitytopMatchextcommunitysetConfig `json:"config,omitempty"`
}
