...
// frinx.logging.logginginterfacesstructural.Interfaces.response
type FrinxLoggingLogginginterfacesstructuralInterfacesResponse struct {
	FrinxLogginginterfaces *FrinxLoggingLogginginterfacesstructuralInterfaces `json:"frinx-logging:interfaces,omitempty"`
}
