...
type FrinxBgpExtensionApiService service

/*
FrinxBgpExtensionApiService
 ...
 * @param afiSafiName Id of afi-safi
 * @param nodeId


*/
func (a *FrinxBgpExtensionApiService) DeleteFrinxOpenconfigNetworkInstanceNetworkInstancesNetworkInstanceProtocolsProtocolBgpNeighborsNeighborAfiSafisAfiSafiConfigSoftReconfiguration(ctx context.Context, name string, identifier string, protocolName string, neighborAddress string, afiSafiName string, nodeId string) (*http.Response, error) {
	var (
...
@return FrinxBgpExtensionSoftreconfigurationgroupSoftReconfigurationResponse
*/
func (a *FrinxBgpExtensionApiService) GetFrinxOpenconfigNetworkInstanceNetworkInstancesNetworkInstanceProtocolsProtocolBgpNeighborsNeighborAfiSafisAfiSafiConfigSoftReconfiguration(ctx context.Context, name string, identifier string, protocolName string, neighborAddress string, afiSafiName string, nodeId string) (FrinxBgpExtensionSoftreconfigurationgroupSoftReconfigurationResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxBgpExtensionSoftreconfigurationgroupSoftReconfigurationResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxBgpExtensionSoftreconfigurationgroupSoftReconfigurationResponse
 ...
 * @param neighborAddress Id of neighbor
 * @param afiSafiName Id of afi-safi
 * @param frinxBgpExtensionSoftreconfigurationgroupSoftReconfigurationBodyParam frinx.bgp.extension.softreconfigurationgroup.SoftReconfiguration to be added or updated
 * @param nodeId


*/
func (a *FrinxBgpExtensionApiService) PutFrinxOpenconfigNetworkInstanceNetworkInstancesNetworkInstanceProtocolsProtocolBgpNeighborsNeighborAfiSafisAfiSafiConfigSoftReconfiguration(ctx context.Context, name string, identifier string, protocolName string, neighborAddress string, afiSafiName string, frinxBgpExtensionSoftreconfigurationgroupSoftReconfigurationBodyParam FrinxBgpExtensionSoftreconfigurationgroupSoftReconfigurationRequest, nodeId string) (*http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &frinxBgpExtensionSoftreconfigurationgroupSoftReconfigurationBodyParam
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
