...
// frinx.openconfig.qos.qosscheduler2r3ctop.tworatethreecolor.exceedaction.Config.request
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorExceedactionConfigRequest struct {
