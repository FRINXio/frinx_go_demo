...
type FrinxOpenconfigVlanVlanroutedtopRoutedvlanConfig struct {
	// Optional[References the VLAN for which this IP interface provides routing services -- similar to a switch virtual interface (SVI), or integrated routing and bridging interface (IRB) in some implementations.] REF:Optional.empty
