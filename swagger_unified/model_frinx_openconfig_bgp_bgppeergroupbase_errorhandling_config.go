...
// Optional[Configuration parameters enabling or modifying the behavior or enhanced error handling mechanisms for the BGP group] REF:Optional.empty
type FrinxOpenconfigBgpBgppeergroupbaseErrorhandlingConfig struct {
