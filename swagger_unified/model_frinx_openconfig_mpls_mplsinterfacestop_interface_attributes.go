...
type FrinxOpenconfigMplsMplsinterfacestopInterfaceAttributes struct {
	// Optional[List of TE interfaces] REF:Optional.empty
	Interface_ []FrinxOpenconfigMplsMplsinterfacestopInterfaceattributesInterface `json:"interface,omitempty"`
}
