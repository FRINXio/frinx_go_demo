...
type FrinxNetflowNetflowinterfacestopInterfacesInterfaceConfig struct {
	// Optional[User-defined identifier for the interface -- a common convention could be '<if name>.<subif index>'] REF:Optional.empty
