...
type FrinxOpenconfigPacketMatchEthernetheadertopL2Response2 struct {
	FrinxOpenconfigQosl2 *FrinxOpenconfigPacketMatchEthernetheadertopL2 `json:"frinx-openconfig-qos:l2,omitempty"`
}
