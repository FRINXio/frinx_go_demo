...
// frinx.openconfig.interfaces.interfaces.interface.Config.response
type FrinxOpenconfigInterfacesInterfacesInterfaceConfigResponse struct {
	FrinxOpenconfigInterfacesconfig *FrinxOpenconfigInterfacesInterfacesInterfaceConfig `json:"frinx-openconfig-interfaces:config,omitempty"`
}
