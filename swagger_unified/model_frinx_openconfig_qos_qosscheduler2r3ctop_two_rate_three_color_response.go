...
// frinx.openconfig.qos.qosscheduler2r3ctop.TwoRateThreeColor.response
type FrinxOpenconfigQosQosscheduler2r3ctopTwoRateThreeColorResponse struct {
	FrinxOpenconfigQostwoRateThreeColor *FrinxOpenconfigQosQosscheduler2r3ctopTwoRateThreeColor `json:"frinx-openconfig-qos:two-rate-three-color,omitempty"`
}
