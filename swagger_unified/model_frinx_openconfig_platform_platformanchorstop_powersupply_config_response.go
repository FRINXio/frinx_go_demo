...
// frinx.openconfig.platform.platformanchorstop.powersupply.Config.response
type FrinxOpenconfigPlatformPlatformanchorstopPowersupplyConfigResponse struct {
	FrinxOpenconfigPlatformconfig *FrinxOpenconfigPlatformPlatformanchorstopPowersupplyConfig `json:"frinx-openconfig-platform:config,omitempty"`
}
