...
// Optional[Configuration and operational state parameters for settings that are global to the OSPFv2 instance] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2Global struct {
	// Optional[OSPFv2 parameters relating to MPLS] REF:Optional.empty
	Mpls *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMpls `json:"mpls,omitempty"`
	// Optional[Configuration and operational state parameters for OSPFv2 graceful restart] REF:Optional.empty
	GracefulRestart *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalGracefulRestart `json:"graceful-restart,omitempty"`
	// Optional[Configuration and operational state parameters for OSPFv2 timers] REF:Optional.empty
	Timers *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2GlobalTimers `json:"timers,omitempty"`
	// Optional[Policies defining how inter-area propagation should be performed by the OSPF instance] REF:Optional.empty
	InterAreaPropagationPolicies *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalInterAreaPropagationPolicies `json:"inter-area-propagation-policies,omitempty"`
	// Optional[Global configuration parameters for OSPFv2] REF:Optional.empty
	Config *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalConfig `json:"config,omitempty"`
}
