...
// Optional[Configuration parameters related to timers for TE LSPs] REF:Optional.empty
type FrinxOpenconfigMplsMplstelsptimersTelsptimersConfig struct {
	...
	// Optional[delay the removal of old te lsp for a specified amount of time] REF:Optional.empty
	CleanupDelay int32 `json:"cleanup-delay,omitempty"`
	// Optional[delay the use of newly installed te lsp for a specified amount of time.] REF:Optional.empty
	InstallDelay int32 `json:"install-delay,omitempty"`
}
