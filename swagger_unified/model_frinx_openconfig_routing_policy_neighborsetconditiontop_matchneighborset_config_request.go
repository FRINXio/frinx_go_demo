...
// frinx.openconfig.routing.policy.neighborsetconditiontop.matchneighborset.Config.request
type FrinxOpenconfigRoutingPolicyNeighborsetconditiontopMatchneighborsetConfigRequest struct {
