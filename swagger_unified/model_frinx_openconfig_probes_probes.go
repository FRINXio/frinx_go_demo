...
// Optional[The container containing the list of probes.] REF:Optional.empty
type FrinxOpenconfigProbesProbes struct {
	// Optional[List of probes configured.] REF:Optional.empty
	Probe []FrinxOpenconfigProbesProbesProbe `json:"probe,omitempty"`
}
