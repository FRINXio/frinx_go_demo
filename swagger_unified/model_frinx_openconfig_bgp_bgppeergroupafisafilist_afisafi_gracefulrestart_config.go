...
// Optional[Configuration options for BGP graceful-restart] REF:Optional.empty
type FrinxOpenconfigBgpBgppeergroupafisafilistAfisafiGracefulrestartConfig struct {
	// Optional[This leaf indicates whether graceful-restart is enabled for this AFI-SAFI] REF:Optional.empty
