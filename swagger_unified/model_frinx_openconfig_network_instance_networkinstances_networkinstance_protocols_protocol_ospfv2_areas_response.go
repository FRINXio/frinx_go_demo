...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.ospfv2.Areas.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2AreasResponse struct {
	FrinxOpenconfigNetworkInstanceareas *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2Areas `json:"frinx-openconfig-network-instance:areas,omitempty"`
}
