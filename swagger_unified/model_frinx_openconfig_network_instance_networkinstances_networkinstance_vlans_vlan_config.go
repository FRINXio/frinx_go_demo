...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceVlansVlanConfig struct {
	// Optional[Interface VLAN name.] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Interface VLAN id.] REF:Optional.empty
	VlanId int32 `json:"vlan-id,omitempty"`
	// Optional[Specify eline for vlan create command.] REF:Optional.empty
	FrinxDasanVlanExtensioneline bool `json:"frinx-dasan-vlan-extension:eline,omitempty"`
	// Optional[Admin state of the VLAN] REF:Optional.empty
	Status *FrinxOpenconfigVlanStatusEnumeration `json:"status,omitempty"`
}
