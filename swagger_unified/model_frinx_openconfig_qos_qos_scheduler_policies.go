...
type FrinxOpenconfigQosQosSchedulerPolicies struct {
	...
	SchedulerPolicy []FrinxOpenconfigQosQosSchedulerpoliciesSchedulerPolicy `json:"scheduler-policy,omitempty"`
}
