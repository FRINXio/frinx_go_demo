...
// frinx.openconfig.isis.isisinterfacegroup.Bfd.response
type FrinxOpenconfigIsisIsisinterfacegroupBfdResponse struct {
	FrinxOpenconfigNetworkInstancebfd *FrinxOpenconfigIsisIsisinterfacegroupBfd `json:"frinx-openconfig-network-instance:bfd,omitempty"`
}
