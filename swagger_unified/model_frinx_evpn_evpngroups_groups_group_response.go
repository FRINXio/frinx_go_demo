...
// frinx.evpn.evpngroups.groups.Group.response
type FrinxEvpnEvpngroupsGroupsGroupResponse struct {
	FrinxEvpngroup []FrinxEvpnEvpngroupsGroupsGroup `json:"frinx-evpn:group,omitempty"`
}
