...
// Optional[This container defines ISIS LSP Generation timers configuration.] REF:Optional.empty
type FrinxOpenconfigIsisIsisglobalbaseTimersLspgenerationConfig struct {
	// Optional[Time interval in milliseconds that specifies the first LSP generation delay.] REF:Optional.empty
	LspFirstWaitInterval int32 `json:"lsp-first-wait-interval,omitempty"`
	// Optional[Time interval in milliseconds that specifies max interval between two consecutive occurrences of an LSP being generated.] REF:Optional.empty
	LspMaxWaitInterval int32 `json:"lsp-max-wait-interval,omitempty"`
	// Optional[Time interval in milliseconds that specifies the millisecond LSP generation delay.] REF:Optional.empty
	LspSecondWaitInterval int32 `json:"lsp-second-wait-interval,omitempty"`
}
