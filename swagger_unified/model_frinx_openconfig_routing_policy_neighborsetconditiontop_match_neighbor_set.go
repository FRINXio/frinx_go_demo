...
type FrinxOpenconfigRoutingPolicyNeighborsetconditiontopMatchNeighborSet struct {
	// Optional[Configuration data ] REF:Optional.empty
	Config *FrinxOpenconfigRoutingPolicyNeighborsetconditiontopMatchneighborsetConfig `json:"config,omitempty"`
}
