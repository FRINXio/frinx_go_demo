...
type FrinxOpenconfigOspfv2TriggerIdentityref string

// List of frinx.openconfig.ospfv2.TriggerIdentityref
const (
	FrinxOpenconfigOspfv2TriggerIdentityref_CISCO_OSPF_EXTENSIONMAX_METRIC_ALWAYS FrinxOpenconfigOspfv2TriggerIdentityref = "frinx-cisco-ospf-extension:MAX_METRIC_ALWAYS"
	FrinxOpenconfigOspfv2TriggerIdentityref_OPENCONFIG_OSPF_TYPESMAX_METRIC_TRIGGER FrinxOpenconfigOspfv2TriggerIdentityref = "frinx-openconfig-ospf-types:MAX_METRIC_TRIGGER"
	FrinxOpenconfigOspfv2TriggerIdentityref_OPENCONFIG_OSPF_TYPESMAX_METRIC_ON_SYSTEM_BOOT FrinxOpenconfigOspfv2TriggerIdentityref = "frinx-openconfig-ospf-types:MAX_METRIC_ON_SYSTEM_BOOT"
	FrinxOpenconfigOspfv2TriggerIdentityref_CISCO_OSPF_EXTENSIONMAX_METRIC_ON_SWITCHOVER FrinxOpenconfigOspfv2TriggerIdentityref = "frinx-cisco-ospf-extension:MAX_METRIC_ON_SWITCHOVER"
)
