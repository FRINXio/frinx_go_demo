...
// frinx.openconfig.qos.qosscheduler2r3ctop.tworatethreecolor.ExceedAction.response
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorExceedActionResponse struct {
	FrinxOpenconfigQosexceedAction *FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorExceedAction `json:"frinx-openconfig-qos:exceed-action,omitempty"`
}
