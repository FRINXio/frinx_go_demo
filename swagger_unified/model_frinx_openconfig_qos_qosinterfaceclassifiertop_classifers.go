...
type FrinxOpenconfigQosQosinterfaceclassifiertopClassifers struct {
	// Optional[A list of classifiers that should be applied to the interface] REF:Optional.empty
	Classifier []FrinxOpenconfigQosQosinterfaceclassifiertopClassifersClassifier `json:"classifier,omitempty"`
}
