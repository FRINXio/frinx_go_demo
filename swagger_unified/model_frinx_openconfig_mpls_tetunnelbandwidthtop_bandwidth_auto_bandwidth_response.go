...
// frinx.openconfig.mpls.tetunnelbandwidthtop.bandwidth.AutoBandwidth.response
type FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutoBandwidthResponse struct {
	FrinxOpenconfigNetworkInstanceautoBandwidth *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutoBandwidth `json:"frinx-openconfig-network-instance:auto-bandwidth,omitempty"`
}
