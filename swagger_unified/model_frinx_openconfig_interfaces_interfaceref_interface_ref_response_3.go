...
type FrinxOpenconfigInterfacesInterfacerefInterfaceRefResponse3 struct {
	FrinxOpenconfigIfIpinterfaceRef *FrinxOpenconfigInterfacesInterfacerefInterfaceRef `json:"frinx-openconfig-if-ip:interface-ref,omitempty"`
}
