...
// frinx.openconfig.qos.qosinterfacestop.interfaces.Interface.response
type FrinxOpenconfigQosQosinterfacestopInterfacesInterfaceResponse struct {
	FrinxOpenconfigQosinterface []FrinxOpenconfigQosQosinterfacestopInterfacesInterface `json:"frinx-openconfig-qos:interface,omitempty"`
}
