...
// Optional[List of LDP neighbors and their attributes.] REF:Optional.empty
type FrinxOpenconfigMplsLdpMplsldpneighborstopNeighborsNeighbor struct {
	// Optional[Neighbor label switch router identifier.] REF:Optional.empty
	LsrId string `json:"lsr-id,omitempty"`
	// Optional[Label space ID of the neighbor.] REF:Optional.empty
	LabelSpaceId int32 `json:"label-space-id,omitempty"`
	// Optional[Neighbor configuration attributes.] REF:Optional.empty
	Config *FrinxOpenconfigMplsLdpMplsldpneighborstopNeighborsNeighborConfig `json:"config,omitempty"`
