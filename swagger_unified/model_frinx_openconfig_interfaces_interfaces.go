...
// Optional[Top level container for interfaces, including configuration and state data.] REF:Optional.empty
type FrinxOpenconfigInterfacesInterfaces struct {
	// Optional[The list of named interfaces on the device.] REF:Optional.empty
	Interface_ []FrinxOpenconfigInterfacesInterfacesInterface `json:"interface,omitempty"`
}
