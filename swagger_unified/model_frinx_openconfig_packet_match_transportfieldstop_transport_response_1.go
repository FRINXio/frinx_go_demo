...
type FrinxOpenconfigPacketMatchTransportfieldstopTransportResponse1 struct {
	FrinxOpenconfigQostransport *FrinxOpenconfigPacketMatchTransportfieldstopTransport `json:"frinx-openconfig-qos:transport,omitempty"`
}
