...
// frinx.openconfig.qos.qosscheduler2r3ctop.tworatethreecolor.conformaction.Config.request
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorConformactionConfigRequest struct {
