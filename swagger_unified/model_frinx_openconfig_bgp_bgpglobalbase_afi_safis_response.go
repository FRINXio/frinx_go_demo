...
// frinx.openconfig.bgp.bgpglobalbase.AfiSafis.response
type FrinxOpenconfigBgpBgpglobalbaseAfiSafisResponse struct {
	FrinxOpenconfigNetworkInstanceafiSafis *FrinxOpenconfigBgpBgpglobalbaseAfiSafis `json:"frinx-openconfig-network-instance:afi-safis,omitempty"`
}
