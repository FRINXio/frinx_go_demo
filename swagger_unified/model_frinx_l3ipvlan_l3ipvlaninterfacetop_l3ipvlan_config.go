...
// Optional[Configuration parameters for vlan interface] REF:Optional.empty
type FrinxL3ipvlanL3ipvlaninterfacetopL3ipvlanConfig struct {
	// Optional[Specify 'ip redirects' for vlan interface.] REF:Optional.empty
	IpRedirects bool `json:"ip-redirects,omitempty"`
}
