...
// Optional[Configuration parameters relating to router advertisements for IPv6.] REF:Optional.empty
type FrinxOpenconfigIfIpIpv6topIpv6RouteradvertisementConfig struct {
	// Optional[The lifetime advertised in the router advertisement neighbor discovery message on this interface.] REF:Optional.empty
	Lifetime int64 `json:"lifetime,omitempty"`
	// Optional[The interval between periodic router advertisement neighbor discovery messages sent on this interface expressed in seconds.] REF:Optional.empty
	Interval int64 `json:"interval,omitempty"`
	// Optional[When set to true, router advertisement neighbor discovery messages are not transmitted on this interface.] REF:Optional.empty
