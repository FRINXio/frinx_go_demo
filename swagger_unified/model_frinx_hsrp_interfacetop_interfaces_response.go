...
// frinx.hsrp.interfacetop.Interfaces.response
type FrinxHsrpInterfacetopInterfacesResponse struct {
	FrinxHsrpinterfaces *FrinxHsrpInterfacetopInterfaces `json:"frinx-hsrp:interfaces,omitempty"`
}
