...
// Optional[List of learned MAC addresses] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntriesEntry struct {
	// Optional[Reference to mac-address list key] REF:Optional.empty
	MacAddress string `json:"mac-address,omitempty"`
	// Optional[Reference to the base and/or subinterface for the MAC table entry] REF:Optional.empty
	Interface_ *FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntriesEntryInterface `json:"interface,omitempty"`
	// Optional[Configuration data for MAC table entries] REF:Optional.empty
	Config *FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntriesEntryConfig `json:"config,omitempty"`
}
