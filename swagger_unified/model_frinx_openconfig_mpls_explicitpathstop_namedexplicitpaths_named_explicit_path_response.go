...
// frinx.openconfig.mpls.explicitpathstop.namedexplicitpaths.NamedExplicitPath.response
type FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedExplicitPathResponse struct {
	FrinxOpenconfigNetworkInstancenamedExplicitPath []FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedExplicitPath `json:"frinx-openconfig-network-instance:named-explicit-path,omitempty"`
}
