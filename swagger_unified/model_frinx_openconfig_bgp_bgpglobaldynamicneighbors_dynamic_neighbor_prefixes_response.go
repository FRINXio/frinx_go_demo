...
// frinx.openconfig.bgp.bgpglobaldynamicneighbors.DynamicNeighborPrefixes.response
type FrinxOpenconfigBgpBgpglobaldynamicneighborsDynamicNeighborPrefixesResponse struct {
	FrinxOpenconfigNetworkInstancedynamicNeighborPrefixes *FrinxOpenconfigBgpBgpglobaldynamicneighborsDynamicNeighborPrefixes `json:"frinx-openconfig-network-instance:dynamic-neighbor-prefixes,omitempty"`
}
