...
// frinx.openconfig.bgp.bgpcommonmpallafisaficommon.prefixlimit.Config.response
type FrinxOpenconfigBgpBgpcommonmpallafisaficommonPrefixlimitConfigResponse struct {
