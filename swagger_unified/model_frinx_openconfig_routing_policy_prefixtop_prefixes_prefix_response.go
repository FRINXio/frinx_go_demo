...
// frinx.openconfig.routing.policy.prefixtop.prefixes.Prefix.response
type FrinxOpenconfigRoutingPolicyPrefixtopPrefixesPrefixResponse struct {
	FrinxOpenconfigRoutingPolicyprefix []FrinxOpenconfigRoutingPolicyPrefixtopPrefixesPrefix `json:"frinx-openconfig-routing-policy:prefix,omitempty"`
}
