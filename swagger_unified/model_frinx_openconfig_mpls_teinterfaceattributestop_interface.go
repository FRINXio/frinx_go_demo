...
// Optional[List of TE interfaces] REF:Optional.empty
type FrinxOpenconfigMplsTeinterfaceattributestopInterface struct {
	// Optional[Interface bandwidth change percentages that trigger update events into the IGP traffic engineering database (TED)] REF:Optional.empty
	IgpFloodingBandwidth *FrinxOpenconfigMplsMplsteigpfloodingbandwidthIgpFloodingBandwidth `json:"igp-flooding-bandwidth,omitempty"`
	// Optional[Configuration parameters related to TE interfaces:] REF:Optional.empty
	Config *FrinxOpenconfigMplsTeinterfaceattributestopInterfaceConfig `json:"config,omitempty"`
