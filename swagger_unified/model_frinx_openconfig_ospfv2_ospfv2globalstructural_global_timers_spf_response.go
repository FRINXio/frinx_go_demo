...
// frinx.openconfig.ospfv2.ospfv2globalstructural.global.timers.Spf.response
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersSpfResponse struct {
	FrinxOpenconfigNetworkInstancespf *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersSpf `json:"frinx-openconfig-network-instance:spf,omitempty"`
}
