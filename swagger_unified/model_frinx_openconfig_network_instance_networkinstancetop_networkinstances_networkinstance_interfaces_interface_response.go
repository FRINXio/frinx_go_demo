...
// frinx.openconfig.network.instance.networkinstancetop.networkinstances.networkinstance.interfaces.Interface.response
type FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceInterfacesInterfaceResponse struct {
	FrinxOpenconfigNetworkInstanceinterface []FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceInterfacesInterface `json:"frinx-openconfig-network-instance:interface,omitempty"`
}
