...
type FrinxOpenconfigBgpBgpcommonstructureneighborgroupebgpmultihopEbgpMultihop struct {
	// Optional[Configuration parameters relating to eBGP multihop for the BGP group] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpcommonstructureneighborgroupebgpmultihopEbgpmultihopConfig `json:"config,omitempty"`
}
