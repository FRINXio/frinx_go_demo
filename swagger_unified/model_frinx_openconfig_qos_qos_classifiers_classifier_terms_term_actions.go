...
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermActions struct {
	// Optional[Actions to be applied to packets that match the classifier term.] REF:Optional.empty
	Config *FrinxOpenconfigQosQosclassifiertermstopTermsTermActionsConfig `json:"config,omitempty"`
	// Optional[Remark actions to be associated with packets that match the classifier term. Where a packet matches these criteria, the specified rewrite actions should be performed.] REF:Optional.empty
	Remark *FrinxOpenconfigQosQosClassifiersClassifierTermsTermActionsRemark `json:"remark,omitempty"`
}
