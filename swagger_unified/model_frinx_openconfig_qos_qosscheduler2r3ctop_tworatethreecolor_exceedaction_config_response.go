...
// frinx.openconfig.qos.qosscheduler2r3ctop.tworatethreecolor.exceedaction.Config.response
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorExceedactionConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorExceedactionConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
