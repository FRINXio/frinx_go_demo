...
// frinx.openconfig.isis.isislevelgroup.Authentication.response
type FrinxOpenconfigIsisIsislevelgroupAuthenticationResponse struct {
	FrinxOpenconfigNetworkInstanceauthentication *FrinxOpenconfigIsisIsislevelgroupAuthentication `json:"frinx-openconfig-network-instance:authentication,omitempty"`
}
