...
// frinx.openconfig.mpls.igplspsetup.PathSetupProtocol.response
type FrinxOpenconfigMplsIgplspsetupPathSetupProtocolResponse struct {
	FrinxOpenconfigNetworkInstancepathSetupProtocol *FrinxOpenconfigMplsIgplspsetupPathSetupProtocol `json:"frinx-openconfig-network-instance:path-setup-protocol,omitempty"`
}
