...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.bgp.peergroups.PeerGroup.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpPeergroupsPeerGroupResponse struct {
	FrinxOpenconfigNetworkInstancepeerGroup []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpPeergroupsPeerGroup `json:"frinx-openconfig-network-instance:peer-group,omitempty"`
}
