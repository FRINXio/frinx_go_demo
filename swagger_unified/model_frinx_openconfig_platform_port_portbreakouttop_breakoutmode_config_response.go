...
// frinx.openconfig.platform.port.portbreakouttop.breakoutmode.Config.response
type FrinxOpenconfigPlatformPortPortbreakouttopBreakoutmodeConfigResponse struct {
	FrinxOpenconfigPlatformPortconfig *FrinxOpenconfigPlatformPortPortbreakouttopBreakoutmodeConfig `json:"frinx-openconfig-platform-port:config,omitempty"`
}
