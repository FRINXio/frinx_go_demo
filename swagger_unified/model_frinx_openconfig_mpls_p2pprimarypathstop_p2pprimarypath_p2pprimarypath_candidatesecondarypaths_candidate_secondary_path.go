...
// Optional[List of secondary paths which may be utilised when the current primary path is in use] REF:Optional.empty
type FrinxOpenconfigMplsP2pprimarypathstopP2pprimarypathP2pprimarypathCandidatesecondarypathsCandidateSecondaryPath struct {
	// Optional[A reference to the secondary path option reference which acts as the key of the candidate-secondary-path list] REF:Optional.empty
	SecondaryPath string `json:"secondary-path,omitempty"`
	// Optional[Configuration parameters relating to the candidate secondary path] REF:Optional.empty
	Config *FrinxOpenconfigMplsP2pprimarypathstopP2pprimarypathP2pprimarypathCandidatesecondarypathsCandidatesecondarypathConfig `json:"config,omitempty"`
}
