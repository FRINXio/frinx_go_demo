...
// frinx.openconfig.mpls.tetunnelbandwidthtop.Bandwidth.response
type FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthResponse struct {
	FrinxOpenconfigNetworkInstancebandwidth *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidth `json:"frinx-openconfig-network-instance:bandwidth,omitempty"`
}
