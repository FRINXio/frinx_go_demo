...
// frinx.openconfig.if.ip.ipv4top.ipv4.addresses.Address.response
type FrinxOpenconfigIfIpIpv4topIpv4AddressesAddressResponse struct {
	FrinxOpenconfigIfIpaddress []FrinxOpenconfigIfIpIpv4topIpv4AddressesAddress `json:"frinx-openconfig-if-ip:address,omitempty"`
}
