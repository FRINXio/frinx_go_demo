...
type FrinxOpenconfigPacketMatchTransportfieldstopTransportConfigResponse1 struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigPacketMatchTransportfieldstopTransportConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
