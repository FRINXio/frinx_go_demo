...
type FrinxOpenconfigBgpPolicySetcommunityactiontopSetCommunity struct {
	// Optional[Provide a reference to a defined community set for the set-community action] REF:Optional.empty
	Reference *FrinxOpenconfigBgpPolicySetcommunityreferencetopReference `json:"reference,omitempty"`
	// Optional[Set the community values for the action inline with a list.] REF:Optional.empty
	Inline *FrinxOpenconfigBgpPolicySetcommunityinlinetopInline `json:"inline,omitempty"`
	// Optional[Configuration data for the set-community action] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicySetcommunityactiontopSetcommunityConfig `json:"config,omitempty"`
}
