...
type FrinxOpenconfigMplsTeinterfaceattributestopInterfaceConfig struct {
	// Optional[TE specific metric for the link] REF:Optional.empty
	TeMetric int64 `json:"te-metric,omitempty"`
	// Optional[list of references to named shared risk link groups that the interface belongs to.] REF:Optional.empty
	SrlgMembership []string `json:"srlg-membership,omitempty"`
	// Optional[Id of the interface] REF:Optional.empty
	InterfaceId string `json:"interface-id,omitempty"`
	// Optional[list of admin groups (by name) on the interface] REF:Optional.empty
