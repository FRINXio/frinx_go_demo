...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsTeGlobalAttributes struct {
	// Optional.empty REF:Optional.empty
	FrinxCiscoMplsTeExtensionconfig *FrinxCiscoMplsTeExtensionCiscomplsteglobalconfigConfig `json:"frinx-cisco-mpls-te-extension:config,omitempty"`
	// Optional[Shared risk link groups attributes] REF:Optional.empty
	Srlgs *FrinxOpenconfigMplsMplstesrlgtopSrlgs `json:"srlgs,omitempty"`
	// Optional[Definition for delays associated with setup and cleanup of TE LSPs] REF:Optional.empty
	TeLspTimers *FrinxOpenconfigMplsMplstelsptimersTeLspTimers `json:"te-lsp-timers,omitempty"`
	// Optional[Top-level container for admin-groups configuration and state] REF:Optional.empty
	MplsAdminGroups *FrinxOpenconfigMplsMplsadmingroupstopMplsAdminGroups `json:"mpls-admin-groups,omitempty"`
}
