...
// frinx.openconfig.if.ip.ipv6top.ipv6.Neighbors.response
type FrinxOpenconfigIfIpIpv6topIpv6NeighborsResponse struct {
	FrinxOpenconfigIfIpneighbors *FrinxOpenconfigIfIpIpv6topIpv6Neighbors `json:"frinx-openconfig-if-ip:neighbors,omitempty"`
}
