...
// frinx.openconfig.mpls.teinterfaceattributestop.interface.Config.response
type FrinxOpenconfigMplsTeinterfaceattributestopInterfaceConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsTeinterfaceattributestopInterfaceConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
