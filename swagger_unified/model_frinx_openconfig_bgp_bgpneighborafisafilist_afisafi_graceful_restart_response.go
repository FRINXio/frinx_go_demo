...
// frinx.openconfig.bgp.bgpneighborafisafilist.afisafi.GracefulRestart.response
type FrinxOpenconfigBgpBgpneighborafisafilistAfisafiGracefulRestartResponse struct {
	FrinxOpenconfigNetworkInstancegracefulRestart *FrinxOpenconfigBgpBgpneighborafisafilistAfisafiGracefulRestart `json:"frinx-openconfig-network-instance:graceful-restart,omitempty"`
}
