...
// frinx.openconfig.bfd.Bfd.response
type FrinxOpenconfigBfdBfdResponse struct {
	FrinxOpenconfigBfdbfd *FrinxOpenconfigBfdBfd `json:"frinx-openconfig-bfd:bfd,omitempty"`
}
