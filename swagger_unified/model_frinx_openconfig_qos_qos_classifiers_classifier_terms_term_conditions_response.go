...
// frinx.openconfig.qos.qos.classifiers.classifier.terms.term.Conditions.response
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsResponse struct {
	FrinxOpenconfigQosconditions *FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditions `json:"frinx-openconfig-qos:conditions,omitempty"`
}
