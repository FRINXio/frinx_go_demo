...
type FrinxOpenconfigOspfPolicyOspfactionsOspfactionsConfig struct {
	// Optional[Set the area for the matched route. This action is typically used when importing prefixes into OSPF, such that a route can be imported into a specific area within the instance.] REF:Optional.empty
	SetArea string `json:"set-area,omitempty"`
}
