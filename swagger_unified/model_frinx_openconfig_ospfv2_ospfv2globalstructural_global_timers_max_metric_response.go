...
// frinx.openconfig.ospfv2.ospfv2globalstructural.global.timers.MaxMetric.response
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersMaxMetricResponse struct {
	FrinxOpenconfigNetworkInstancemaxMetric *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersMaxMetric `json:"frinx-openconfig-network-instance:max-metric,omitempty"`
}
