...
// frinx.openconfig.if.ip.ipv4top.ipv4.addresses.address.Config.response
type FrinxOpenconfigIfIpIpv4topIpv4AddressesAddressConfigResponse struct {
	FrinxOpenconfigIfIpconfig *FrinxOpenconfigIfIpIpv4topIpv4AddressesAddressConfig `json:"frinx-openconfig-if-ip:config,omitempty"`
}
