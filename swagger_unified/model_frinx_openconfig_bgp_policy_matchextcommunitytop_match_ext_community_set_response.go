...
// frinx.openconfig.bgp.policy.matchextcommunitytop.MatchExtCommunitySet.response
type FrinxOpenconfigBgpPolicyMatchextcommunitytopMatchExtCommunitySetResponse struct {
	FrinxOpenconfigBgpPolicymatchExtCommunitySet *FrinxOpenconfigBgpPolicyMatchextcommunitytopMatchExtCommunitySet `json:"frinx-openconfig-bgp-policy:match-ext-community-set,omitempty"`
}
