...
// frinx.openconfig.isis.isisglobalbase.gracefulrestart.Config.response
type FrinxOpenconfigIsisIsisglobalbaseGracefulrestartConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisglobalbaseGracefulrestartConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
