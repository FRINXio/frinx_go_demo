...
type FrinxOpenconfigProbesProbesProbeConfig struct {
	// Optional[The name of the probe.] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Define the probe is delegate-probes or not] REF:Optional.empty
	FrinxJuniperProbesExtensiondelegateProbes bool `json:"frinx-juniper-probes-extension:delegate-probes,omitempty"`
	// Optional[Whether the probe is enabled.] REF:Optional.empty
