...
// frinx.openconfig.isis.keychainbasegroup.Keychain.response
type FrinxOpenconfigIsisKeychainbasegroupKeychainResponse struct {
	FrinxOpenconfigNetworkInstancekeychain *FrinxOpenconfigIsisKeychainbasegroupKeychain `json:"frinx-openconfig-network-instance:keychain,omitempty"`
}
