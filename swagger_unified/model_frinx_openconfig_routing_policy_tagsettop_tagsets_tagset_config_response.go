...
// frinx.openconfig.routing.policy.tagsettop.tagsets.tagset.Config.response
type FrinxOpenconfigRoutingPolicyTagsettopTagsetsTagsetConfigResponse struct {
	FrinxOpenconfigRoutingPolicyconfig *FrinxOpenconfigRoutingPolicyTagsettopTagsetsTagsetConfig `json:"frinx-openconfig-routing-policy:config,omitempty"`
}
