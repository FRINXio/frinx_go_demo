...
// frinx.openconfig.mpls.tetunnelbandwidthtop.bandwidth.Config.response
type FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
