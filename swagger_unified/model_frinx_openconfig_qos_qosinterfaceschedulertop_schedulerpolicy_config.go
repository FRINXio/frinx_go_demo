...
type FrinxOpenconfigQosQosinterfaceschedulertopSchedulerpolicyConfig struct {
	// Optional[The scheduler policy to be applied to traffic on this interface.] REF:Optional.empty
