...
type FrinxOpenconfigBfdBfdenableEnablebfdConfigResponse1 struct {
	FrinxBfdExtensionconfig *FrinxOpenconfigBfdBfdenableEnablebfdConfig `json:"frinx-bfd-extension:config,omitempty"`
}
