...
// frinx.openconfig.ospf.policy.ospfactions.ospfactions.Config.response
type FrinxOpenconfigOspfPolicyOspfactionsOspfactionsConfigResponse struct {
	FrinxOpenconfigOspfPolicyconfig *FrinxOpenconfigOspfPolicyOspfactionsOspfactionsConfig `json:"frinx-openconfig-ospf-policy:config,omitempty"`
}
