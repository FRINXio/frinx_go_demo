...
// frinx.openconfig.network.instance.l2niinstance.fdb.Config.response
type FrinxOpenconfigNetworkInstanceL2niinstanceFdbConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigNetworkInstanceL2niinstanceFdbConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
