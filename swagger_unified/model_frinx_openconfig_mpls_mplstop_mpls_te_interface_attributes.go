...
type FrinxOpenconfigMplsMplstopMplsTeInterfaceAttributes struct {
	// Optional[List of TE interfaces] REF:Optional.empty
	Interface_ []FrinxOpenconfigMplsTeinterfaceattributestopInterface `json:"interface,omitempty"`
}
