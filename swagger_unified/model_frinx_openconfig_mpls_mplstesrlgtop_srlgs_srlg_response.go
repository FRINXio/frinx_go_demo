...
// frinx.openconfig.mpls.mplstesrlgtop.srlgs.Srlg.response
type FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgResponse struct {
	FrinxOpenconfigNetworkInstancesrlg []FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlg `json:"frinx-openconfig-network-instance:srlg,omitempty"`
}
