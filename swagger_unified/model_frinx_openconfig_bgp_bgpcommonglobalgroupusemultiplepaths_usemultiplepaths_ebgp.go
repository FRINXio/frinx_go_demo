...
type FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsEbgp struct {
	// Optional[Configuration parameters relating to eBGP multipath] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsEbgpConfig `json:"config,omitempty"`
}
