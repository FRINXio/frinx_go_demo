...
// frinx.openconfig.isis.interlevelpropagationpoliciesstructural.interlevelpropagationpolicies.level1tolevel2.Config.response
type FrinxOpenconfigIsisInterlevelpropagationpoliciesstructuralInterlevelpropagationpoliciesLevel1tolevel2ConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisInterlevelpropagationpoliciesstructuralInterlevelpropagationpoliciesLevel1tolevel2Config `json:"frinx-openconfig-network-instance:config,omitempty"`
}
