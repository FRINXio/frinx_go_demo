...
// Optional[Top-level container for LLDP configuration and state data] REF:Optional.empty
type FrinxOpenconfigLldpLldptopLldp struct {
	// Optional[Configuration data ] REF:Optional.empty
	Config *FrinxOpenconfigLldpLldptopLldpConfig `json:"config,omitempty"`
	// Optional[Enclosing container ] REF:Optional.empty
	Interfaces *FrinxOpenconfigLldpLldpinterfacetopInterfaces `json:"interfaces,omitempty"`
}
