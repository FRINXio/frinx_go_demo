...
// Optional[List of defined BGP community sets] REF:Optional.empty
type FrinxOpenconfigBgpPolicyCommunitysettopCommunitysetsCommunitySet struct {
	...
	Config *FrinxOpenconfigBgpPolicyCommunitysettopCommunitysetsCommunitysetConfig `json:"config,omitempty"`
}
