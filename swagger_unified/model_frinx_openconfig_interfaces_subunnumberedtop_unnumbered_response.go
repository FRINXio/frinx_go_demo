...
// frinx.openconfig.interfaces.subunnumberedtop.Unnumbered.response
type FrinxOpenconfigInterfacesSubunnumberedtopUnnumberedResponse struct {
	FrinxOpenconfigIfIpunnumbered *FrinxOpenconfigInterfacesSubunnumberedtopUnnumbered `json:"frinx-openconfig-if-ip:unnumbered,omitempty"`
}
