...
// frinx.openconfig.network.instance.networkinstances.networkinstance.policyforwarding.interfaces.Interface.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstancePolicyforwardingInterfacesInterfaceResponse struct {
	FrinxOpenconfigNetworkInstanceinterface []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstancePolicyforwardingInterfacesInterface `json:"frinx-openconfig-network-instance:interface,omitempty"`
}
