...
// frinx.openconfig.bgp.bgpcommonmpipv4unicastgroup.Ipv4Unicast.response
type FrinxOpenconfigBgpBgpcommonmpipv4unicastgroupIpv4UnicastResponse struct {
	FrinxOpenconfigNetworkInstanceipv4Unicast *FrinxOpenconfigBgpBgpcommonmpipv4unicastgroupIpv4Unicast `json:"frinx-openconfig-network-instance:ipv4-unicast,omitempty"`
}
