...
// frinx.openconfig.bgp.policy.communitysettop.communitysets.communityset.Config.response
type FrinxOpenconfigBgpPolicyCommunitysettopCommunitysetsCommunitysetConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicyCommunitysettopCommunitysetsCommunitysetConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
