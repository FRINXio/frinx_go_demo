...
// frinx.openconfig.qos.qos.schedulerpolicies.schedulerpolicy.Schedulers.response
type FrinxOpenconfigQosQosSchedulerpoliciesSchedulerpolicySchedulersResponse struct {
	FrinxOpenconfigQosschedulers *FrinxOpenconfigQosQosSchedulerpoliciesSchedulerpolicySchedulers `json:"frinx-openconfig-qos:schedulers,omitempty"`
}
