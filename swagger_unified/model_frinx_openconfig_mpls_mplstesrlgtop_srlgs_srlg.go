...
// Optional[List of shared risk link groups] REF:Optional.empty
type FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlg struct {
	// Optional[The SRLG group identifier] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Configuration parameters related to the SRLG] REF:Optional.empty
	Config *FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgConfig `json:"config,omitempty"`
	// Optional[SRLG members for static (not flooded) SRLGs ] REF:Optional.empty
	StaticSrlgMembers *FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgStaticSrlgMembers `json:"static-srlg-members,omitempty"`
}
