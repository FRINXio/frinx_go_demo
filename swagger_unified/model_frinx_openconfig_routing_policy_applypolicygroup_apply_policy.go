...
type FrinxOpenconfigRoutingPolicyApplypolicygroupApplyPolicy struct {
	// Optional[Policy configuration data.] REF:Optional.empty
	Config *FrinxOpenconfigRoutingPolicyApplypolicygroupApplypolicyConfig `json:"config,omitempty"`
}
