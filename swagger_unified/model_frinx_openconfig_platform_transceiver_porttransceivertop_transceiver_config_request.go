...
// frinx.openconfig.platform.transceiver.porttransceivertop.transceiver.Config.request
type FrinxOpenconfigPlatformTransceiverPorttransceivertopTransceiverConfigRequest struct {
