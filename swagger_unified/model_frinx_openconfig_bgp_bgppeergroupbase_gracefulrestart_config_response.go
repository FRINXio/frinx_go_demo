...
// frinx.openconfig.bgp.bgppeergroupbase.gracefulrestart.Config.response
type FrinxOpenconfigBgpBgppeergroupbaseGracefulrestartConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgppeergroupbaseGracefulrestartConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
