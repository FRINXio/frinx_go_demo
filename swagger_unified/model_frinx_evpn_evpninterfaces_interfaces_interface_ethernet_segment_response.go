...
// frinx.evpn.evpninterfaces.interfaces.interface.EthernetSegment.response
type FrinxEvpnEvpninterfacesInterfacesInterfaceEthernetSegmentResponse struct {
	FrinxEvpnethernetSegment *FrinxEvpnEvpninterfacesInterfacesInterfaceEthernetSegment `json:"frinx-evpn:ethernet-segment,omitempty"`
}
