...
// Optional[Configuration data for scheduler output] REF:Optional.empty
type FrinxOpenconfigQosQosscheduleroutputtopOutputConfig struct {
	// Optional[Describes the type of output sink for the scheduler.] REF:Optional.empty
	OutputType *FrinxOpenconfigQosOutputTypeEnumeration `json:"output-type,omitempty"`
	// Optional[When the scheduler output type is a forwarding group, this leaf provides a reference to the forwarding group.] REF:Optional.empty
	OutputFwdGroup string `json:"output-fwd-group,omitempty"`
	// Optional[When the scheduler output type is a child scheduler, this leaf provides a reference to the downstream scheduler.] REF:Optional.empty
	ChildScheduler string `json:"child-scheduler,omitempty"`
}
