...
// frinx.openconfig.platform.platformanchorstop.cpu.Config.response
type FrinxOpenconfigPlatformPlatformanchorstopCpuConfigResponse struct {
	FrinxOpenconfigPlatformconfig *FrinxOpenconfigPlatformPlatformanchorstopCpuConfig `json:"frinx-openconfig-platform:config,omitempty"`
}
