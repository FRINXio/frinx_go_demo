...
type FrinxOpenconfigBgpPolicySetcommunityinlinetopInline struct {
	// Optional[Configuration data or inline specification of set-community action] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicySetcommunityinlinetopInlineConfig `json:"config,omitempty"`
}
