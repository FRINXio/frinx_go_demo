...
type FrinxOpenconfigNetworkInstanceDstProtocolIdentityref string

// List of frinx.openconfig.network.instance.DstProtocolIdentityref
const (
	FrinxOpenconfigNetworkInstanceDstProtocolIdentityref_OSPF FrinxOpenconfigNetworkInstanceDstProtocolIdentityref = "frinx-openconfig-policy-types:OSPF"
	FrinxOpenconfigNetworkInstanceDstProtocolIdentityref_DIRECTLY_CONNECTED FrinxOpenconfigNetworkInstanceDstProtocolIdentityref = "frinx-openconfig-policy-types:DIRECTLY_CONNECTED"
	FrinxOpenconfigNetworkInstanceDstProtocolIdentityref_OSPF3 FrinxOpenconfigNetworkInstanceDstProtocolIdentityref = "frinx-openconfig-policy-types:OSPF3"
	FrinxOpenconfigNetworkInstanceDstProtocolIdentityref_STATIC FrinxOpenconfigNetworkInstanceDstProtocolIdentityref = "frinx-openconfig-policy-types:STATIC"
	FrinxOpenconfigNetworkInstanceDstProtocolIdentityref_INSTALL_PROTOCOL_TYPE FrinxOpenconfigNetworkInstanceDstProtocolIdentityref = "frinx-openconfig-policy-types:INSTALL_PROTOCOL_TYPE"
	FrinxOpenconfigNetworkInstanceDstProtocolIdentityref_ISIS FrinxOpenconfigNetworkInstanceDstProtocolIdentityref = "frinx-openconfig-policy-types:ISIS"
	FrinxOpenconfigNetworkInstanceDstProtocolIdentityref_BGP FrinxOpenconfigNetworkInstanceDstProtocolIdentityref = "frinx-openconfig-policy-types:BGP"
	FrinxOpenconfigNetworkInstanceDstProtocolIdentityref_LOCAL_AGGREGATE FrinxOpenconfigNetworkInstanceDstProtocolIdentityref = "frinx-openconfig-policy-types:LOCAL_AGGREGATE"
)
