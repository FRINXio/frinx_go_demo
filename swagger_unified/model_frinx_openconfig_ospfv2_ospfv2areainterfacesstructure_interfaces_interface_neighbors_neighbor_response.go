...
// frinx.openconfig.ospfv2.ospfv2areainterfacesstructure.interfaces.interface.neighbors.Neighbor.response
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceNeighborsNeighborResponse struct {
	FrinxOpenconfigNetworkInstanceneighbor []FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceNeighborsNeighbor `json:"frinx-openconfig-network-instance:neighbor,omitempty"`
}
