...
// frinx.openconfig.bgp.bgpcommonmpipv4labeledunicastgroup.Ipv4LabeledUnicast.response
type FrinxOpenconfigBgpBgpcommonmpipv4labeledunicastgroupIpv4LabeledUnicastResponse struct {
	FrinxOpenconfigNetworkInstanceipv4LabeledUnicast *FrinxOpenconfigBgpBgpcommonmpipv4labeledunicastgroupIpv4LabeledUnicast `json:"frinx-openconfig-network-instance:ipv4-labeled-unicast,omitempty"`
}
