...
type FrinxOpenconfigRoutingPolicyPrefixsettopPrefixSets struct {
	// Optional[List of the defined prefix sets] REF:Optional.empty
	PrefixSet []FrinxOpenconfigRoutingPolicyPrefixsettopPrefixsetsPrefixSet `json:"prefix-set,omitempty"`
}
