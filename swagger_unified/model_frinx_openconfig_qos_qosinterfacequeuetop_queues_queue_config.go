...
// Optional[Configuration data for the queue associated with the interface] REF:Optional.empty
type FrinxOpenconfigQosQosinterfacequeuetopQueuesQueueConfig struct {
	// Optional[Reference to the queue associated with this interface. A queue may be explicitly configured, or implicitly created by the system based on default queues that are instantiated by a hardware component, or are assumed to be default on the system.] REF:Optional.empty
