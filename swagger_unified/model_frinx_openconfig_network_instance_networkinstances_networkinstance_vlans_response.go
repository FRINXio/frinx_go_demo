...
// frinx.openconfig.network.instance.networkinstances.networkinstance.Vlans.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceVlansResponse struct {
	FrinxOpenconfigNetworkInstancevlans *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceVlans `json:"frinx-openconfig-network-instance:vlans,omitempty"`
}
