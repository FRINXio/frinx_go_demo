...
type FrinxOpenconfigMplsLdpMplsldpneighborstopNeighbors struct {
	// Optional[List of LDP neighbors and their attributes.] REF:Optional.empty
	Neighbor []FrinxOpenconfigMplsLdpMplsldpneighborstopNeighborsNeighbor `json:"neighbor,omitempty"`
}
