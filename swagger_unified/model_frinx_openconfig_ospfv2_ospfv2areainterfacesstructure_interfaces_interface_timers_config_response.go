...
// frinx.openconfig.ospfv2.ospfv2areainterfacesstructure.interfaces.interface.timers.Config.response
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceTimersConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceTimersConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
