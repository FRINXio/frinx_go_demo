...
type FrinxOpenconfigOspfPolicyOspfmatchconditionsOspfconditionsConfig struct {
	// Optional[Match prefixes which are within a particular OSPF area] REF:Optional.empty
	AreaEq string `json:"area-eq,omitempty"`
}
