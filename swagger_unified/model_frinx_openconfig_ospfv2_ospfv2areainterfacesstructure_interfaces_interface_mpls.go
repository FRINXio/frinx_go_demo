...
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMpls struct {
	// Optional[OSPFv2 parameters relating to LDP/IGP synchronization] REF:Optional.empty
	IgpLdpSync *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMplsIgpLdpSync `json:"igp-ldp-sync,omitempty"`
	// Optional[Configuration parameters for OSPFv2 extensions relating to MPLS for the interface] REF:Optional.empty
	Config *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMplsConfig `json:"config,omitempty"`
}
