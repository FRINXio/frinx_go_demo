...
type FrinxOpenconfigInterfacesInterfacephysholdtimetopHoldTime struct {
	// Optional[Configuration data for interface hold-time settings.] REF:Optional.empty
	Config *FrinxOpenconfigInterfacesInterfacephysholdtimetopHoldtimeConfig `json:"config,omitempty"`
}
