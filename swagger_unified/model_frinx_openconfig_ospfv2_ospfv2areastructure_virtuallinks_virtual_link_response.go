...
// frinx.openconfig.ospfv2.ospfv2areastructure.virtuallinks.VirtualLink.response
type FrinxOpenconfigOspfv2Ospfv2areastructureVirtuallinksVirtualLinkResponse struct {
	FrinxOpenconfigNetworkInstancevirtualLink []FrinxOpenconfigOspfv2Ospfv2areastructureVirtuallinksVirtualLink `json:"frinx-openconfig-network-instance:virtual-link,omitempty"`
}
