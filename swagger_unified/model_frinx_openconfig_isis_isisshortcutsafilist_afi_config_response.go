...
// frinx.openconfig.isis.isisshortcutsafilist.afi.Config.response
type FrinxOpenconfigIsisIsisshortcutsafilistAfiConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisshortcutsafilistAfiConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
