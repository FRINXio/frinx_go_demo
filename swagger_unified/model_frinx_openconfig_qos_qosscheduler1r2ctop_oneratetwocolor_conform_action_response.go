...
// frinx.openconfig.qos.qosscheduler1r2ctop.oneratetwocolor.ConformAction.response
type FrinxOpenconfigQosQosscheduler1r2ctopOneratetwocolorConformActionResponse struct {
	FrinxOpenconfigQosconformAction *FrinxOpenconfigQosQosscheduler1r2ctopOneratetwocolorConformAction `json:"frinx-openconfig-qos:conform-action,omitempty"`
}
