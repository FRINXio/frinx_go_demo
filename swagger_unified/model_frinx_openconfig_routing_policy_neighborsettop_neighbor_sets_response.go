...
// frinx.openconfig.routing.policy.neighborsettop.NeighborSets.response
type FrinxOpenconfigRoutingPolicyNeighborsettopNeighborSetsResponse struct {
	FrinxOpenconfigRoutingPolicyneighborSets *FrinxOpenconfigRoutingPolicyNeighborsettopNeighborSets `json:"frinx-openconfig-routing-policy:neighbor-sets,omitempty"`
}
