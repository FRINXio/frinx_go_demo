...
// frinx.openconfig.isis.isisglobalbase.nsr.Config.response
type FrinxOpenconfigIsisIsisglobalbaseNsrConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisglobalbaseNsrConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
