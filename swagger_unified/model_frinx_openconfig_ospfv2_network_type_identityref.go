...
type FrinxOpenconfigOspfv2NetworkTypeIdentityref string

// List of frinx.openconfig.ospfv2.NetworkTypeIdentityref
const (
	FrinxOpenconfigOspfv2NetworkTypeIdentityref_OSPF_NETWORK_TYPE FrinxOpenconfigOspfv2NetworkTypeIdentityref = "frinx-openconfig-ospf-types:OSPF_NETWORK_TYPE"
	FrinxOpenconfigOspfv2NetworkTypeIdentityref_BROADCAST_NETWORK FrinxOpenconfigOspfv2NetworkTypeIdentityref = "frinx-openconfig-ospf-types:BROADCAST_NETWORK"
	FrinxOpenconfigOspfv2NetworkTypeIdentityref_NON_BROADCAST_NETWORK FrinxOpenconfigOspfv2NetworkTypeIdentityref = "frinx-openconfig-ospf-types:NON_BROADCAST_NETWORK"
	FrinxOpenconfigOspfv2NetworkTypeIdentityref_POINT_TO_POINT_NETWORK FrinxOpenconfigOspfv2NetworkTypeIdentityref = "frinx-openconfig-ospf-types:POINT_TO_POINT_NETWORK"
)
