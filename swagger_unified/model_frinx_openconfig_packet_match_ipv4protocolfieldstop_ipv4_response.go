...
// frinx.openconfig.packet.match.ipv4protocolfieldstop.Ipv4.response
type FrinxOpenconfigPacketMatchIpv4protocolfieldstopIpv4Response struct {
	FrinxOpenconfigNetworkInstanceipv4 *FrinxOpenconfigPacketMatchIpv4protocolfieldstopIpv4 `json:"frinx-openconfig-network-instance:ipv4,omitempty"`
}
