...
// frinx.openconfig.mpls.ldp.mplsldpgracefulrestart.GracefulRestart.response
type FrinxOpenconfigMplsLdpMplsldpgracefulrestartGracefulRestartResponse struct {
	FrinxOpenconfigNetworkInstancegracefulRestart *FrinxOpenconfigMplsLdpMplsldpgracefulrestartGracefulRestart `json:"frinx-openconfig-network-instance:graceful-restart,omitempty"`
}
