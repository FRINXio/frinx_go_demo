...
// frinx.openconfig.network.instance.l2nimactabletop.mactable.entries.Entry.response
type FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntriesEntryResponse struct {
	FrinxOpenconfigNetworkInstanceentry []FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntriesEntry `json:"frinx-openconfig-network-instance:entry,omitempty"`
}
