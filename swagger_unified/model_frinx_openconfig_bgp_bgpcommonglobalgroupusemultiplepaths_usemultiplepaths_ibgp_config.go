...
// Optional[Configuration parameters relating to iBGP multipath] REF:Optional.empty
type FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsIbgpConfig struct {
	// Optional[Maximum number of parallel paths to consider when using iBGP multipath. The default is to use a single path] REF:Optional.empty
