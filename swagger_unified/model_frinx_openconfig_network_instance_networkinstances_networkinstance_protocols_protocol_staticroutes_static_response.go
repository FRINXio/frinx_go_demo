...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.staticroutes.Static.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticroutesStaticResponse struct {
	FrinxOpenconfigNetworkInstancestatic []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticroutesStatic `json:"frinx-openconfig-network-instance:static,omitempty"`
}
