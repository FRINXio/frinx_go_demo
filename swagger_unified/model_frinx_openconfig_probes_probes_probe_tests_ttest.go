...
// Optional[List of tests associated with this probe.] REF:Optional.empty
type FrinxOpenconfigProbesProbesProbeTestsTest struct {
	// Optional[Reference to the list key] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Contains the results of the tests.] REF:Optional.empty
	Results *FrinxOpenconfigProbesProbeteststopTestResults `json:"results,omitempty"`
	// Optional[Configuration data for the test of this probe.] REF:Optional.empty
	Config *FrinxOpenconfigProbesProbesProbeTestsTestConfig `json:"config,omitempty"`
	// Optional[The target configuration of the test. The nature of the target depends on the probe type: for HTTP probes we need to provide an URL to poll, while ICMP probes require an IP address to monitor.] REF:Optional.empty
	Target *FrinxOpenconfigProbesTesttargetTarget `json:"target,omitempty"`
}
