...
// frinx.openconfig.qos.qosclassifiertop.classifiers.classifier.Config.response
type FrinxOpenconfigQosQosclassifiertopClassifiersClassifierConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosclassifiertopClassifiersClassifierConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
