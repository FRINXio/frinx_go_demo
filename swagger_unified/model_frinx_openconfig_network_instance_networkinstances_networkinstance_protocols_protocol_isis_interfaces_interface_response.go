...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.isis.interfaces.Interface.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsisInterfacesInterfaceResponse struct {
	FrinxOpenconfigNetworkInstanceinterface []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsisInterfacesInterface `json:"frinx-openconfig-network-instance:interface,omitempty"`
}
