...
// frinx.openconfig.mpls.rsvp.mplsrsvpsoftpreemption.SoftPreemption.response
type FrinxOpenconfigMplsRsvpMplsrsvpsoftpreemptionSoftPreemptionResponse struct {
	FrinxOpenconfigNetworkInstancesoftPreemption *FrinxOpenconfigMplsRsvpMplsrsvpsoftpreemptionSoftPreemption `json:"frinx-openconfig-network-instance:soft-preemption,omitempty"`
}
