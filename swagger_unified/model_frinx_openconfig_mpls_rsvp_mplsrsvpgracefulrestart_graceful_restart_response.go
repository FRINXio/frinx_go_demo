...
// frinx.openconfig.mpls.rsvp.mplsrsvpgracefulrestart.GracefulRestart.response
type FrinxOpenconfigMplsRsvpMplsrsvpgracefulrestartGracefulRestartResponse struct {
	FrinxOpenconfigNetworkInstancegracefulRestart *FrinxOpenconfigMplsRsvpMplsrsvpgracefulrestartGracefulRestart `json:"frinx-openconfig-network-instance:graceful-restart,omitempty"`
}
