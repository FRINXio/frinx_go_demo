...
// frinx.netflow.interfaceingressnetflowtop.ingressflows.ingressflow.Config.response
type FrinxNetflowInterfaceingressnetflowtopIngressflowsIngressflowConfigResponse struct {
	FrinxNetflowconfig *FrinxNetflowInterfaceingressnetflowtopIngressflowsIngressflowConfig `json:"frinx-netflow:config,omitempty"`
}
