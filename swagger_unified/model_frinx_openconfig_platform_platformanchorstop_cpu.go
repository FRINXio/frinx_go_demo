...
type FrinxOpenconfigPlatformPlatformanchorstopCpu struct {
	// Optional[Configuration data for cpu components] REF:Optional.empty
	Config *FrinxOpenconfigPlatformPlatformanchorstopCpuConfig `json:"config,omitempty"`
}
