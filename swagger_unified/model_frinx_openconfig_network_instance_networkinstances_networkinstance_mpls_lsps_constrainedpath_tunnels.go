...
// Optional[Enclosing container for tunnels] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLspsConstrainedpathTunnels struct {
	...
	Tunnel []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLspsConstrainedpathTunnelsTunnel `json:"tunnel,omitempty"`
}
