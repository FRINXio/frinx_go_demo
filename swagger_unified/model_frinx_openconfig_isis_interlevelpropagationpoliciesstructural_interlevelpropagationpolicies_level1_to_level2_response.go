...
// frinx.openconfig.isis.interlevelpropagationpoliciesstructural.interlevelpropagationpolicies.Level1ToLevel2.response
type FrinxOpenconfigIsisInterlevelpropagationpoliciesstructuralInterlevelpropagationpoliciesLevel1ToLevel2Response struct {
	FrinxOpenconfigNetworkInstancelevel1ToLevel2 *FrinxOpenconfigIsisInterlevelpropagationpoliciesstructuralInterlevelpropagationpoliciesLevel1ToLevel2 `json:"frinx-openconfig-network-instance:level1-to-level2,omitempty"`
}
