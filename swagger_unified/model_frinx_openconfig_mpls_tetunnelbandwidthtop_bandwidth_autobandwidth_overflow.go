...
type FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthOverflow struct {
	// Optional[Config information for MPLS overflow bandwidth adjustment] REF:Optional.empty
	Config *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthOverflowConfig `json:"config,omitempty"`
}
