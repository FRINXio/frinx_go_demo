...
// frinx.openconfig.network.instance.NetworkInstances.response
type FrinxOpenconfigNetworkInstanceNetworkInstancesResponse struct {
	FrinxOpenconfigNetworkInstancenetworkInstances *FrinxOpenconfigNetworkInstanceNetworkInstances `json:"frinx-openconfig-network-instance:network-instances,omitempty"`
}
