...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpNeighborsNeighborAfiSafis struct {
	// Optional[AFI,SAFI configuration available for the neighbour or group] REF:Optional.empty
	AfiSafi []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpNeighborsNeighborAfisafisAfiSafi `json:"afi-safi,omitempty"`
}
