...
type FrinxEvpnEvpninterfacesInterfacesInterfaceCoreIsolationGroup struct {
	// Optional[Config data of core isolation group] REF:Optional.empty
	Config *FrinxEvpnEvpninterfacesInterfacesInterfaceCoreisolationgroupConfig `json:"config,omitempty"`
}
