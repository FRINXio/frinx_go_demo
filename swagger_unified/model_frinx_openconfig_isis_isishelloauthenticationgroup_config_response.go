...
// frinx.openconfig.isis.isishelloauthenticationgroup.Config.response
type FrinxOpenconfigIsisIsishelloauthenticationgroupConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsishelloauthenticationgroupConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
