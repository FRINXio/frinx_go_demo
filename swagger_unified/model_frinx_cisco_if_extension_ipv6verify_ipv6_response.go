...
// frinx.cisco.if.extension.ipv6verify.Ipv6.response
type FrinxCiscoIfExtensionIpv6verifyIpv6Response struct {
	FrinxCiscoIfExtensionipv6 *FrinxCiscoIfExtensionIpv6verifyIpv6 `json:"frinx-cisco-if-extension:ipv6,omitempty"`
}
