...
// frinx.openconfig.platform.platformanchorstop.backplane.Config.response
type FrinxOpenconfigPlatformPlatformanchorstopBackplaneConfigResponse struct {
	FrinxOpenconfigPlatformconfig *FrinxOpenconfigPlatformPlatformanchorstopBackplaneConfig `json:"frinx-openconfig-platform:config,omitempty"`
}
