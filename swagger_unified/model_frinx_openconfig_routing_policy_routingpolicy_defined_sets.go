...
// Optional[Predefined sets of attributes used in policy match statements] REF:Optional.empty
type FrinxOpenconfigRoutingPolicyRoutingpolicyDefinedSets struct {
	// Optional[Enclosing container ] REF:Optional.empty
	PrefixSets *FrinxOpenconfigRoutingPolicyPrefixsettopPrefixSets `json:"prefix-sets,omitempty"`
	// Optional[Enclosing container for the list of tag sets.] REF:Optional.empty
	TagSets *FrinxOpenconfigRoutingPolicyTagsettopTagSets `json:"tag-sets,omitempty"`
	// Optional[Enclosing container for the list of neighbor set definitions] REF:Optional.empty
	NeighborSets *FrinxOpenconfigRoutingPolicyNeighborsettopNeighborSets `json:"neighbor-sets,omitempty"`
	// Optional[BGP-related set definitions for policy match conditions] REF:Optional.empty
	FrinxOpenconfigBgpPolicybgpDefinedSets *FrinxOpenconfigBgpPolicyRoutingpolicyDefinedsetsBgpDefinedSets `json:"frinx-openconfig-bgp-policy:bgp-defined-sets,omitempty"`
}
