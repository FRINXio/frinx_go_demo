...
// frinx.openconfig.mpls.mplstesrlgtop.srlgs.srlg.staticsrlgmembers.MembersList.response
type FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgStaticsrlgmembersMembersListResponse struct {
	FrinxOpenconfigNetworkInstancemembersList []FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgStaticsrlgmembersMembersList `json:"frinx-openconfig-network-instance:members-list,omitempty"`
}
