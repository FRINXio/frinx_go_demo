...
// frinx.openconfig.isis.isisinterfacegroup.CircuitCounters.response
type FrinxOpenconfigIsisIsisinterfacegroupCircuitCountersResponse struct {
	FrinxOpenconfigNetworkInstancecircuitCounters *FrinxOpenconfigIsisIsisinterfacegroupCircuitCounters `json:"frinx-openconfig-network-instance:circuit-counters,omitempty"`
}
