...
// frinx.openconfig.isis.isisglobalbase.timers.lspgeneration.Config.response
type FrinxOpenconfigIsisIsisglobalbaseTimersLspgenerationConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisglobalbaseTimersLspgenerationConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
