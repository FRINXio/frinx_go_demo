...
// frinx.evpn.evpninterfaces.interfaces.interface.coreisolationgroup.Config.response
type FrinxEvpnEvpninterfacesInterfacesInterfaceCoreisolationgroupConfigResponse struct {
	FrinxEvpnconfig *FrinxEvpnEvpninterfacesInterfacesInterfaceCoreisolationgroupConfig `json:"frinx-evpn:config,omitempty"`
}
