...
// frinx.openconfig.if.ip.ipv6top.ipv6.Config.response
type FrinxOpenconfigIfIpIpv6topIpv6ConfigResponse struct {
	FrinxOpenconfigIfIpconfig *FrinxOpenconfigIfIpIpv6topIpv6Config `json:"frinx-openconfig-if-ip:config,omitempty"`
}
