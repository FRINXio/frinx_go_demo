...
// frinx.openconfig.isis.isishelloauthenticationgroup.Key.response
type FrinxOpenconfigIsisIsishelloauthenticationgroupKeyResponse struct {
	FrinxOpenconfigNetworkInstancekey *FrinxOpenconfigIsisIsishelloauthenticationgroupKey `json:"frinx-openconfig-network-instance:key,omitempty"`
}
