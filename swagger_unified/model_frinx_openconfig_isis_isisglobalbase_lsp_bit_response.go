...
// frinx.openconfig.isis.isisglobalbase.LspBit.response
type FrinxOpenconfigIsisIsisglobalbaseLspBitResponse struct {
	FrinxOpenconfigNetworkInstancelspBit *FrinxOpenconfigIsisIsisglobalbaseLspBit `json:"frinx-openconfig-network-instance:lsp-bit,omitempty"`
}
