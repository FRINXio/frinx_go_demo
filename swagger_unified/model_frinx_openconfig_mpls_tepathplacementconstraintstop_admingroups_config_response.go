...
// frinx.openconfig.mpls.tepathplacementconstraintstop.admingroups.Config.response
type FrinxOpenconfigMplsTepathplacementconstraintstopAdmingroupsConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsTepathplacementconstraintstopAdmingroupsConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
