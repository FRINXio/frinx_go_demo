...
// frinx.openconfig.bfd.bfd.interfaces.Interface.response
type FrinxOpenconfigBfdBfdInterfacesInterfaceResponse struct {
	FrinxOpenconfigBfdinterface []FrinxOpenconfigBfdBfdInterfacesInterface `json:"frinx-openconfig-bfd:interface,omitempty"`
}
