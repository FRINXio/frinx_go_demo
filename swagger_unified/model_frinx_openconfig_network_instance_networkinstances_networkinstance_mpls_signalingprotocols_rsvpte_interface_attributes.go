...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsRsvpteInterfaceAttributes struct {
	// Optional[list of per-interface RSVP configurations] REF:Optional.empty
	Interface_ []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsRsvpteInterfaceattributesInterface `json:"interface,omitempty"`
}
