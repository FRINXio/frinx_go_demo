...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.ospfv2.areas.area.Interfaces.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2AreasAreaInterfacesResponse struct {
	FrinxOpenconfigNetworkInstanceinterfaces *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2AreasAreaInterfaces `json:"frinx-openconfig-network-instance:interfaces,omitempty"`
}
