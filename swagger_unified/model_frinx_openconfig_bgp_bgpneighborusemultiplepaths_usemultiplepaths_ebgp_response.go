...
// frinx.openconfig.bgp.bgpneighborusemultiplepaths.usemultiplepaths.Ebgp.response
type FrinxOpenconfigBgpBgpneighborusemultiplepathsUsemultiplepathsEbgpResponse struct {
	FrinxOpenconfigNetworkInstanceebgp *FrinxOpenconfigBgpBgpneighborusemultiplepathsUsemultiplepathsEbgp `json:"frinx-openconfig-network-instance:ebgp,omitempty"`
}
