...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingProtocols struct {
	// Optional[RSVP-TE global signaling protocol configuration] REF:Optional.empty
	RsvpTe *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsRsvpTe `json:"rsvp-te,omitempty"`
	// Optional[LDP global signaling configuration] REF:Optional.empty
	Ldp *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsLdp `json:"ldp,omitempty"`
}
