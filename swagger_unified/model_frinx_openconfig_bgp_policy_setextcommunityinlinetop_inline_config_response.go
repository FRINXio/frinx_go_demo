...
// frinx.openconfig.bgp.policy.setextcommunityinlinetop.inline.Config.response
type FrinxOpenconfigBgpPolicySetextcommunityinlinetopInlineConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicySetextcommunityinlinetopInlineConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
