...
// frinx.openconfig.lldp.lldpinterfacetop.interfaces.interface.Config.response
type FrinxOpenconfigLldpLldpinterfacetopInterfacesInterfaceConfigResponse1 struct {
	FrinxOpenconfigLldpconfig *FrinxOpenconfigLldpLldpinterfacetopInterfacesInterfaceConfig `json:"frinx-openconfig-lldp:config,omitempty"`
}
