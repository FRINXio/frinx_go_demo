...
// frinx.hsrp.interfacetop.interfaces.Interface.response
type FrinxHsrpInterfacetopInterfacesInterfaceResponse struct {
	FrinxHsrpinterface []FrinxHsrpInterfacetopInterfacesInterface `json:"frinx-hsrp:interface,omitempty"`
}
