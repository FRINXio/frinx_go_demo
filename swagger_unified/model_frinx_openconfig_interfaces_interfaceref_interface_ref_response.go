...
type FrinxOpenconfigInterfacesInterfacerefInterfaceRefResponse struct {
	FrinxLogginginterfaceRef *FrinxOpenconfigInterfacesInterfacerefInterfaceRef `json:"frinx-logging:interface-ref,omitempty"`
}
