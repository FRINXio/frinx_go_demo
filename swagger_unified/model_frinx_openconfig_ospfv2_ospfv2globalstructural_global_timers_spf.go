...
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersSpf struct {
	// Optional[Configuration parameters relating to global OSPFv2 SPF timers] REF:Optional.empty
	Config *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersSpfConfig `json:"config,omitempty"`
}
