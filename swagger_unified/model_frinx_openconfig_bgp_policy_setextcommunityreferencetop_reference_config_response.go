...
// frinx.openconfig.bgp.policy.setextcommunityreferencetop.reference.Config.response
type FrinxOpenconfigBgpPolicySetextcommunityreferencetopReferenceConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicySetextcommunityreferencetopReferenceConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
