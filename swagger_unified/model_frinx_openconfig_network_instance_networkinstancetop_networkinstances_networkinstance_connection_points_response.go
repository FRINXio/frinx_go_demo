...
// frinx.openconfig.network.instance.networkinstancetop.networkinstances.networkinstance.ConnectionPoints.response
type FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceConnectionPointsResponse struct {
	FrinxOpenconfigNetworkInstanceconnectionPoints *FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceConnectionPoints `json:"frinx-openconfig-network-instance:connection-points,omitempty"`
}
