...
type FrinxOpenconfigNetworkInstanceL3EnabledAddressFamiliesIdentityref string

// List of frinx.openconfig.network.instance.l3.EnabledAddressFamiliesIdentityref
const (
	FrinxOpenconfigNetworkInstanceL3EnabledAddressFamiliesIdentityref_MPLS FrinxOpenconfigNetworkInstanceL3EnabledAddressFamiliesIdentityref = "frinx-openconfig-types:MPLS"
	FrinxOpenconfigNetworkInstanceL3EnabledAddressFamiliesIdentityref_IPV4 FrinxOpenconfigNetworkInstanceL3EnabledAddressFamiliesIdentityref = "frinx-openconfig-types:IPV4"
	FrinxOpenconfigNetworkInstanceL3EnabledAddressFamiliesIdentityref_IPV6 FrinxOpenconfigNetworkInstanceL3EnabledAddressFamiliesIdentityref = "frinx-openconfig-types:IPV6"
	FrinxOpenconfigNetworkInstanceL3EnabledAddressFamiliesIdentityref_ADDRESS_FAMILY FrinxOpenconfigNetworkInstanceL3EnabledAddressFamiliesIdentityref = "frinx-openconfig-types:ADDRESS_FAMILY"
	FrinxOpenconfigNetworkInstanceL3EnabledAddressFamiliesIdentityref_L2_ETHERNET FrinxOpenconfigNetworkInstanceL3EnabledAddressFamiliesIdentityref = "frinx-openconfig-types:L2_ETHERNET"
)
