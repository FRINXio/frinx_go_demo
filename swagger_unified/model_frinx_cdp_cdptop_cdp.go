...
// Optional[Top-level container for CDP configuration and state data] REF:Optional.empty
type FrinxCdpCdptopCdp struct {
	// Optional[Configuration data ] REF:Optional.empty
	Config *FrinxCdpCdptopCdpConfig `json:"config,omitempty"`
