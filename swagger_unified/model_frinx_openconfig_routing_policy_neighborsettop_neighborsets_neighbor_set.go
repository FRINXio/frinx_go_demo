...
// Optional[List of defined neighbor sets for use in policies.] REF:Optional.empty
type FrinxOpenconfigRoutingPolicyNeighborsettopNeighborsetsNeighborSet struct {
	// Optional[Reference to the neighbor set name list key.] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Configuration data for neighbor sets.] REF:Optional.empty
	Config *FrinxOpenconfigRoutingPolicyNeighborsettopNeighborsetsNeighborsetConfig `json:"config,omitempty"`
}
