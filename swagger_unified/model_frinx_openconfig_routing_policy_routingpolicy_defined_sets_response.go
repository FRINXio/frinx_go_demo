...
// frinx.openconfig.routing.policy.routingpolicy.DefinedSets.response
type FrinxOpenconfigRoutingPolicyRoutingpolicyDefinedSetsResponse struct {
	FrinxOpenconfigRoutingPolicydefinedSets *FrinxOpenconfigRoutingPolicyRoutingpolicyDefinedSets `json:"frinx-openconfig-routing-policy:defined-sets,omitempty"`
}
