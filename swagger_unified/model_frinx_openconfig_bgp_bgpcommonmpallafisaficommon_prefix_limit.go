...
type FrinxOpenconfigBgpBgpcommonmpallafisaficommonPrefixLimit struct {
	// Optional[Configuration parameters relating to the prefix limit for the AFI-SAFI] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpcommonmpallafisaficommonPrefixlimitConfig `json:"config,omitempty"`
}
