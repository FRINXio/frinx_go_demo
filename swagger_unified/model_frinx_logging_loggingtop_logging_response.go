...
// frinx.logging.loggingtop.Logging.response
type FrinxLoggingLoggingtopLoggingResponse struct {
	FrinxLogginglogging *FrinxLoggingLoggingtopLogging `json:"frinx-logging:logging,omitempty"`
}
