...
// frinx.openconfig.vlan.vlanroutedtop.routedvlan.Config.response
type FrinxOpenconfigVlanVlanroutedtopRoutedvlanConfigResponse struct {
	FrinxOpenconfigVlanconfig *FrinxOpenconfigVlanVlanroutedtopRoutedvlanConfig `json:"frinx-openconfig-vlan:config,omitempty"`
}
