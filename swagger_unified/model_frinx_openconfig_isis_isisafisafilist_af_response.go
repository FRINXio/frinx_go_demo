...
// frinx.openconfig.isis.isisafisafilist.Af.response
type FrinxOpenconfigIsisIsisafisafilistAfResponse struct {
	FrinxOpenconfigNetworkInstanceaf []FrinxOpenconfigIsisIsisafisafilistAf `json:"frinx-openconfig-network-instance:af,omitempty"`
}
