...
// Optional[This container defines Overload Bit configuration.] REF:Optional.empty
type FrinxOpenconfigIsisIsisglobalbaseLspbitOverloadBit struct {
	// Optional[This container defines ISIS Overload Bit configuration.] REF:Optional.empty
	Config *FrinxOpenconfigIsisOverloadbitgroupConfig `json:"config,omitempty"`
	// Optional[This container defines state for ISIS Overload Bit reset triggers] REF:Optional.empty
	ResetTriggers *FrinxOpenconfigIsisOverloadbitgroupResetTriggers `json:"reset-triggers,omitempty"`
}
