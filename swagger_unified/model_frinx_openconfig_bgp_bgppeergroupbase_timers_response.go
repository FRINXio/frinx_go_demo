...
// frinx.openconfig.bgp.bgppeergroupbase.Timers.response
type FrinxOpenconfigBgpBgppeergroupbaseTimersResponse struct {
	FrinxOpenconfigNetworkInstancetimers *FrinxOpenconfigBgpBgppeergroupbaseTimers `json:"frinx-openconfig-network-instance:timers,omitempty"`
}
