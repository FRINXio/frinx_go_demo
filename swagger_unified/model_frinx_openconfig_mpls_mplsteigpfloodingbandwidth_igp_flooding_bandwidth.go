...
type FrinxOpenconfigMplsMplsteigpfloodingbandwidthIgpFloodingBandwidth struct {
	// Optional[Configuration parameters for TED update threshold ] REF:Optional.empty
	Config *FrinxOpenconfigMplsMplsteigpfloodingbandwidthIgpfloodingbandwidthConfig `json:"config,omitempty"`
}
