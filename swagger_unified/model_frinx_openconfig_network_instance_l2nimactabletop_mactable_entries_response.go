...
// frinx.openconfig.network.instance.l2nimactabletop.mactable.Entries.response
type FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntriesResponse struct {
	FrinxOpenconfigNetworkInstanceentries *FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntries `json:"frinx-openconfig-network-instance:entries,omitempty"`
}
