...
type FrinxOpenconfigMplsRsvpLinkProtectionStyleRequestedIdentityref string

// List of frinx.openconfig.mpls.rsvp.LinkProtectionStyleRequestedIdentityref
const (
	FrinxOpenconfigMplsRsvpLinkProtectionStyleRequestedIdentityref_LINK_PROTECTION_REQUIRED FrinxOpenconfigMplsRsvpLinkProtectionStyleRequestedIdentityref = "frinx-openconfig-mpls-types:LINK_PROTECTION_REQUIRED"
	FrinxOpenconfigMplsRsvpLinkProtectionStyleRequestedIdentityref_LINK_NODE_PROTECTION_REQUESTED FrinxOpenconfigMplsRsvpLinkProtectionStyleRequestedIdentityref = "frinx-openconfig-mpls-types:LINK_NODE_PROTECTION_REQUESTED"
	FrinxOpenconfigMplsRsvpLinkProtectionStyleRequestedIdentityref_PROTECTION_TYPE FrinxOpenconfigMplsRsvpLinkProtectionStyleRequestedIdentityref = "frinx-openconfig-mpls-types:PROTECTION_TYPE"
	FrinxOpenconfigMplsRsvpLinkProtectionStyleRequestedIdentityref_UNPROTECTED FrinxOpenconfigMplsRsvpLinkProtectionStyleRequestedIdentityref = "frinx-openconfig-mpls-types:UNPROTECTED"
)
