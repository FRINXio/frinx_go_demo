...
// frinx.evpn.evpninterfacepart.Config.response
type FrinxEvpnEvpninterfacepartConfigResponse struct {
	FrinxEvpnconfig *FrinxEvpnEvpninterfacepartConfig `json:"frinx-evpn:config,omitempty"`
}
