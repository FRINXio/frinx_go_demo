...
type FrinxOpenconfigMplsMplstopMplsLspsUnconstrainedPath struct {
	// Optional[select and configure the signaling method for  the LSP] REF:Optional.empty
	PathSetupProtocol *FrinxOpenconfigMplsIgplspsetupPathSetupProtocol `json:"path-setup-protocol,omitempty"`
}
