...
// frinx.openconfig.isis.isisglobalbase.ReferenceBandwidth.response
type FrinxOpenconfigIsisIsisglobalbaseReferenceBandwidthResponse struct {
	FrinxOpenconfigNetworkInstancereferenceBandwidth *FrinxOpenconfigIsisIsisglobalbaseReferenceBandwidth `json:"frinx-openconfig-network-instance:reference-bandwidth,omitempty"`
}
