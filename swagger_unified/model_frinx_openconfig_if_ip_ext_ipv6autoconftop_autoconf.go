...
// Optional[Top-level container for IPv6 autoconf] REF:Optional.empty
type FrinxOpenconfigIfIpExtIpv6autoconftopAutoconf struct {
	...
	Config *FrinxOpenconfigIfIpExtIpv6autoconftopAutoconfConfig `json:"config,omitempty"`
}
