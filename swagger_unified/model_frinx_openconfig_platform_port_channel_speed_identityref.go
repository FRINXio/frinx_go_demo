...
type FrinxOpenconfigPlatformPortChannelSpeedIdentityref string

// List of frinx.openconfig.platform.port.ChannelSpeedIdentityref
const (
	FrinxOpenconfigPlatformPortChannelSpeedIdentityref_SPEED_UNKNOWN FrinxOpenconfigPlatformPortChannelSpeedIdentityref = "frinx-openconfig-if-ethernet:SPEED_UNKNOWN"
	FrinxOpenconfigPlatformPortChannelSpeedIdentityref_SPEED_1_GB FrinxOpenconfigPlatformPortChannelSpeedIdentityref = "frinx-openconfig-if-ethernet:SPEED_1GB"
	FrinxOpenconfigPlatformPortChannelSpeedIdentityref_SPEED_100_MB FrinxOpenconfigPlatformPortChannelSpeedIdentityref = "frinx-openconfig-if-ethernet:SPEED_100MB"
	FrinxOpenconfigPlatformPortChannelSpeedIdentityref_SPEED_50_GB FrinxOpenconfigPlatformPortChannelSpeedIdentityref = "frinx-openconfig-if-ethernet:SPEED_50GB"
	FrinxOpenconfigPlatformPortChannelSpeedIdentityref_SPEED_100_GB FrinxOpenconfigPlatformPortChannelSpeedIdentityref = "frinx-openconfig-if-ethernet:SPEED_100GB"
	FrinxOpenconfigPlatformPortChannelSpeedIdentityref_SPEED_40_GB FrinxOpenconfigPlatformPortChannelSpeedIdentityref = "frinx-openconfig-if-ethernet:SPEED_40GB"
	FrinxOpenconfigPlatformPortChannelSpeedIdentityref_ETHERNET_SPEED FrinxOpenconfigPlatformPortChannelSpeedIdentityref = "frinx-openconfig-if-ethernet:ETHERNET_SPEED"
	FrinxOpenconfigPlatformPortChannelSpeedIdentityref_SPEED_25_GB FrinxOpenconfigPlatformPortChannelSpeedIdentityref = "frinx-openconfig-if-ethernet:SPEED_25GB"
	FrinxOpenconfigPlatformPortChannelSpeedIdentityref_SPEED_10_MB FrinxOpenconfigPlatformPortChannelSpeedIdentityref = "frinx-openconfig-if-ethernet:SPEED_10MB"
	FrinxOpenconfigPlatformPortChannelSpeedIdentityref_SPEED_10_GB FrinxOpenconfigPlatformPortChannelSpeedIdentityref = "frinx-openconfig-if-ethernet:SPEED_10GB"
)
