...
// Optional[Configuration data for physical channels] REF:Optional.empty
type FrinxOpenconfigPlatformTransceiverPhysicalchanneltopPhysicalchannelsChannelConfig struct {
	// Optional[Text description for the client physical channel] REF:Optional.empty
	Description string `json:"description,omitempty"`
	// Optional[Index of the physical channnel or lane within a physical client port] REF:Optional.empty
	Index int32 `json:"index,omitempty"`
	// Optional[Target output optical power level of the optical channel, expressed in increments of 0.01 dBm (decibel-milliwats)] REF:Optional.empty
	TargetOutputPower int32 `json:"target-output-power,omitempty"`
	// Optional[Enable (true) or disable (false) the transmit label for the channel] REF:Optional.empty
