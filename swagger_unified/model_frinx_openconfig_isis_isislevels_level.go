...
// Optional[Configuration and operational state parameters related to a particular level within the IS-IS protocol instance] REF:Optional.empty
type FrinxOpenconfigIsisIsislevelsLevel struct {
	// Optional[Reference to ISIS level-number.] REF:Optional.empty
	LevelNumber int32 `json:"level-number,omitempty"`
	// Optional[This container defines Administrative Distance (or preference) assigned to ISIS routes (level1 internal, level2 internal, level1 external, level2 external).] REF:Optional.empty
	RoutePreference *FrinxOpenconfigIsisIsislevelgroupRoutePreference `json:"route-preference,omitempty"`
	// Optional[This container defines ISIS TE.] REF:Optional.empty
	TrafficEngineering *FrinxOpenconfigIsisIsislevelgroupTrafficEngineering `json:"traffic-engineering,omitempty"`
	// Optional[This container defines ISIS level based configuration.] REF:Optional.empty
	Config *FrinxOpenconfigIsisIsislevelgroupConfig `json:"config,omitempty"`
	// Optional[This container defines ISIS system level counters.] REF:Optional.empty
	SystemLevelCounters *FrinxOpenconfigIsisIsislevelgroupSystemLevelCounters `json:"system-level-counters,omitempty"`
	// Optional[This container defines ISIS authentication.] REF:Optional.empty
	Authentication *FrinxOpenconfigIsisIsislevelgroupAuthentication `json:"authentication,omitempty"`
}
