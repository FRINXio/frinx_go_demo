...
// frinx.openconfig.isis.isisglobalbase.timers.spf.Config.response
type FrinxOpenconfigIsisIsisglobalbaseTimersSpfConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisglobalbaseTimersSpfConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
