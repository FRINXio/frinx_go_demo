...
// frinx.openconfig.mpls.rsvp.rsvpglobal.rsvpte.Global.response
type FrinxOpenconfigMplsRsvpRsvpglobalRsvpteGlobalResponse struct {
	FrinxOpenconfigNetworkInstanceglobal *FrinxOpenconfigMplsRsvpRsvpglobalRsvpteGlobal `json:"frinx-openconfig-network-instance:global,omitempty"`
}
