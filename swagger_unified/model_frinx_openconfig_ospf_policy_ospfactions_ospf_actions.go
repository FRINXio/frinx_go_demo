...
type FrinxOpenconfigOspfPolicyOspfactionsOspfActions struct {
	// Optional[Configuration parameters for OSPF actions] REF:Optional.empty
	Config *FrinxOpenconfigOspfPolicyOspfactionsOspfactionsConfig `json:"config,omitempty"`
	// Optional[Configuration and state parameters relating to manipulating the OSPF metric] REF:Optional.empty
	SetMetric *FrinxOpenconfigOspfPolicyOspfactionsOspfactionsSetMetric `json:"set-metric,omitempty"`
}
