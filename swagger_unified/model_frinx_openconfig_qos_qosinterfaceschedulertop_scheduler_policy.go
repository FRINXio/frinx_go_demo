...
type FrinxOpenconfigQosQosinterfaceschedulertopSchedulerPolicy struct {
	// Optional[Configuration parameters relating to a scheduler policy on an interface.] REF:Optional.empty
	Config *FrinxOpenconfigQosQosinterfaceschedulertopSchedulerpolicyConfig `json:"config,omitempty"`
}
