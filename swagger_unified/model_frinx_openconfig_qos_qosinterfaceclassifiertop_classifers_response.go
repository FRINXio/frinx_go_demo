...
// frinx.openconfig.qos.qosinterfaceclassifiertop.Classifers.response
type FrinxOpenconfigQosQosinterfaceclassifiertopClassifersResponse struct {
	FrinxOpenconfigQosclassifers *FrinxOpenconfigQosQosinterfaceclassifiertopClassifers `json:"frinx-openconfig-qos:classifers,omitempty"`
}
