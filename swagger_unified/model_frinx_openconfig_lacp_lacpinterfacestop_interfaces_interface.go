...
// Optional[List of aggregate interfaces managed by LACP] REF:Optional.empty
type FrinxOpenconfigLacpLacpinterfacestopInterfacesInterface struct {
	...
	Config *FrinxOpenconfigLacpLacpinterfacestopInterfacesInterfaceConfig `json:"config,omitempty"`
	// Optional[Enclosing container for the list of members interfaces of the aggregate. This list is considered operational state only so is labeled config false and has no config container] REF:Optional.empty
	Members *FrinxOpenconfigLacpAggregationlacpmemberstopMembers `json:"members,omitempty"`
}
