...
type FrinxOpenconfigIsisIsisauthenticationgroupConfig struct {
	// Optional[Enable or disable authentication for IS-IS LSPs.] REF:Optional.empty
	LspAuthentication bool `json:"lsp-authentication,omitempty"`
	// Optional[Enable or disable authentication for IS-IS PSNPs.] REF:Optional.empty
	PsnpAuthentication bool `json:"psnp-authentication,omitempty"`
	// Optional[Enable or disable for IS-IS CSNPs.] REF:Optional.empty
