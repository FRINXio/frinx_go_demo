...
// Optional[LDP global signaling configuration] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsLdp struct {
	// Optional[Container including attributes for LDP-enabled interfaces] REF:Optional.empty
	InterfaceAttributes *FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceAttributes `json:"interface-attributes,omitempty"`
	// Optional[Top container for targeted LDP state and configuration attributes.] REF:Optional.empty
	Targeted *FrinxOpenconfigMplsLdpMplsldptargetedtopTargeted `json:"targeted,omitempty"`
	// Optional[Platform wide LDP configuration and state] REF:Optional.empty
	Global *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsLdpGlobal `json:"global,omitempty"`
	// Optional[State and configuration LDP neighbors attributes] REF:Optional.empty
	Neighbors *FrinxOpenconfigMplsLdpMplsldpneighborstopNeighbors `json:"neighbors,omitempty"`
}
