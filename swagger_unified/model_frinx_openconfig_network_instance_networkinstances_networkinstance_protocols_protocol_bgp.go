...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgp struct {
	// Optional[Global configuration for the BGP router] REF:Optional.empty
	Global *FrinxOpenconfigBgpBgptopBgpGlobal `json:"global,omitempty"`
	// Optional[Configuration for BGP peer-groups] REF:Optional.empty
	PeerGroups *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpPeerGroups `json:"peer-groups,omitempty"`
	// Optional[Configuration for BGP neighbors] REF:Optional.empty
	Neighbors *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpNeighbors `json:"neighbors,omitempty"`
}
