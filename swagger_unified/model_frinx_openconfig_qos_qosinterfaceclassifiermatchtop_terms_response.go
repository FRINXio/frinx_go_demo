...
// frinx.openconfig.qos.qosinterfaceclassifiermatchtop.Terms.response
type FrinxOpenconfigQosQosinterfaceclassifiermatchtopTermsResponse struct {
	FrinxOpenconfigQosterms *FrinxOpenconfigQosQosinterfaceclassifiermatchtopTerms `json:"frinx-openconfig-qos:terms,omitempty"`
}
