...
// frinx.openconfig.platform.platformanchorstop.Fan.response
type FrinxOpenconfigPlatformPlatformanchorstopFanResponse struct {
	FrinxOpenconfigPlatformfan *FrinxOpenconfigPlatformPlatformanchorstopFan `json:"frinx-openconfig-platform:fan,omitempty"`
}
