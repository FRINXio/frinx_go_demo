...
// frinx.openconfig.platform.platformanchorstop.Backplane.response
type FrinxOpenconfigPlatformPlatformanchorstopBackplaneResponse struct {
	FrinxOpenconfigPlatformbackplane *FrinxOpenconfigPlatformPlatformanchorstopBackplane `json:"frinx-openconfig-platform:backplane,omitempty"`
}
