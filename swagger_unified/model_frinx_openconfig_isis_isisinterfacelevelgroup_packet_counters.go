...
// Optional[This container defines ISIS interface packet counters.] REF:Optional.empty
type FrinxOpenconfigIsisIsisinterfacelevelgroupPacketCounters struct {
	// Optional[This container defines PSNP packet counters.] REF:Optional.empty
	Psnp *FrinxOpenconfigIsisPacketcountersstructuralPsnp `json:"psnp,omitempty"`
	// Optional[This container defines LSP packet counters.] REF:Optional.empty
	Lsp *FrinxOpenconfigIsisPacketcountersstructuralLsp `json:"lsp,omitempty"`
	// Optional[This container defines IIH packet counters.] REF:Optional.empty
	Iih *FrinxOpenconfigIsisPacketcountersstructuralIih `json:"iih,omitempty"`
	// Optional[This container defines ESH packet counters.] REF:Optional.empty
	Esh *FrinxOpenconfigIsisPacketcountersstructuralEsh `json:"esh,omitempty"`
	// Optional[Operational state parameters relating to CSNPs.] REF:Optional.empty
	Csnp *FrinxOpenconfigIsisPacketcountersstructuralCsnp `json:"csnp,omitempty"`
	// Optional[Operational state parameters relating to IS-IS PDUs that are not otherwise classified - referred to as Unknown PDUs.] REF:Optional.empty
	Unknown *FrinxOpenconfigIsisPacketcountersstructuralUnknown `json:"unknown,omitempty"`
	// Optional[This container defines ISH packet counters.] REF:Optional.empty
	Ish *FrinxOpenconfigIsisPacketcountersstructuralIsh `json:"ish,omitempty"`
}
