...
// frinx.evpn.evpninterfaces.interfaces.Interface.response
type FrinxEvpnEvpninterfacesInterfacesInterfaceResponse struct {
	FrinxEvpninterface []FrinxEvpnEvpninterfacesInterfacesInterface `json:"frinx-evpn:interface,omitempty"`
}
