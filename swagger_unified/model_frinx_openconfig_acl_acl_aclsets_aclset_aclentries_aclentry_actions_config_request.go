...
// frinx.openconfig.acl.acl.aclsets.aclset.aclentries.aclentry.actions.Config.request
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryActionsConfigRequest struct {
