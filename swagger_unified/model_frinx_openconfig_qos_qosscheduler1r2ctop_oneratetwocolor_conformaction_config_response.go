...
// frinx.openconfig.qos.qosscheduler1r2ctop.oneratetwocolor.conformaction.Config.response
type FrinxOpenconfigQosQosscheduler1r2ctopOneratetwocolorConformactionConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosscheduler1r2ctopOneratetwocolorConformactionConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
