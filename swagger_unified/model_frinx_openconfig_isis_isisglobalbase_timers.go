...
type FrinxOpenconfigIsisIsisglobalbaseTimers struct {
	// Optional[This container defines ISIS SPF timer settings.] REF:Optional.empty
	Spf *FrinxOpenconfigIsisIsisglobalbaseTimersSpf `json:"spf,omitempty"`
	// Optional[This container defines ISIS LSP Generation.] REF:Optional.empty
	LspGeneration *FrinxOpenconfigIsisIsisglobalbaseTimersLspGeneration `json:"lsp-generation,omitempty"`
	// Optional[This container defines ISIS global timers configuration.] REF:Optional.empty
	Config *FrinxOpenconfigIsisIsisglobalbaseTimersConfig `json:"config,omitempty"`
}
