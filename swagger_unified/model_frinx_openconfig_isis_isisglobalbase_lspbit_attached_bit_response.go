...
// frinx.openconfig.isis.isisglobalbase.lspbit.AttachedBit.response
type FrinxOpenconfigIsisIsisglobalbaseLspbitAttachedBitResponse struct {
	FrinxOpenconfigNetworkInstanceattachedBit *FrinxOpenconfigIsisIsisglobalbaseLspbitAttachedBit `json:"frinx-openconfig-network-instance:attached-bit,omitempty"`
}
