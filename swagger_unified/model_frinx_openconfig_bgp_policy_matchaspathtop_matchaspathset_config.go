...
// Optional[Configuration data for match conditions on AS path set] REF:Optional.empty
type FrinxOpenconfigBgpPolicyMatchaspathtopMatchaspathsetConfig struct {
	...
	// Optional[References a defined AS path set] REF:Optional.empty
