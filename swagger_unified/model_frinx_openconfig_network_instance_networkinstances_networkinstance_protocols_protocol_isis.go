...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsis struct {
	// Optional[This container defines global ISIS interface configuration and state information.] REF:Optional.empty
	Interfaces *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsisInterfaces `json:"interfaces,omitempty"`
	// Optional[This container defines global ISIS configuration and state information.] REF:Optional.empty
	Global *FrinxOpenconfigIsisIsistopIsisGlobal `json:"global,omitempty"`
	// Optional[This container defines ISIS level configuration and state information.] REF:Optional.empty
	Levels *FrinxOpenconfigIsisIsistopIsisLevels `json:"levels,omitempty"`
}
