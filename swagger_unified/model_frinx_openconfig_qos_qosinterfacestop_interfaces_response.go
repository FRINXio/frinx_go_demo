...
// frinx.openconfig.qos.qosinterfacestop.Interfaces.response
type FrinxOpenconfigQosQosinterfacestopInterfacesResponse struct {
	FrinxOpenconfigQosinterfaces *FrinxOpenconfigQosQosinterfacestopInterfaces `json:"frinx-openconfig-qos:interfaces,omitempty"`
}
