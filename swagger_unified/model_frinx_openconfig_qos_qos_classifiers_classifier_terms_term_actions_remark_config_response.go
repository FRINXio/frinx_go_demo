...
// frinx.openconfig.qos.qos.classifiers.classifier.terms.term.actions.remark.Config.response
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermActionsRemarkConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosClassifiersClassifierTermsTermActionsRemarkConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
