...
// frinx.openconfig.isis.isisinterfacegroup.Authentication.response
type FrinxOpenconfigIsisIsisinterfacegroupAuthenticationResponse struct {
	FrinxOpenconfigNetworkInstanceauthentication *FrinxOpenconfigIsisIsisinterfacegroupAuthentication `json:"frinx-openconfig-network-instance:authentication,omitempty"`
}
