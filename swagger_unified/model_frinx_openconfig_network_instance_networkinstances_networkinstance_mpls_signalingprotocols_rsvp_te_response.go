...
// frinx.openconfig.network.instance.networkinstances.networkinstance.mpls.signalingprotocols.RsvpTe.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsRsvpTeResponse struct {
	FrinxOpenconfigNetworkInstancersvpTe *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsRsvpTe `json:"frinx-openconfig-network-instance:rsvp-te,omitempty"`
}
