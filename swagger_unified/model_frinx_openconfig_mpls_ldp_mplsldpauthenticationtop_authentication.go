...
type FrinxOpenconfigMplsLdpMplsldpauthenticationtopAuthentication struct {
	// Optional[Configuration of LDP authentication attributes] REF:Optional.empty
	Config *FrinxOpenconfigMplsLdpMplsldpauthenticationtopAuthenticationConfig `json:"config,omitempty"`
}
