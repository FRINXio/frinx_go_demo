...
type FrinxOpenconfigQosQosclassifiertopClassifiersClassifierConfig struct {
	// Optional[User-assigned name of the classifier] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Type of classifier.] REF:Optional.empty
