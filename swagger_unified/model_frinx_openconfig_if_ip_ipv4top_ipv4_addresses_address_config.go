...
type FrinxOpenconfigIfIpIpv4topIpv4AddressesAddressConfig struct {
	// Optional[[adapted from IETF IP model RFC 7277]  The length of the subnet prefix.] REF:Optional.empty
	PrefixLength int32 `json:"prefix-length,omitempty"`
	// Optional[[adapted from IETF IP model RFC 7277]  The IPv4 address on the interface.] REF:Optional.empty
