...
// frinx.openconfig.mpls.rsvp.rsvpglobal.rsvpte.interfaceattributes.interface.Config.response
type FrinxOpenconfigMplsRsvpRsvpglobalRsvpteInterfaceattributesInterfaceConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsRsvpRsvpglobalRsvpteInterfaceattributesInterfaceConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
