...
// frinx.openconfig.if.aggregate.aggregationlogicaltop.Aggregation.response
type FrinxOpenconfigIfAggregateAggregationlogicaltopAggregationResponse struct {
