...
// frinx.openconfig.isis.isisifafisafilist.Af.response
type FrinxOpenconfigIsisIsisifafisafilistAfResponse struct {
	FrinxOpenconfigNetworkInstanceaf []FrinxOpenconfigIsisIsisifafisafilistAf `json:"frinx-openconfig-network-instance:af,omitempty"`
}
