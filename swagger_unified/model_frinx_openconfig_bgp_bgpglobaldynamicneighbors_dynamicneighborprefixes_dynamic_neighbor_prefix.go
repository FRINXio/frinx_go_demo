...
// Optional[An individual prefix from which dynamic neighbor connections are allowed.] REF:Optional.empty
type FrinxOpenconfigBgpBgpglobaldynamicneighborsDynamicneighborprefixesDynamicNeighborPrefix struct {
	...
	Config *FrinxOpenconfigBgpBgpglobaldynamicneighborsDynamicneighborprefixesDynamicneighborprefixConfig `json:"config,omitempty"`
	// Optional[Reference to the IP prefix from which source connections are allowed for the dynamic neighbor group.] REF:Optional.empty
