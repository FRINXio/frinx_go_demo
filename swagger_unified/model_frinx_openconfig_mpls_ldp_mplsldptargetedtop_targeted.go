...
type FrinxOpenconfigMplsLdpMplsldptargetedtopTargeted struct {
	// Optional[Configuration attributes related to targeted LDP.] REF:Optional.empty
	Config *FrinxOpenconfigMplsLdpMplsldptargetedtopTargetedConfig `json:"config,omitempty"`
}
