...
type FrinxOpenconfigBfdBfdinterfacemicrobfdstructuralMicrobfdsessionsMicrobfdsessionConfig struct {
	// Optional[The remote IP destination that should be used by the system for the micro-BFD session specified.] REF:Optional.empty
	RemoteAddress string `json:"remote-address,omitempty"`
	// Optional[Reference to a member link of the aggregate interface being described.] REF:Optional.empty
	MemberInterface string `json:"member-interface,omitempty"`
	// Optional[The local IP address used by the system for the micro-BFD session specified.] REF:Optional.empty
