...
// frinx.openconfig.mpls.mplstop.mpls.TeInterfaceAttributes.response
type FrinxOpenconfigMplsMplstopMplsTeInterfaceAttributesResponse struct {
	FrinxOpenconfigNetworkInstanceteInterfaceAttributes *FrinxOpenconfigMplsMplstopMplsTeInterfaceAttributes `json:"frinx-openconfig-network-instance:te-interface-attributes,omitempty"`
}
