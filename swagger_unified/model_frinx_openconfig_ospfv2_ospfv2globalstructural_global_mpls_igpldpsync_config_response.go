...
// frinx.openconfig.ospfv2.ospfv2globalstructural.global.mpls.igpldpsync.Config.response
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMplsIgpldpsyncConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMplsIgpldpsyncConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
