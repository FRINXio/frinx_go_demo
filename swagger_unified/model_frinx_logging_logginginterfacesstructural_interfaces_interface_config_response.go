...
// frinx.logging.logginginterfacesstructural.interfaces.interface.Config.response
type FrinxLoggingLogginginterfacesstructuralInterfacesInterfaceConfigResponse struct {
	FrinxLoggingconfig *FrinxLoggingLogginginterfacesstructuralInterfacesInterfaceConfig `json:"frinx-logging:config,omitempty"`
}
