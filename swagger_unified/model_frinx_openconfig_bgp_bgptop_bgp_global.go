...
// Optional[Global configuration for the BGP router] REF:Optional.empty
type FrinxOpenconfigBgpBgptopBgpGlobal struct {
	...
	// Optional[A list of IP prefixes from which the system should:  - Accept connections to the BGP daemon  - Dynamically configure a BGP neighbor corresponding to the    source address of the remote system, using the parameters    of the specified peer-group. For such neighbors, an entry within the neighbor list should be created, indicating that the peer was dynamically configured, and referencing the peer-group from which the configuration was derived.] REF:Optional.empty
	DynamicNeighborPrefixes *FrinxOpenconfigBgpBgpglobaldynamicneighborsDynamicNeighborPrefixes `json:"dynamic-neighbor-prefixes,omitempty"`
	...
	// Optional[Address family specific configuration] REF:Optional.empty
	AfiSafis *FrinxOpenconfigBgpBgpglobalbaseAfiSafis `json:"afi-safis,omitempty"`
	// Optional[Parameters relating the graceful restart mechanism for BGP] REF:Optional.empty
	GracefulRestart *FrinxOpenconfigBgpBgpglobalbaseGracefulRestart `json:"graceful-restart,omitempty"`
	// Optional[Administrative distance (or preference) assigned to routes received from different sources (external, internal, and local).] REF:Optional.empty
	DefaultRouteDistance *FrinxOpenconfigBgpBgpglobalbaseDefaultRouteDistance `json:"default-route-distance,omitempty"`
	// Optional[Configuration parameters relating to the global BGP router] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpglobalbaseConfig `json:"config,omitempty"`
	// Optional[Parameters indicating whether the local system acts as part of a BGP confederation] REF:Optional.empty
	Confederation *FrinxOpenconfigBgpBgpglobalbaseConfederation `json:"confederation,omitempty"`
}
