...
// frinx.openconfig.qos.qosinterfaceclassifiermatchtop.terms.term.Config.response
type FrinxOpenconfigQosQosinterfaceclassifiermatchtopTermsTermConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosinterfaceclassifiermatchtopTermsTermConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
