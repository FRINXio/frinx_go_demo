...
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryIpv4 struct {
	// Optional[Configuration data for IPv4 match fields] REF:Optional.empty
	Config *FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryIpv4Config `json:"config,omitempty"`
}
