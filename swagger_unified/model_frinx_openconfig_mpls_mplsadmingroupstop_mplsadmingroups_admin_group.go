...
// Optional[configuration of value to name mapping for mpls affinities/admin-groups] REF:Optional.empty
type FrinxOpenconfigMplsMplsadmingroupstopMplsadmingroupsAdminGroup struct {
	// Optional[Configurable items for admin-groups] REF:Optional.empty
	Config *FrinxOpenconfigMplsMplsadmingroupstopMplsadmingroupsAdmingroupConfig `json:"config,omitempty"`
