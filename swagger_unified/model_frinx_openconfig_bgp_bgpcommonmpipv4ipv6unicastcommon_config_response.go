...
// frinx.openconfig.bgp.bgpcommonmpipv4ipv6unicastcommon.Config.response
type FrinxOpenconfigBgpBgpcommonmpipv4ipv6unicastcommonConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpcommonmpipv4ipv6unicastcommonConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
