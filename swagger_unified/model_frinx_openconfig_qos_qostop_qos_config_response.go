...
// frinx.openconfig.qos.qostop.qos.Config.response
type FrinxOpenconfigQosQostopQosConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQostopQosConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
