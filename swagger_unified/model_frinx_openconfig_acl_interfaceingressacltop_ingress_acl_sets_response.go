...
// frinx.openconfig.acl.interfaceingressacltop.IngressAclSets.response
type FrinxOpenconfigAclInterfaceingressacltopIngressAclSetsResponse struct {
	FrinxOpenconfigAclingressAclSets *FrinxOpenconfigAclInterfaceingressacltopIngressAclSets `json:"frinx-openconfig-acl:ingress-acl-sets,omitempty"`
}
