...
// frinx.openconfig.bgp.bgppeergroupbase.Transport.response
type FrinxOpenconfigBgpBgppeergroupbaseTransportResponse struct {
	FrinxOpenconfigNetworkInstancetransport *FrinxOpenconfigBgpBgppeergroupbaseTransport `json:"frinx-openconfig-network-instance:transport,omitempty"`
}
