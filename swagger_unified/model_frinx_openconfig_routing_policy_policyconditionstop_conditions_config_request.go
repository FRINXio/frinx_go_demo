...
// frinx.openconfig.routing.policy.policyconditionstop.conditions.Config.request
type FrinxOpenconfigRoutingPolicyPolicyconditionstopConditionsConfigRequest struct {
