...
// frinx.snmp.snmpinterfacesstructural.interfaces.interface.Config.response
type FrinxSnmpSnmpinterfacesstructuralInterfacesInterfaceConfigResponse struct {
	FrinxSnmpconfig *FrinxSnmpSnmpinterfacesstructuralInterfacesInterfaceConfig `json:"frinx-snmp:config,omitempty"`
}
