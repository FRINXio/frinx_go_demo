...
// frinx.openconfig.acl.acl.aclsets.aclset.AclEntries.response
type FrinxOpenconfigAclAclAclsetsAclsetAclEntriesResponse struct {
	FrinxOpenconfigAclaclEntries *FrinxOpenconfigAclAclAclsetsAclsetAclEntries `json:"frinx-openconfig-acl:acl-entries,omitempty"`
}
