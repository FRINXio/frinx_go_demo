...
// Optional[Condition statements for the current policy statement] REF:Optional.empty
type FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicydefinitionStatementsStatementConditions struct {
	// Optional[Top-level container for protocol instance match condition in policy statements.  The protocol instance is referenced by an identifier and name] REF:Optional.empty
	FrinxOpenconfigNetworkInstancePolicymatchProtocolInstance *FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchProtocolInstance `json:"frinx-openconfig-network-instance-policy:match-protocol-instance,omitempty"`
	// Optional[Match conditions specific to OSPF] REF:Optional.empty
	FrinxOpenconfigOspfPolicyospfConditions *FrinxOpenconfigOspfPolicyOspfmatchconditionsOspfConditions `json:"frinx-openconfig-ospf-policy:ospf-conditions,omitempty"`
	// Optional[Match a referenced neighbor set according to the logic defined in the match-set-options-leaf] REF:Optional.empty
	MatchNeighborSet *FrinxOpenconfigRoutingPolicyNeighborsetconditiontopMatchNeighborSet `json:"match-neighbor-set,omitempty"`
	// Optional[Match conditions relating to the IS-IS protocol] REF:Optional.empty
	FrinxOpenconfigIsisPolicyisisConditions *FrinxOpenconfigIsisPolicyIsismatchconditionsIsisConditions `json:"frinx-openconfig-isis-policy:isis-conditions,omitempty"`
	// Optional[Match a referenced tag set according to the logic defined in the match-options-set leaf] REF:Optional.empty
	MatchTagSet *FrinxOpenconfigRoutingPolicyTagsetconditiontopMatchTagSet `json:"match-tag-set,omitempty"`
	// Optional[Top-level container ] REF:Optional.empty
	FrinxOpenconfigBgpPolicybgpConditions *FrinxOpenconfigBgpPolicyBgpconditionstopBgpConditions `json:"frinx-openconfig-bgp-policy:bgp-conditions,omitempty"`
	// Optional[Match a referenced prefix-set according to the logic defined in the match-set-options leaf] REF:Optional.empty
	MatchPrefixSet *FrinxOpenconfigRoutingPolicyPrefixsetconditiontopMatchPrefixSet `json:"match-prefix-set,omitempty"`
	// Optional[Configuration data for policy conditions] REF:Optional.empty
	Config *FrinxOpenconfigRoutingPolicyPolicyconditionstopConditionsConfig `json:"config,omitempty"`
	// Optional[Top-level container for interface match conditions] REF:Optional.empty
	MatchInterface *FrinxOpenconfigRoutingPolicyMatchinterfaceconditiontopMatchInterface `json:"match-interface,omitempty"`
}
