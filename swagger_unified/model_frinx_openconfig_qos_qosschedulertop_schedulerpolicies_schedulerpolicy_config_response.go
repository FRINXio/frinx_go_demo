...
// frinx.openconfig.qos.qosschedulertop.schedulerpolicies.schedulerpolicy.Config.response
type FrinxOpenconfigQosQosschedulertopSchedulerpoliciesSchedulerpolicyConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosschedulertopSchedulerpoliciesSchedulerpolicyConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
