...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2 struct {
	...
	Global *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2Global `json:"global,omitempty"`
	// Optional[Configuration and operational state relating to an OSPFv2 area.] REF:Optional.empty
	Areas *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2Areas `json:"areas,omitempty"`
}
