...
// frinx.damping.dampingtop.damping.Config.response
type FrinxDampingDampingtopDampingConfigResponse struct {
	FrinxDampingconfig *FrinxDampingDampingtopDampingConfig `json:"frinx-damping:config,omitempty"`
}
