...
// frinx.openconfig.isis.isisglobalbase.timers.Config.response
type FrinxOpenconfigIsisIsisglobalbaseTimersConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisglobalbaseTimersConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
