...
// frinx.openconfig.lacp.aggregationlacpmemberstop.Members.response
type FrinxOpenconfigLacpAggregationlacpmemberstopMembersResponse struct {
	FrinxOpenconfigLacpmembers *FrinxOpenconfigLacpAggregationlacpmemberstopMembers `json:"frinx-openconfig-lacp:members,omitempty"`
}
