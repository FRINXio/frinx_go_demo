...
// frinx.openconfig.isis.isisglobalbase.Nsr.response
type FrinxOpenconfigIsisIsisglobalbaseNsrResponse struct {
	FrinxOpenconfigNetworkInstancensr *FrinxOpenconfigIsisIsisglobalbaseNsr `json:"frinx-openconfig-network-instance:nsr,omitempty"`
}
