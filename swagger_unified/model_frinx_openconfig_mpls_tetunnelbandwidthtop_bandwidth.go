...
type FrinxOpenconfigMplsTetunnelbandwidthtopBandwidth struct {
	// Optional[Configuration parameters related to bandwidth on TE tunnels:] REF:Optional.empty
	Config *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthConfig `json:"config,omitempty"`
	// Optional[Parameters related to auto-bandwidth] REF:Optional.empty
	AutoBandwidth *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutoBandwidth `json:"auto-bandwidth,omitempty"`
}
