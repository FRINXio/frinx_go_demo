...
// Optional[Configuration data for the HSRP group] REF:Optional.empty
type FrinxHsrpHsrpgroupsHsrpgroupConfig struct {
	// Optional[Set the virtual router id for use by the HSRP group. This usually also determines the virtual MAC address that is generated for the HSRP group] REF:Optional.empty
	VirtualRouterId int64 `json:"virtual-router-id,omitempty"`
	// Optional[Priority level] REF:Optional.empty
	Priority int32 `json:"priority,omitempty"`
	// Optional[Version of HSRP] REF:Optional.empty
	Version int32 `json:"version,omitempty"`
	// Optional[The address family of the prefix contained in the Extended Prefix LSA] REF:Optional.empty
	AddressFamily *FrinxHsrpAddressFamilyIdentityref `json:"address-family,omitempty"`
}
