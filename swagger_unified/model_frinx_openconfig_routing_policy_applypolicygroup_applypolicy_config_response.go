...
// frinx.openconfig.routing.policy.applypolicygroup.applypolicy.Config.response
type FrinxOpenconfigRoutingPolicyApplypolicygroupApplypolicyConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigRoutingPolicyApplypolicygroupApplypolicyConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
