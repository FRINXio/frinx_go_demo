...
// frinx.openconfig.mpls.mplstop.mpls.lsps.UnconstrainedPath.response
type FrinxOpenconfigMplsMplstopMplsLspsUnconstrainedPathResponse struct {
	FrinxOpenconfigNetworkInstanceunconstrainedPath *FrinxOpenconfigMplsMplstopMplsLspsUnconstrainedPath `json:"frinx-openconfig-network-instance:unconstrained-path,omitempty"`
}
