...
// frinx.openconfig.if.ip.ipv6top.ipv6.Addresses.response
type FrinxOpenconfigIfIpIpv6topIpv6AddressesResponse struct {
	FrinxOpenconfigIfIpaddresses *FrinxOpenconfigIfIpIpv6topIpv6Addresses `json:"frinx-openconfig-if-ip:addresses,omitempty"`
}
