...
// frinx.netflow.netflowinterfacestop.Interfaces.response
type FrinxNetflowNetflowinterfacestopInterfacesResponse struct {
	FrinxNetflowinterfaces *FrinxNetflowNetflowinterfacestopInterfaces `json:"frinx-netflow:interfaces,omitempty"`
}
