...
// frinx.openconfig.lacp.aggregationlacptop.lacp.Config.response
type FrinxOpenconfigLacpAggregationlacptopLacpConfigResponse struct {
	FrinxOpenconfigLacpconfig *FrinxOpenconfigLacpAggregationlacptopLacpConfig `json:"frinx-openconfig-lacp:config,omitempty"`
}
