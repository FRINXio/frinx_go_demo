...
// Optional[This list describes ISIS Overload reset trigger reasons.] REF:Optional.empty
type FrinxOpenconfigIsisOverloadbitgroupResettriggersResetTrigger struct {
	// Optional[Reference to the reset trigger reason] REF:Optional.empty
	ResetTrigger string `json:"reset-trigger,omitempty"`
	// Optional[This container defines ISIS Overload Bit reset trigger configuration.] REF:Optional.empty
	Config *FrinxOpenconfigIsisOverloadbitgroupResettriggersResettriggerConfig `json:"config,omitempty"`
}
