...
// frinx.openconfig.qos.qosinterfaceclassifiertop.classifers.Classifier.response
type FrinxOpenconfigQosQosinterfaceclassifiertopClassifersClassifierResponse struct {
	FrinxOpenconfigQosclassifier []FrinxOpenconfigQosQosinterfaceclassifiertopClassifersClassifier `json:"frinx-openconfig-qos:classifier,omitempty"`
}
