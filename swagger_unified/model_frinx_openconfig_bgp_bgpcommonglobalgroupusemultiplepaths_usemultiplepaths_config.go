...
type FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsConfig struct {
	// Optional[Whether the use of multiple paths for the same NLRI is enabled for the neighbor. This value is overridden by any more specific configuration value.] REF:Optional.empty
