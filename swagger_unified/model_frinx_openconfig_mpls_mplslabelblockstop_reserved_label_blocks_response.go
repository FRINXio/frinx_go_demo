...
// frinx.openconfig.mpls.mplslabelblockstop.ReservedLabelBlocks.response
type FrinxOpenconfigMplsMplslabelblockstopReservedLabelBlocksResponse struct {
	FrinxOpenconfigNetworkInstancereservedLabelBlocks *FrinxOpenconfigMplsMplslabelblockstopReservedLabelBlocks `json:"frinx-openconfig-network-instance:reserved-label-blocks,omitempty"`
}
