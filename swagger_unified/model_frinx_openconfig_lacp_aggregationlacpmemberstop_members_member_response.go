...
// frinx.openconfig.lacp.aggregationlacpmemberstop.members.Member.response
type FrinxOpenconfigLacpAggregationlacpmemberstopMembersMemberResponse struct {
	FrinxOpenconfigLacpmember []FrinxOpenconfigLacpAggregationlacpmemberstopMembersMember `json:"frinx-openconfig-lacp:member,omitempty"`
}
