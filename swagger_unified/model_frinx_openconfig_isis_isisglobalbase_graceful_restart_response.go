...
// frinx.openconfig.isis.isisglobalbase.GracefulRestart.response
type FrinxOpenconfigIsisIsisglobalbaseGracefulRestartResponse struct {
	FrinxOpenconfigNetworkInstancegracefulRestart *FrinxOpenconfigIsisIsisglobalbaseGracefulRestart `json:"frinx-openconfig-network-instance:graceful-restart,omitempty"`
}
