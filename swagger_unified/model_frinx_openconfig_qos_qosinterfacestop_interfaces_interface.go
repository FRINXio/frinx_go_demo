...
// Optional[List of interfaces referenced by QoS entities.] REF:Optional.empty
type FrinxOpenconfigQosQosinterfacestopInterfacesInterface struct {
	// Optional[Top-level container for QoS data related to the egress interface] REF:Optional.empty
	Output *FrinxOpenconfigQosQosinterfaceoutputtopOutput `json:"output,omitempty"`
	// Optional[Top-level container for QoS data for the ingress interface] REF:Optional.empty
	Input *FrinxOpenconfigQosQosinterfaceinputtopInput `json:"input,omitempty"`
	// Optional[Configuration data ] REF:Optional.empty
	Config *FrinxOpenconfigQosQosinterfacestopInterfacesInterfaceConfig `json:"config,omitempty"`
