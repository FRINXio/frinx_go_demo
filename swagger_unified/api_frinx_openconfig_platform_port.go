...
type FrinxOpenconfigPlatformPortApiService service

/*
FrinxOpenconfigPlatformPortApiService
...
*/
func (a *FrinxOpenconfigPlatformPortApiService) DeleteFrinxOpenconfigPlatformComponentsComponentBreakoutMode(ctx context.Context, name string, nodeId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/config/network-topology:network-topology/network-topology:topology/unified/network-topology:node/{node-id}/yang-ext:mount/frinx-openconfig-platform:components/frinx-openconfig-platform:component/{name}/frinx-openconfig-platform-port:breakout-mode/"
...
*/
func (a *FrinxOpenconfigPlatformPortApiService) DeleteFrinxOpenconfigPlatformComponentsComponentBreakoutModeConfig(ctx context.Context, name string, nodeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return FrinxOpenconfigPlatformPortPortbreakouttopBreakoutModeResponse
*/
func (a *FrinxOpenconfigPlatformPortApiService) GetFrinxOpenconfigPlatformComponentsComponentBreakoutMode(ctx context.Context, name string, nodeId string) (FrinxOpenconfigPlatformPortPortbreakouttopBreakoutModeResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxOpenconfigPlatformPortPortbreakouttopBreakoutModeResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxOpenconfigPlatformPortPortbreakouttopBreakoutModeResponse
...
@return FrinxOpenconfigPlatformPortPortbreakouttopBreakoutmodeConfigResponse
*/
func (a *FrinxOpenconfigPlatformPortApiService) GetFrinxOpenconfigPlatformComponentsComponentBreakoutModeConfig(ctx context.Context, name string, nodeId string) (FrinxOpenconfigPlatformPortPortbreakouttopBreakoutmodeConfigResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxOpenconfigPlatformPortPortbreakouttopBreakoutmodeConfigResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxOpenconfigPlatformPortPortbreakouttopBreakoutmodeConfigResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Id of component
 * @param frinxOpenconfigPlatformPortPortbreakouttopBreakoutModeBodyParam frinx.openconfig.platform.port.portbreakouttop.BreakoutMode to be added or updated
 * @param nodeId


*/
func (a *FrinxOpenconfigPlatformPortApiService) PutFrinxOpenconfigPlatformComponentsComponentBreakoutMode(ctx context.Context, name string, frinxOpenconfigPlatformPortPortbreakouttopBreakoutModeBodyParam FrinxOpenconfigPlatformPortPortbreakouttopBreakoutModeRequest, nodeId string) (*http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &frinxOpenconfigPlatformPortPortbreakouttopBreakoutModeBodyParam
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Id of component
 * @param frinxOpenconfigPlatformPortPortbreakouttopBreakoutmodeConfigBodyParam frinx.openconfig.platform.port.portbreakouttop.breakoutmode.Config to be added or updated
 * @param nodeId


*/
func (a *FrinxOpenconfigPlatformPortApiService) PutFrinxOpenconfigPlatformComponentsComponentBreakoutModeConfig(ctx context.Context, name string, frinxOpenconfigPlatformPortPortbreakouttopBreakoutmodeConfigBodyParam FrinxOpenconfigPlatformPortPortbreakouttopBreakoutmodeConfigRequest, nodeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// body params
	localVarPostBody = &frinxOpenconfigPlatformPortPortbreakouttopBreakoutmodeConfigBodyParam
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
