...
// Optional[Configuration parameters enabling or modifying logging for events relating to the BGPgroup] REF:Optional.empty
type FrinxOpenconfigBgpBgpcommonstructureneighborgrouploggingoptionsLoggingoptionsConfig struct {
	// Optional[Configure logging of peer state changes.  Default is to enable logging of peer state changes.] REF:Optional.empty
	LogNeighborStateChanges bool `json:"log-neighbor-state-changes,omitempty"`
}
