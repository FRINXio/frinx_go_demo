...
// Optional[This container defines AFI-SAFI multi-topology configuration parameters] REF:Optional.empty
type FrinxOpenconfigIsisIsismtlistMultitopologyConfig struct {
