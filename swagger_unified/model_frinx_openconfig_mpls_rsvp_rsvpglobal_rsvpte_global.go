...
type FrinxOpenconfigMplsRsvpRsvpglobalRsvpteGlobal struct {
	// Optional[Operational state and configuration parameters relating to graceful-restart for RSVP] REF:Optional.empty
	GracefulRestart *FrinxOpenconfigMplsRsvpMplsrsvpgracefulrestartGracefulRestart `json:"graceful-restart,omitempty"`
	...
	// Optional[Protocol options relating to RSVP soft preemption] REF:Optional.empty
	SoftPreemption *FrinxOpenconfigMplsRsvpMplsrsvpsoftpreemptionSoftPreemption `json:"soft-preemption,omitempty"`
}
