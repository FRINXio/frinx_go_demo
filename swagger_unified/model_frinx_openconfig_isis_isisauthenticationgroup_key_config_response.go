...
// frinx.openconfig.isis.isisauthenticationgroup.key.Config.response
type FrinxOpenconfigIsisIsisauthenticationgroupKeyConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisauthenticationgroupKeyConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
