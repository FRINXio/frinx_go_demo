...
// Optional[Configuration and operational state relating SNMP on interfaces.] REF:Optional.empty
type FrinxSnmpSnmpinterfacesstructuralInterfaces struct {
	...
	Interface_ []FrinxSnmpSnmpinterfacesstructuralInterfacesInterface `json:"interface,omitempty"`
}
