...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.ospfv2.Global.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2GlobalResponse struct {
	FrinxOpenconfigNetworkInstanceglobal *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2Global `json:"frinx-openconfig-network-instance:global,omitempty"`
}
