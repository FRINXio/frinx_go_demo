...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2Areas struct {
	// Optional[The OSPFv2 areas within which the local system exists] REF:Optional.empty
	Area []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2AreasArea `json:"area,omitempty"`
}
