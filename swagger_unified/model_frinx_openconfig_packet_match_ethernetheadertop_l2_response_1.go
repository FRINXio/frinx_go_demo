...
// frinx.openconfig.packet.match.ethernetheadertop.L2.response
type FrinxOpenconfigPacketMatchEthernetheadertopL2Response1 struct {
	FrinxOpenconfigNetworkInstancel2 *FrinxOpenconfigPacketMatchEthernetheadertopL2 `json:"frinx-openconfig-network-instance:l2,omitempty"`
}
