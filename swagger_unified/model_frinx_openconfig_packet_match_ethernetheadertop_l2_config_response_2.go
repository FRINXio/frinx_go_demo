...
type FrinxOpenconfigPacketMatchEthernetheadertopL2ConfigResponse2 struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigPacketMatchEthernetheadertopL2Config `json:"frinx-openconfig-qos:config,omitempty"`
}
