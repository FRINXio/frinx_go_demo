...
// frinx.openconfig.routing.policy.policystatementstop.statements.statement.Config.request
type FrinxOpenconfigRoutingPolicyPolicystatementstopStatementsStatementConfigRequest struct {
