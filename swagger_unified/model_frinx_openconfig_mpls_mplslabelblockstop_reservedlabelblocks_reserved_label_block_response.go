...
// frinx.openconfig.mpls.mplslabelblockstop.reservedlabelblocks.ReservedLabelBlock.response
type FrinxOpenconfigMplsMplslabelblockstopReservedlabelblocksReservedLabelBlockResponse struct {
	FrinxOpenconfigNetworkInstancereservedLabelBlock []FrinxOpenconfigMplsMplslabelblockstopReservedlabelblocksReservedLabelBlock `json:"frinx-openconfig-network-instance:reserved-label-block,omitempty"`
}
