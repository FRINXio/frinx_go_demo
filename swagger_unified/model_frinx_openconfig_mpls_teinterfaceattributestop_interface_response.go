...
// frinx.openconfig.mpls.teinterfaceattributestop.Interface.response
type FrinxOpenconfigMplsTeinterfaceattributestopInterfaceResponse struct {
	FrinxOpenconfigNetworkInstanceinterface []FrinxOpenconfigMplsTeinterfaceattributestopInterface `json:"frinx-openconfig-network-instance:interface,omitempty"`
}
