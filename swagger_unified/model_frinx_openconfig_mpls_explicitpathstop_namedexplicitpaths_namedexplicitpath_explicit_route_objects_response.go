...
// frinx.openconfig.mpls.explicitpathstop.namedexplicitpaths.namedexplicitpath.ExplicitRouteObjects.response
type FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedexplicitpathExplicitRouteObjectsResponse struct {
	FrinxOpenconfigNetworkInstanceexplicitRouteObjects *FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedexplicitpathExplicitRouteObjects `json:"frinx-openconfig-network-instance:explicit-route-objects,omitempty"`
}
