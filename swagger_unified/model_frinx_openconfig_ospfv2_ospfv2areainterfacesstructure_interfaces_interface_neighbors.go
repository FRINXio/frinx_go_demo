...
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceNeighbors struct {
	// Optional[A neighbor with which an OSPFv2 adjacency has been established within this area] REF:Optional.empty
	Neighbor []FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceNeighborsNeighbor `json:"neighbor,omitempty"`
}
