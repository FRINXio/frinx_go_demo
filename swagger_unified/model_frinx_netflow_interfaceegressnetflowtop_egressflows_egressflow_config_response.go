...
// frinx.netflow.interfaceegressnetflowtop.egressflows.egressflow.Config.response
type FrinxNetflowInterfaceegressnetflowtopEgressflowsEgressflowConfigResponse struct {
	FrinxNetflowconfig *FrinxNetflowInterfaceegressnetflowtopEgressflowsEgressflowConfig `json:"frinx-netflow:config,omitempty"`
}
