...
// frinx.openconfig.probes.probes.probe.tests.test.Config.response
type FrinxOpenconfigProbesProbesProbeTestsTestConfigResponse struct {
	FrinxOpenconfigProbesconfig *FrinxOpenconfigProbesProbesProbeTestsTestConfig `json:"frinx-openconfig-probes:config,omitempty"`
}
