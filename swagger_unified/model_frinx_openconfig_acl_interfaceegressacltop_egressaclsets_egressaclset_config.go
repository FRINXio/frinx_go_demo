...
type FrinxOpenconfigAclInterfaceegressacltopEgressaclsetsEgressaclsetConfig struct {
	...
	// Optional[Reference to the ACL set name applied on egress] REF:Optional.empty
