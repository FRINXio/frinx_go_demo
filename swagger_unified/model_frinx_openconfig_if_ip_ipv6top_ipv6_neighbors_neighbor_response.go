...
// frinx.openconfig.if.ip.ipv6top.ipv6.neighbors.Neighbor.response
type FrinxOpenconfigIfIpIpv6topIpv6NeighborsNeighborResponse struct {
	FrinxOpenconfigIfIpneighbor []FrinxOpenconfigIfIpIpv6topIpv6NeighborsNeighbor `json:"frinx-openconfig-if-ip:neighbor,omitempty"`
}
