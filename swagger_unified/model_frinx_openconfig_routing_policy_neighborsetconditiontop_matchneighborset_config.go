...
type FrinxOpenconfigRoutingPolicyNeighborsetconditiontopMatchneighborsetConfig struct {
	// Optional[References a defined neighbor set] REF:Optional.empty
	NeighborSet string `json:"neighbor-set,omitempty"`
