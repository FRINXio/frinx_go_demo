...
type FrinxOpenconfigProbesTesttargetTargetConfig struct {
	// Optional[IP address of the target, either IPv4 or IPv6.] REF:Optional.empty
	Address string `json:"address,omitempty"`
	// Optional[Destination port.] REF:Optional.empty
	Port int32 `json:"port,omitempty"`
	// Optional[Target URL to probe.] REF:Optional.empty
