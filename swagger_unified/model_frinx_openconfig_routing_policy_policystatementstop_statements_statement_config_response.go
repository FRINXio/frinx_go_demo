...
// frinx.openconfig.routing.policy.policystatementstop.statements.statement.Config.response
type FrinxOpenconfigRoutingPolicyPolicystatementstopStatementsStatementConfigResponse struct {
	FrinxOpenconfigRoutingPolicyconfig *FrinxOpenconfigRoutingPolicyPolicystatementstopStatementsStatementConfig `json:"frinx-openconfig-routing-policy:config,omitempty"`
}
