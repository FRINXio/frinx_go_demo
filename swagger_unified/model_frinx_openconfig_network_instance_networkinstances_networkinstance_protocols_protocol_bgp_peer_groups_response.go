...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.bgp.PeerGroups.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpPeerGroupsResponse struct {
	FrinxOpenconfigNetworkInstancepeerGroups *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpPeerGroups `json:"frinx-openconfig-network-instance:peer-groups,omitempty"`
}
