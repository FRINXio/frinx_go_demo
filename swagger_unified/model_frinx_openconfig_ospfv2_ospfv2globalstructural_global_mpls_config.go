...
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMplsConfig struct {
	// Optional[When this leaf is set to true, use traffic engineering extensions for OSPF to advertise TE parameters via type 10 Opaque LSAs] REF:Optional.empty
	TrafficEngineeringExtensions bool `json:"traffic-engineering-extensions,omitempty"`
}
