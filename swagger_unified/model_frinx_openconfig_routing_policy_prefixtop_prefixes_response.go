...
// frinx.openconfig.routing.policy.prefixtop.Prefixes.response
type FrinxOpenconfigRoutingPolicyPrefixtopPrefixesResponse struct {
	FrinxOpenconfigRoutingPolicyprefixes *FrinxOpenconfigRoutingPolicyPrefixtopPrefixes `json:"frinx-openconfig-routing-policy:prefixes,omitempty"`
}
