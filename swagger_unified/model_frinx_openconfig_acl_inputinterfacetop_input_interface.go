...
type FrinxOpenconfigAclInputinterfacetopInputInterface struct {
	// Optional[Config data] REF:Optional.empty
	Config *FrinxOpenconfigAclInputinterfacetopInputinterfaceConfig `json:"config,omitempty"`
