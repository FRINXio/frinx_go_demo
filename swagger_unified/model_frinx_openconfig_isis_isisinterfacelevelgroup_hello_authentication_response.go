...
// frinx.openconfig.isis.isisinterfacelevelgroup.HelloAuthentication.response
type FrinxOpenconfigIsisIsisinterfacelevelgroupHelloAuthenticationResponse struct {
	FrinxOpenconfigNetworkInstancehelloAuthentication *FrinxOpenconfigIsisIsisinterfacelevelgroupHelloAuthentication `json:"frinx-openconfig-network-instance:hello-authentication,omitempty"`
}
