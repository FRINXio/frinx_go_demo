...
// frinx.openconfig.isis.isisglobalbase.referencebandwidth.Config.response
type FrinxOpenconfigIsisIsisglobalbaseReferencebandwidthConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisglobalbaseReferencebandwidthConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
