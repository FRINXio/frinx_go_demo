...
type FrinxOpenconfigMplsRsvpMplsrsvplinkprotectionProtection struct {
	// Optional[Configuration for link-protection] REF:Optional.empty
	Config *FrinxOpenconfigMplsRsvpMplsrsvplinkprotectionProtectionConfig `json:"config,omitempty"`
}
