...
// frinx.openconfig.isis.isisglobalbase.mpls.igpldpsync.Config.response
type FrinxOpenconfigIsisIsisglobalbaseMplsIgpldpsyncConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisglobalbaseMplsIgpldpsyncConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
