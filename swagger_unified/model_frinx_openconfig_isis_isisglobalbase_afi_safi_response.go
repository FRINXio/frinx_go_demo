...
// frinx.openconfig.isis.isisglobalbase.AfiSafi.response
type FrinxOpenconfigIsisIsisglobalbaseAfiSafiResponse struct {
	FrinxOpenconfigNetworkInstanceafiSafi *FrinxOpenconfigIsisIsisglobalbaseAfiSafi `json:"frinx-openconfig-network-instance:afi-safi,omitempty"`
}
