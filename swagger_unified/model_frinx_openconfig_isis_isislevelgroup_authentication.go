...
type FrinxOpenconfigIsisIsislevelgroupAuthentication struct {
	...
	Config *FrinxOpenconfigIsisIsisauthenticationgroupConfig `json:"config,omitempty"`
	// Optional[This container defines ISIS authentication key] REF:Optional.empty
	Key *FrinxOpenconfigIsisIsisauthenticationgroupKey `json:"key,omitempty"`
}
