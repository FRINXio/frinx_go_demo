...
// frinx.openconfig.mpls.ldp.mplsldpauthenticationtop.authentication.Config.response
type FrinxOpenconfigMplsLdpMplsldpauthenticationtopAuthenticationConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsLdpMplsldpauthenticationtopAuthenticationConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
