...
// frinx.openconfig.platform.platformcomponentpropertiestop.properties.property.Config.response
type FrinxOpenconfigPlatformPlatformcomponentpropertiestopPropertiesPropertyConfigResponse struct {
	FrinxOpenconfigPlatformconfig *FrinxOpenconfigPlatformPlatformcomponentpropertiestopPropertiesPropertyConfig `json:"frinx-openconfig-platform:config,omitempty"`
}
