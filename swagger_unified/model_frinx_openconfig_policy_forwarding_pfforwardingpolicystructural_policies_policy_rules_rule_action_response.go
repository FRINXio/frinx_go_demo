...
// frinx.openconfig.policy.forwarding.pfforwardingpolicystructural.policies.policy.rules.rule.Action.response
type FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRuleActionResponse struct {
	FrinxOpenconfigNetworkInstanceaction *FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRuleAction `json:"frinx-openconfig-network-instance:action,omitempty"`
}
