...
// Optional[List of locally configured static routes] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticroutesStatic struct {
	// Optional[Configuration and state parameters relating to the next-hops that are to be utilised for the static route being specified] REF:Optional.empty
	NextHops *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticroutesStaticNextHops `json:"next-hops,omitempty"`
	// Optional[Configuration data for static routes] REF:Optional.empty
	Config *FrinxOpenconfigLocalRoutingLocalstatictopStaticroutesStaticConfig `json:"config,omitempty"`
	// Optional[Reference to the destination prefix list key.] REF:Optional.empty
