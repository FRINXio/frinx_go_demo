...
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMplsIgpLdpSync struct {
	// Optional[Configuration parameters relating to LDP/IG synchronization.] REF:Optional.empty
	Config *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMplsIgpldpsyncConfig `json:"config,omitempty"`
}
