...
// Optional[List of explicit route objects] REF:Optional.empty
type FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedexplicitpathExplicitrouteobjectsExplicitRouteObject struct {
	// Optional[Index of this explicit route object, to express the order of hops in path] REF:Optional.empty
	Index int32 `json:"index,omitempty"`
	// Optional[Configuration parameters relating to an explicit route] REF:Optional.empty
	Config *FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedexplicitpathExplicitrouteobjectsExplicitrouteobjectConfig `json:"config,omitempty"`
}
