...
type FrinxOpenconfigIfIpIpv4topIpv4 struct {
	// Optional[Enclosing container for address list] REF:Optional.empty
	Addresses *FrinxOpenconfigIfIpIpv4topIpv4Addresses `json:"addresses,omitempty"`
	// Optional[Top-level IPv4 configuration data for the interface] REF:Optional.empty
	Config *FrinxOpenconfigIfIpIpv4topIpv4Config `json:"config,omitempty"`
	...
	// Optional[Enclosing container for neighbor list] REF:Optional.empty
	Neighbors *FrinxOpenconfigIfIpIpv4topIpv4Neighbors `json:"neighbors,omitempty"`
}
