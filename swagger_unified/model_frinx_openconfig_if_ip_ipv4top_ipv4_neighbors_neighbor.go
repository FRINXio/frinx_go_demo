...
// Optional[A list of mappings from IPv4 addresses to link-layer addresses.  Entries in this list are used as static entries in the ARP Cache.] REF:Optional[RFC 826: An Ethernet Address Resolution Protocol]
type FrinxOpenconfigIfIpIpv4topIpv4NeighborsNeighbor struct {
	// Optional[Configuration data for each configured IPv4 address on the interface] REF:Optional.empty
	Config *FrinxOpenconfigIfIpIpv4topIpv4NeighborsNeighborConfig `json:"config,omitempty"`
