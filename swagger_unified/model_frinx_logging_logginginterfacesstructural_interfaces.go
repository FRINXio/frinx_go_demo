...
// Optional[Configuration and operational state relating logging on interfaces.] REF:Optional.empty
type FrinxLoggingLogginginterfacesstructuralInterfaces struct {
	...
	Interface_ []FrinxLoggingLogginginterfacesstructuralInterfacesInterface `json:"interface,omitempty"`
}
