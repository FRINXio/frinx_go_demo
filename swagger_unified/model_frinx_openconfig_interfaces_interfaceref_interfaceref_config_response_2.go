...
type FrinxOpenconfigInterfacesInterfacerefInterfacerefConfigResponse2 struct {
	FrinxOpenconfigBfdconfig *FrinxOpenconfigInterfacesInterfacerefInterfacerefConfig `json:"frinx-openconfig-bfd:config,omitempty"`
}
