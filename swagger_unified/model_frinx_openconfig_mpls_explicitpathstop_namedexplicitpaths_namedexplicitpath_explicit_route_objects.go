...
type FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedexplicitpathExplicitRouteObjects struct {
	// Optional[List of explicit route objects] REF:Optional.empty
	ExplicitRouteObject []FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedexplicitpathExplicitrouteobjectsExplicitRouteObject `json:"explicit-route-object,omitempty"`
}
