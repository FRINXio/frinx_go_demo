...
type FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceattributesInterfaces struct {
	// Optional[list of per-interface LDP configurations] REF:Optional.empty
	Interface_ []FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceattributesInterfacesInterface `json:"interface,omitempty"`
}
