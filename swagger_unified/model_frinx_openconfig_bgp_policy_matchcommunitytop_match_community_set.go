...
type FrinxOpenconfigBgpPolicyMatchcommunitytopMatchCommunitySet struct {
	// Optional[Configuration data for match conditions on communities] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicyMatchcommunitytopMatchcommunitysetConfig `json:"config,omitempty"`
}
