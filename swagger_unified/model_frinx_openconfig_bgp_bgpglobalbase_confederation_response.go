...
// frinx.openconfig.bgp.bgpglobalbase.Confederation.response
type FrinxOpenconfigBgpBgpglobalbaseConfederationResponse struct {
	FrinxOpenconfigNetworkInstanceconfederation *FrinxOpenconfigBgpBgpglobalbaseConfederation `json:"frinx-openconfig-network-instance:confederation,omitempty"`
}
