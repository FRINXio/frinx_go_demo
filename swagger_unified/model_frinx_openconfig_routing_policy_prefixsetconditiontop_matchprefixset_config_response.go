...
// frinx.openconfig.routing.policy.prefixsetconditiontop.matchprefixset.Config.response
type FrinxOpenconfigRoutingPolicyPrefixsetconditiontopMatchprefixsetConfigResponse struct {
	FrinxOpenconfigRoutingPolicyconfig *FrinxOpenconfigRoutingPolicyPrefixsetconditiontopMatchprefixsetConfig `json:"frinx-openconfig-routing-policy:config,omitempty"`
}
