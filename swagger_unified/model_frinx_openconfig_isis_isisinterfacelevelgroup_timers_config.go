...
// Optional[This container defines ISIS interface hello-timers configuration.] REF:Optional.empty
type FrinxOpenconfigIsisIsisinterfacelevelgroupTimersConfig struct {
	// Optional[ISIS hello-multiplier value.] REF:Optional.empty
	HelloMultiplier int32 `json:"hello-multiplier,omitempty"`
	// Optional[ISIS hello-interval value.] REF:Optional.empty
