...
// Optional[A match rule for the policy. In the case that multiple criteria are specified within a single ] REF:Optional.empty
type FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRule struct {
	// Optional[Top level container for IPv4 match field data] REF:Optional.empty
	Ipv4 *FrinxOpenconfigPacketMatchIpv4protocolfieldstopIpv4 `json:"ipv4,omitempty"`
	// Optional[Top-level container for IPv6 match field data] REF:Optional.empty
	Ipv6 *FrinxOpenconfigPacketMatchIpv6protocolfieldstopIpv6 `json:"ipv6,omitempty"`
	// Optional[Ethernet header fields] REF:Optional.empty
	L2 *FrinxOpenconfigPacketMatchEthernetheadertopL2 `json:"l2,omitempty"`
	// Optional[A unique sequence identifier for the match rule.] REF:Optional.empty
	SequenceId int64 `json:"sequence-id,omitempty"`
	// Optional[The forwarding policy action to be applied for packets matching the rule.] REF:Optional.empty
	Action *FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRuleAction `json:"action,omitempty"`
	// Optional[Transport fields container] REF:Optional.empty
	Transport *FrinxOpenconfigPacketMatchTransportfieldstopTransport `json:"transport,omitempty"`
	// Optional[Configuration parameters relating to the match rule.] REF:Optional.empty
	Config *FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRuleConfig `json:"config,omitempty"`
}
