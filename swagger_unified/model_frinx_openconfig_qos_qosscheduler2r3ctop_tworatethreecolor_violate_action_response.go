...
// frinx.openconfig.qos.qosscheduler2r3ctop.tworatethreecolor.ViolateAction.response
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorViolateActionResponse struct {
	FrinxOpenconfigQosviolateAction *FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorViolateAction `json:"frinx-openconfig-qos:violate-action,omitempty"`
}
