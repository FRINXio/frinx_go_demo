...
// frinx.openconfig.acl.acl.aclsets.aclset.aclentries.aclentry.Ipv4.response
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryIpv4Response struct {
	FrinxOpenconfigAclipv4 *FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryIpv4 `json:"frinx-openconfig-acl:ipv4,omitempty"`
}
