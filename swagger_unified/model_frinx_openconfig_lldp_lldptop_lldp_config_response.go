...
// frinx.openconfig.lldp.lldptop.lldp.Config.response
type FrinxOpenconfigLldpLldptopLldpConfigResponse struct {
	FrinxOpenconfigLldpconfig *FrinxOpenconfigLldpLldptopLldpConfig `json:"frinx-openconfig-lldp:config,omitempty"`
}
