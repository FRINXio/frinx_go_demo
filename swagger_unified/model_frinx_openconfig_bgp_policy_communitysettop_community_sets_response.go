...
// frinx.openconfig.bgp.policy.communitysettop.CommunitySets.response
type FrinxOpenconfigBgpPolicyCommunitysettopCommunitySetsResponse struct {
	FrinxOpenconfigBgpPolicycommunitySets *FrinxOpenconfigBgpPolicyCommunitysettopCommunitySets `json:"frinx-openconfig-bgp-policy:community-sets,omitempty"`
}
