...
// frinx.openconfig.platform.platformcomponentpropertiestop.Properties.response
type FrinxOpenconfigPlatformPlatformcomponentpropertiestopPropertiesResponse struct {
	FrinxOpenconfigPlatformproperties *FrinxOpenconfigPlatformPlatformcomponentpropertiestopProperties `json:"frinx-openconfig-platform:properties,omitempty"`
}
