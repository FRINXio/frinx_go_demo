...
// frinx.openconfig.routing.policy.prefixsettop.prefixsets.PrefixSet.response
type FrinxOpenconfigRoutingPolicyPrefixsettopPrefixsetsPrefixSetResponse struct {
	FrinxOpenconfigRoutingPolicyprefixSet []FrinxOpenconfigRoutingPolicyPrefixsettopPrefixsetsPrefixSet `json:"frinx-openconfig-routing-policy:prefix-set,omitempty"`
}
