...
// frinx.openconfig.bgp.bgpcommonstructureneighborgrouploggingoptions.LoggingOptions.response
type FrinxOpenconfigBgpBgpcommonstructureneighborgrouploggingoptionsLoggingOptionsResponse struct {
	FrinxOpenconfigNetworkInstanceloggingOptions *FrinxOpenconfigBgpBgpcommonstructureneighborgrouploggingoptionsLoggingOptions `json:"frinx-openconfig-network-instance:logging-options,omitempty"`
}
