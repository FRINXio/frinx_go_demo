...
// frinx.openconfig.ospf.policy.ospfactions.ospfactions.SetMetric.response
type FrinxOpenconfigOspfPolicyOspfactionsOspfactionsSetMetricResponse struct {
	FrinxOpenconfigOspfPolicysetMetric *FrinxOpenconfigOspfPolicyOspfactionsOspfactionsSetMetric `json:"frinx-openconfig-ospf-policy:set-metric,omitempty"`
}
