...
type FrinxOpenconfigBgpBgppeergroupafisafilistAfisafiGracefulRestart struct {
	// Optional[Configuration options for BGP graceful-restart] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgppeergroupafisafilistAfisafiGracefulrestartConfig `json:"config,omitempty"`
}
