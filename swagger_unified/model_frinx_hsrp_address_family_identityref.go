...
type FrinxHsrpAddressFamilyIdentityref string

// List of frinx.hsrp.AddressFamilyIdentityref
const (
	FrinxHsrpAddressFamilyIdentityref_MPLS FrinxHsrpAddressFamilyIdentityref = "frinx-openconfig-types:MPLS"
	FrinxHsrpAddressFamilyIdentityref_IPV4 FrinxHsrpAddressFamilyIdentityref = "frinx-openconfig-types:IPV4"
	FrinxHsrpAddressFamilyIdentityref_IPV6 FrinxHsrpAddressFamilyIdentityref = "frinx-openconfig-types:IPV6"
	FrinxHsrpAddressFamilyIdentityref_ADDRESS_FAMILY FrinxHsrpAddressFamilyIdentityref = "frinx-openconfig-types:ADDRESS_FAMILY"
	FrinxHsrpAddressFamilyIdentityref_L2_ETHERNET FrinxHsrpAddressFamilyIdentityref = "frinx-openconfig-types:L2_ETHERNET"
)
