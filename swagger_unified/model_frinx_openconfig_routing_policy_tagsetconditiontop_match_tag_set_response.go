...
// frinx.openconfig.routing.policy.tagsetconditiontop.MatchTagSet.response
type FrinxOpenconfigRoutingPolicyTagsetconditiontopMatchTagSetResponse struct {
	FrinxOpenconfigRoutingPolicymatchTagSet *FrinxOpenconfigRoutingPolicyTagsetconditiontopMatchTagSet `json:"frinx-openconfig-routing-policy:match-tag-set,omitempty"`
}
