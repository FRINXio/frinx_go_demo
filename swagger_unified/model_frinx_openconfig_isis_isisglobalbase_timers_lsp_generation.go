...
type FrinxOpenconfigIsisIsisglobalbaseTimersLspGeneration struct {
	// Optional[This container defines ISIS LSP Generation timers configuration.] REF:Optional.empty
	Config *FrinxOpenconfigIsisIsisglobalbaseTimersLspgenerationConfig `json:"config,omitempty"`
}
