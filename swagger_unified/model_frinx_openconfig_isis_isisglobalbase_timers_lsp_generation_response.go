...
// frinx.openconfig.isis.isisglobalbase.timers.LspGeneration.response
type FrinxOpenconfigIsisIsisglobalbaseTimersLspGenerationResponse struct {
	FrinxOpenconfigNetworkInstancelspGeneration *FrinxOpenconfigIsisIsisglobalbaseTimersLspGeneration `json:"frinx-openconfig-network-instance:lsp-generation,omitempty"`
}
