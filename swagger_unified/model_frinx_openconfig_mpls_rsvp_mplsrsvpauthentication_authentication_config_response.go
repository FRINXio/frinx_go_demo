...
// frinx.openconfig.mpls.rsvp.mplsrsvpauthentication.authentication.Config.response
type FrinxOpenconfigMplsRsvpMplsrsvpauthenticationAuthenticationConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsRsvpMplsrsvpauthenticationAuthenticationConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
