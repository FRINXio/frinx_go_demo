...
// frinx.openconfig.packet.match.mplsheadertop.Mpls.response
type FrinxOpenconfigPacketMatchMplsheadertopMplsResponse struct {
	FrinxOpenconfigQosmpls *FrinxOpenconfigPacketMatchMplsheadertopMpls `json:"frinx-openconfig-qos:mpls,omitempty"`
}
