...
// Optional[Configuration data for each property] REF:Optional.empty
type FrinxOpenconfigPlatformPlatformcomponentpropertiestopPropertiesPropertyConfig struct {
	// Optional[System-supplied name of the property -- this is typically non-configurable] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Property values can take on a variety of types.  Signed and unsigned integer types may be provided in smaller sizes, e.g., int8, uint16, etc.] REF:Optional.empty
