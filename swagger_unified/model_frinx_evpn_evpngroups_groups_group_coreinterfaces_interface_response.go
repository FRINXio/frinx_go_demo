...
// frinx.evpn.evpngroups.groups.group.coreinterfaces.Interface.response
type FrinxEvpnEvpngroupsGroupsGroupCoreinterfacesInterfaceResponse struct {
	FrinxEvpninterface []FrinxEvpnEvpngroupsGroupsGroupCoreinterfacesInterface `json:"frinx-evpn:interface,omitempty"`
}
