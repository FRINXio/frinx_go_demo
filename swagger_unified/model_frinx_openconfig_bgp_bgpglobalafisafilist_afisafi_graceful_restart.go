...
type FrinxOpenconfigBgpBgpglobalafisafilistAfisafiGracefulRestart struct {
	// Optional[Configuration options for BGP graceful-restart] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpglobalafisafilistAfisafiGracefulrestartConfig `json:"config,omitempty"`
}
