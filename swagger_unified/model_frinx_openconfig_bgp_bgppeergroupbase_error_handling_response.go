...
// frinx.openconfig.bgp.bgppeergroupbase.ErrorHandling.response
type FrinxOpenconfigBgpBgppeergroupbaseErrorHandlingResponse struct {
	FrinxOpenconfigNetworkInstanceerrorHandling *FrinxOpenconfigBgpBgppeergroupbaseErrorHandling `json:"frinx-openconfig-network-instance:error-handling,omitempty"`
}
