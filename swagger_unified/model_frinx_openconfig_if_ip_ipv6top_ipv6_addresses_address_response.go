...
// frinx.openconfig.if.ip.ipv6top.ipv6.addresses.Address.response
type FrinxOpenconfigIfIpIpv6topIpv6AddressesAddressResponse struct {
	FrinxOpenconfigIfIpaddress []FrinxOpenconfigIfIpIpv6topIpv6AddressesAddress `json:"frinx-openconfig-if-ip:address,omitempty"`
}
