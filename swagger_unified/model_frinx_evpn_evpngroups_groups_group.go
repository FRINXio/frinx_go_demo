...
// Optional[List of EVPN groups, keyed by group id] REF:Optional.empty
type FrinxEvpnEvpngroupsGroupsGroup struct {
	// Optional[References the configured group id for this EVPN group] REF:Optional.empty
	Id int64 `json:"id,omitempty"`
	// Optional[Configuration data for the EVPN group] REF:Optional.empty
	Config *FrinxEvpnEvpngroupsGroupsGroupConfig `json:"config,omitempty"`
	// Optional[Core interfaces of EVPN group] REF:Optional.empty
	CoreInterfaces *FrinxEvpnEvpngroupsGroupsGroupCoreInterfaces `json:"core-interfaces,omitempty"`
}
