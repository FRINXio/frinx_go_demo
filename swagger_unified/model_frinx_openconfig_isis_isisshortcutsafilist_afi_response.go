...
// frinx.openconfig.isis.isisshortcutsafilist.Afi.response
type FrinxOpenconfigIsisIsisshortcutsafilistAfiResponse struct {
	FrinxOpenconfigNetworkInstanceafi []FrinxOpenconfigIsisIsisshortcutsafilistAfi `json:"frinx-openconfig-network-instance:afi,omitempty"`
}
