...
// frinx.openconfig.platform.platformanchorstop.PowerSupply.response
type FrinxOpenconfigPlatformPlatformanchorstopPowerSupplyResponse struct {
	FrinxOpenconfigPlatformpowerSupply *FrinxOpenconfigPlatformPlatformanchorstopPowerSupply `json:"frinx-openconfig-platform:power-supply,omitempty"`
}
