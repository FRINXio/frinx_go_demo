...
// frinx.openconfig.isis.isisinterfacegroup.Levels.response
type FrinxOpenconfigIsisIsisinterfacegroupLevelsResponse struct {
	FrinxOpenconfigNetworkInstancelevels *FrinxOpenconfigIsisIsisinterfacegroupLevels `json:"frinx-openconfig-network-instance:levels,omitempty"`
}
