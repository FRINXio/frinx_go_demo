...
// frinx.openconfig.platform.Components.response
type FrinxOpenconfigPlatformComponentsResponse struct {
	FrinxOpenconfigPlatformcomponents *FrinxOpenconfigPlatformComponents `json:"frinx-openconfig-platform:components,omitempty"`
}
