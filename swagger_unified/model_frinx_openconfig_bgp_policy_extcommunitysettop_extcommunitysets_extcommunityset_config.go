...
// Optional[Configuration data for extended BGP community sets] REF:Optional.empty
type FrinxOpenconfigBgpPolicyExtcommunitysettopExtcommunitysetsExtcommunitysetConfig struct {
	// Optional[members of the extended community set] REF:Optional.empty
	ExtCommunityMember []string `json:"ext-community-member,omitempty"`
	// Optional[name / label of the extended community set -- this is used to reference the set in match conditions] REF:Optional.empty
	ExtCommunitySetName string `json:"ext-community-set-name,omitempty"`
}
