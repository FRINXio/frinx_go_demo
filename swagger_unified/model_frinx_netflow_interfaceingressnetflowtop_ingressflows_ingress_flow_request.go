...
// frinx.netflow.interfaceingressnetflowtop.ingressflows.IngressFlow.request
type FrinxNetflowInterfaceingressnetflowtopIngressflowsIngressFlowRequest struct {
