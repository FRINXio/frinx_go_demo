...
// frinx.openconfig.routing.policy.routingpolicy.policydefinitions.policydefinition.statements.Statement.response
type FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicydefinitionStatementsStatementResponse struct {
	FrinxOpenconfigRoutingPolicystatement []FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicydefinitionStatementsStatement `json:"frinx-openconfig-routing-policy:statement,omitempty"`
}
