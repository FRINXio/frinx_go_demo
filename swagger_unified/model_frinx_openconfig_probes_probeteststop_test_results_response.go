...
// frinx.openconfig.probes.probeteststop.test.Results.response
type FrinxOpenconfigProbesProbeteststopTestResultsResponse struct {
	FrinxOpenconfigProbesresults *FrinxOpenconfigProbesProbeteststopTestResults `json:"frinx-openconfig-probes:results,omitempty"`
}
