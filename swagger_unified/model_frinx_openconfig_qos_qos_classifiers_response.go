...
// frinx.openconfig.qos.qos.Classifiers.response
type FrinxOpenconfigQosQosClassifiersResponse struct {
	FrinxOpenconfigQosclassifiers *FrinxOpenconfigQosQosClassifiers `json:"frinx-openconfig-qos:classifiers,omitempty"`
}
