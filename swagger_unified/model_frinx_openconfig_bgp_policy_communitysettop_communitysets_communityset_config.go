...
// Optional[Configuration data for BGP community sets] REF:Optional.empty
type FrinxOpenconfigBgpPolicyCommunitysettopCommunitysetsCommunitysetConfig struct {
	// Optional[name / label of the community set -- this is used to reference the set in match conditions] REF:Optional.empty
	CommunitySetName string `json:"community-set-name,omitempty"`
	// Optional[members of the community set] REF:Optional.empty
	CommunityMember []string `json:"community-member,omitempty"`
}
