...
// frinx.openconfig.qos.qosforwardinggrouptop.forwardinggroups.forwardinggroup.Config.response
type FrinxOpenconfigQosQosforwardinggrouptopForwardinggroupsForwardinggroupConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosforwardinggrouptopForwardinggroupsForwardinggroupConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
