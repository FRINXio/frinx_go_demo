...
// frinx.openconfig.acl.acl.aclsets.aclset.aclentries.aclentry.ipv6.Config.response
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryIpv6ConfigResponse struct {
	FrinxOpenconfigAclconfig *FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryIpv6Config `json:"frinx-openconfig-acl:config,omitempty"`
}
