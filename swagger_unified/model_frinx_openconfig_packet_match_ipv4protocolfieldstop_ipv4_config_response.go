...
// frinx.openconfig.packet.match.ipv4protocolfieldstop.ipv4.Config.response
type FrinxOpenconfigPacketMatchIpv4protocolfieldstopIpv4ConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigPacketMatchIpv4protocolfieldstopIpv4Config `json:"frinx-openconfig-network-instance:config,omitempty"`
}
