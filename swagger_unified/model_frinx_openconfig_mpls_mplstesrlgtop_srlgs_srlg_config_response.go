...
// frinx.openconfig.mpls.mplstesrlgtop.srlgs.srlg.Config.response
type FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
