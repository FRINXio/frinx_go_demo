...
type FrinxOpenconfigMplsLdpMplsldpgracefulrestartGracefulRestart struct {
	// Optional[LDP graceful-restart configuration attributes.] REF:Optional.empty
	Config *FrinxOpenconfigMplsLdpMplsldpgracefulrestartGracefulrestartConfig `json:"config,omitempty"`
}
