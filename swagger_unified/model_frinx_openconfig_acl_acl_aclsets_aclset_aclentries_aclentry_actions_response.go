...
// frinx.openconfig.acl.acl.aclsets.aclset.aclentries.aclentry.Actions.response
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryActionsResponse struct {
	FrinxOpenconfigAclactions *FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryActions `json:"frinx-openconfig-acl:actions,omitempty"`
}
