...
// frinx.openconfig.bfd.bfdinterfacepeerstructural.Peers.response
type FrinxOpenconfigBfdBfdinterfacepeerstructuralPeersResponse struct {
	FrinxOpenconfigBfdpeers *FrinxOpenconfigBfdBfdinterfacepeerstructuralPeers `json:"frinx-openconfig-bfd:peers,omitempty"`
}
