...
// frinx.openconfig.routing.policy.routingpolicy.policydefinitions.policydefinition.statements.statement.Conditions.response
type FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicydefinitionStatementsStatementConditionsResponse struct {
	FrinxOpenconfigRoutingPolicyconditions *FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicydefinitionStatementsStatementConditions `json:"frinx-openconfig-routing-policy:conditions,omitempty"`
}
