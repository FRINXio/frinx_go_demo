...
type FrinxOpenconfigBgpBgpcommonstructureneighborgroupaspathoptionsAsPathOptions struct {
	// Optional[Configuration parameters relating to AS_PATH manipulation for the BGP peer or group] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpcommonstructureneighborgroupaspathoptionsAspathoptionsConfig `json:"config,omitempty"`
}
