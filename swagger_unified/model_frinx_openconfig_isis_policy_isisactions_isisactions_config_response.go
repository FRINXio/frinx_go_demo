...
// frinx.openconfig.isis.policy.isisactions.isisactions.Config.response
type FrinxOpenconfigIsisPolicyIsisactionsIsisactionsConfigResponse struct {
	FrinxOpenconfigIsisPolicyconfig *FrinxOpenconfigIsisPolicyIsisactionsIsisactionsConfig `json:"frinx-openconfig-isis-policy:config,omitempty"`
}
