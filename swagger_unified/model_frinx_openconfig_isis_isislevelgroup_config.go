...
type FrinxOpenconfigIsisIsislevelgroupConfig struct {
	...
	// Optional[ISIS level number (level-1, level-2).] REF:Optional.empty
	LevelNumber int32 `json:"level-number,omitempty"`
	// Optional[ISIS metric style types(narrow, wide).] REF:Optional.empty
	MetricStyle *FrinxOpenconfigIsisTypesMetricStyle `json:"metric-style,omitempty"`
