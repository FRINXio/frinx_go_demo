...
// frinx.openconfig.acl.acl.aclsets.aclset.aclentries.aclentry.actions.Config.response
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryActionsConfigResponse struct {
	FrinxOpenconfigAclconfig *FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryActionsConfig `json:"frinx-openconfig-acl:config,omitempty"`
}
