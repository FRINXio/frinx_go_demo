...
// frinx.openconfig.isis.isisinterfacelevelgroup.AfiSafi.response
type FrinxOpenconfigIsisIsisinterfacelevelgroupAfiSafiResponse struct {
	FrinxOpenconfigNetworkInstanceafiSafi *FrinxOpenconfigIsisIsisinterfacelevelgroupAfiSafi `json:"frinx-openconfig-network-instance:afi-safi,omitempty"`
}
