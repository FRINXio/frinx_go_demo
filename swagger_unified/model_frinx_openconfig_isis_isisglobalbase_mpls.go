...
type FrinxOpenconfigIsisIsisglobalbaseMpls struct {
	// Optional[Configuration and operational state relating to synchronisation between the LDP and IS-IS] REF:Optional.empty
	IgpLdpSync *FrinxOpenconfigIsisIsisglobalbaseMplsIgpLdpSync `json:"igp-ldp-sync,omitempty"`
}
