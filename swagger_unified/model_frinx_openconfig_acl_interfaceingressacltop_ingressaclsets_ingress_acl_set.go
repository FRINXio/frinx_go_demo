...
// Optional[List of ingress ACLs on the interface] REF:Optional.empty
type FrinxOpenconfigAclInterfaceingressacltopIngressaclsetsIngressAclSet struct {
	// Optional[Reference to set name list key] REF:Optional.empty
	SetName string `json:"set-name,omitempty"`
	// Optional[Reference to type list key] REF:Optional.empty
	Type_ string `json:"type,omitempty"`
	// Optional[Configuration data ] REF:Optional.empty
	Config *FrinxOpenconfigAclInterfaceingressacltopIngressaclsetsIngressaclsetConfig `json:"config,omitempty"`
}
