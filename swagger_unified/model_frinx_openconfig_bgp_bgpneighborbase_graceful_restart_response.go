...
// frinx.openconfig.bgp.bgpneighborbase.GracefulRestart.response
type FrinxOpenconfigBgpBgpneighborbaseGracefulRestartResponse struct {
	FrinxOpenconfigNetworkInstancegracefulRestart *FrinxOpenconfigBgpBgpneighborbaseGracefulRestart `json:"frinx-openconfig-network-instance:graceful-restart,omitempty"`
}
