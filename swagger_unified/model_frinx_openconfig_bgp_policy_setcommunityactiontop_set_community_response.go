...
// frinx.openconfig.bgp.policy.setcommunityactiontop.SetCommunity.response
type FrinxOpenconfigBgpPolicySetcommunityactiontopSetCommunityResponse struct {
	FrinxOpenconfigBgpPolicysetCommunity *FrinxOpenconfigBgpPolicySetcommunityactiontopSetCommunity `json:"frinx-openconfig-bgp-policy:set-community,omitempty"`
}
