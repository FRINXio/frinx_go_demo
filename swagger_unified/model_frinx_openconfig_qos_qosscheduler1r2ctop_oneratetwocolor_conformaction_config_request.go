...
// frinx.openconfig.qos.qosscheduler1r2ctop.oneratetwocolor.conformaction.Config.request
type FrinxOpenconfigQosQosscheduler1r2ctopOneratetwocolorConformactionConfigRequest struct {
