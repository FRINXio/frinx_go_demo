...
type FrinxOpenconfigPlatformPlatformanchorstopFabric struct {
	// Optional[Configuration data for fabric components] REF:Optional.empty
	Config *FrinxOpenconfigPlatformPlatformanchorstopFabricConfig `json:"config,omitempty"`
}
