...
// frinx.openconfig.bgp.bgpcommonstructureneighborgrouploggingoptions.loggingoptions.Config.response
type FrinxOpenconfigBgpBgpcommonstructureneighborgrouploggingoptionsLoggingoptionsConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpcommonstructureneighborgrouploggingoptionsLoggingoptionsConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
