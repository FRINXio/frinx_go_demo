...
// frinx.openconfig.qos.qos.classifiers.classifier.terms.term.conditions.Ipv4.response
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv4Response struct {
	FrinxOpenconfigQosipv4 *FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv4 `json:"frinx-openconfig-qos:ipv4,omitempty"`
}
