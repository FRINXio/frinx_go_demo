...
type FrinxOpenconfigInterfacesInterfacephysholdtimetopHoldtimeConfigResponse1 struct {
	FrinxCiscoIfExtensionconfig *FrinxOpenconfigInterfacesInterfacephysholdtimetopHoldtimeConfig `json:"frinx-cisco-if-extension:config,omitempty"`
}
