...
// frinx.openconfig.acl.acl.aclsets.aclset.aclentries.aclentry.Config.response
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryConfigResponse struct {
	FrinxOpenconfigAclconfig *FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryConfig `json:"frinx-openconfig-acl:config,omitempty"`
}
