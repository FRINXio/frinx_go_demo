...
// Optional[Configuration parameters for statistics] REF:Optional.empty
type FrinxCiscoIfExtensionStatisticstopStatisticsConfig struct {
	// Optional[Specify interval for load calculation for an interface. 0 disables load calculation, otherwise some multiple of 30 between 30 and 600.] REF:Optional.empty
	LoadInterval int64 `json:"load-interval,omitempty"`
}
