...
type FrinxOpenconfigInterfacesInterfacerefInterfacerefConfigResponse struct {
	FrinxLoggingconfig *FrinxOpenconfigInterfacesInterfacerefInterfacerefConfig `json:"frinx-logging:config,omitempty"`
}
