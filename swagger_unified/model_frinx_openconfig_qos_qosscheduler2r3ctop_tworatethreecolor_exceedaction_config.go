...
// Optional[Configuration parameters relating to the action applied to exceeding packets.] REF:Optional.empty
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorExceedactionConfig struct {
