...
type FrinxOpenconfigMplsRsvpMplsrsvpgracefulrestartGracefulrestartConfig struct {
	// Optional[Graceful restart time (seconds).] REF:Optional[RFC 5495: Description of the Resource Reservation Protocol - Traffic-Engineered (RSVP-TE) Graceful Restart Procedures]
	RestartTime int64 `json:"restart-time,omitempty"`
	// Optional[Enables graceful restart on the node.] REF:Optional.empty
	Enable bool `json:"enable,omitempty"`
	// Optional[RSVP state recovery time] REF:Optional.empty
	RecoveryTime int64 `json:"recovery-time,omitempty"`
}
