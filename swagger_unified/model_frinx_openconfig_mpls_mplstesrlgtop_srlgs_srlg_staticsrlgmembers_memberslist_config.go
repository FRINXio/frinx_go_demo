...
type FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgStaticsrlgmembersMemberslistConfig struct {
	// Optional[IP address of the z-side of the SRLG link] REF:Optional.empty
	ToAddress string `json:"to-address,omitempty"`
	// Optional[IP address of the a-side of the SRLG link] REF:Optional.empty
