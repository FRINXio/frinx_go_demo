...
// frinx.openconfig.ospfv2.ospfv2areastructure.virtuallinks.virtuallink.Config.response
type FrinxOpenconfigOspfv2Ospfv2areastructureVirtuallinksVirtuallinkConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigOspfv2Ospfv2areastructureVirtuallinksVirtuallinkConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
