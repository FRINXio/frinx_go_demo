...
type FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref string

// List of frinx.openconfig.routing.policy.InstallProtocolEqIdentityref
const (
	FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref_OSPF FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref = "frinx-openconfig-policy-types:OSPF"
	FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref_DIRECTLY_CONNECTED FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref = "frinx-openconfig-policy-types:DIRECTLY_CONNECTED"
	FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref_OSPF3 FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref = "frinx-openconfig-policy-types:OSPF3"
	FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref_STATIC FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref = "frinx-openconfig-policy-types:STATIC"
	FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref_INSTALL_PROTOCOL_TYPE FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref = "frinx-openconfig-policy-types:INSTALL_PROTOCOL_TYPE"
	FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref_ISIS FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref = "frinx-openconfig-policy-types:ISIS"
	FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref_BGP FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref = "frinx-openconfig-policy-types:BGP"
	FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref_LOCAL_AGGREGATE FrinxOpenconfigRoutingPolicyInstallProtocolEqIdentityref = "frinx-openconfig-policy-types:LOCAL_AGGREGATE"
)
