...
// Optional[Top-level container for all routing policy configuration] REF:Optional.empty
type FrinxOpenconfigRoutingPolicyRoutingPolicy struct {
	// Optional[Enclosing container for the list of top-level policy  definitions] REF:Optional.empty
	PolicyDefinitions *FrinxOpenconfigRoutingPolicyRoutingpolicyPolicyDefinitions `json:"policy-definitions,omitempty"`
	// Optional[Predefined sets of attributes used in policy match statements] REF:Optional.empty
	DefinedSets *FrinxOpenconfigRoutingPolicyRoutingpolicyDefinedSets `json:"defined-sets,omitempty"`
}
