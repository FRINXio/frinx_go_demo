...
// Optional[Configuration parameters related to bandwidth on TE tunnels:] REF:Optional.empty
type FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthConfig struct {
	// Optional[The method used for settign the bandwidth, either explicitly specified or configured] REF:Optional.empty
	SpecificationType *FrinxOpenconfigMplsTeBandwidthType `json:"specification-type,omitempty"`
	// Optional[set bandwidth explicitly, e.g., using offline calculation] REF:Optional.empty
	SetBandwidth int32 `json:"set-bandwidth,omitempty"`
}
