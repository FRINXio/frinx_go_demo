...
type FrinxOpenconfigQosTypeIdentityref string

// List of frinx.openconfig.qos.TypeIdentityref
const (
	FrinxOpenconfigQosTypeIdentityref_ONE_RATE_TWO_COLOR FrinxOpenconfigQosTypeIdentityref = "frinx-openconfig-qos-types:ONE_RATE_TWO_COLOR"
	FrinxOpenconfigQosTypeIdentityref_QOS_SCHEDULER_TYPE FrinxOpenconfigQosTypeIdentityref = "frinx-openconfig-qos-types:QOS_SCHEDULER_TYPE"
	FrinxOpenconfigQosTypeIdentityref_TWO_RATE_THREE_COLOR FrinxOpenconfigQosTypeIdentityref = "frinx-openconfig-qos-types:TWO_RATE_THREE_COLOR"
)
