...
type FrinxCiscoIfExtensionIpv4verifyIpv4 struct {
	// Optional.empty REF:Optional.empty
	AllowConfig []FrinxCiscoIfExtensionAllowConfigIdentityref `json:"allow-config,omitempty"`
	// Optional.empty REF:Optional.empty
	RpfCheck *FrinxCiscoIfExtensionRpfCheckEnumeration `json:"rpf-check,omitempty"`
}
