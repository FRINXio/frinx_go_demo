...
// Optional[Configuration parameters relating to the action applied to violating packets.] REF:Optional.empty
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorViolateactionConfig struct {
	// Optional[If set to true, packets within this context are dropped.] REF:Optional.empty
