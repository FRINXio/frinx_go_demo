...
// frinx.openconfig.isis.policy.isismatchconditions.isisconditions.Config.request
type FrinxOpenconfigIsisPolicyIsismatchconditionsIsisconditionsConfigRequest struct {
