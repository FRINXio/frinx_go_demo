...
// Optional[The L2, L3, or L2+L3 forwarding instances that are configured on the local system] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkInstances struct {
	// Optional[Network instances configured on the local system] REF:Optional.empty
	NetworkInstance []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkInstance `json:"network-instance,omitempty"`
}
