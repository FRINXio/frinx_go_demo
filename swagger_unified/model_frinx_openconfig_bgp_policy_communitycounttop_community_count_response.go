...
// frinx.openconfig.bgp.policy.communitycounttop.CommunityCount.response
type FrinxOpenconfigBgpPolicyCommunitycounttopCommunityCountResponse struct {
	FrinxOpenconfigBgpPolicycommunityCount *FrinxOpenconfigBgpPolicyCommunitycounttopCommunityCount `json:"frinx-openconfig-bgp-policy:community-count,omitempty"`
}
