...
// frinx.openconfig.bgp.policy.matchextcommunitytop.matchextcommunityset.Config.response
type FrinxOpenconfigBgpPolicyMatchextcommunitytopMatchextcommunitysetConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicyMatchextcommunitytopMatchextcommunitysetConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
