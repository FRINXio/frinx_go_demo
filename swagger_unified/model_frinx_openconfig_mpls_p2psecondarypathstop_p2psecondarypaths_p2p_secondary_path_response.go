...
// frinx.openconfig.mpls.p2psecondarypathstop.p2psecondarypaths.P2pSecondaryPath.response
type FrinxOpenconfigMplsP2psecondarypathstopP2psecondarypathsP2pSecondaryPathResponse struct {
	FrinxOpenconfigNetworkInstancep2pSecondaryPath []FrinxOpenconfigMplsP2psecondarypathstopP2psecondarypathsP2pSecondaryPath `json:"frinx-openconfig-network-instance:p2p-secondary-path,omitempty"`
}
