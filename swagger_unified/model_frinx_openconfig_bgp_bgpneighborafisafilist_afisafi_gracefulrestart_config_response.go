...
// frinx.openconfig.bgp.bgpneighborafisafilist.afisafi.gracefulrestart.Config.response
type FrinxOpenconfigBgpBgpneighborafisafilistAfisafiGracefulrestartConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpneighborafisafilistAfisafiGracefulrestartConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
