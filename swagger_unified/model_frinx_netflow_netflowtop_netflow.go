...
// Optional[Top level enclosing container for NetFlow model config and operational state data] REF:Optional.empty
type FrinxNetflowNetflowtopNetflow struct {
	// Optional[Global config data for NetFlow] REF:Optional.empty
	Config *FrinxNetflowNetflowtopNetflowConfig `json:"config,omitempty"`
	// Optional[Enclosing container for the list of interfaces on which NetFlow is set] REF:Optional.empty
	Interfaces *FrinxNetflowNetflowinterfacestopInterfaces `json:"interfaces,omitempty"`
}
