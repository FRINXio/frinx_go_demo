...
// frinx.openconfig.network.instance.networkinstancetop.networkinstances.networkinstance.Encapsulation.response
type FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceEncapsulationResponse struct {
	FrinxOpenconfigNetworkInstanceencapsulation *FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceEncapsulation `json:"frinx-openconfig-network-instance:encapsulation,omitempty"`
}
