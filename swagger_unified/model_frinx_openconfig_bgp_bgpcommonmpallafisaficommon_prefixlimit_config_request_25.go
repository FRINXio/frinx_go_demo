...
// frinx.openconfig.bgp.bgpcommonmpallafisaficommon.prefixlimit.Config.request
type FrinxOpenconfigBgpBgpcommonmpallafisaficommonPrefixlimitConfigRequest25 struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpcommonmpallafisaficommonPrefixlimitConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
