...
type FrinxNetflowInterfaceingressnetflowtopIngressflowsIngressflowConfig struct {
	// Optional[Flow monitor map name] REF:Optional.empty
	MonitorName string `json:"monitor-name,omitempty"`
	// Optional[NetFlow type] REF:Optional.empty
	NetflowType *FrinxNetflowNetflowTypeIdentityref `json:"netflow-type,omitempty"`
	// Optional[Sampler map name] REF:Optional.empty
	SamplerName string `json:"sampler-name,omitempty"`
}
