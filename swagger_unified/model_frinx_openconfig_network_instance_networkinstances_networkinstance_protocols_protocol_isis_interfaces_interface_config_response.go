...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.isis.interfaces.interface.Config.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsisInterfacesInterfaceConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsisInterfacesInterfaceConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
