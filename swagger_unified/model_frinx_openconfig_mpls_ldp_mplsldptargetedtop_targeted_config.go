...
type FrinxOpenconfigMplsLdpMplsldptargetedtopTargetedConfig struct {
	...
	// Optional[Enables or disables the acceptance of targeted LDP hello messages.] REF:Optional[RFC5036 LDP Specification]
	HelloAccept bool `json:"hello-accept,omitempty"`
