...
type FrinxOpenconfigPlatformTransceiverPorttransceivertopTransceiver struct {
	// Optional[Configuration data for client port transceivers] REF:Optional.empty
	Config *FrinxOpenconfigPlatformTransceiverPorttransceivertopTransceiverConfig `json:"config,omitempty"`
	// Optional[Enclosing container for client channels] REF:Optional.empty
	PhysicalChannels *FrinxOpenconfigPlatformTransceiverPhysicalchanneltopPhysicalChannels `json:"physical-channels,omitempty"`
}
