...
// Optional[Configuration parameters relating to LDP/IG synchronization.] REF:Optional.empty
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMplsIgpldpsyncConfig struct {
	// Optional[This leaf specifies a delay, expressed in units of milliseconds, between the LDP session to the IGP neighbor being established, and it being considered synchronized by the IGP.] REF:Optional.empty
	PostSessionUpDelay int64 `json:"post-session-up-delay,omitempty"`
	// Optional[When this leaf is set to true, do not utilise this link for forwarding via the IGP until such time as LDP adjacencies to the neighbor(s) over the link are established.] REF:Optional.empty
