...
type FrinxOpenconfigMplsP2psecondarypathstopP2pSecondaryPaths struct {
	// Optional[List of p2p primary paths for a tunnel] REF:Optional.empty
	P2pSecondaryPath []FrinxOpenconfigMplsP2psecondarypathstopP2psecondarypathsP2pSecondaryPath `json:"p2p-secondary-path,omitempty"`
}
