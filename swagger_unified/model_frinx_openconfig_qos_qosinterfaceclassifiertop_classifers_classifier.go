...
// Optional[A list of classifiers that should be applied to the interface] REF:Optional.empty
type FrinxOpenconfigQosQosinterfaceclassifiertopClassifersClassifier struct {
	// Optional[Reference to the classifier name.] REF:Optional.empty
	Type_ *FrinxOpenconfigQosTypeEnumeration `json:"type,omitempty"`
	// Optional[Enclosing container for the list of match terms in the classifier] REF:Optional.empty
	Terms *FrinxOpenconfigQosQosinterfaceclassifiermatchtopTerms `json:"terms,omitempty"`
	// Optional[Configuration parameters for the list of classifiers.] REF:Optional.empty
	Config *FrinxOpenconfigQosQosinterfaceclassifiertopClassifersClassifierConfig `json:"config,omitempty"`
}
