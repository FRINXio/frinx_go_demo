...
type FrinxOpenconfigMplsAdminStatusIdentityref string

// List of frinx.openconfig.mpls.AdminStatusIdentityref
const (
	FrinxOpenconfigMplsAdminStatusIdentityref_TUNNEL_ADMIN_STATUS FrinxOpenconfigMplsAdminStatusIdentityref = "frinx-openconfig-mpls-types:TUNNEL_ADMIN_STATUS"
	FrinxOpenconfigMplsAdminStatusIdentityref_ADMIN_UP FrinxOpenconfigMplsAdminStatusIdentityref = "frinx-openconfig-mpls-types:ADMIN_UP"
	FrinxOpenconfigMplsAdminStatusIdentityref_ADMIN_DOWN FrinxOpenconfigMplsAdminStatusIdentityref = "frinx-openconfig-mpls-types:ADMIN_DOWN"
)
