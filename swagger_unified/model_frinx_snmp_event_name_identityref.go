...
type FrinxSnmpEventNameIdentityref string

// List of frinx.snmp.EventNameIdentityref
const (
	FrinxSnmpEventNameIdentityref_EVENT_TYPE FrinxSnmpEventNameIdentityref = "frinx-event-types:EVENT_TYPE"
	FrinxSnmpEventNameIdentityref_LINK_UP_DOWN FrinxSnmpEventNameIdentityref = "frinx-event-types:LINK_UP_DOWN"
)
