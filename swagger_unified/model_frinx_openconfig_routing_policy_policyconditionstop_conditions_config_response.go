...
// frinx.openconfig.routing.policy.policyconditionstop.conditions.Config.response
type FrinxOpenconfigRoutingPolicyPolicyconditionstopConditionsConfigResponse struct {
	FrinxOpenconfigRoutingPolicyconfig *FrinxOpenconfigRoutingPolicyPolicyconditionstopConditionsConfig `json:"frinx-openconfig-routing-policy:config,omitempty"`
}
