...
// frinx.openconfig.network.instance.networkinstances.networkinstance.Mpls.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsResponse struct {
	FrinxOpenconfigNetworkInstancempls *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMpls `json:"frinx-openconfig-network-instance:mpls,omitempty"`
}
