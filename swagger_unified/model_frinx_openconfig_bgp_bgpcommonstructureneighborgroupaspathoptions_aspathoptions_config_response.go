...
// frinx.openconfig.bgp.bgpcommonstructureneighborgroupaspathoptions.aspathoptions.Config.response
type FrinxOpenconfigBgpBgpcommonstructureneighborgroupaspathoptionsAspathoptionsConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpcommonstructureneighborgroupaspathoptionsAspathoptionsConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
