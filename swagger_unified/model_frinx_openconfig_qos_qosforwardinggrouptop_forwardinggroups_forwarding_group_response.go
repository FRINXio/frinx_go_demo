...
// frinx.openconfig.qos.qosforwardinggrouptop.forwardinggroups.ForwardingGroup.response
type FrinxOpenconfigQosQosforwardinggrouptopForwardinggroupsForwardingGroupResponse struct {
	FrinxOpenconfigQosforwardingGroup []FrinxOpenconfigQosQosforwardinggrouptopForwardinggroupsForwardingGroup `json:"frinx-openconfig-qos:forwarding-group,omitempty"`
}
