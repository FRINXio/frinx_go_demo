...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpNeighborsNeighborAfisafisAfiSafi struct {
	...
	GracefulRestart *FrinxOpenconfigBgpBgpneighborafisafilistAfisafiGracefulRestart `json:"graceful-restart,omitempty"`
	...
	Config *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolBgpNeighborsNeighborAfisafisAfisafiConfig `json:"config,omitempty"`
}
