...
// Optional[Top-level container for QoS data] REF:Optional.empty
type FrinxOpenconfigQosQos struct {
	// Optional[Enclosing container for the list of configured scheduler policies.] REF:Optional.empty
	SchedulerPolicies *FrinxOpenconfigQosQosSchedulerPolicies `json:"scheduler-policies,omitempty"`
	// Optional[Enclosing container for the list of interface references] REF:Optional.empty
	Interfaces *FrinxOpenconfigQosQosinterfacestopInterfaces `json:"interfaces,omitempty"`
	// Optional[Enclosing container for the list of queues] REF:Optional.empty
	Queues *FrinxOpenconfigQosQosqueuetopQueues `json:"queues,omitempty"`
	// Optional[Enclosing container for QoS classifiers] REF:Optional.empty
	Classifiers *FrinxOpenconfigQosQosClassifiers `json:"classifiers,omitempty"`
	// Optional[Enclosing container for list of forwarding groups] REF:Optional.empty
	ForwardingGroups *FrinxOpenconfigQosQosforwardinggrouptopForwardingGroups `json:"forwarding-groups,omitempty"`
	// Optional[Configuration data for global QoS] REF:Optional.empty
	Config *FrinxOpenconfigQosQostopQosConfig `json:"config,omitempty"`
}
