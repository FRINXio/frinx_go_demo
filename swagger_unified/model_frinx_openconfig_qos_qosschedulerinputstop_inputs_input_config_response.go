...
// frinx.openconfig.qos.qosschedulerinputstop.inputs.input.Config.response
type FrinxOpenconfigQosQosschedulerinputstopInputsInputConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosschedulerinputstopInputsInputConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
