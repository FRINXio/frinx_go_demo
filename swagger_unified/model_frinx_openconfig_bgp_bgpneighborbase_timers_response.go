...
// frinx.openconfig.bgp.bgpneighborbase.Timers.response
type FrinxOpenconfigBgpBgpneighborbaseTimersResponse struct {
	FrinxOpenconfigNetworkInstancetimers *FrinxOpenconfigBgpBgpneighborbaseTimers `json:"frinx-openconfig-network-instance:timers,omitempty"`
}
