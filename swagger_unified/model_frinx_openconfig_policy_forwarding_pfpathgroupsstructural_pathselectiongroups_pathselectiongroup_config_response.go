...
// frinx.openconfig.policy.forwarding.pfpathgroupsstructural.pathselectiongroups.pathselectiongroup.Config.response
type FrinxOpenconfigPolicyForwardingPfpathgroupsstructuralPathselectiongroupsPathselectiongroupConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigPolicyForwardingPfpathgroupsstructuralPathselectiongroupsPathselectiongroupConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
