...
type FrinxEvpnEvpninterfacesInterfacesInterfaceEthernetsegmentConfig struct {
	// Optional[Identifier of ethernet segment.] REF:Optional.empty
	Identifier string `json:"identifier,omitempty"`
	// Optional[BGP route target of ethernet segment] REF:Optional.empty
	BgpRouteTarget string `json:"bgp-route-target,omitempty"`
	// Optional[Load balance mode of ethernet segment] REF:Optional.empty
	LoadBalancingMode *FrinxEvpnLoadBalancingModeIdentityref `json:"load-balancing-mode,omitempty"`
}
