...
// frinx.openconfig.if.ip.ext.ipv6autoconftop.autoconf.Config.response
type FrinxOpenconfigIfIpExtIpv6autoconftopAutoconfConfigResponse struct {
	FrinxOpenconfigIfIpExtconfig *FrinxOpenconfigIfIpExtIpv6autoconftopAutoconfConfig `json:"frinx-openconfig-if-ip-ext:config,omitempty"`
}
