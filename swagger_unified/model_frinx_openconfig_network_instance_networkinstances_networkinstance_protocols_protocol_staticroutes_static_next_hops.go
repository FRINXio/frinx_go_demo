...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticroutesStaticNextHops struct {
	// Optional[A list of next-hops to be utilised for the static route being specified.] REF:Optional.empty
	NextHop []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticroutesStaticNexthopsNextHop `json:"next-hop,omitempty"`
}
