...
// frinx.openconfig.qos.qosscheduler2r3ctop.tworatethreecolor.conformaction.Config.response
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorConformactionConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorConformactionConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
