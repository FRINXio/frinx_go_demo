...
// frinx.openconfig.isis.isisinterfacelevelgroup.PacketCounters.response
type FrinxOpenconfigIsisIsisinterfacelevelgroupPacketCountersResponse struct {
	FrinxOpenconfigNetworkInstancepacketCounters *FrinxOpenconfigIsisIsisinterfacelevelgroupPacketCounters `json:"frinx-openconfig-network-instance:packet-counters,omitempty"`
}
