...
type FrinxOpenconfigMplsTetunnelp2ptopP2pTunnelAttributes struct {
	// Optional[Secondary paths for the LSP] REF:Optional.empty
	P2pSecondaryPaths *FrinxOpenconfigMplsP2psecondarypathstopP2pSecondaryPaths `json:"p2p-secondary-paths,omitempty"`
	// Optional[Configuration parameters for P2P LSPs] REF:Optional.empty
	Config *FrinxOpenconfigMplsTetunnelp2ptopP2ptunnelattributesConfig `json:"config,omitempty"`
	// Optional[Primary paths associated with the LSP] REF:Optional.empty
	P2pPrimaryPath *FrinxOpenconfigMplsP2pprimarypathstopP2pPrimaryPath `json:"p2p-primary-path,omitempty"`
}
