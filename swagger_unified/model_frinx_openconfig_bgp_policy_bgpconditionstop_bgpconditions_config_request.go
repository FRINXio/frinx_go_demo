...
// frinx.openconfig.bgp.policy.bgpconditionstop.bgpconditions.Config.request
type FrinxOpenconfigBgpPolicyBgpconditionstopBgpconditionsConfigRequest struct {
