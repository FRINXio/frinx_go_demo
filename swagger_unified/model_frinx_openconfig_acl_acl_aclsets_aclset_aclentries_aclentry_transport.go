...
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryTransport struct {
	// Optional[Configuration data] REF:Optional.empty
	Config *FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryTransportConfig `json:"config,omitempty"`
}
