...
// frinx.openconfig.lacp.lacpinterfacestop.interfaces.interface.Config.request
type FrinxOpenconfigLacpLacpinterfacestopInterfacesInterfaceConfigRequest struct {
