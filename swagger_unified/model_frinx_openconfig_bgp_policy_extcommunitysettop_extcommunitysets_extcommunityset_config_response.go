...
// frinx.openconfig.bgp.policy.extcommunitysettop.extcommunitysets.extcommunityset.Config.response
type FrinxOpenconfigBgpPolicyExtcommunitysettopExtcommunitysetsExtcommunitysetConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicyExtcommunitysettopExtcommunitysetsExtcommunitysetConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
