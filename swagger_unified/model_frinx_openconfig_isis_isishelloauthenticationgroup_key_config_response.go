...
// frinx.openconfig.isis.isishelloauthenticationgroup.key.Config.response
type FrinxOpenconfigIsisIsishelloauthenticationgroupKeyConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsishelloauthenticationgroupKeyConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
