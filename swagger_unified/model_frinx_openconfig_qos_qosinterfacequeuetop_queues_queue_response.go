...
// frinx.openconfig.qos.qosinterfacequeuetop.queues.Queue.response
type FrinxOpenconfigQosQosinterfacequeuetopQueuesQueueResponse struct {
	FrinxOpenconfigQosqueue []FrinxOpenconfigQosQosinterfacequeuetopQueuesQueue `json:"frinx-openconfig-qos:queue,omitempty"`
}
