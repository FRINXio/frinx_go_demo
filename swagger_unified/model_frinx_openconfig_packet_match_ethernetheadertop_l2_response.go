...
type FrinxOpenconfigPacketMatchEthernetheadertopL2Response struct {
	FrinxOpenconfigAcll2 *FrinxOpenconfigPacketMatchEthernetheadertopL2 `json:"frinx-openconfig-acl:l2,omitempty"`
}
