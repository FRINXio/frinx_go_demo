...
// frinx.openconfig.mpls.ldp.mplsldpneighborstop.neighbors.neighbor.Config.request
type FrinxOpenconfigMplsLdpMplsldpneighborstopNeighborsNeighborConfigRequest struct {
