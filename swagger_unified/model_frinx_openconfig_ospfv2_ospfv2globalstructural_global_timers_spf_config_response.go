...
// frinx.openconfig.ospfv2.ospfv2globalstructural.global.timers.spf.Config.response
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersSpfConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersSpfConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
