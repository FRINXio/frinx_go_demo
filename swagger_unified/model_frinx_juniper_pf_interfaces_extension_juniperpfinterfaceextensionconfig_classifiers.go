...
type FrinxJuniperPfInterfacesExtensionJuniperpfinterfaceextensionconfigClassifiers struct {
	// Optional[IPv4 precedence classifier] REF:Optional.empty
	InetPrecedence *FrinxJuniperPfInterfacesExtensionJuniperpfinterfaceextensionconfigClassifiersInetPrecedence `json:"inet-precedence,omitempty"`
	// Optional[MPLS EXP classifier] REF:Optional.empty
	Exp *FrinxJuniperPfInterfacesExtensionJuniperpfinterfaceextensionconfigClassifiersExp `json:"exp,omitempty"`
}
