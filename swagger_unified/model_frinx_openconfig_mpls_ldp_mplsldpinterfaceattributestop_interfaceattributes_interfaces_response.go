...
// frinx.openconfig.mpls.ldp.mplsldpinterfaceattributestop.interfaceattributes.Interfaces.response
type FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceattributesInterfacesResponse struct {
	FrinxOpenconfigNetworkInstanceinterfaces *FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceattributesInterfaces `json:"frinx-openconfig-network-instance:interfaces,omitempty"`
}
