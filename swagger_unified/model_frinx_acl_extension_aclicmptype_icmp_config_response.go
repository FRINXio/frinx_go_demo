...
// frinx.acl.extension.aclicmptype.icmp.Config.response
type FrinxAclExtensionAclicmptypeIcmpConfigResponse struct {
	FrinxAclExtensionconfig *FrinxAclExtensionAclicmptypeIcmpConfig `json:"frinx-acl-extension:config,omitempty"`
}
