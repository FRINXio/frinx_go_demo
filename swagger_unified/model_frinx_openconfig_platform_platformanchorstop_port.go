...
type FrinxOpenconfigPlatformPlatformanchorstopPort struct {
	// Optional[Configuration data for physical port components] REF:Optional.empty
	Config *FrinxOpenconfigPlatformPlatformanchorstopPortConfig `json:"config,omitempty"`
}
