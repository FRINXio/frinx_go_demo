...
// frinx.openconfig.packet.match.ethernetheadertop.l2.Config.response
type FrinxOpenconfigPacketMatchEthernetheadertopL2ConfigResponse1 struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigPacketMatchEthernetheadertopL2Config `json:"frinx-openconfig-network-instance:config,omitempty"`
}
