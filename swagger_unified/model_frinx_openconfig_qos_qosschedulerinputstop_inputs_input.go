...
// Optional[List of input sources for the scheduler.] REF:Optional.empty
type FrinxOpenconfigQosQosschedulerinputstopInputsInput struct {
	// Optional[Configuration data for scheduler input sources] REF:Optional.empty
	Config *FrinxOpenconfigQosQosschedulerinputstopInputsInputConfig `json:"config,omitempty"`
