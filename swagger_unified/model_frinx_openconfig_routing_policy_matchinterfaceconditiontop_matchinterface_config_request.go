...
// frinx.openconfig.routing.policy.matchinterfaceconditiontop.matchinterface.Config.request
type FrinxOpenconfigRoutingPolicyMatchinterfaceconditiontopMatchinterfaceConfigRequest struct {
