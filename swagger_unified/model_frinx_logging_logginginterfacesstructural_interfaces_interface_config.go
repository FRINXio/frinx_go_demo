...
type FrinxLoggingLogginginterfacesstructuralInterfacesInterfaceConfig struct {
	// Optional[Event which triggers logging.] REF:Optional.empty
	EnabledLoggingForEvent []FrinxLoggingLogginginterfaceconfigEnabledLoggingForEvent `json:"enabled-logging-for-event,omitempty"`
