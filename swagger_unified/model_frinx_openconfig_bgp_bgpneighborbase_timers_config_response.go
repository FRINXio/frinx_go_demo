...
// frinx.openconfig.bgp.bgpneighborbase.timers.Config.response
type FrinxOpenconfigBgpBgpneighborbaseTimersConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpneighborbaseTimersConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
