...
// frinx.openconfig.acl.inputinterfacetop.inputinterface.Config.response
type FrinxOpenconfigAclInputinterfacetopInputinterfaceConfigResponse struct {
	FrinxOpenconfigAclconfig *FrinxOpenconfigAclInputinterfacetopInputinterfaceConfig `json:"frinx-openconfig-acl:config,omitempty"`
}
