...
type FrinxOpenconfigInterfacesInterfacerefInterfacerefConfigResponse5 struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigInterfacesInterfacerefInterfacerefConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
