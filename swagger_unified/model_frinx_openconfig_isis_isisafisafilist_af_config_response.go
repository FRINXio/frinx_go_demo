...
// frinx.openconfig.isis.isisafisafilist.af.Config.response
type FrinxOpenconfigIsisIsisafisafilistAfConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisafisafilistAfConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
