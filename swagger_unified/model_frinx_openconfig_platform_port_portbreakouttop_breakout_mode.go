...
type FrinxOpenconfigPlatformPortPortbreakouttopBreakoutMode struct {
	// Optional[Configuration data for port breakout] REF:Optional.empty
	Config *FrinxOpenconfigPlatformPortPortbreakouttopBreakoutmodeConfig `json:"config,omitempty"`
}
