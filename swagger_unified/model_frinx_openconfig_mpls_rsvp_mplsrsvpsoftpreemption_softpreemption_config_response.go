...
// frinx.openconfig.mpls.rsvp.mplsrsvpsoftpreemption.softpreemption.Config.response
type FrinxOpenconfigMplsRsvpMplsrsvpsoftpreemptionSoftpreemptionConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsRsvpMplsrsvpsoftpreemptionSoftpreemptionConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
