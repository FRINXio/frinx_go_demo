...
// frinx.openconfig.bfd.bfdinterfacemicrobfdstructural.MicroBfdSessions.response
type FrinxOpenconfigBfdBfdinterfacemicrobfdstructuralMicroBfdSessionsResponse struct {
	FrinxOpenconfigBfdmicroBfdSessions *FrinxOpenconfigBfdBfdinterfacemicrobfdstructuralMicroBfdSessions `json:"frinx-openconfig-bfd:micro-bfd-sessions,omitempty"`
}
