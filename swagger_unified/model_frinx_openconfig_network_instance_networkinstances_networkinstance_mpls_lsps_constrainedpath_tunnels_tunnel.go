...
// Optional[List of TE tunnels. This list contains only the LSPs that the current device originates (i.e., for which it is the head-end). Where the signaling protocol utilised for an LSP allows a mid-point or tail device to be aware of the LSP (e.g., RSVP-TE), then the associated sessions are maintained per protocol] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLspsConstrainedpathTunnelsTunnel struct {
	// Optional[The tunnel name] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Bandwidth configuration for TE LSPs] REF:Optional.empty
	Bandwidth *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidth `json:"bandwidth,omitempty"`
	// Optional[Configuration parameters related to TE tunnels:] REF:Optional.empty
	Config *FrinxOpenconfigMplsTetunnelstopTunnelsTunnelConfig `json:"config,omitempty"`
	// Optional[Enclosing container for CISCO MPLS TE tunnel specific data.] REF:Optional.empty
	FrinxCiscoMplsTeExtensionciscoMplsTeExtension *FrinxCiscoMplsTeExtensionCiscomplstetunneltopCiscoMplsTeExtension `json:"frinx-cisco-mpls-te-extension:cisco-mpls-te-extension,omitempty"`
	// Optional[Parameters related to LSPs of type P2P] REF:Optional.empty
	P2pTunnelAttributes *FrinxOpenconfigMplsTetunnelp2ptopP2pTunnelAttributes `json:"p2p-tunnel-attributes,omitempty"`
}
