...
// frinx.openconfig.bgp.bgpneighborbase.transport.Config.response
type FrinxOpenconfigBgpBgpneighborbaseTransportConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpneighborbaseTransportConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
