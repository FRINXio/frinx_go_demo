...
// frinx.openconfig.policy.forwarding.pfforwardingpolicystructural.policies.policy.rules.rule.Config.response
type FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRuleConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRuleConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
