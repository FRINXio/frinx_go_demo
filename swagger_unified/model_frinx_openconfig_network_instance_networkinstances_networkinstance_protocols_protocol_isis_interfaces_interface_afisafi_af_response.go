...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.isis.interfaces.interface.afisafi.Af.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsisInterfacesInterfaceAfisafiAfResponse struct {
	FrinxOpenconfigNetworkInstanceaf []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsisInterfacesInterfaceAfisafiAf `json:"frinx-openconfig-network-instance:af,omitempty"`
}
