...
// frinx.openconfig.platform.platformanchorstop.Cpu.response
type FrinxOpenconfigPlatformPlatformanchorstopCpuResponse struct {
	FrinxOpenconfigPlatformcpu *FrinxOpenconfigPlatformPlatformanchorstopCpu `json:"frinx-openconfig-platform:cpu,omitempty"`
}
