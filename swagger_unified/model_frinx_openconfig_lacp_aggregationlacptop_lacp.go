...
// Optional[Configuration and operational state data for LACP protocol operation on the aggregate interface] REF:Optional.empty
type FrinxOpenconfigLacpAggregationlacptopLacp struct {
	// Optional[Configuration data for LACP] REF:Optional.empty
	Config *FrinxOpenconfigLacpAggregationlacptopLacpConfig `json:"config,omitempty"`
	// Optional[Enclosing container for the list of LACP-enabled interfaces] REF:Optional.empty
	Interfaces *FrinxOpenconfigLacpLacpinterfacestopInterfaces `json:"interfaces,omitempty"`
}
