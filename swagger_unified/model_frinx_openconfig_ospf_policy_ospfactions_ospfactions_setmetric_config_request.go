...
// frinx.openconfig.ospf.policy.ospfactions.ospfactions.setmetric.Config.request
type FrinxOpenconfigOspfPolicyOspfactionsOspfactionsSetmetricConfigRequest struct {
