...
// frinx.openconfig.qos.qos.classifiers.classifier.terms.term.conditions.ipv4.Config.response
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv4ConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv4Config `json:"frinx-openconfig-qos:config,omitempty"`
}
