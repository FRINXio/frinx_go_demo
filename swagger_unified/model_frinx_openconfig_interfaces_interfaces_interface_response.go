...
// frinx.openconfig.interfaces.interfaces.Interface.response
type FrinxOpenconfigInterfacesInterfacesInterfaceResponse struct {
	FrinxOpenconfigInterfacesinterface []FrinxOpenconfigInterfacesInterfacesInterface `json:"frinx-openconfig-interfaces:interface,omitempty"`
}
