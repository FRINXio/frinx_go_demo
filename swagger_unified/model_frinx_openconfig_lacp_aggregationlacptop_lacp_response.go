...
// frinx.openconfig.lacp.aggregationlacptop.Lacp.response
type FrinxOpenconfigLacpAggregationlacptopLacpResponse struct {
	FrinxOpenconfigLacplacp *FrinxOpenconfigLacpAggregationlacptopLacp `json:"frinx-openconfig-lacp:lacp,omitempty"`
}
