...
// Optional[RSVP-TE global signaling protocol configuration] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsRsvpTe struct {
	// Optional[Attributes relating to RSVP-TE enabled interfaces] REF:Optional.empty
	InterfaceAttributes *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsRsvpteInterfaceAttributes `json:"interface-attributes,omitempty"`
	// Optional[Enclosing container for sessions] REF:Optional.empty
	Sessions *FrinxOpenconfigMplsRsvpMplsrsvpsessionstateSessions `json:"sessions,omitempty"`
	// Optional[Platform wide RSVP configuration and state] REF:Optional.empty
	Global *FrinxOpenconfigMplsRsvpRsvpglobalRsvpteGlobal `json:"global,omitempty"`
	// Optional[Configuration and state for RSVP neighbors connecting to the device] REF:Optional.empty
	Neighbors *FrinxOpenconfigMplsRsvpRsvpglobalRsvpteNeighbors `json:"neighbors,omitempty"`
}
