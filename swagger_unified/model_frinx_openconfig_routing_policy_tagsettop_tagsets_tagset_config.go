...
type FrinxOpenconfigRoutingPolicyTagsettopTagsetsTagsetConfig struct {
	// Optional[name / label of the tag set -- this is used to reference the set in match conditions] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Value of the tag set member] REF:Optional.empty
