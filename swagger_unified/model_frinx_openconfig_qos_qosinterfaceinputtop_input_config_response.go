...
// frinx.openconfig.qos.qosinterfaceinputtop.input.Config.response
type FrinxOpenconfigQosQosinterfaceinputtopInputConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosinterfaceinputtopInputConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
