...
// frinx.openconfig.qos.qosinterfaceoutputtop.output.Config.response
type FrinxOpenconfigQosQosinterfaceoutputtopOutputConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosinterfaceoutputtopOutputConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
