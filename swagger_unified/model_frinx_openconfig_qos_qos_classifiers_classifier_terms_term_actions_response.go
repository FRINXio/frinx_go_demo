...
// frinx.openconfig.qos.qos.classifiers.classifier.terms.term.Actions.response
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermActionsResponse struct {
	FrinxOpenconfigQosactions *FrinxOpenconfigQosQosClassifiersClassifierTermsTermActions `json:"frinx-openconfig-qos:actions,omitempty"`
}
