...
// frinx.openconfig.network.instance.l2nimactabletop.mactable.entries.entry.Config.request
type FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntriesEntryConfigRequest struct {
