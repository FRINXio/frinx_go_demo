...
// Optional[List of SRLG members, which are expressed as IP address endpoints of links contained in the SRLG] REF:Optional.empty
type FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgStaticsrlgmembersMembersList struct {
	// Optional[Configuration parameters relating to the SRLG members] REF:Optional.empty
	Config *FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgStaticsrlgmembersMemberslistConfig `json:"config,omitempty"`
	// Optional[The from address of the link in the SRLG] REF:Optional.empty
