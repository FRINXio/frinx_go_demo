...
// frinx.openconfig.vlan.vlanswitchedtop.switchedvlan.Config.response
type FrinxOpenconfigVlanVlanswitchedtopSwitchedvlanConfigResponse struct {
	FrinxOpenconfigVlanconfig *FrinxOpenconfigVlanVlanswitchedtopSwitchedvlanConfig `json:"frinx-openconfig-vlan:config,omitempty"`
}
