...
type FrinxCiscoOspfExtensionMaxmetricsfieldsMaxmetrictimersMaxMetricTimer struct {
	// Optional.empty REF:Optional.empty
	Config *FrinxCiscoOspfExtensionMaxmetricsfieldsMaxmetrictimersMaxmetrictimerConfig `json:"config,omitempty"`
	// Optional.empty REF:Optional.empty
