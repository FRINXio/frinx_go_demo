...
type FrinxOpenconfigBgpPolicyCommunitycounttopCommunityCount struct {
	// Optional[Configuration data for community count condition] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicyCommunitycounttopCommunitycountConfig `json:"config,omitempty"`
}
