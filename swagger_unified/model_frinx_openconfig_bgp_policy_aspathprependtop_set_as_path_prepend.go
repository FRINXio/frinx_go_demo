...
type FrinxOpenconfigBgpPolicyAspathprependtopSetAsPathPrepend struct {
	// Optional[Configuration data for the AS path prepend action] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicyAspathprependtopSetaspathprependConfig `json:"config,omitempty"`
}
