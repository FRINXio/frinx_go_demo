...
// Optional[Top-level container for BGP-specific actions] REF:Optional.empty
type FrinxOpenconfigBgpPolicyBgpactionstopBgpActions struct {
	// Optional[Action to set the extended community attributes of the route, along with options to modify how the community is modified. Extended communities may be set using an inline list OR a reference to an existing defined set (but not both).] REF:Optional.empty
	SetExtCommunity *FrinxOpenconfigBgpPolicySetextcommunityactiontopSetExtCommunity `json:"set-ext-community,omitempty"`
	// Optional[Configuration data for BGP-specific actions] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicyBgpactionstopBgpactionsConfig `json:"config,omitempty"`
	// Optional[Action to prepend the specified AS number to the AS-path a specified number of times] REF:Optional.empty
	SetAsPathPrepend *FrinxOpenconfigBgpPolicyAspathprependtopSetAsPathPrepend `json:"set-as-path-prepend,omitempty"`
	// Optional[Action to set the community attributes of the route, along with options to modify how the community is modified. Communities may be set using an inline list OR reference to an existing defined set (not both).] REF:Optional.empty
	SetCommunity *FrinxOpenconfigBgpPolicySetcommunityactiontopSetCommunity `json:"set-community,omitempty"`
}
