...
// frinx.openconfig.isis.isisglobalbase.Timers.response
type FrinxOpenconfigIsisIsisglobalbaseTimersResponse struct {
	FrinxOpenconfigNetworkInstancetimers *FrinxOpenconfigIsisIsisglobalbaseTimers `json:"frinx-openconfig-network-instance:timers,omitempty"`
}
