...
type FrinxOpenconfigVlanVlanroutedtopRoutedVlan struct {
	...
	// Optional[Configuration data for routed vlan interfaces] REF:Optional.empty
	Config *FrinxOpenconfigVlanVlanroutedtopRoutedvlanConfig `json:"config,omitempty"`
}
