...
// frinx.openconfig.ospfv2.ospfv2globalstructural.global.gracefulrestart.Config.response
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalGracefulrestartConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalGracefulrestartConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
