...
type FrinxOpenconfigPlatformPlatformanchorstopBackplane struct {
	// Optional[Configuration data for backplane components] REF:Optional.empty
	Config *FrinxOpenconfigPlatformPlatformanchorstopBackplaneConfig `json:"config,omitempty"`
}
