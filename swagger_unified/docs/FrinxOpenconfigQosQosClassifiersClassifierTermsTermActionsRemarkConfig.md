# FrinxOpenconfigQosQosClassifiersClassifierTermsTermActionsRemarkConfig

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**FrinxQosExtensionsetQosGroup** | **[]string** | Optional.empty REF:Optional.empty | [optional] [default to null]
...
**FrinxQosExtensionsetPrecedences** | **[]string** | Optional[List of precedences valid for both ipv4 and ipv6.] REF:Optional.empty | [optional] [default to null]
