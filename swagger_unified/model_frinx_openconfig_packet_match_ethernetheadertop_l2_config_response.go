...
type FrinxOpenconfigPacketMatchEthernetheadertopL2ConfigResponse struct {
	FrinxOpenconfigAclconfig *FrinxOpenconfigPacketMatchEthernetheadertopL2Config `json:"frinx-openconfig-acl:config,omitempty"`
}
