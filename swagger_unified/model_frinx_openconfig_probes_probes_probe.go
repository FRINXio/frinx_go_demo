...
// Optional[List of probes configured.] REF:Optional.empty
type FrinxOpenconfigProbesProbesProbe struct {
	// Optional[Reference to the list key] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[The tests associated to be executed for the probe.] REF:Optional.empty
	Tests *FrinxOpenconfigProbesProbesProbeTests `json:"tests,omitempty"`
	// Optional[Configuration data for the probes.] REF:Optional.empty
	Config *FrinxOpenconfigProbesProbesProbeConfig `json:"config,omitempty"`
}
