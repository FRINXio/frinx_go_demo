...
// frinx.openconfig.network.instance.networkinstances.networkinstance.Protocols.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsResponse struct {
	FrinxOpenconfigNetworkInstanceprotocols *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocols `json:"frinx-openconfig-network-instance:protocols,omitempty"`
}
