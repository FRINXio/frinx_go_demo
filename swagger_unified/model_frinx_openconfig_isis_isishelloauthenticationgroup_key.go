...
type FrinxOpenconfigIsisIsishelloauthenticationgroupKey struct {
	// Optional[This container defines ISIS authentication key configuration.] REF:Optional.empty
	Config *FrinxOpenconfigIsisIsishelloauthenticationgroupKeyConfig `json:"config,omitempty"`
}
