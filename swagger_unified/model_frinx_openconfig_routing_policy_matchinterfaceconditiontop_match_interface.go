...
type FrinxOpenconfigRoutingPolicyMatchinterfaceconditiontopMatchInterface struct {
	// Optional[Configuration data for interface match conditions] REF:Optional.empty
	Config *FrinxOpenconfigRoutingPolicyMatchinterfaceconditiontopMatchinterfaceConfig `json:"config,omitempty"`
}
