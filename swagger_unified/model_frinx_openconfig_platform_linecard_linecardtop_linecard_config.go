...
type FrinxOpenconfigPlatformLinecardLinecardtopLinecardConfig struct {
	// Optional[Enable or disable power to the linecard] REF:Optional.empty
	Power *FrinxOpenconfigPlatformTypesComponentPowerType `json:"power,omitempty"`
}
