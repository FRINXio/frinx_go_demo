...
// frinx.openconfig.if.aggregate.aggregationlogicaltop.aggregation.Config.request
type FrinxOpenconfigIfAggregateAggregationlogicaltopAggregationConfigRequest struct {
