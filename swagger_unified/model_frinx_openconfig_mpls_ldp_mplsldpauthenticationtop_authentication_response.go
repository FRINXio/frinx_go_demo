...
// frinx.openconfig.mpls.ldp.mplsldpauthenticationtop.Authentication.response
type FrinxOpenconfigMplsLdpMplsldpauthenticationtopAuthenticationResponse struct {
	FrinxOpenconfigNetworkInstanceauthentication *FrinxOpenconfigMplsLdpMplsldpauthenticationtopAuthentication `json:"frinx-openconfig-network-instance:authentication,omitempty"`
}
