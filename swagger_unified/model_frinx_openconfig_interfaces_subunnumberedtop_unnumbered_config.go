...
type FrinxOpenconfigInterfacesSubunnumberedtopUnnumberedConfig struct {
	// Optional[Indicates that the subinterface is unnumbered.  By default the subinterface is numbered, i.e., expected to have an IP address configuration.] REF:Optional.empty
