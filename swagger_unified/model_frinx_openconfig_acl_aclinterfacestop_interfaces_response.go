...
// frinx.openconfig.acl.aclinterfacestop.Interfaces.response
type FrinxOpenconfigAclAclinterfacestopInterfacesResponse struct {
	FrinxOpenconfigAclinterfaces *FrinxOpenconfigAclAclinterfacestopInterfaces `json:"frinx-openconfig-acl:interfaces,omitempty"`
}
