...
type FrinxOpenconfigMplsP2psecondarypathstopP2psecondarypathsP2pSecondaryPath struct {
	...
	Config *FrinxOpenconfigMplsP2psecondarypathstopP2psecondarypathsP2psecondarypathConfig `json:"config,omitempty"`
}
