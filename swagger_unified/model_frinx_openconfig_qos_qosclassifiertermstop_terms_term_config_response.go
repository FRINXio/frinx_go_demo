...
// frinx.openconfig.qos.qosclassifiertermstop.terms.term.Config.response
type FrinxOpenconfigQosQosclassifiertermstopTermsTermConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosclassifiertermstopTermsTermConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
