...
// frinx.openconfig.isis.packetcountersstructural.Psnp.response
type FrinxOpenconfigIsisPacketcountersstructuralPsnpResponse struct {
	FrinxOpenconfigNetworkInstancepsnp *FrinxOpenconfigIsisPacketcountersstructuralPsnp `json:"frinx-openconfig-network-instance:psnp,omitempty"`
}
