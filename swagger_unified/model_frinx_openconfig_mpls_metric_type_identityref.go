...
type FrinxOpenconfigMplsMetricTypeIdentityref string

// List of frinx.openconfig.mpls.MetricTypeIdentityref
const (
	FrinxOpenconfigMplsMetricTypeIdentityref_RELATIVE FrinxOpenconfigMplsMetricTypeIdentityref = "frinx-openconfig-mpls-types:LSP_METRIC_RELATIVE"
	FrinxOpenconfigMplsMetricTypeIdentityref_TYPE_ FrinxOpenconfigMplsMetricTypeIdentityref = "frinx-openconfig-mpls-types:LSP_METRIC_TYPE"
	FrinxOpenconfigMplsMetricTypeIdentityref_ABSOLUTE FrinxOpenconfigMplsMetricTypeIdentityref = "frinx-openconfig-mpls-types:LSP_METRIC_ABSOLUTE"
	FrinxOpenconfigMplsMetricTypeIdentityref_INHERITED FrinxOpenconfigMplsMetricTypeIdentityref = "frinx-openconfig-mpls-types:LSP_METRIC_INHERITED"
)
