...
// frinx.openconfig.routing.policy.prefixsetconditiontop.matchprefixset.Config.request
type FrinxOpenconfigRoutingPolicyPrefixsetconditiontopMatchprefixsetConfigRequest struct {
