...
type FrinxOpenconfigNetworkInstanceTypeIdentityref string

// List of frinx.openconfig.network.instance.TypeIdentityref
const (
	FrinxOpenconfigNetworkInstanceTypeIdentityref_DEFAULT_INSTANCE FrinxOpenconfigNetworkInstanceTypeIdentityref = "frinx-openconfig-network-instance-types:DEFAULT_INSTANCE"
	FrinxOpenconfigNetworkInstanceTypeIdentityref_NETWORK_INSTANCE_TYPE FrinxOpenconfigNetworkInstanceTypeIdentityref = "frinx-openconfig-network-instance-types:NETWORK_INSTANCE_TYPE"
	FrinxOpenconfigNetworkInstanceTypeIdentityref_L2_L3 FrinxOpenconfigNetworkInstanceTypeIdentityref = "frinx-openconfig-network-instance-types:L2L3"
	FrinxOpenconfigNetworkInstanceTypeIdentityref_L2_P2_P FrinxOpenconfigNetworkInstanceTypeIdentityref = "frinx-openconfig-network-instance-types:L2P2P"
	FrinxOpenconfigNetworkInstanceTypeIdentityref_L3_VRF FrinxOpenconfigNetworkInstanceTypeIdentityref = "frinx-openconfig-network-instance-types:L3VRF"
	FrinxOpenconfigNetworkInstanceTypeIdentityref_L2_VSI FrinxOpenconfigNetworkInstanceTypeIdentityref = "frinx-openconfig-network-instance-types:L2VSI"
)
