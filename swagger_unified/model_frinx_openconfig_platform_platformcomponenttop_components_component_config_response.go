...
// frinx.openconfig.platform.platformcomponenttop.components.component.Config.response
type FrinxOpenconfigPlatformPlatformcomponenttopComponentsComponentConfigResponse struct {
	FrinxOpenconfigPlatformconfig *FrinxOpenconfigPlatformPlatformcomponenttopComponentsComponentConfig `json:"frinx-openconfig-platform:config,omitempty"`
}
