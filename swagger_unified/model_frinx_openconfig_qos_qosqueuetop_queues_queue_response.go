...
// frinx.openconfig.qos.qosqueuetop.queues.Queue.response
type FrinxOpenconfigQosQosqueuetopQueuesQueueResponse struct {
	FrinxOpenconfigQosqueue []FrinxOpenconfigQosQosqueuetopQueuesQueue `json:"frinx-openconfig-qos:queue,omitempty"`
}
