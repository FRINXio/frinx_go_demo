...
// frinx.openconfig.packet.match.mplsheadertop.mpls.Config.response
type FrinxOpenconfigPacketMatchMplsheadertopMplsConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigPacketMatchMplsheadertopMplsConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
