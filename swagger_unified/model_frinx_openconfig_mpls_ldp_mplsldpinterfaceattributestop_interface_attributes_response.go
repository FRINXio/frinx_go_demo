...
// frinx.openconfig.mpls.ldp.mplsldpinterfaceattributestop.InterfaceAttributes.response
type FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceAttributesResponse struct {
	FrinxOpenconfigNetworkInstanceinterfaceAttributes *FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceAttributes `json:"frinx-openconfig-network-instance:interface-attributes,omitempty"`
}
