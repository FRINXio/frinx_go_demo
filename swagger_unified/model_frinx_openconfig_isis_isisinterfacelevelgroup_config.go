...
type FrinxOpenconfigIsisIsisinterfacelevelgroupConfig struct {
	// Optional[ISIS level number(level-1, level-2).] REF:Optional.empty
	LevelNumber int32 `json:"level-number,omitempty"`
	// Optional[ISIS neighbor priority(LAN hello PDU only).] REF:Optional.empty
	Priority int32 `json:"priority,omitempty"`
	// Optional[ISIS passive interface admin enable/disable function.] REF:Optional.empty
