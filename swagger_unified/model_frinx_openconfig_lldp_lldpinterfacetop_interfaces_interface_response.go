...
type FrinxOpenconfigLldpLldpinterfacetopInterfacesInterfaceResponse struct {
	FrinxCdpinterface []FrinxOpenconfigLldpLldpinterfacetopInterfacesInterface `json:"frinx-cdp:interface,omitempty"`
}
