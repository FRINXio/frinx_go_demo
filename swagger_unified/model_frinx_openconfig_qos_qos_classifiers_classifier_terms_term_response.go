...
// frinx.openconfig.qos.qos.classifiers.classifier.terms.Term.response
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermResponse struct {
	FrinxOpenconfigQosterm []FrinxOpenconfigQosQosClassifiersClassifierTermsTerm `json:"frinx-openconfig-qos:term,omitempty"`
}
