...
type FrinxOpenconfigNetworkInstanceIdentifierIdentityref string

// List of frinx.openconfig.network.instance.IdentifierIdentityref
const (
	FrinxOpenconfigNetworkInstanceIdentifierIdentityref_OSPF FrinxOpenconfigNetworkInstanceIdentifierIdentityref = "frinx-openconfig-policy-types:OSPF"
	FrinxOpenconfigNetworkInstanceIdentifierIdentityref_DIRECTLY_CONNECTED FrinxOpenconfigNetworkInstanceIdentifierIdentityref = "frinx-openconfig-policy-types:DIRECTLY_CONNECTED"
	FrinxOpenconfigNetworkInstanceIdentifierIdentityref_OSPF3 FrinxOpenconfigNetworkInstanceIdentifierIdentityref = "frinx-openconfig-policy-types:OSPF3"
	FrinxOpenconfigNetworkInstanceIdentifierIdentityref_STATIC FrinxOpenconfigNetworkInstanceIdentifierIdentityref = "frinx-openconfig-policy-types:STATIC"
	FrinxOpenconfigNetworkInstanceIdentifierIdentityref_INSTALL_PROTOCOL_TYPE FrinxOpenconfigNetworkInstanceIdentifierIdentityref = "frinx-openconfig-policy-types:INSTALL_PROTOCOL_TYPE"
	FrinxOpenconfigNetworkInstanceIdentifierIdentityref_ISIS FrinxOpenconfigNetworkInstanceIdentifierIdentityref = "frinx-openconfig-policy-types:ISIS"
	FrinxOpenconfigNetworkInstanceIdentifierIdentityref_BGP FrinxOpenconfigNetworkInstanceIdentifierIdentityref = "frinx-openconfig-policy-types:BGP"
	FrinxOpenconfigNetworkInstanceIdentifierIdentityref_LOCAL_AGGREGATE FrinxOpenconfigNetworkInstanceIdentifierIdentityref = "frinx-openconfig-policy-types:LOCAL_AGGREGATE"
)
