...
// frinx.cisco.mpls.te.extension.ciscomplstetunneltop.ciscomplsteextension.Config.response
type FrinxCiscoMplsTeExtensionCiscomplstetunneltopCiscomplsteextensionConfigResponse struct {
	FrinxCiscoMplsTeExtensionconfig *FrinxCiscoMplsTeExtensionCiscomplstetunneltopCiscomplsteextensionConfig `json:"frinx-cisco-mpls-te-extension:config,omitempty"`
}
