...
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv4 struct {
	// Optional[Configuration data for IPv4 match fields] REF:Optional.empty
	Config *FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv4Config `json:"config,omitempty"`
}
