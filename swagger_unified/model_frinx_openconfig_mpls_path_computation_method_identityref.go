...
type FrinxOpenconfigMplsPathComputationMethodIdentityref string

// List of frinx.openconfig.mpls.PathComputationMethodIdentityref
const (
	FrinxOpenconfigMplsPathComputationMethodIdentityref_EXPLICITLY_DEFINED FrinxOpenconfigMplsPathComputationMethodIdentityref = "frinx-openconfig-mpls-types:EXPLICITLY_DEFINED"
	FrinxOpenconfigMplsPathComputationMethodIdentityref_EXTERNALLY_QUERIED FrinxOpenconfigMplsPathComputationMethodIdentityref = "frinx-openconfig-mpls-types:EXTERNALLY_QUERIED"
	FrinxOpenconfigMplsPathComputationMethodIdentityref_PATH_COMPUTATION_METHOD FrinxOpenconfigMplsPathComputationMethodIdentityref = "frinx-openconfig-mpls-types:PATH_COMPUTATION_METHOD"
	FrinxOpenconfigMplsPathComputationMethodIdentityref_LOCALLY_COMPUTED FrinxOpenconfigMplsPathComputationMethodIdentityref = "frinx-openconfig-mpls-types:LOCALLY_COMPUTED"
)
