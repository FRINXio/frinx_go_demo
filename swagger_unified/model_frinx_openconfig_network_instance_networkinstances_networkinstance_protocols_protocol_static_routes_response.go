...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.StaticRoutes.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticRoutesResponse struct {
	FrinxOpenconfigNetworkInstancestaticRoutes *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticRoutes `json:"frinx-openconfig-network-instance:static-routes,omitempty"`
}
