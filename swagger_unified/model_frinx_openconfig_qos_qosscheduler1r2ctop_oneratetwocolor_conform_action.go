...
type FrinxOpenconfigQosQosscheduler1r2ctopOneratetwocolorConformAction struct {
	// Optional[Configuration parameters relating to conforming packets for the 1r2c scheduler.] REF:Optional.empty
	Config *FrinxOpenconfigQosQosscheduler1r2ctopOneratetwocolorConformactionConfig `json:"config,omitempty"`
}
