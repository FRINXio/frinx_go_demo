...
// frinx.bfd.bfdtop.bfd.Config.response
type FrinxBfdBfdtopBfdConfigResponse1 struct {
	FrinxBfdExtensionconfig *FrinxBfdBfdtopBfdConfig `json:"frinx-bfd-extension:config,omitempty"`
}
