...
type FrinxOpenconfigQosPriorityEnumeration string

// List of frinx.openconfig.qos.PriorityEnumeration
const (
	FrinxOpenconfigQosPriorityEnumeration_STRICT FrinxOpenconfigQosPriorityEnumeration = "STRICT"
)
