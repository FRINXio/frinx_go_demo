...
// frinx.openconfig.mpls.mplsinterfacestop.interfaceattributes.Interface.response
type FrinxOpenconfigMplsMplsinterfacestopInterfaceattributesInterfaceResponse struct {
	FrinxOpenconfigNetworkInstanceinterface []FrinxOpenconfigMplsMplsinterfacestopInterfaceattributesInterface `json:"frinx-openconfig-network-instance:interface,omitempty"`
}
