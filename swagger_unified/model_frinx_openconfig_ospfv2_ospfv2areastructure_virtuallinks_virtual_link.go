...
// Optional[Configuration and state parameters relating to a virtual link] REF:Optional.empty
type FrinxOpenconfigOspfv2Ospfv2areastructureVirtuallinksVirtualLink struct {
	// Optional[Reference to the remote router ID] REF:Optional.empty
	RemoteRouterId string `json:"remote-router-id,omitempty"`
	// Optional[Configuration parameters relating to the OSPF virtual link] REF:Optional.empty
	Config *FrinxOpenconfigOspfv2Ospfv2areastructureVirtuallinksVirtuallinkConfig `json:"config,omitempty"`
}
