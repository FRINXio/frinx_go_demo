...
type FrinxOpenconfigIsisIsisinterfacelevelgroupHelloAuthentication struct {
	// Optional[This container defines keychain parameters.] REF:Optional.empty
	Keychain *FrinxOpenconfigIsisKeychainbasegroupKeychain `json:"keychain,omitempty"`
	// Optional[This container defines ISIS authentication configuration.] REF:Optional.empty
	Config *FrinxOpenconfigIsisIsishelloauthenticationgroupConfig `json:"config,omitempty"`
	// Optional[This container defines ISIS authentication key] REF:Optional.empty
	Key *FrinxOpenconfigIsisIsishelloauthenticationgroupKey `json:"key,omitempty"`
}
