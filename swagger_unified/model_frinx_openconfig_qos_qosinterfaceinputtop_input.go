...
// Optional[Top-level container for QoS data for the ingress interface] REF:Optional.empty
type FrinxOpenconfigQosQosinterfaceinputtopInput struct {
	// Optional[Classifiers to be applied to the interface.] REF:Optional.empty
	Classifers *FrinxOpenconfigQosQosinterfaceclassifiertopClassifers `json:"classifers,omitempty"`
	// Optional[Scheduler policy associated with the interface.] REF:Optional.empty
	SchedulerPolicy *FrinxOpenconfigQosQosinterfaceschedulertopSchedulerPolicy `json:"scheduler-policy,omitempty"`
	// Optional[Surrounding container for the list of egress interfaces for which virtual output queues are instantiated on this interface.] REF:Optional.empty
	VirtualOutputQueues *FrinxOpenconfigQosQosinterfacevoqstopVirtualOutputQueues `json:"virtual-output-queues,omitempty"`
	// Optional[Configuration data for QoS on ingress interface] REF:Optional.empty
	Config *FrinxOpenconfigQosQosinterfaceinputtopInputConfig `json:"config,omitempty"`
	// Optional[Surrounding container for a list of queues that are instantiated on an interface.] REF:Optional.empty
	Queues *FrinxOpenconfigQosQosinterfacequeuetopQueues `json:"queues,omitempty"`
}
