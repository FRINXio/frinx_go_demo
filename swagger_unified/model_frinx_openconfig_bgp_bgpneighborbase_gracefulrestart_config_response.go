...
// frinx.openconfig.bgp.bgpneighborbase.gracefulrestart.Config.response
type FrinxOpenconfigBgpBgpneighborbaseGracefulrestartConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpneighborbaseGracefulrestartConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
