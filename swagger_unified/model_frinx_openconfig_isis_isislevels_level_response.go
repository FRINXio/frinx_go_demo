...
// frinx.openconfig.isis.isislevels.Level.response
type FrinxOpenconfigIsisIsislevelsLevelResponse struct {
	FrinxOpenconfigNetworkInstancelevel []FrinxOpenconfigIsisIsislevelsLevel `json:"frinx-openconfig-network-instance:level,omitempty"`
}
