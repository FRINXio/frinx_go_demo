...
// frinx.openconfig.local.routing.localstatictop.staticroutes.static.nexthops.nexthop.Config.response
type FrinxOpenconfigLocalRoutingLocalstatictopStaticroutesStaticNexthopsNexthopConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigLocalRoutingLocalstatictopStaticroutesStaticNexthopsNexthopConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
