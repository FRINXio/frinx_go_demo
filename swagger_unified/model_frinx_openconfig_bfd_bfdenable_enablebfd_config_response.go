...
// frinx.openconfig.bfd.bfdenable.enablebfd.Config.response
type FrinxOpenconfigBfdBfdenableEnablebfdConfigResponse struct {
	FrinxOpenconfigBfdconfig *FrinxOpenconfigBfdBfdenableEnablebfdConfig `json:"frinx-openconfig-bfd:config,omitempty"`
}
