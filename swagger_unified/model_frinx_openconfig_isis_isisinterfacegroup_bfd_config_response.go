...
// frinx.openconfig.isis.isisinterfacegroup.bfd.Config.response
type FrinxOpenconfigIsisIsisinterfacegroupBfdConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisinterfacegroupBfdConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
