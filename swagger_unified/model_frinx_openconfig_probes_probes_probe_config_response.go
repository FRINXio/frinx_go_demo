...
// frinx.openconfig.probes.probes.probe.Config.response
type FrinxOpenconfigProbesProbesProbeConfigResponse struct {
	FrinxOpenconfigProbesconfig *FrinxOpenconfigProbesProbesProbeConfig `json:"frinx-openconfig-probes:config,omitempty"`
}
