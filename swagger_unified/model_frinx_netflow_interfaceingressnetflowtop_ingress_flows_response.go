...
// frinx.netflow.interfaceingressnetflowtop.IngressFlows.response
type FrinxNetflowInterfaceingressnetflowtopIngressFlowsResponse struct {
	FrinxNetflowingressFlows *FrinxNetflowInterfaceingressnetflowtopIngressFlows `json:"frinx-netflow:ingress-flows,omitempty"`
}
