...
// frinx.openconfig.isis.isisinterfacelevelgroup.Timers.response
type FrinxOpenconfigIsisIsisinterfacelevelgroupTimersResponse struct {
	FrinxOpenconfigNetworkInstancetimers *FrinxOpenconfigIsisIsisinterfacelevelgroupTimers `json:"frinx-openconfig-network-instance:timers,omitempty"`
}
