...
// frinx.openconfig.isis.isisauthenticationgroup.Config.response
type FrinxOpenconfigIsisIsisauthenticationgroupConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisauthenticationgroupConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
