...
type FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref string

// List of frinx.openconfig.network.instance.policy.ProtocolIdentifierIdentityref
const (
	FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref_OSPF FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref = "frinx-openconfig-policy-types:OSPF"
	FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref_DIRECTLY_CONNECTED FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref = "frinx-openconfig-policy-types:DIRECTLY_CONNECTED"
	FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref_OSPF3 FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref = "frinx-openconfig-policy-types:OSPF3"
	FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref_STATIC FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref = "frinx-openconfig-policy-types:STATIC"
	FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref_INSTALL_PROTOCOL_TYPE FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref = "frinx-openconfig-policy-types:INSTALL_PROTOCOL_TYPE"
	FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref_ISIS FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref = "frinx-openconfig-policy-types:ISIS"
	FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref_BGP FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref = "frinx-openconfig-policy-types:BGP"
	FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref_LOCAL_AGGREGATE FrinxOpenconfigNetworkInstancePolicyProtocolIdentifierIdentityref = "frinx-openconfig-policy-types:LOCAL_AGGREGATE"
)
