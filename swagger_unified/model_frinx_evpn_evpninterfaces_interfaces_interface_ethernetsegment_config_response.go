...
// frinx.evpn.evpninterfaces.interfaces.interface.ethernetsegment.Config.response
type FrinxEvpnEvpninterfacesInterfacesInterfaceEthernetsegmentConfigResponse struct {
	FrinxEvpnconfig *FrinxEvpnEvpninterfacesInterfacesInterfaceEthernetsegmentConfig `json:"frinx-evpn:config,omitempty"`
}
