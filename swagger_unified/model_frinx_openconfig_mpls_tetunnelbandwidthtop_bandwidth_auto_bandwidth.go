...
// Optional[Parameters related to auto-bandwidth] REF:Optional.empty
type FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutoBandwidth struct {
	// Optional[configuration of MPLS underflow bandwidth adjustement for the LSP] REF:Optional.empty
	Underflow *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthUnderflow `json:"underflow,omitempty"`
	// Optional[configuration of MPLS overflow bandwidth adjustement for the LSP] REF:Optional.empty
	Overflow *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthOverflow `json:"overflow,omitempty"`
	// Optional[Configuration parameters relating to MPLS auto-bandwidth on the tunnel.] REF:Optional.empty
	Config *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthConfig `json:"config,omitempty"`
}
