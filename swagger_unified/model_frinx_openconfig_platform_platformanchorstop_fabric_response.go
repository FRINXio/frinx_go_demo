...
// frinx.openconfig.platform.platformanchorstop.Fabric.response
type FrinxOpenconfigPlatformPlatformanchorstopFabricResponse struct {
	FrinxOpenconfigPlatformfabric *FrinxOpenconfigPlatformPlatformanchorstopFabric `json:"frinx-openconfig-platform:fabric,omitempty"`
}
