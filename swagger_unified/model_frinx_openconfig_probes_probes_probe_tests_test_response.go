...
// frinx.openconfig.probes.probes.probe.tests.Test.response
type FrinxOpenconfigProbesProbesProbeTestsTestResponse struct {
	FrinxOpenconfigProbestest []FrinxOpenconfigProbesProbesProbeTestsTest `json:"frinx-openconfig-probes:test,omitempty"`
}
