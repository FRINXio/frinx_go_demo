...
// Optional[Configuration parameters relating to BGP confederations] REF:Optional.empty
type FrinxOpenconfigBgpBgpglobalbaseConfederationConfig struct {
	// Optional[Confederation identifier for the autonomous system.] REF:Optional.empty
	Identifier int64 `json:"identifier,omitempty"`
	// Optional[Remote autonomous systems that are to be treated as part of the local confederation.] REF:Optional.empty
	MemberAs []int64 `json:"member-as,omitempty"`
	// Optional[When this leaf is set to true it indicates that the local-AS is part of a BGP confederation] REF:Optional.empty
