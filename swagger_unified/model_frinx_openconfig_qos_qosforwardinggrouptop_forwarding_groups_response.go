...
// frinx.openconfig.qos.qosforwardinggrouptop.ForwardingGroups.response
type FrinxOpenconfigQosQosforwardinggrouptopForwardingGroupsResponse struct {
	FrinxOpenconfigQosforwardingGroups *FrinxOpenconfigQosQosforwardinggrouptopForwardingGroups `json:"frinx-openconfig-qos:forwarding-groups,omitempty"`
}
