...
type FrinxOpenconfigInterfacesInterfacerefInterfacerefConfigResponse1 struct {
	FrinxOpenconfigAclconfig *FrinxOpenconfigInterfacesInterfacerefInterfacerefConfig `json:"frinx-openconfig-acl:config,omitempty"`
}
