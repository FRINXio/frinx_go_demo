...
// frinx.openconfig.lldp.lldpinterfacetop.Interfaces.response
type FrinxOpenconfigLldpLldpinterfacetopInterfacesResponse1 struct {
	FrinxOpenconfigLldpinterfaces *FrinxOpenconfigLldpLldpinterfacetopInterfaces `json:"frinx-openconfig-lldp:interfaces,omitempty"`
}
