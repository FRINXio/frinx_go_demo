...
// frinx.openconfig.qos.qosinterfaceoutputtop.Output.response
type FrinxOpenconfigQosQosinterfaceoutputtopOutputResponse struct {
	FrinxOpenconfigQosoutput *FrinxOpenconfigQosQosinterfaceoutputtopOutput `json:"frinx-openconfig-qos:output,omitempty"`
}
