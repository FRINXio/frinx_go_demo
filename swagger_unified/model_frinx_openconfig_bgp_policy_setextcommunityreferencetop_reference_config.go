...
type FrinxOpenconfigBgpPolicySetextcommunityreferencetopReferenceConfig struct {
	// Optional[References a defined extended community set by name] REF:Optional.empty
	ExtCommunitySetRef string `json:"ext-community-set-ref,omitempty"`
}
