...
// frinx.openconfig.platform.platformanchorstop.Storage.response
type FrinxOpenconfigPlatformPlatformanchorstopStorageResponse struct {
	FrinxOpenconfigPlatformstorage *FrinxOpenconfigPlatformPlatformanchorstopStorage `json:"frinx-openconfig-platform:storage,omitempty"`
}
