...
type FrinxOpenconfigInterfacesInterfacesInterfaceSubinterfaces struct {
	// Optional[The list of subinterfaces (logical interfaces) associated with a physical interface] REF:Optional.empty
	Subinterface []FrinxOpenconfigInterfacesInterfacesInterfaceSubinterfacesSubinterface `json:"subinterface,omitempty"`
}
