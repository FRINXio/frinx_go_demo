...
// frinx.openconfig.platform.platformsubcomponentreftop.subcomponents.subcomponent.Config.response
type FrinxOpenconfigPlatformPlatformsubcomponentreftopSubcomponentsSubcomponentConfigResponse struct {
	FrinxOpenconfigPlatformconfig *FrinxOpenconfigPlatformPlatformsubcomponentreftopSubcomponentsSubcomponentConfig `json:"frinx-openconfig-platform:config,omitempty"`
}
