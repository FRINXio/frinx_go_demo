...
// frinx.openconfig.mpls.mplstesrlgtop.Srlgs.response
type FrinxOpenconfigMplsMplstesrlgtopSrlgsResponse struct {
	FrinxOpenconfigNetworkInstancesrlgs *FrinxOpenconfigMplsMplstesrlgtopSrlgs `json:"frinx-openconfig-network-instance:srlgs,omitempty"`
}
