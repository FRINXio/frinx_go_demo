...
type FrinxHsrpInterfacetopInterfacesInterface struct {
	// Optional[List of HSRP groups, keyed by address-family, virtual router id] REF:Optional.empty
	HsrpGroup []FrinxHsrpHsrpgroupsHsrpGroup `json:"hsrp-group,omitempty"`
	// Optional.empty REF:Optional.empty
	Config *FrinxHsrpInterfacetopInterfacesInterfaceConfig `json:"config,omitempty"`
