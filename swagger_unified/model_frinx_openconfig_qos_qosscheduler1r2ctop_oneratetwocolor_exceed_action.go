...
type FrinxOpenconfigQosQosscheduler1r2ctopOneratetwocolorExceedAction struct {
	// Optional[Configuration parameters relating to exceeding packets for the 1r2c scheduler.] REF:Optional.empty
	Config *FrinxOpenconfigQosQosscheduler1r2ctopOneratetwocolorExceedactionConfig `json:"config,omitempty"`
}
