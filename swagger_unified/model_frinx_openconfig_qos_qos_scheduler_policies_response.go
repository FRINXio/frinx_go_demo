...
// frinx.openconfig.qos.qos.SchedulerPolicies.response
type FrinxOpenconfigQosQosSchedulerPoliciesResponse struct {
	FrinxOpenconfigQosschedulerPolicies *FrinxOpenconfigQosQosSchedulerPolicies `json:"frinx-openconfig-qos:scheduler-policies,omitempty"`
}
