...
// frinx.openconfig.qos.qosqueuetop.Queues.response
type FrinxOpenconfigQosQosqueuetopQueuesResponse struct {
	FrinxOpenconfigQosqueues *FrinxOpenconfigQosQosqueuetopQueues `json:"frinx-openconfig-qos:queues,omitempty"`
}
