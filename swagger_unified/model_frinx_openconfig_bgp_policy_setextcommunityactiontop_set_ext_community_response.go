...
// frinx.openconfig.bgp.policy.setextcommunityactiontop.SetExtCommunity.response
type FrinxOpenconfigBgpPolicySetextcommunityactiontopSetExtCommunityResponse struct {
	FrinxOpenconfigBgpPolicysetExtCommunity *FrinxOpenconfigBgpPolicySetextcommunityactiontopSetExtCommunity `json:"frinx-openconfig-bgp-policy:set-ext-community,omitempty"`
}
