...
// frinx.openconfig.lacp.lacpinterfacestop.Interfaces.response
type FrinxOpenconfigLacpLacpinterfacestopInterfacesResponse struct {
	FrinxOpenconfigLacpinterfaces *FrinxOpenconfigLacpLacpinterfacestopInterfaces `json:"frinx-openconfig-lacp:interfaces,omitempty"`
}
