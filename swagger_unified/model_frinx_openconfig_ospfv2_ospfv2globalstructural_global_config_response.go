...
// frinx.openconfig.ospfv2.ospfv2globalstructural.global.Config.response
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
