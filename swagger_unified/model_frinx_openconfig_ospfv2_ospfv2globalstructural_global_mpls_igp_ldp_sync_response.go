...
// frinx.openconfig.ospfv2.ospfv2globalstructural.global.mpls.IgpLdpSync.response
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMplsIgpLdpSyncResponse struct {
	FrinxOpenconfigNetworkInstanceigpLdpSync *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMplsIgpLdpSync `json:"frinx-openconfig-network-instance:igp-ldp-sync,omitempty"`
}
