...
// frinx.openconfig.ospfv2.ospfv2areainterfacesstructure.interfaces.interface.Mpls.response
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMplsResponse struct {
	FrinxOpenconfigNetworkInstancempls *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMpls `json:"frinx-openconfig-network-instance:mpls,omitempty"`
}
