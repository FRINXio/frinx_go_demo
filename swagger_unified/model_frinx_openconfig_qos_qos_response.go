...
// frinx.openconfig.qos.Qos.response
type FrinxOpenconfigQosQosResponse struct {
	FrinxOpenconfigQosqos *FrinxOpenconfigQosQos `json:"frinx-openconfig-qos:qos,omitempty"`
}
