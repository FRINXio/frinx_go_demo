...
// frinx.openconfig.routing.policy.RoutingPolicy.response
type FrinxOpenconfigRoutingPolicyRoutingPolicyResponse struct {
	FrinxOpenconfigRoutingPolicyroutingPolicy *FrinxOpenconfigRoutingPolicyRoutingPolicy `json:"frinx-openconfig-routing-policy:routing-policy,omitempty"`
}
