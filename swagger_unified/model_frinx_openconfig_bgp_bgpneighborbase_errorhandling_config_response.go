...
// frinx.openconfig.bgp.bgpneighborbase.errorhandling.Config.response
type FrinxOpenconfigBgpBgpneighborbaseErrorhandlingConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpneighborbaseErrorhandlingConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
