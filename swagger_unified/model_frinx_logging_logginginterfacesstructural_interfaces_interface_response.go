...
// frinx.logging.logginginterfacesstructural.interfaces.Interface.response
type FrinxLoggingLogginginterfacesstructuralInterfacesInterfaceResponse struct {
	FrinxLogginginterface []FrinxLoggingLogginginterfacesstructuralInterfacesInterface `json:"frinx-logging:interface,omitempty"`
}
