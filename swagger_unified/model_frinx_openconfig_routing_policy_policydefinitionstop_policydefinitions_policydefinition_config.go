...
type FrinxOpenconfigRoutingPolicyPolicydefinitionstopPolicydefinitionsPolicydefinitionConfig struct {
	// Optional[Name of the top-level policy definition -- this name is used in references to the current policy] REF:Optional.empty
