...
// frinx.openconfig.qos.qos.classifiers.classifier.terms.term.actions.Remark.request
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermActionsRemarkRequest struct {
