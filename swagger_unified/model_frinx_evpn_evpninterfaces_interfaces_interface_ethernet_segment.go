...
type FrinxEvpnEvpninterfacesInterfacesInterfaceEthernetSegment struct {
	// Optional.empty REF:Optional.empty
	Config *FrinxEvpnEvpninterfacesInterfacesInterfaceEthernetsegmentConfig `json:"config,omitempty"`
}
