...
// frinx.openconfig.routing.policy.applypolicygroup.ApplyPolicy.response
type FrinxOpenconfigRoutingPolicyApplypolicygroupApplyPolicyResponse struct {
	FrinxOpenconfigNetworkInstanceapplyPolicy *FrinxOpenconfigRoutingPolicyApplypolicygroupApplyPolicy `json:"frinx-openconfig-network-instance:apply-policy,omitempty"`
}
