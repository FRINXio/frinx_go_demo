...
// Optional[Policy statements group conditions and actions within a policy definition.  They are evaluated in the order specified (see the description of policy evaluation at the top of this module.] REF:Optional.empty
type FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicydefinitionStatementsStatement struct {
	// Optional[Reference to list key] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Condition statements for the current policy statement] REF:Optional.empty
	Conditions *FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicydefinitionStatementsStatementConditions `json:"conditions,omitempty"`
	// Optional[Top-level container for policy action statements] REF:Optional.empty
	Actions *FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicydefinitionStatementsStatementActions `json:"actions,omitempty"`
	// Optional[Configuration data for policy statements] REF:Optional.empty
	Config *FrinxOpenconfigRoutingPolicyPolicystatementstopStatementsStatementConfig `json:"config,omitempty"`
}
