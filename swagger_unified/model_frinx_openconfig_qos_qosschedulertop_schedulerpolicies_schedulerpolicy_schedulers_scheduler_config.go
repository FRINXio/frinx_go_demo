...
type FrinxOpenconfigQosQosschedulertopSchedulerpoliciesSchedulerpolicySchedulersSchedulerConfig struct {
	// Optional[Sequence number for the scheduler within the scheduler policy. Schedulers are processed from lowest sequence to highest.] REF:Optional.empty
	Sequence int64 `json:"sequence,omitempty"`
	// Optional[Priority of the scheduler within the scheduler policy.] REF:Optional.empty
	Priority *FrinxOpenconfigQosPriorityEnumeration `json:"priority,omitempty"`
	// Optional[Sets the type of scheduler, i.e. the scheduling algorithm used to serve inputs.] REF:Optional.empty
	Type_ *FrinxOpenconfigQosTypeIdentityref `json:"type,omitempty"`
}
