...
// frinx.openconfig.network.instance.networkinstancetop.networkinstances.networkinstance.InterInstancePolicies.response
type FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceInterInstancePoliciesResponse struct {
	FrinxOpenconfigNetworkInstanceinterInstancePolicies *FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceInterInstancePolicies `json:"frinx-openconfig-network-instance:inter-instance-policies,omitempty"`
}
