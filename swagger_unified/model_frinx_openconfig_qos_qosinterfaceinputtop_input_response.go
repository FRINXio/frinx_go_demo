...
// frinx.openconfig.qos.qosinterfaceinputtop.Input.response
type FrinxOpenconfigQosQosinterfaceinputtopInputResponse struct {
	FrinxOpenconfigQosinput *FrinxOpenconfigQosQosinterfaceinputtopInput `json:"frinx-openconfig-qos:input,omitempty"`
}
