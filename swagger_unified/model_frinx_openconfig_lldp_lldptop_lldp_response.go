...
// frinx.openconfig.lldp.lldptop.Lldp.response
type FrinxOpenconfigLldpLldptopLldpResponse struct {
	FrinxOpenconfigLldplldp *FrinxOpenconfigLldpLldptopLldp `json:"frinx-openconfig-lldp:lldp,omitempty"`
}
