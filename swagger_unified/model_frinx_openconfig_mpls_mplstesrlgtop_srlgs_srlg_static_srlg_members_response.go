...
// frinx.openconfig.mpls.mplstesrlgtop.srlgs.srlg.StaticSrlgMembers.response
type FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgStaticSrlgMembersResponse struct {
	FrinxOpenconfigNetworkInstancestaticSrlgMembers *FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgStaticSrlgMembers `json:"frinx-openconfig-network-instance:static-srlg-members,omitempty"`
}
