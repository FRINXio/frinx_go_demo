...
// frinx.netflow.netflowtop.Netflow.response
type FrinxNetflowNetflowtopNetflowResponse struct {
	FrinxNetflownetflow *FrinxNetflowNetflowtopNetflow `json:"frinx-netflow:netflow,omitempty"`
}
