...
type FrinxOpenconfigIsisIsisglobalbaseTimersConfig struct {
	// Optional[Time interval in seconds that specifies how long an LSP remains in LSDB without being refreshed.] REF:Optional.empty
	LspLifetimeInterval int32 `json:"lsp-lifetime-interval,omitempty"`
	// Optional[Time interval in seconds that specifies how often route topology that a device originates is transmitted in LSPs.] REF:Optional.empty
	LspRefreshInterval int32 `json:"lsp-refresh-interval,omitempty"`
}
