...
type FrinxOpenconfigIsisIsisglobalbaseReferenceBandwidth struct {
	// Optional[This container defines Reference Bandwidth configuration] REF:Optional.empty
	Config *FrinxOpenconfigIsisIsisglobalbaseReferencebandwidthConfig `json:"config,omitempty"`
}
