...
// frinx.openconfig.network.instance.l2nimactabletop.mactable.entries.entry.Interface.response
type FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntriesEntryInterfaceResponse struct {
	FrinxOpenconfigNetworkInstanceinterface *FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntriesEntryInterface `json:"frinx-openconfig-network-instance:interface,omitempty"`
}
