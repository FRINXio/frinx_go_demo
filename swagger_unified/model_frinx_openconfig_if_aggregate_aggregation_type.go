...
type FrinxOpenconfigIfAggregateAggregationType string

// List of frinx.openconfig.if.aggregate.AggregationType
const (
	FrinxOpenconfigIfAggregateAggregationType_LACP FrinxOpenconfigIfAggregateAggregationType = "LACP"
	FrinxOpenconfigIfAggregateAggregationType_STATIC FrinxOpenconfigIfAggregateAggregationType = "STATIC"
)
