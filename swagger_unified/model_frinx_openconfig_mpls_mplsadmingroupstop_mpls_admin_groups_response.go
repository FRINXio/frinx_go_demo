...
// frinx.openconfig.mpls.mplsadmingroupstop.MplsAdminGroups.response
type FrinxOpenconfigMplsMplsadmingroupstopMplsAdminGroupsResponse struct {
	FrinxOpenconfigNetworkInstancemplsAdminGroups *FrinxOpenconfigMplsMplsadmingroupstopMplsAdminGroups `json:"frinx-openconfig-network-instance:mpls-admin-groups,omitempty"`
}
