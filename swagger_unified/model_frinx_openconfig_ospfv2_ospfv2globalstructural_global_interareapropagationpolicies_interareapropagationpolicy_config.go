...
// Optional[Configuration parameters relating to the inter-area propagation policy] REF:Optional.empty
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalInterareapropagationpoliciesInterareapropagationpolicyConfig struct {
	...
	// Optional[The destination area to which prefixes are to be imported] REF:Optional.empty
	DstArea string `json:"dst-area,omitempty"`
	// Optional[The area from which prefixes are to be exported.] REF:Optional.empty
	SrcArea string `json:"src-area,omitempty"`
