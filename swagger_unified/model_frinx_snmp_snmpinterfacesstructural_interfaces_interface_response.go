...
// frinx.snmp.snmpinterfacesstructural.interfaces.Interface.response
type FrinxSnmpSnmpinterfacesstructuralInterfacesInterfaceResponse struct {
	FrinxSnmpinterface []FrinxSnmpSnmpinterfacesstructuralInterfacesInterface `json:"frinx-snmp:interface,omitempty"`
}
