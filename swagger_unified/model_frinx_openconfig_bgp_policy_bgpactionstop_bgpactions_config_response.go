...
// frinx.openconfig.bgp.policy.bgpactionstop.bgpactions.Config.response
type FrinxOpenconfigBgpPolicyBgpactionstopBgpactionsConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicyBgpactionstopBgpactionsConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
