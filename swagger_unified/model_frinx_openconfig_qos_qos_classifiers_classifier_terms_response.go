...
// frinx.openconfig.qos.qos.classifiers.classifier.Terms.response
type FrinxOpenconfigQosQosClassifiersClassifierTermsResponse struct {
	FrinxOpenconfigQosterms *FrinxOpenconfigQosQosClassifiersClassifierTerms `json:"frinx-openconfig-qos:terms,omitempty"`
}
