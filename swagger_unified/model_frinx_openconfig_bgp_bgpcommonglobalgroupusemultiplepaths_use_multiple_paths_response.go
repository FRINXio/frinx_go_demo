...
// frinx.openconfig.bgp.bgpcommonglobalgroupusemultiplepaths.UseMultiplePaths.response
type FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUseMultiplePathsResponse struct {
	FrinxOpenconfigNetworkInstanceuseMultiplePaths *FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUseMultiplePaths `json:"frinx-openconfig-network-instance:use-multiple-paths,omitempty"`
}
