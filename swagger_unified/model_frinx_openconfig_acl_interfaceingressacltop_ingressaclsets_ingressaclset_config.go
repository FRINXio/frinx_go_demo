...
type FrinxOpenconfigAclInterfaceingressacltopIngressaclsetsIngressaclsetConfig struct {
	...
	// Optional[Reference to the ACL set name applied on ingress] REF:Optional.empty
