...
// frinx.openconfig.interfaces.interfaces.interface.subinterfaces.Subinterface.response
type FrinxOpenconfigInterfacesInterfacesInterfaceSubinterfacesSubinterfaceResponse struct {
	FrinxOpenconfigInterfacessubinterface []FrinxOpenconfigInterfacesInterfacesInterfaceSubinterfacesSubinterface `json:"frinx-openconfig-interfaces:subinterface,omitempty"`
}
