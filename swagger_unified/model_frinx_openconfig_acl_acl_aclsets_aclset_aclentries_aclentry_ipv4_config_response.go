...
// frinx.openconfig.acl.acl.aclsets.aclset.aclentries.aclentry.ipv4.Config.response
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryIpv4ConfigResponse struct {
	FrinxOpenconfigAclconfig *FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryIpv4Config `json:"frinx-openconfig-acl:config,omitempty"`
}
