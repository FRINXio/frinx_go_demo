...
type FrinxOpenconfigPlatformTransceiverPhysicalchanneltopPhysicalChannels struct {
	...
	Channel []FrinxOpenconfigPlatformTransceiverPhysicalchanneltopPhysicalchannelsChannel `json:"channel,omitempty"`
}
