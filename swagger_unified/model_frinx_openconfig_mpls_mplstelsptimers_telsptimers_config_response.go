...
// frinx.openconfig.mpls.mplstelsptimers.telsptimers.Config.response
type FrinxOpenconfigMplsMplstelsptimersTelsptimersConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsMplstelsptimersTelsptimersConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
