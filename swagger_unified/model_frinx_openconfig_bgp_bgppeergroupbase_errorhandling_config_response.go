...
// frinx.openconfig.bgp.bgppeergroupbase.errorhandling.Config.response
type FrinxOpenconfigBgpBgppeergroupbaseErrorhandlingConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgppeergroupbaseErrorhandlingConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
