...
// frinx.openconfig.interfaces.subunnumberedtop.unnumbered.Config.response
type FrinxOpenconfigInterfacesSubunnumberedtopUnnumberedConfigResponse struct {
	FrinxOpenconfigIfIpconfig *FrinxOpenconfigInterfacesSubunnumberedtopUnnumberedConfig `json:"frinx-openconfig-if-ip:config,omitempty"`
}
