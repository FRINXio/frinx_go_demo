...
// frinx.openconfig.qos.qosscheduleroutputtop.Output.response
type FrinxOpenconfigQosQosscheduleroutputtopOutputResponse struct {
	FrinxOpenconfigQosoutput *FrinxOpenconfigQosQosscheduleroutputtopOutput `json:"frinx-openconfig-qos:output,omitempty"`
}
