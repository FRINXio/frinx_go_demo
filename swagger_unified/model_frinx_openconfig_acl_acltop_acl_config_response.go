...
// frinx.openconfig.acl.acltop.acl.Config.response
type FrinxOpenconfigAclAcltopAclConfigResponse struct {
	FrinxOpenconfigAclconfig *FrinxOpenconfigAclAcltopAclConfig `json:"frinx-openconfig-acl:config,omitempty"`
}
