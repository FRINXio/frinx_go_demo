...
// frinx.openconfig.qos.qos.classifiers.classifier.terms.term.conditions.ipv6.Config.response
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv6ConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv6Config `json:"frinx-openconfig-qos:config,omitempty"`
}
