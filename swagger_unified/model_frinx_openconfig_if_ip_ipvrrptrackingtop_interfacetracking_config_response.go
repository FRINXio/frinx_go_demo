...
// frinx.openconfig.if.ip.ipvrrptrackingtop.interfacetracking.Config.response
type FrinxOpenconfigIfIpIpvrrptrackingtopInterfacetrackingConfigResponse struct {
	FrinxOpenconfigIfIpconfig *FrinxOpenconfigIfIpIpvrrptrackingtopInterfacetrackingConfig `json:"frinx-openconfig-if-ip:config,omitempty"`
}
