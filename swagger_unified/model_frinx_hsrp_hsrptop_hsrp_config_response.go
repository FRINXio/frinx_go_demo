...
// frinx.hsrp.hsrptop.hsrp.Config.response
type FrinxHsrpHsrptopHsrpConfigResponse struct {
	FrinxHsrpconfig *FrinxHsrpHsrptopHsrpConfig `json:"frinx-hsrp:config,omitempty"`
}
