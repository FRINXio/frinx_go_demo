...
// frinx.openconfig.ospf.policy.ospfmatchconditions.ospfconditions.Config.response
type FrinxOpenconfigOspfPolicyOspfmatchconditionsOspfconditionsConfigResponse struct {
	FrinxOpenconfigOspfPolicyconfig *FrinxOpenconfigOspfPolicyOspfmatchconditionsOspfconditionsConfig `json:"frinx-openconfig-ospf-policy:config,omitempty"`
}
