...
type FrinxOpenconfigPlatformLinecardLinecardtopLinecard struct {
	// Optional[Configuration data for linecards] REF:Optional.empty
	Config *FrinxOpenconfigPlatformLinecardLinecardtopLinecardConfig `json:"config,omitempty"`
}
