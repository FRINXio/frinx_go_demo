...
// Optional[List of egress ACLs on the interface] REF:Optional.empty
type FrinxOpenconfigAclInterfaceegressacltopEgressaclsetsEgressAclSet struct {
	...
	Config *FrinxOpenconfigAclInterfaceegressacltopEgressaclsetsEgressaclsetConfig `json:"config,omitempty"`
}
