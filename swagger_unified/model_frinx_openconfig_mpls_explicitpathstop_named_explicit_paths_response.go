...
// frinx.openconfig.mpls.explicitpathstop.NamedExplicitPaths.response
type FrinxOpenconfigMplsExplicitpathstopNamedExplicitPathsResponse struct {
	FrinxOpenconfigNetworkInstancenamedExplicitPaths *FrinxOpenconfigMplsExplicitpathstopNamedExplicitPaths `json:"frinx-openconfig-network-instance:named-explicit-paths,omitempty"`
}
