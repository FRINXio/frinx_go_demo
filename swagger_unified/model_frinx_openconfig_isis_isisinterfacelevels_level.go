...
// Optional[Configuration and operational state parameters related to a particular level on an IS-IS enabled interface.] REF:Optional.empty
type FrinxOpenconfigIsisIsisinterfacelevelsLevel struct {
	// Optional[This container defines address-family specific configuration and state information.] REF:Optional.empty
	AfiSafi *FrinxOpenconfigIsisIsisinterfacelevelgroupAfiSafi `json:"afi-safi,omitempty"`
	// Optional[This container defines ISIS timers.] REF:Optional.empty
	Timers *FrinxOpenconfigIsisIsisinterfacelevelgroupTimers `json:"timers,omitempty"`
	...
	HelloAuthentication *FrinxOpenconfigIsisIsisinterfacelevelgroupHelloAuthentication `json:"hello-authentication,omitempty"`
	// Optional[This container defines ISIS interface packet counters.] REF:Optional.empty
	PacketCounters *FrinxOpenconfigIsisIsisinterfacelevelgroupPacketCounters `json:"packet-counters,omitempty"`
	// Optional[This container defines interface ISIS level configuration.] REF:Optional.empty
	Config *FrinxOpenconfigIsisIsisinterfacelevelgroupConfig `json:"config,omitempty"`
}
