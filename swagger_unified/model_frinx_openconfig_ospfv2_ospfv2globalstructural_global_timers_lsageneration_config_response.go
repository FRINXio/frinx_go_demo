...
// frinx.openconfig.ospfv2.ospfv2globalstructural.global.timers.lsageneration.Config.response
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersLsagenerationConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersLsagenerationConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
