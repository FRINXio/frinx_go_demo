...
// frinx.openconfig.if.ip.ipvrrptrackingtop.interfacetracking.Config.request
type FrinxOpenconfigIfIpIpvrrptrackingtopInterfacetrackingConfigRequest2 struct {
