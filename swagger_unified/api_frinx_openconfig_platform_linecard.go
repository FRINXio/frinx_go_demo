...
type FrinxOpenconfigPlatformLinecardApiService service

/*
FrinxOpenconfigPlatformLinecardApiService
...
*/
func (a *FrinxOpenconfigPlatformLinecardApiService) DeleteFrinxOpenconfigPlatformComponentsComponentLinecard(ctx context.Context, name string, nodeId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/config/network-topology:network-topology/network-topology:topology/unified/network-topology:node/{node-id}/yang-ext:mount/frinx-openconfig-platform:components/frinx-openconfig-platform:component/{name}/frinx-openconfig-platform-linecard:linecard/"
...
*/
func (a *FrinxOpenconfigPlatformLinecardApiService) DeleteFrinxOpenconfigPlatformComponentsComponentLinecardConfig(ctx context.Context, name string, nodeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return FrinxOpenconfigPlatformLinecardLinecardtopLinecardResponse
*/
func (a *FrinxOpenconfigPlatformLinecardApiService) GetFrinxOpenconfigPlatformComponentsComponentLinecard(ctx context.Context, name string, nodeId string) (FrinxOpenconfigPlatformLinecardLinecardtopLinecardResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxOpenconfigPlatformLinecardLinecardtopLinecardResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxOpenconfigPlatformLinecardLinecardtopLinecardResponse
...
@return FrinxOpenconfigPlatformLinecardLinecardtopLinecardConfigResponse
*/
func (a *FrinxOpenconfigPlatformLinecardApiService) GetFrinxOpenconfigPlatformComponentsComponentLinecardConfig(ctx context.Context, name string, nodeId string) (FrinxOpenconfigPlatformLinecardLinecardtopLinecardConfigResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxOpenconfigPlatformLinecardLinecardtopLinecardConfigResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxOpenconfigPlatformLinecardLinecardtopLinecardConfigResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Id of component
 * @param frinxOpenconfigPlatformLinecardLinecardtopLinecardBodyParam frinx.openconfig.platform.linecard.linecardtop.Linecard to be added or updated
 * @param nodeId


*/
func (a *FrinxOpenconfigPlatformLinecardApiService) PutFrinxOpenconfigPlatformComponentsComponentLinecard(ctx context.Context, name string, frinxOpenconfigPlatformLinecardLinecardtopLinecardBodyParam FrinxOpenconfigPlatformLinecardLinecardtopLinecardRequest, nodeId string) (*http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &frinxOpenconfigPlatformLinecardLinecardtopLinecardBodyParam
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Id of component
 * @param frinxOpenconfigPlatformLinecardLinecardtopLinecardConfigBodyParam frinx.openconfig.platform.linecard.linecardtop.linecard.Config to be added or updated
 * @param nodeId


*/
func (a *FrinxOpenconfigPlatformLinecardApiService) PutFrinxOpenconfigPlatformComponentsComponentLinecardConfig(ctx context.Context, name string, frinxOpenconfigPlatformLinecardLinecardtopLinecardConfigBodyParam FrinxOpenconfigPlatformLinecardLinecardtopLinecardConfigRequest, nodeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// body params
	localVarPostBody = &frinxOpenconfigPlatformLinecardLinecardtopLinecardConfigBodyParam
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
