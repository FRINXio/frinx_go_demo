...
type FrinxOpenconfigIfAggregateApiService service

/*
FrinxOpenconfigIfAggregateApiService
...
*/
func (a *FrinxOpenconfigIfAggregateApiService) DeleteFrinxOpenconfigInterfacesInterfacesInterfaceAggregation(ctx context.Context, name string, nodeId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/config/network-topology:network-topology/network-topology:topology/unified/network-topology:node/{node-id}/yang-ext:mount/frinx-openconfig-interfaces:interfaces/frinx-openconfig-interfaces:interface/{name}/frinx-openconfig-if-aggregate:aggregation/"
...
*/
func (a *FrinxOpenconfigIfAggregateApiService) DeleteFrinxOpenconfigInterfacesInterfacesInterfaceAggregationConfig(ctx context.Context, name string, nodeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return FrinxOpenconfigIfAggregateAggregationlogicaltopAggregationResponse
*/
func (a *FrinxOpenconfigIfAggregateApiService) GetFrinxOpenconfigInterfacesInterfacesInterfaceAggregation(ctx context.Context, name string, nodeId string) (FrinxOpenconfigIfAggregateAggregationlogicaltopAggregationResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxOpenconfigIfAggregateAggregationlogicaltopAggregationResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxOpenconfigIfAggregateAggregationlogicaltopAggregationResponse
...
@return FrinxOpenconfigIfAggregateAggregationlogicaltopAggregationConfigResponse
*/
func (a *FrinxOpenconfigIfAggregateApiService) GetFrinxOpenconfigInterfacesInterfacesInterfaceAggregationConfig(ctx context.Context, name string, nodeId string) (FrinxOpenconfigIfAggregateAggregationlogicaltopAggregationConfigResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxOpenconfigIfAggregateAggregationlogicaltopAggregationConfigResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxOpenconfigIfAggregateAggregationlogicaltopAggregationConfigResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Id of interface
 * @param frinxOpenconfigIfAggregateAggregationlogicaltopAggregationBodyParam frinx.openconfig.if.aggregate.aggregationlogicaltop.Aggregation to be added or updated
 * @param nodeId


*/
func (a *FrinxOpenconfigIfAggregateApiService) PutFrinxOpenconfigInterfacesInterfacesInterfaceAggregation(ctx context.Context, name string, frinxOpenconfigIfAggregateAggregationlogicaltopAggregationBodyParam FrinxOpenconfigIfAggregateAggregationlogicaltopAggregationRequest, nodeId string) (*http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &frinxOpenconfigIfAggregateAggregationlogicaltopAggregationBodyParam
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Id of interface
 * @param frinxOpenconfigIfAggregateAggregationlogicaltopAggregationConfigBodyParam frinx.openconfig.if.aggregate.aggregationlogicaltop.aggregation.Config to be added or updated
 * @param nodeId


*/
func (a *FrinxOpenconfigIfAggregateApiService) PutFrinxOpenconfigInterfacesInterfacesInterfaceAggregationConfig(ctx context.Context, name string, frinxOpenconfigIfAggregateAggregationlogicaltopAggregationConfigBodyParam FrinxOpenconfigIfAggregateAggregationlogicaltopAggregationConfigRequest, nodeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// body params
	localVarPostBody = &frinxOpenconfigIfAggregateAggregationlogicaltopAggregationConfigBodyParam
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
