...
// frinx.openconfig.isis.isisinterfacelevels.Level.response
type FrinxOpenconfigIsisIsisinterfacelevelsLevelResponse struct {
	FrinxOpenconfigNetworkInstancelevel []FrinxOpenconfigIsisIsisinterfacelevelsLevel `json:"frinx-openconfig-network-instance:level,omitempty"`
}
