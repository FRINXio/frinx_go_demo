...
type FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesRuleConfig struct {
	// Optional[Unique sequence number for the policy rule.] REF:Optional.empty
