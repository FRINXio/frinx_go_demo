...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolLocalAggregates struct {
	// Optional[List of aggregates] REF:Optional.empty
	Aggregate []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolLocalaggregatesAggregate `json:"aggregate,omitempty"`
}
