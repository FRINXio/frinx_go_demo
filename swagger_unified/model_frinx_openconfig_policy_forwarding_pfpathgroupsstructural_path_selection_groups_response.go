...
// frinx.openconfig.policy.forwarding.pfpathgroupsstructural.PathSelectionGroups.response
type FrinxOpenconfigPolicyForwardingPfpathgroupsstructuralPathSelectionGroupsResponse struct {
	FrinxOpenconfigNetworkInstancepathSelectionGroups *FrinxOpenconfigPolicyForwardingPfpathgroupsstructuralPathSelectionGroups `json:"frinx-openconfig-network-instance:path-selection-groups,omitempty"`
}
