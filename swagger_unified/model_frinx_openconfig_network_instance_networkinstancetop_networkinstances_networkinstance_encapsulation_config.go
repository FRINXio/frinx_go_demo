...
// Optional[Configuration parameters relating to the encapsulation of the network instance] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceEncapsulationConfig struct {
	// Optional[The on-the-wire encapsulation that should be used when sending traffic from this network instance] REF:Optional.empty
	EncapsulationType *FrinxOpenconfigNetworkInstanceEncapsulationTypeIdentityref `json:"encapsulation-type,omitempty"`
	// Optional[Whether the control-word should be used for the network instance] REF:Optional[RFC3985]
	ControlWord bool `json:"control-word,omitempty"`
	// Optional[The label allocation mode to be used for L3 entries in the network instance] REF:Optional.empty
	LabelAllocationMode *FrinxOpenconfigNetworkInstanceLabelAllocationModeIdentityref `json:"label-allocation-mode,omitempty"`
}
