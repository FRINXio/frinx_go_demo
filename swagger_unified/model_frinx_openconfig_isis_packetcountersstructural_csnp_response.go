...
// frinx.openconfig.isis.packetcountersstructural.Csnp.response
type FrinxOpenconfigIsisPacketcountersstructuralCsnpResponse struct {
	FrinxOpenconfigNetworkInstancecsnp *FrinxOpenconfigIsisPacketcountersstructuralCsnp `json:"frinx-openconfig-network-instance:csnp,omitempty"`
}
