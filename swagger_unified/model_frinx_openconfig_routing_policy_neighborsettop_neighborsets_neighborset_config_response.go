...
// frinx.openconfig.routing.policy.neighborsettop.neighborsets.neighborset.Config.response
type FrinxOpenconfigRoutingPolicyNeighborsettopNeighborsetsNeighborsetConfigResponse struct {
	FrinxOpenconfigRoutingPolicyconfig *FrinxOpenconfigRoutingPolicyNeighborsettopNeighborsetsNeighborsetConfig `json:"frinx-openconfig-routing-policy:config,omitempty"`
}
