...
// frinx.openconfig.bgp.policy.matchcommunitytop.MatchCommunitySet.response
type FrinxOpenconfigBgpPolicyMatchcommunitytopMatchCommunitySetResponse struct {
	FrinxOpenconfigBgpPolicymatchCommunitySet *FrinxOpenconfigBgpPolicyMatchcommunitytopMatchCommunitySet `json:"frinx-openconfig-bgp-policy:match-community-set,omitempty"`
}
