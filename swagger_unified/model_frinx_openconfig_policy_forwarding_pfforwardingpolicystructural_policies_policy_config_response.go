...
// frinx.openconfig.policy.forwarding.pfforwardingpolicystructural.policies.policy.Config.response
type FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
