...
type FrinxCiscoOspfExtensionIncludeIdentityref string

// List of frinx.cisco.ospf.extension.IncludeIdentityref
const (
	FrinxCiscoOspfExtensionIncludeIdentityref_OPENCONFIG_OSPF_TYPESMAX_METRIC_INCLUDE_STUB FrinxCiscoOspfExtensionIncludeIdentityref = "frinx-openconfig-ospf-types:MAX_METRIC_INCLUDE_STUB"
	FrinxCiscoOspfExtensionIncludeIdentityref_OPENCONFIG_OSPF_TYPESMAX_METRIC_INCLUDE_TYPE2_EXTERNAL FrinxCiscoOspfExtensionIncludeIdentityref = "frinx-openconfig-ospf-types:MAX_METRIC_INCLUDE_TYPE2_EXTERNAL"
	FrinxCiscoOspfExtensionIncludeIdentityref_OPENCONFIG_OSPF_TYPESMAX_METRIC_INCLUDE FrinxCiscoOspfExtensionIncludeIdentityref = "frinx-openconfig-ospf-types:MAX_METRIC_INCLUDE"
	FrinxCiscoOspfExtensionIncludeIdentityref_CISCO_OSPF_EXTENSIONMAX_METRIC_SUMMARY_LSA FrinxCiscoOspfExtensionIncludeIdentityref = "frinx-cisco-ospf-extension:MAX_METRIC_SUMMARY_LSA"
)
