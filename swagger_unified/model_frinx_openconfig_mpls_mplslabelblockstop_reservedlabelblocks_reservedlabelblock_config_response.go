...
// frinx.openconfig.mpls.mplslabelblockstop.reservedlabelblocks.reservedlabelblock.Config.response
type FrinxOpenconfigMplsMplslabelblockstopReservedlabelblocksReservedlabelblockConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsMplslabelblockstopReservedlabelblocksReservedlabelblockConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
