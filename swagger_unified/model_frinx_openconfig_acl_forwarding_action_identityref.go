...
type FrinxOpenconfigAclForwardingActionIdentityref string

// List of frinx.openconfig.acl.ForwardingActionIdentityref
const (
	FrinxOpenconfigAclForwardingActionIdentityref_FORWARDING_ACTION FrinxOpenconfigAclForwardingActionIdentityref = "frinx-openconfig-acl:FORWARDING_ACTION"
	FrinxOpenconfigAclForwardingActionIdentityref_REJECT FrinxOpenconfigAclForwardingActionIdentityref = "frinx-openconfig-acl:REJECT"
	FrinxOpenconfigAclForwardingActionIdentityref_ACCEPT FrinxOpenconfigAclForwardingActionIdentityref = "frinx-openconfig-acl:ACCEPT"
	FrinxOpenconfigAclForwardingActionIdentityref_DROP FrinxOpenconfigAclForwardingActionIdentityref = "frinx-openconfig-acl:DROP"
)
