...
// frinx.openconfig.qos.qosinterfaceclassifiertop.classifers.classifier.Config.response
type FrinxOpenconfigQosQosinterfaceclassifiertopClassifersClassifierConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosinterfaceclassifiertopClassifersClassifierConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
