...
type FrinxOpenconfigIsisIsisglobalbaseTransport struct {
	// Optional[This container defines ISIS transport related configuration.] REF:Optional.empty
	Config *FrinxOpenconfigIsisIsisglobalbaseTransportConfig `json:"config,omitempty"`
}
