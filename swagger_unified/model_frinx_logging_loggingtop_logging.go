...
// Optional[Enclosing container for logging data.] REF:Optional.empty
type FrinxLoggingLoggingtopLogging struct {
	// Optional[Configuration and operational state relating logging on interfaces.] REF:Optional.empty
	Interfaces *FrinxLoggingLogginginterfacesstructuralInterfaces `json:"interfaces,omitempty"`
}
