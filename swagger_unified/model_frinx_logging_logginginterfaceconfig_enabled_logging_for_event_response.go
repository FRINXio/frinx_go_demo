...
// frinx.logging.logginginterfaceconfig.EnabledLoggingForEvent.response
type FrinxLoggingLogginginterfaceconfigEnabledLoggingForEventResponse struct {
	FrinxLoggingenabledLoggingForEvent []FrinxLoggingLogginginterfaceconfigEnabledLoggingForEvent `json:"frinx-logging:enabled-logging-for-event,omitempty"`
}
