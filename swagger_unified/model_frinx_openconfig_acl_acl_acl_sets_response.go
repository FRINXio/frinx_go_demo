...
// frinx.openconfig.acl.acl.AclSets.response
type FrinxOpenconfigAclAclAclSetsResponse struct {
	FrinxOpenconfigAclaclSets *FrinxOpenconfigAclAclAclSets `json:"frinx-openconfig-acl:acl-sets,omitempty"`
}
