...
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersMaxMetric struct {
	...
	Config *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersMaxmetricConfig `json:"config,omitempty"`
}
