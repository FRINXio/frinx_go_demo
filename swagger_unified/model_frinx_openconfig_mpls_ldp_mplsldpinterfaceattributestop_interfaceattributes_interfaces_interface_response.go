...
// frinx.openconfig.mpls.ldp.mplsldpinterfaceattributestop.interfaceattributes.interfaces.Interface.response
type FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceattributesInterfacesInterfaceResponse struct {
	FrinxOpenconfigNetworkInstanceinterface []FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceattributesInterfacesInterface `json:"frinx-openconfig-network-instance:interface,omitempty"`
}
