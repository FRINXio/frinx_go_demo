...
// frinx.openconfig.interfaces.interfaceref.InterfaceRef.response
type FrinxOpenconfigInterfacesInterfacerefInterfaceRefResponse4 struct {
	FrinxOpenconfigNetworkInstanceinterfaceRef *FrinxOpenconfigInterfacesInterfacerefInterfaceRef `json:"frinx-openconfig-network-instance:interface-ref,omitempty"`
}
