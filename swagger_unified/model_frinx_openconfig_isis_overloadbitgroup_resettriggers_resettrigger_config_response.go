...
// frinx.openconfig.isis.overloadbitgroup.resettriggers.resettrigger.Config.response
type FrinxOpenconfigIsisOverloadbitgroupResettriggersResettriggerConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisOverloadbitgroupResettriggersResettriggerConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
