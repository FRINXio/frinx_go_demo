...
type FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceEncapsulation struct {
	// Optional[Configuration parameters relating to the encapsulation of the network instance] REF:Optional.empty
	Config *FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceEncapsulationConfig `json:"config,omitempty"`
}
