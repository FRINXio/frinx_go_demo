...
// frinx.openconfig.bgp.bgpcommonglobalgroupusemultiplepaths.usemultiplepaths.Config.response
type FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
