...
// frinx.openconfig.if.aggregate.aggregationlogicaltop.aggregation.Config.response
type FrinxOpenconfigIfAggregateAggregationlogicaltopAggregationConfigResponse struct {
	FrinxOpenconfigIfAggregateconfig *FrinxOpenconfigIfAggregateAggregationlogicaltopAggregationConfig `json:"frinx-openconfig-if-aggregate:config,omitempty"`
}
