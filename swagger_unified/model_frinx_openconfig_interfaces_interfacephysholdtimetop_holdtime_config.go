...
// Optional[Configuration data for interface hold-time settings.] REF:Optional.empty
type FrinxOpenconfigInterfacesInterfacephysholdtimetopHoldtimeConfig struct {
	// Optional[Dampens advertisement when the interface transitions from up to down.  A zero value means dampening is turned off, i.e., immediate notification.] REF:Optional.empty
	Down int64 `json:"down,omitempty"`
	// Optional[Dampens advertisement when the interface transitions from down to up.  A zero value means dampening is turned off, i.e., immediate notification.] REF:Optional.empty
