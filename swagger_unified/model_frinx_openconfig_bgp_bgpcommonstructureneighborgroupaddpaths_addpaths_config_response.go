...
// frinx.openconfig.bgp.bgpcommonstructureneighborgroupaddpaths.addpaths.Config.response
type FrinxOpenconfigBgpBgpcommonstructureneighborgroupaddpathsAddpathsConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpcommonstructureneighborgroupaddpathsAddpathsConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
