...
// frinx.netflow.interfaceingressnetflowtop.ingressflows.ingressflow.Config.request
type FrinxNetflowInterfaceingressnetflowtopIngressflowsIngressflowConfigRequest struct {
