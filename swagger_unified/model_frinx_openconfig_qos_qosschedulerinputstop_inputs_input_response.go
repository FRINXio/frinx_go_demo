...
// frinx.openconfig.qos.qosschedulerinputstop.inputs.Input.response
type FrinxOpenconfigQosQosschedulerinputstopInputsInputResponse struct {
	FrinxOpenconfigQosinput []FrinxOpenconfigQosQosschedulerinputstopInputsInput `json:"frinx-openconfig-qos:input,omitempty"`
}
