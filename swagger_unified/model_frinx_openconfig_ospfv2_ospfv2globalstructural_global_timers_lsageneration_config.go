...
// Optional[Configuration parameters relating to the generation of LSAs by the local system] REF:Optional.empty
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersLsagenerationConfig struct {
	// Optional[The value of this leaf specifies the time between the first time an LSA is generated and advertised and the subsequent generation of that LSA.] REF:Optional.empty
	InitialDelay int64 `json:"initial-delay,omitempty"`
	// Optional[The value of this leaf specifies the maximum time between the generation of an LSA and the subsequent re-generation of that LSA. This value is used in implementations that support increasing delay between generation of an LSA] REF:Optional.empty
	MaximumDelay int64 `json:"maximum-delay,omitempty"`
}
