...
// Optional[List of interfaces which are enabled within this area] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2AreasAreaInterfacesInterface struct {
	// Optional[Enclosing container for BFD interface-specific data.] REF:Optional.empty
	FrinxBfdExtensionbfd *FrinxBfdBfdtopBfd `json:"frinx-bfd-extension:bfd,omitempty"`
	// Optional[Timers relating to OSPFv2 on the interface] REF:Optional.empty
	Timers *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceTimers `json:"timers,omitempty"`
	// Optional[Enable BFD for liveliness detection to the next-hop or neighbour.] REF:Optional.empty
	FrinxBfdExtensionenableBfd *FrinxOpenconfigBfdBfdenableEnableBfd `json:"frinx-bfd-extension:enable-bfd,omitempty"`
	// Optional[Enclosing container for the list of neighbors that an adjacency has been established with on the interface] REF:Optional.empty
	Neighbors *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceNeighbors `json:"neighbors,omitempty"`
	// Optional[OSPFv2 parameters relating to filtering of LSAs to neighbors the specified interface.] REF:Optional.empty
	LsaFilter *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceLsaFilter `json:"lsa-filter,omitempty"`
	// Optional[Configuration and operational state parameters for OSPFv2 extensions related to MPLS on the interface.] REF:Optional.empty
	Mpls *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMpls `json:"mpls,omitempty"`
	// Optional[A pointer to the identifier for the interface.] REF:Optional.empty
	Id string `json:"id,omitempty"`
	// Optional[Configuration parameters for the interface on which OSPFv2 is enabled] REF:Optional.empty
	Config *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2AreasAreaInterfacesInterfaceConfig `json:"config,omitempty"`
