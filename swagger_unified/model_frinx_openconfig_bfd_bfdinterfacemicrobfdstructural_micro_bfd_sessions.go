...
type FrinxOpenconfigBfdBfdinterfacemicrobfdstructuralMicroBfdSessions struct {
	...
	MicroBfdSession []FrinxOpenconfigBfdBfdinterfacemicrobfdstructuralMicrobfdsessionsMicroBfdSession `json:"micro-bfd-session,omitempty"`
}
