...
// frinx.openconfig.isis.overloadbitgroup.resettriggers.ResetTrigger.response
type FrinxOpenconfigIsisOverloadbitgroupResettriggersResetTriggerResponse struct {
	FrinxOpenconfigNetworkInstanceresetTrigger []FrinxOpenconfigIsisOverloadbitgroupResettriggersResetTrigger `json:"frinx-openconfig-network-instance:reset-trigger,omitempty"`
}
