...
// frinx.openconfig.platform.transceiver.physicalchanneltop.physicalchannels.channel.Config.response
type FrinxOpenconfigPlatformTransceiverPhysicalchanneltopPhysicalchannelsChannelConfigResponse struct {
	FrinxOpenconfigPlatformTransceiverconfig *FrinxOpenconfigPlatformTransceiverPhysicalchanneltopPhysicalchannelsChannelConfig `json:"frinx-openconfig-platform-transceiver:config,omitempty"`
}
