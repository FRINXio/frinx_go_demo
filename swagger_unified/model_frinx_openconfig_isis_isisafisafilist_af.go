...
type FrinxOpenconfigIsisIsisafisafilistAf struct {
	...
	// Optional[This container defines AFI-SAFI configuration parameters] REF:Optional.empty
	Config *FrinxOpenconfigIsisIsisafisafilistAfConfig `json:"config,omitempty"`
	// Optional[This container defines multi-topology address-family configuration and state information. ISIS TLV 235, 237.] REF:Optional.empty
	MultiTopology *FrinxOpenconfigIsisIsismtlistMultiTopology `json:"multi-topology,omitempty"`
}
