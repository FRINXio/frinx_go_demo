...
// frinx.openconfig.isis.packetcountersstructural.Ish.response
type FrinxOpenconfigIsisPacketcountersstructuralIshResponse struct {
	FrinxOpenconfigNetworkInstanceish *FrinxOpenconfigIsisPacketcountersstructuralIsh `json:"frinx-openconfig-network-instance:ish,omitempty"`
}
