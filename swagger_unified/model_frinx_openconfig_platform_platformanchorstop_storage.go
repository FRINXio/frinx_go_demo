...
type FrinxOpenconfigPlatformPlatformanchorstopStorage struct {
	// Optional[Configuration data for storage components] REF:Optional.empty
	Config *FrinxOpenconfigPlatformPlatformanchorstopStorageConfig `json:"config,omitempty"`
}
