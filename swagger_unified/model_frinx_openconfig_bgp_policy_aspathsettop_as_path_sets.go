...
type FrinxOpenconfigBgpPolicyAspathsettopAsPathSets struct {
	// Optional[List of defined AS path sets] REF:Optional.empty
	AsPathSet []FrinxOpenconfigBgpPolicyAspathsettopAspathsetsAsPathSet `json:"as-path-set,omitempty"`
}
