...
// frinx.openconfig.bgp.policy.setextcommunityinlinetop.Inline.response
type FrinxOpenconfigBgpPolicySetextcommunityinlinetopInlineResponse struct {
	FrinxOpenconfigBgpPolicyinline *FrinxOpenconfigBgpPolicySetextcommunityinlinetopInline `json:"frinx-openconfig-bgp-policy:inline,omitempty"`
}
