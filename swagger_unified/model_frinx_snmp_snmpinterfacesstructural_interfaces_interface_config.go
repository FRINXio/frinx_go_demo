...
type FrinxSnmpSnmpinterfacesstructuralInterfacesInterfaceConfig struct {
	// Optional[A unique identifier for the interface.] REF:Optional.empty
	InterfaceId string `json:"interface-id,omitempty"`
	// Optional[Event which triggers SNMP trap.] REF:Optional.empty
	EnabledTrapForEvent []FrinxSnmpSnmpinterfaceconfigEnabledTrapForEvent `json:"enabled-trap-for-event,omitempty"`
}
