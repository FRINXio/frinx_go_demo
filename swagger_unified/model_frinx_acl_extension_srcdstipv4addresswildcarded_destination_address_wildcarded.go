...
type FrinxAclExtensionSrcdstipv4addresswildcardedDestinationAddressWildcarded struct {
	// Optional[IPv4 wildcard mask.] REF:Optional.empty
	WildcardMask string `json:"wildcard-mask,omitempty"`
	// Optional[IPv4 address.] REF:Optional.empty
