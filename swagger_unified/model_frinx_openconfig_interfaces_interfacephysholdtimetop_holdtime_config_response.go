...
// frinx.openconfig.interfaces.interfacephysholdtimetop.holdtime.Config.response
type FrinxOpenconfigInterfacesInterfacephysholdtimetopHoldtimeConfigResponse struct {
	FrinxOpenconfigInterfacesconfig *FrinxOpenconfigInterfacesInterfacephysholdtimetopHoldtimeConfig `json:"frinx-openconfig-interfaces:config,omitempty"`
}
