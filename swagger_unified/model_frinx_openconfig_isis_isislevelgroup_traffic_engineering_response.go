...
// frinx.openconfig.isis.isislevelgroup.TrafficEngineering.response
type FrinxOpenconfigIsisIsislevelgroupTrafficEngineeringResponse struct {
	FrinxOpenconfigNetworkInstancetrafficEngineering *FrinxOpenconfigIsisIsislevelgroupTrafficEngineering `json:"frinx-openconfig-network-instance:traffic-engineering,omitempty"`
}
