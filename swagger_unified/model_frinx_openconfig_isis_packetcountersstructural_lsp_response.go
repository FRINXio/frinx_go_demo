...
// frinx.openconfig.isis.packetcountersstructural.Lsp.response
type FrinxOpenconfigIsisPacketcountersstructuralLspResponse struct {
	FrinxOpenconfigNetworkInstancelsp *FrinxOpenconfigIsisPacketcountersstructuralLsp `json:"frinx-openconfig-network-instance:lsp,omitempty"`
}
