...
// frinx.openconfig.bgp.bgppeergroupafisafilist.afisafi.Config.response
type FrinxOpenconfigBgpBgppeergroupafisafilistAfisafiConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgppeergroupafisafilistAfisafiConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
