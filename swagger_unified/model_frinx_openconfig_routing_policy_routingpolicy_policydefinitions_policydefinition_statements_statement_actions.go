...
// Optional[Top-level container for policy action statements] REF:Optional.empty
type FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicydefinitionStatementsStatementActions struct {
	// Optional[Actions specific to OSPF] REF:Optional.empty
	FrinxOpenconfigOspfPolicyospfActions *FrinxOpenconfigOspfPolicyOspfactionsOspfActions `json:"frinx-openconfig-ospf-policy:ospf-actions,omitempty"`
	// Optional[Actions that can be performed by IS-IS within a policy] REF:Optional.empty
	FrinxOpenconfigIsisPolicyisisActions *FrinxOpenconfigIsisPolicyIsisactionsIsisActions `json:"frinx-openconfig-isis-policy:isis-actions,omitempty"`
	// Optional[Configuration data for policy actions] REF:Optional.empty
	Config *FrinxOpenconfigRoutingPolicyPolicyactionstopActionsConfig `json:"config,omitempty"`
	// Optional[Top-level container for BGP-specific actions] REF:Optional.empty
	FrinxOpenconfigBgpPolicybgpActions *FrinxOpenconfigBgpPolicyBgpactionstopBgpActions `json:"frinx-openconfig-bgp-policy:bgp-actions,omitempty"`
}
