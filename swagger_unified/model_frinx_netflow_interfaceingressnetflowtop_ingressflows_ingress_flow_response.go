...
// frinx.netflow.interfaceingressnetflowtop.ingressflows.IngressFlow.response
type FrinxNetflowInterfaceingressnetflowtopIngressflowsIngressFlowResponse struct {
	FrinxNetflowingressFlow []FrinxNetflowInterfaceingressnetflowtopIngressflowsIngressFlow `json:"frinx-netflow:ingress-flow,omitempty"`
}
