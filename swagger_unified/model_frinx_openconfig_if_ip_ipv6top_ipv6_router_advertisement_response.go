...
// frinx.openconfig.if.ip.ipv6top.ipv6.RouterAdvertisement.response
type FrinxOpenconfigIfIpIpv6topIpv6RouterAdvertisementResponse struct {
	FrinxOpenconfigIfIprouterAdvertisement *FrinxOpenconfigIfIpIpv6topIpv6RouterAdvertisement `json:"frinx-openconfig-if-ip:router-advertisement,omitempty"`
}
