...
// frinx.openconfig.platform.platformanchorstop.storage.Config.response
type FrinxOpenconfigPlatformPlatformanchorstopStorageConfigResponse struct {
	FrinxOpenconfigPlatformconfig *FrinxOpenconfigPlatformPlatformanchorstopStorageConfig `json:"frinx-openconfig-platform:config,omitempty"`
}
