...
// frinx.openconfig.mpls.ldp.mplsldpinterfaceattributestop.interfaceattributes.Config.response
type FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceattributesConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceattributesConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
