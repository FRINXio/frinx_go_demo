...
// frinx.openconfig.qos.qosinterfacequeuetop.queues.queue.Config.response
type FrinxOpenconfigQosQosinterfacequeuetopQueuesQueueConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosinterfacequeuetopQueuesQueueConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
