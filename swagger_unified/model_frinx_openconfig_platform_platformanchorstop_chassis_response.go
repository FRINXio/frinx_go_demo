...
// frinx.openconfig.platform.platformanchorstop.Chassis.response
type FrinxOpenconfigPlatformPlatformanchorstopChassisResponse struct {
	FrinxOpenconfigPlatformchassis *FrinxOpenconfigPlatformPlatformanchorstopChassis `json:"frinx-openconfig-platform:chassis,omitempty"`
}
