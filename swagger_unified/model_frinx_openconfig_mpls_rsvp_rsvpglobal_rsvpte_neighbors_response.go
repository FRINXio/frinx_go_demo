...
// frinx.openconfig.mpls.rsvp.rsvpglobal.rsvpte.Neighbors.response
type FrinxOpenconfigMplsRsvpRsvpglobalRsvpteNeighborsResponse struct {
	FrinxOpenconfigNetworkInstanceneighbors *FrinxOpenconfigMplsRsvpRsvpglobalRsvpteNeighbors `json:"frinx-openconfig-network-instance:neighbors,omitempty"`
}
