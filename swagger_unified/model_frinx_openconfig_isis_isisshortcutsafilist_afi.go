...
// Optional[Address-family list.] REF:Optional.empty
type FrinxOpenconfigIsisIsisshortcutsafilistAfi struct {
	...
	Config *FrinxOpenconfigIsisIsisshortcutsafilistAfiConfig `json:"config,omitempty"`
}
