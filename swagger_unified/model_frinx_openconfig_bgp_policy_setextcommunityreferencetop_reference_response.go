...
// frinx.openconfig.bgp.policy.setextcommunityreferencetop.Reference.response
type FrinxOpenconfigBgpPolicySetextcommunityreferencetopReferenceResponse struct {
	FrinxOpenconfigBgpPolicyreference *FrinxOpenconfigBgpPolicySetextcommunityreferencetopReference `json:"frinx-openconfig-bgp-policy:reference,omitempty"`
}
