...
// frinx.openconfig.routing.policy.tagsettop.TagSets.response
type FrinxOpenconfigRoutingPolicyTagsettopTagSetsResponse struct {
	FrinxOpenconfigRoutingPolicytagSets *FrinxOpenconfigRoutingPolicyTagsettopTagSets `json:"frinx-openconfig-routing-policy:tag-sets,omitempty"`
}
