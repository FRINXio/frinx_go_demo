...
// Optional[List of match terms used in the classifier] REF:Optional.empty
type FrinxOpenconfigQosQosClassifiersClassifierTermsTerm struct {
	// Optional[Reference to id list key.] REF:Optional.empty
	...
	Conditions *FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditions `json:"conditions,omitempty"`
	// Optional[Actions to be applied for packets matching the specified classification rules.] REF:Optional.empty
	Actions *FrinxOpenconfigQosQosClassifiersClassifierTermsTermActions `json:"actions,omitempty"`
	// Optional[Configuration data for list of match criteria in a QoS classifier] REF:Optional.empty
	Config *FrinxOpenconfigQosQosclassifiertermstopTermsTermConfig `json:"config,omitempty"`
}
