...
// frinx.openconfig.bgp.bgppeergroupafisafilist.AfiSafi.response
type FrinxOpenconfigBgpBgppeergroupafisafilistAfiSafiResponse struct {
	FrinxOpenconfigNetworkInstanceafiSafi []FrinxOpenconfigBgpBgppeergroupafisafilistAfiSafi `json:"frinx-openconfig-network-instance:afi-safi,omitempty"`
}
