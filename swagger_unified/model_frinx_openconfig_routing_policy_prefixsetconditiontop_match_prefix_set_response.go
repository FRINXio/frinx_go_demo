...
// frinx.openconfig.routing.policy.prefixsetconditiontop.MatchPrefixSet.response
type FrinxOpenconfigRoutingPolicyPrefixsetconditiontopMatchPrefixSetResponse struct {
	FrinxOpenconfigRoutingPolicymatchPrefixSet *FrinxOpenconfigRoutingPolicyPrefixsetconditiontopMatchPrefixSet `json:"frinx-openconfig-routing-policy:match-prefix-set,omitempty"`
}
