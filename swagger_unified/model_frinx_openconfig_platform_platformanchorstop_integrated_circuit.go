...
type FrinxOpenconfigPlatformPlatformanchorstopIntegratedCircuit struct {
	// Optional[Configuration data for chip components] REF:Optional.empty
	Config *FrinxOpenconfigPlatformPlatformanchorstopIntegratedcircuitConfig `json:"config,omitempty"`
}
