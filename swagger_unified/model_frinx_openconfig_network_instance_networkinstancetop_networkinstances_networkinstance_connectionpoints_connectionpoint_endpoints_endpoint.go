...
// Optional[A list of the endpoints (interfaces or remote connection points that can be used for this connection point). The active endpoint is selected based on the precedence that it is configured with] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceConnectionpointsConnectionpointEndpointsEndpoint struct {
	// Optional[Configuration and operational state parameters relating to a remote interface] REF:Optional.empty
	Remote *FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceConnectionpointsConnectionpointEndpointsEndpointRemote `json:"remote,omitempty"`
	// Optional[Configuration parameters relating to the endpoint] REF:Optional.empty
	Config *FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceConnectionpointsConnectionpointEndpointsEndpointConfig `json:"config,omitempty"`
	// Optional[Configuration and operational state parameters relating to a local interface] REF:Optional.empty
	Local *FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceConnectionpointsConnectionpointEndpointsEndpointLocal `json:"local,omitempty"`
	// Optional[A pointer to the configured identifier for the endpoint] REF:Optional.empty
