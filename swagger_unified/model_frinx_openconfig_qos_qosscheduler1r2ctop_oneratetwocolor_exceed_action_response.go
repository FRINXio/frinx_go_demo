...
// frinx.openconfig.qos.qosscheduler1r2ctop.oneratetwocolor.ExceedAction.response
type FrinxOpenconfigQosQosscheduler1r2ctopOneratetwocolorExceedActionResponse struct {
	FrinxOpenconfigQosexceedAction *FrinxOpenconfigQosQosscheduler1r2ctopOneratetwocolorExceedAction `json:"frinx-openconfig-qos:exceed-action,omitempty"`
}
