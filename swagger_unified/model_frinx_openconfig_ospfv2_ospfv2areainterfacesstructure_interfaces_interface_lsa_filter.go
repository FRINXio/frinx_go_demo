...
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceLsaFilter struct {
	// Optional[Configuration parameters relating to filtering LSAs on the specified interface.] REF:Optional.empty
	Config *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceLsafilterConfig `json:"config,omitempty"`
}
