...
// frinx.openconfig.packet.match.ipv6protocolfieldstop.ipv6.Config.response
type FrinxOpenconfigPacketMatchIpv6protocolfieldstopIpv6ConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigPacketMatchIpv6protocolfieldstopIpv6Config `json:"frinx-openconfig-network-instance:config,omitempty"`
}
