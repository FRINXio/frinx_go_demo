...
// frinx.openconfig.policy.forwarding.pfpathgroupsstructural.pathselectiongroups.PathSelectionGroup.response
type FrinxOpenconfigPolicyForwardingPfpathgroupsstructuralPathselectiongroupsPathSelectionGroupResponse struct {
	FrinxOpenconfigNetworkInstancepathSelectionGroup []FrinxOpenconfigPolicyForwardingPfpathgroupsstructuralPathselectiongroupsPathSelectionGroup `json:"frinx-openconfig-network-instance:path-selection-group,omitempty"`
}
