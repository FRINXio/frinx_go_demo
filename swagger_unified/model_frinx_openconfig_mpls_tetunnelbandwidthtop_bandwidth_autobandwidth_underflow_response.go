...
// frinx.openconfig.mpls.tetunnelbandwidthtop.bandwidth.autobandwidth.Underflow.response
type FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthUnderflowResponse struct {
	FrinxOpenconfigNetworkInstanceunderflow *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthUnderflow `json:"frinx-openconfig-network-instance:underflow,omitempty"`
}
