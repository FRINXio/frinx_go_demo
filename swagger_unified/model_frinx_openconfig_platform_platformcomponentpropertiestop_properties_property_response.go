...
// frinx.openconfig.platform.platformcomponentpropertiestop.properties.Property.response
type FrinxOpenconfigPlatformPlatformcomponentpropertiestopPropertiesPropertyResponse struct {
	FrinxOpenconfigPlatformproperty []FrinxOpenconfigPlatformPlatformcomponentpropertiestopPropertiesProperty `json:"frinx-openconfig-platform:property,omitempty"`
}
