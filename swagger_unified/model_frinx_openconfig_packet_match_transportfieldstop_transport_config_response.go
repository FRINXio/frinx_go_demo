...
// frinx.openconfig.packet.match.transportfieldstop.transport.Config.response
type FrinxOpenconfigPacketMatchTransportfieldstopTransportConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigPacketMatchTransportfieldstopTransportConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
