...
// frinx.openconfig.mpls.mplsglobaltop.Config.response
type FrinxOpenconfigMplsMplsglobaltopConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsMplsglobaltopConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
