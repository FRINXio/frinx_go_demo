...
// frinx.openconfig.if.ip.ipvrrptop.vrrp.VrrpGroup.response
type FrinxOpenconfigIfIpIpvrrptopVrrpVrrpGroupResponse struct {
	FrinxOpenconfigIfIpvrrpGroup []FrinxOpenconfigIfIpIpvrrptopVrrpVrrpGroup `json:"frinx-openconfig-if-ip:vrrp-group,omitempty"`
}
