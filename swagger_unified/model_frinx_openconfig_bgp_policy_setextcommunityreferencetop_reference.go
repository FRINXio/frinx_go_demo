...
type FrinxOpenconfigBgpPolicySetextcommunityreferencetopReference struct {
	// Optional[Configuration data for referening an extended community-set in the set-ext-community action] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicySetextcommunityreferencetopReferenceConfig `json:"config,omitempty"`
}
