...
type FrinxOpenconfigRoutingPolicyRoutingpolicyPolicyDefinitions struct {
	...
	PolicyDefinition []FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicyDefinition `json:"policy-definition,omitempty"`
}
