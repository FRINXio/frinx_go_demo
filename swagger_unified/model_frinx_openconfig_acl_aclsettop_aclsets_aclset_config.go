...
type FrinxOpenconfigAclAclsettopAclsetsAclsetConfig struct {
	// Optional[The name of the access-list set] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Description, or comment, for the ACL set] REF:Optional.empty
	Description string `json:"description,omitempty"`
	// Optional[The type determines the fields allowed in the ACL entries belonging to the ACL set (e.g., IPv4, IPv6, etc.)] REF:Optional.empty
	Type_ *FrinxOpenconfigAclTypeIdentityref `json:"type,omitempty"`
}
