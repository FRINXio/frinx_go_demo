...
// Optional[This container defines route preference configuration.] REF:Optional.empty
type FrinxOpenconfigIsisIsislevelgroupRoutepreferenceConfig struct {
	// Optional[Administrative Distance(preference) for internal ISIS routes.] REF:Optional.empty
	InternalRoutePreference int32 `json:"internal-route-preference,omitempty"`
	// Optional[Administrative Distance(preference) for external ISIS routes.] REF:Optional.empty
	ExternalRoutePreference int32 `json:"external-route-preference,omitempty"`
}
