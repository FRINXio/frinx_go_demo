...
// frinx.openconfig.if.ip.ipv6top.ipv6.routeradvertisement.Config.response
type FrinxOpenconfigIfIpIpv6topIpv6RouteradvertisementConfigResponse struct {
	FrinxOpenconfigIfIpconfig *FrinxOpenconfigIfIpIpv6topIpv6RouteradvertisementConfig `json:"frinx-openconfig-if-ip:config,omitempty"`
}
