...
// frinx.openconfig.network.instance.networkinstances.networkinstance.mpls.signalingprotocols.Ldp.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsLdpResponse struct {
	FrinxOpenconfigNetworkInstanceldp *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsLdp `json:"frinx-openconfig-network-instance:ldp,omitempty"`
}
