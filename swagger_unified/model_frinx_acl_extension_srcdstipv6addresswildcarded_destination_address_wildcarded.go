...
type FrinxAclExtensionSrcdstipv6addresswildcardedDestinationAddressWildcarded struct {
	// Optional[IPv6 wildcard mask.] REF:Optional.empty
	WildcardMask string `json:"wildcard-mask,omitempty"`
	// Optional[IPv6 address.] REF:Optional.empty
