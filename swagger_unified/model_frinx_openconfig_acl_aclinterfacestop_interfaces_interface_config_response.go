...
// frinx.openconfig.acl.aclinterfacestop.interfaces.interface.Config.response
type FrinxOpenconfigAclAclinterfacestopInterfacesInterfaceConfigResponse struct {
	FrinxOpenconfigAclconfig *FrinxOpenconfigAclAclinterfacestopInterfacesInterfaceConfig `json:"frinx-openconfig-acl:config,omitempty"`
}
