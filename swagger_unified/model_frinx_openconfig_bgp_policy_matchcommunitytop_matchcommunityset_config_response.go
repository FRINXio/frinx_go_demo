...
// frinx.openconfig.bgp.policy.matchcommunitytop.matchcommunityset.Config.response
type FrinxOpenconfigBgpPolicyMatchcommunitytopMatchcommunitysetConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicyMatchcommunitytopMatchcommunitysetConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
