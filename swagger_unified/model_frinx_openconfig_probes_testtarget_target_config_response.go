...
// frinx.openconfig.probes.testtarget.target.Config.response
type FrinxOpenconfigProbesTesttargetTargetConfigResponse struct {
	FrinxOpenconfigProbesconfig *FrinxOpenconfigProbesTesttargetTargetConfig `json:"frinx-openconfig-probes:config,omitempty"`
}
