...
// Optional[List of interfaces on which NetFlow is set] REF:Optional.empty
type FrinxNetflowNetflowinterfacestopInterfacesInterface struct {
	// Optional[Enclosing container the list of egress flows on the interface] REF:Optional.empty
	EgressFlows *FrinxNetflowInterfaceegressnetflowtopEgressFlows `json:"egress-flows,omitempty"`
	// Optional[Reference to the interface id list key] REF:Optional.empty
	Id string `json:"id,omitempty"`
	// Optional[Enclosing container the list of ingress flows on the interface] REF:Optional.empty
	IngressFlows *FrinxNetflowInterfaceingressnetflowtopIngressFlows `json:"ingress-flows,omitempty"`
	// Optional[Configuration for NetFlow per-interface data] REF:Optional.empty
	Config *FrinxNetflowNetflowinterfacestopInterfacesInterfaceConfig `json:"config,omitempty"`
}
