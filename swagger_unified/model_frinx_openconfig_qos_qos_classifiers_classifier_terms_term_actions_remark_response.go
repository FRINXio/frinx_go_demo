...
// frinx.openconfig.qos.qos.classifiers.classifier.terms.term.actions.Remark.response
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermActionsRemarkResponse struct {
	FrinxOpenconfigQosremark *FrinxOpenconfigQosQosClassifiersClassifierTermsTermActionsRemark `json:"frinx-openconfig-qos:remark,omitempty"`
}
