...
// frinx.openconfig.acl.interfaceingressacltop.ingressaclsets.ingressaclset.Config.response
type FrinxOpenconfigAclInterfaceingressacltopIngressaclsetsIngressaclsetConfigResponse struct {
	FrinxOpenconfigAclconfig *FrinxOpenconfigAclInterfaceingressacltopIngressaclsetsIngressaclsetConfig `json:"frinx-openconfig-acl:config,omitempty"`
}
