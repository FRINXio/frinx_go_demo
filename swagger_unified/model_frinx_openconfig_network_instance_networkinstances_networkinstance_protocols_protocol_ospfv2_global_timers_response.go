...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.ospfv2.global.Timers.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2GlobalTimersResponse struct {
	FrinxOpenconfigNetworkInstancetimers *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2GlobalTimers `json:"frinx-openconfig-network-instance:timers,omitempty"`
}
