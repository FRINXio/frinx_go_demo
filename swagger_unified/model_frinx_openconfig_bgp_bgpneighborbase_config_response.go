...
// frinx.openconfig.bgp.bgpneighborbase.Config.response
type FrinxOpenconfigBgpBgpneighborbaseConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpneighborbaseConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
