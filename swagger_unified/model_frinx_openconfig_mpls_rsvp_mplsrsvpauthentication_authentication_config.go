...
// Optional[Configuration parameters relating to authentication] REF:Optional.empty
type FrinxOpenconfigMplsRsvpMplsrsvpauthenticationAuthenticationConfig struct {
	// Optional[authenticate RSVP signaling messages] REF:Optional[RFC 2747: RSVP Cryptographic Authentication]
	AuthenticationKey string `json:"authentication-key,omitempty"`
	// Optional[Enables RSVP authentication on the node.] REF:Optional.empty
