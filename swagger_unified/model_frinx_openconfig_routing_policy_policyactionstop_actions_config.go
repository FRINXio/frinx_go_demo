...
type FrinxOpenconfigRoutingPolicyPolicyactionstopActionsConfig struct {
	// Optional[Select the final disposition for the route, either accept or reject.] REF:Optional.empty
	PolicyResult *FrinxOpenconfigRoutingPolicyPolicyResultType `json:"policy-result,omitempty"`
}
