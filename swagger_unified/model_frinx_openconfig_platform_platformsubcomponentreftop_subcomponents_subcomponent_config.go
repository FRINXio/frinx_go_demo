...
type FrinxOpenconfigPlatformPlatformsubcomponentreftopSubcomponentsSubcomponentConfig struct {
	// Optional[Reference to the name of the subcomponent] REF:Optional.empty
