...
type FrinxOpenconfigOspfv2Ospfv2areastructureVirtualLinks struct {
	// Optional[Configuration and state parameters relating to a virtual link] REF:Optional.empty
	VirtualLink []FrinxOpenconfigOspfv2Ospfv2areastructureVirtuallinksVirtualLink `json:"virtual-link,omitempty"`
}
