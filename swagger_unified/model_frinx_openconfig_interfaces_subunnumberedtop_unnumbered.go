...
type FrinxOpenconfigInterfacesSubunnumberedtopUnnumbered struct {
	// Optional[Configuration data for unnumbered interface] REF:Optional.empty
	Config *FrinxOpenconfigInterfacesSubunnumberedtopUnnumberedConfig `json:"config,omitempty"`
