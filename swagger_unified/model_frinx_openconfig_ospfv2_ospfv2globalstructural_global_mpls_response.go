...
// frinx.openconfig.ospfv2.ospfv2globalstructural.global.Mpls.response
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMplsResponse struct {
	FrinxOpenconfigNetworkInstancempls *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMpls `json:"frinx-openconfig-network-instance:mpls,omitempty"`
}
