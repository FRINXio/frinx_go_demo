...
type FrinxOpenconfigQosQosinterfacevoqstopVirtualOutputQueues struct {
	// Optional[List of egress interfaces for which a virtual output queue is instantiated at this interface.] REF:Optional.empty
	VoqInterface []FrinxOpenconfigQosQosinterfacevoqstopVirtualoutputqueuesVoqInterface `json:"voq-interface,omitempty"`
}
