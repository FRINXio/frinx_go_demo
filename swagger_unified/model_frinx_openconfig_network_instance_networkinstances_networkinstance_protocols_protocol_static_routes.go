...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticRoutes struct {
	// Optional[List of locally configured static routes] REF:Optional.empty
	Static []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolStaticroutesStatic `json:"static,omitempty"`
}
