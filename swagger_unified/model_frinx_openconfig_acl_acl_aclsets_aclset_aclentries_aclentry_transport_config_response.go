...
// frinx.openconfig.acl.acl.aclsets.aclset.aclentries.aclentry.transport.Config.response
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryTransportConfigResponse struct {
	FrinxOpenconfigAclconfig *FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryTransportConfig `json:"frinx-openconfig-acl:config,omitempty"`
}
