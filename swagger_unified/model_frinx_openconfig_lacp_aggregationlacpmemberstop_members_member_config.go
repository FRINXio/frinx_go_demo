...
type FrinxOpenconfigLacpAggregationlacpmemberstopMembersMemberConfig struct {
	...
	// Optional[Reference to interface member of the LACP aggregate] REF:Optional.empty
