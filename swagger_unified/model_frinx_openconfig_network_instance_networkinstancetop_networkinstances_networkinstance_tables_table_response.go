...
// frinx.openconfig.network.instance.networkinstancetop.networkinstances.networkinstance.tables.Table.response
type FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceTablesTableResponse struct {
	FrinxOpenconfigNetworkInstancetable []FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceTablesTable `json:"frinx-openconfig-network-instance:table,omitempty"`
}
