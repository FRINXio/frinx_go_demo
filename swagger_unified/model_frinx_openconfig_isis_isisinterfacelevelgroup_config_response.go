...
// frinx.openconfig.isis.isisinterfacelevelgroup.Config.response
type FrinxOpenconfigIsisIsisinterfacelevelgroupConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisinterfacelevelgroupConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
