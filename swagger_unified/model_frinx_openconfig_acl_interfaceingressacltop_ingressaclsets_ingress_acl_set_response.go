...
// frinx.openconfig.acl.interfaceingressacltop.ingressaclsets.IngressAclSet.response
type FrinxOpenconfigAclInterfaceingressacltopIngressaclsetsIngressAclSetResponse struct {
	FrinxOpenconfigAclingressAclSet []FrinxOpenconfigAclInterfaceingressacltopIngressaclsetsIngressAclSet `json:"frinx-openconfig-acl:ingress-acl-set,omitempty"`
}
