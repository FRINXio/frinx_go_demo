...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsisInterfaces struct {
	// Optional[This list contains ISIS interfaces.] REF:Optional.empty
	Interface_ []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolIsisInterfacesInterface `json:"interface,omitempty"`
}
