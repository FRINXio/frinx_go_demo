...
// frinx.openconfig.isis.isisauthenticationgroup.Key.response
type FrinxOpenconfigIsisIsisauthenticationgroupKeyResponse struct {
	FrinxOpenconfigNetworkInstancekey *FrinxOpenconfigIsisIsisauthenticationgroupKey `json:"frinx-openconfig-network-instance:key,omitempty"`
}
