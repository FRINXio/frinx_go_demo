...
// frinx.openconfig.isis.policy.isismatchconditions.isisconditions.Config.response
type FrinxOpenconfigIsisPolicyIsismatchconditionsIsisconditionsConfigResponse struct {
	FrinxOpenconfigIsisPolicyconfig *FrinxOpenconfigIsisPolicyIsismatchconditionsIsisconditionsConfig `json:"frinx-openconfig-isis-policy:config,omitempty"`
}
