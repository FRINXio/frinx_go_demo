...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.Config.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
