...
// Optional[Configuration parameters for OSPFv2 timers on the interface] REF:Optional.empty
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceTimersConfig struct {
	// Optional[The number of seconds the local system waits between the transmission of subsequent Hello packets] REF:Optional.empty
	...
	RetransmissionInterval int64 `json:"retransmission-interval,omitempty"`
	// Optional[The number of seconds that the local system should let elapse before declaring a silent router down] REF:Optional[RFC2328]
