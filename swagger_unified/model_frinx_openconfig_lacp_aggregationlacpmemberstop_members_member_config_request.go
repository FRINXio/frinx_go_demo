...
// frinx.openconfig.lacp.aggregationlacpmemberstop.members.member.Config.request
type FrinxOpenconfigLacpAggregationlacpmemberstopMembersMemberConfigRequest struct {
