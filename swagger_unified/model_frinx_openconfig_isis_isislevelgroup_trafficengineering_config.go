...
// Optional[This container defines ISIS TE configuration.] REF:Optional.empty
type FrinxOpenconfigIsisIsislevelgroupTrafficengineeringConfig struct {
	// Optional[IPv4 MPLS Traffic Engineering Router-ID.] REF:Optional.empty
	Ipv4RouterId string `json:"ipv4-router-id,omitempty"`
	...
	// Optional[IPv6 MPLS Traffic Engineering Router-ID.] REF:Optional.empty
	Ipv6RouterId string `json:"ipv6-router-id,omitempty"`
}
