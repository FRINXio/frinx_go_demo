...
type FrinxOpenconfigBgpPolicySetcommunityreferencetopReference struct {
	// Optional[Configuration data for referening a community-set in the set-community action] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicySetcommunityreferencetopReferenceConfig `json:"config,omitempty"`
}
