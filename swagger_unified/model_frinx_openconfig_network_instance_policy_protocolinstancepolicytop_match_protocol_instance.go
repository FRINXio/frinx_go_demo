...
type FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchProtocolInstance struct {
	// Optional[Configuration data for policy matching on protocol instance] REF:Optional.empty
	Config *FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchprotocolinstanceConfig `json:"config,omitempty"`
}
