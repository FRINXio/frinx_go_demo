...
// Optional[List of egress interfaces for which a virtual output queue is instantiated at this interface.] REF:Optional.empty
type FrinxOpenconfigQosQosinterfacevoqstopVirtualoutputqueuesVoqInterface struct {
	// Optional[Name used to refer to the egress interface.] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Configuration parameters relating to the interface for which the VOQs are instantiated.] REF:Optional.empty
	Config *FrinxOpenconfigQosQosinterfacevoqstopVirtualoutputqueuesVoqinterfaceConfig `json:"config,omitempty"`
