...
// frinx.openconfig.network.instance.l2nimactabletop.mactable.entries.Entry.request
type FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntriesEntryRequest struct {
