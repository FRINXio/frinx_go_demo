...
// frinx.openconfig.lacp.lacpinterfacestop.interfaces.Interface.response
type FrinxOpenconfigLacpLacpinterfacestopInterfacesInterfaceResponse struct {
	FrinxOpenconfigLacpinterface []FrinxOpenconfigLacpLacpinterfacestopInterfacesInterface `json:"frinx-openconfig-lacp:interface,omitempty"`
}
