...
// frinx.openconfig.qos.qosinterfacequeuetop.Queues.response
type FrinxOpenconfigQosQosinterfacequeuetopQueuesResponse struct {
	FrinxOpenconfigQosqueues *FrinxOpenconfigQosQosinterfacequeuetopQueues `json:"frinx-openconfig-qos:queues,omitempty"`
}
