...
// frinx.openconfig.policy.forwarding.pfforwardingpolicystructural.policies.policy.Rules.response
type FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRulesResponse struct {
	FrinxOpenconfigNetworkInstancerules *FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyRules `json:"frinx-openconfig-network-instance:rules,omitempty"`
}
