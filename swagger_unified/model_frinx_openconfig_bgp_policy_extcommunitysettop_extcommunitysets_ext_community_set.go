...
// Optional[List of defined extended BGP community sets] REF:Optional.empty
type FrinxOpenconfigBgpPolicyExtcommunitysettopExtcommunitysetsExtCommunitySet struct {
	// Optional[Configuration data for extended BGP community sets] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicyExtcommunitysettopExtcommunitysetsExtcommunitysetConfig `json:"config,omitempty"`
