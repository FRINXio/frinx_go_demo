...
// frinx.evpn.evpngroups.groups.group.Config.response
type FrinxEvpnEvpngroupsGroupsGroupConfigResponse struct {
	FrinxEvpnconfig *FrinxEvpnEvpngroupsGroupsGroupConfig `json:"frinx-evpn:config,omitempty"`
}
