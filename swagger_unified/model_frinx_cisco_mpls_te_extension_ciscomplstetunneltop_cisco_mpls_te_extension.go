...
type FrinxCiscoMplsTeExtensionCiscomplstetunneltopCiscoMplsTeExtension struct {
	// Optional[Configuration parameters for CISCO MPLS TE tunnel] REF:Optional.empty
	Config *FrinxCiscoMplsTeExtensionCiscomplstetunneltopCiscomplsteextensionConfig `json:"config,omitempty"`
}
