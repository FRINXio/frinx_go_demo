...
// frinx.openconfig.ospfv2.ospfv2areainterfacesstructure.interfaces.interface.Neighbors.response
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceNeighborsResponse struct {
	FrinxOpenconfigNetworkInstanceneighbors *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceNeighbors `json:"frinx-openconfig-network-instance:neighbors,omitempty"`
}
