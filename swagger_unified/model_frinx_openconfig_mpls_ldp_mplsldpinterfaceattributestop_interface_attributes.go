...
type FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceAttributes struct {
	// Optional[Configuration of per-interface LDP parameters] REF:Optional.empty
	Config *FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceattributesConfig `json:"config,omitempty"`
	// Optional[Container aggregating all interfaces and their LDP-specific attributes.] REF:Optional.empty
	Interfaces *FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceattributesInterfaces `json:"interfaces,omitempty"`
}
