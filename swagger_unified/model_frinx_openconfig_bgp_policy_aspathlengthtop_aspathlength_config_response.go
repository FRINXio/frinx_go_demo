...
// frinx.openconfig.bgp.policy.aspathlengthtop.aspathlength.Config.response
type FrinxOpenconfigBgpPolicyAspathlengthtopAspathlengthConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicyAspathlengthtopAspathlengthConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
