...
// frinx.openconfig.interfaces.interfaceref.interfaceref.Config.response
type FrinxOpenconfigInterfacesInterfacerefInterfacerefConfigResponse4 struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigInterfacesInterfacerefInterfacerefConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
