...
// frinx.openconfig.bgp.bgpglobalafisafilist.afisafi.gracefulrestart.Config.response
type FrinxOpenconfigBgpBgpglobalafisafilistAfisafiGracefulrestartConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpglobalafisafilistAfisafiGracefulrestartConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
