...
// Optional[This list contains configuration and state parameters relating to micro-BFD session.] REF:Optional[RFC7130 - Bidirectional Forwarding Detection (BFD) on Link Aggregation Group (LAG) Interfaces.]
type FrinxOpenconfigBfdBfdinterfacemicrobfdstructuralMicrobfdsessionsMicroBfdSession struct {
	// Optional[A reference to the member interface of the link aggregate.] REF:Optional.empty
	MemberInterface string `json:"member-interface,omitempty"`
	// Optional[Configuration parameters for the micro-BFD session.] REF:Optional.empty
	Config *FrinxOpenconfigBfdBfdinterfacemicrobfdstructuralMicrobfdsessionsMicrobfdsessionConfig `json:"config,omitempty"`
}
