...
type FrinxOpenconfigMplsRsvpMplsrsvpsoftpreemptionSoftPreemption struct {
	// Optional[Configuration parameters relating to RSVP soft preemption support] REF:Optional.empty
	Config *FrinxOpenconfigMplsRsvpMplsrsvpsoftpreemptionSoftpreemptionConfig `json:"config,omitempty"`
}
