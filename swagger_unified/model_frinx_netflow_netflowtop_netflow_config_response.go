...
// frinx.netflow.netflowtop.netflow.Config.response
type FrinxNetflowNetflowtopNetflowConfigResponse struct {
	FrinxNetflowconfig *FrinxNetflowNetflowtopNetflowConfig `json:"frinx-netflow:config,omitempty"`
}
