...
type FrinxOpenconfigMplsMplstesrlgtopSrlgsSrlgConfig struct {
	// Optional[SRLG group identifier] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[The cost of the SRLG to the computation algorithm] REF:Optional.empty
	Cost int64 `json:"cost,omitempty"`
	// Optional[The type of SRLG, either flooded in the IGP or statically configured] REF:Optional.empty
	FloodingType *FrinxOpenconfigMplsMplsSrlgFloodingType `json:"flooding-type,omitempty"`
	// Optional[group ID for the SRLG] REF:Optional.empty
