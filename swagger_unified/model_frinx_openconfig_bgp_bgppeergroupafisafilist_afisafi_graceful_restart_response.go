...
// frinx.openconfig.bgp.bgppeergroupafisafilist.afisafi.GracefulRestart.response
type FrinxOpenconfigBgpBgppeergroupafisafilistAfisafiGracefulRestartResponse struct {
	FrinxOpenconfigNetworkInstancegracefulRestart *FrinxOpenconfigBgpBgppeergroupafisafilistAfisafiGracefulRestart `json:"frinx-openconfig-network-instance:graceful-restart,omitempty"`
}
