...
type FrinxOpenconfigQosQosqueuewredtopWred struct {
	// Optional[Configuration data for WRED] REF:Optional.empty
	Config *FrinxOpenconfigQosQosqueuewredtopWredConfig `json:"config,omitempty"`
}
