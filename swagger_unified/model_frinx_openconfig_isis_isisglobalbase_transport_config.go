...
type FrinxOpenconfigIsisIsisglobalbaseTransportConfig struct {
	// Optional[The maximum size in bytes of an IS-IS Link state PDU.] REF:Optional.empty
	LspMtuSize int32 `json:"lsp-mtu-size,omitempty"`
}
