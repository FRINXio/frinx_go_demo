...
// frinx.openconfig.ospfv2.ospfv2areastructure.Mpls.response
type FrinxOpenconfigOspfv2Ospfv2areastructureMplsResponse struct {
	FrinxOpenconfigNetworkInstancempls *FrinxOpenconfigOspfv2Ospfv2areastructureMpls `json:"frinx-openconfig-network-instance:mpls,omitempty"`
}
