...
// frinx.openconfig.acl.acl.aclsets.aclset.aclentries.AclEntry.response
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclEntryResponse struct {
	FrinxOpenconfigAclaclEntry []FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclEntry `json:"frinx-openconfig-acl:acl-entry,omitempty"`
}
