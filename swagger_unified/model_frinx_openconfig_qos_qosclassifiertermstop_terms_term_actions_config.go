...
type FrinxOpenconfigQosQosclassifiertermstopTermsTermActionsConfig struct {
	// Optional[References the forwarding group or class to which the matched packets should be assigned] REF:Optional.empty
	TargetGroup string `json:"target-group,omitempty"`
}
