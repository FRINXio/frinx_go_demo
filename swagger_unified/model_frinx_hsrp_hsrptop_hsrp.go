...
// Optional[Top level enclosing container for HSRP model config and operational state data] REF:Optional.empty
type FrinxHsrpHsrptopHsrp struct {
	// Optional[Global config data for HSRPs] REF:Optional.empty
	Config *FrinxHsrpHsrptopHsrpConfig `json:"config,omitempty"`
	// Optional[Interface list entries variables enclosing container] REF:Optional.empty
	Interfaces *FrinxHsrpInterfacetopInterfaces `json:"interfaces,omitempty"`
}
