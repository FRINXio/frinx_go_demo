...
// frinx.openconfig.acl.acl.aclsets.aclset.aclentries.aclentry.Ipv6.response
type FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryIpv6Response struct {
	FrinxOpenconfigAclipv6 *FrinxOpenconfigAclAclAclsetsAclsetAclentriesAclentryIpv6 `json:"frinx-openconfig-acl:ipv6,omitempty"`
}
