...
// Optional[Top level configuration containers for EVPN data] REF:Optional.empty
type FrinxEvpnEvpntopEvpn struct {
	// Optional[Groups of EVPN] REF:Optional.empty
	Groups *FrinxEvpnEvpngroupsGroups `json:"groups,omitempty"`
	// Optional[Interfaces of EVPN] REF:Optional.empty
	Interfaces *FrinxEvpnEvpninterfacesInterfaces `json:"interfaces,omitempty"`
	// Optional[Config container for evpn container] REF:Optional.empty
	Config *FrinxEvpnEvpntopEvpnConfig `json:"config,omitempty"`
}
