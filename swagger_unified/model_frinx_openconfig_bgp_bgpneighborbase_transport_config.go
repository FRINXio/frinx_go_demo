...
// Optional[Configuration parameters relating to the transport session(s) used for the BGP neighbor] REF:Optional.empty
type FrinxOpenconfigBgpBgpneighborbaseTransportConfig struct {
