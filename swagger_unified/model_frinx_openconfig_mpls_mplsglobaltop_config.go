...
type FrinxOpenconfigMplsMplsglobaltopConfig struct {
	// Optional[The null-label type used, implicit or explicit] REF:Optional.empty
	NullLabel *FrinxOpenconfigMplsNullLabelIdentityref `json:"null-label,omitempty"`
}
