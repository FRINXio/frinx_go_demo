...
// frinx.openconfig.mpls.tetunnelbandwidthtop.bandwidth.autobandwidth.underflow.Config.response
type FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthUnderflowConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthUnderflowConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
