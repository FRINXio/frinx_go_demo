...
// frinx.openconfig.network.instance.l2nimactabletop.mactable.entries.entry.Config.response
type FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntriesEntryConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntriesEntryConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
