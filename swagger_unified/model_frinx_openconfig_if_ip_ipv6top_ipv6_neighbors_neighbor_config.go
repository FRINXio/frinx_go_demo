...
type FrinxOpenconfigIfIpIpv6topIpv6NeighborsNeighborConfig struct {
	// Optional[[adapted from IETF IP model RFC 7277]  The link-layer address of the neighbor node.] REF:Optional.empty
	LinkLayerAddress string `json:"link-layer-address,omitempty"`
	// Optional[[adapted from IETF IP model RFC 7277]  The IPv6 address of the neighbor node.] REF:Optional.empty
