...
// frinx.openconfig.bgp.bgpglobalafisafilist.AfiSafi.response
type FrinxOpenconfigBgpBgpglobalafisafilistAfiSafiResponse struct {
	FrinxOpenconfigNetworkInstanceafiSafi []FrinxOpenconfigBgpBgpglobalafisafilistAfiSafi `json:"frinx-openconfig-network-instance:afi-safi,omitempty"`
}
