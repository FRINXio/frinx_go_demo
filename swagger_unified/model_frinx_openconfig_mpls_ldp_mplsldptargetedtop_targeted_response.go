...
// frinx.openconfig.mpls.ldp.mplsldptargetedtop.Targeted.response
type FrinxOpenconfigMplsLdpMplsldptargetedtopTargetedResponse struct {
	FrinxOpenconfigNetworkInstancetargeted *FrinxOpenconfigMplsLdpMplsldptargetedtopTargeted `json:"frinx-openconfig-network-instance:targeted,omitempty"`
}
