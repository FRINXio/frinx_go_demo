...
type FrinxOpenconfigOspfPolicyOspfactionsOspfactionsSetMetric struct {
	// Optional[Configuration parameters relating to setting the OSPF metric] REF:Optional.empty
	Config *FrinxOpenconfigOspfPolicyOspfactionsOspfactionsSetmetricConfig `json:"config,omitempty"`
}
