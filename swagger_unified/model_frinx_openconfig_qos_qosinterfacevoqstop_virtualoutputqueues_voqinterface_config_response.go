...
// frinx.openconfig.qos.qosinterfacevoqstop.virtualoutputqueues.voqinterface.Config.response
type FrinxOpenconfigQosQosinterfacevoqstopVirtualoutputqueuesVoqinterfaceConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosinterfacevoqstopVirtualoutputqueuesVoqinterfaceConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
