...
// frinx.openconfig.bgp.bgppeergroupbase.timers.Config.response
type FrinxOpenconfigBgpBgppeergroupbaseTimersConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgppeergroupbaseTimersConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
