...
type FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPoliciesPolicyConfig struct {
	// Optional[A unique name identifying the forwarding policy. This name is used when applying the policy to a particular interface.] REF:Optional.empty
