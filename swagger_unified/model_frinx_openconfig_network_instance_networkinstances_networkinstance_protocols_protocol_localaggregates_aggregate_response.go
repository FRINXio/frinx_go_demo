...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.localaggregates.Aggregate.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolLocalaggregatesAggregateResponse struct {
	FrinxOpenconfigNetworkInstanceaggregate []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolLocalaggregatesAggregate `json:"frinx-openconfig-network-instance:aggregate,omitempty"`
}
