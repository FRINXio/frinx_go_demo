...
// Optional[This container defines ISIS SPF timers configuration.] REF:Optional.empty
type FrinxOpenconfigIsisIsisglobalbaseTimersSpfConfig struct {
	// Optional[Time interval in milliseconds between the detection of topology change and when the SPF algorithm runs.] REF:Optional.empty
	SpfFirstInterval int32 `json:"spf-first-interval,omitempty"`
	// Optional[SPF Hold Down time interval in milliseconds.] REF:Optional.empty
	SpfHoldInterval int32 `json:"spf-hold-interval,omitempty"`
	// Optional[Time interval in milliseconds between the first and second SPF calculation.] REF:Optional.empty
	SpfSecondInterval int32 `json:"spf-second-interval,omitempty"`
}
