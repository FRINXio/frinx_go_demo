...
// frinx.openconfig.ospfv2.ospfv2globalstructural.global.mpls.Config.response
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMplsConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMplsConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
