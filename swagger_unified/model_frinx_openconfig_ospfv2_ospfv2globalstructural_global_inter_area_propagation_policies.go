...
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalInterAreaPropagationPolicies struct {
	...
	InterAreaPropagationPolicy []FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalInterareapropagationpoliciesInterAreaPropagationPolicy `json:"inter-area-propagation-policy,omitempty"`
}
