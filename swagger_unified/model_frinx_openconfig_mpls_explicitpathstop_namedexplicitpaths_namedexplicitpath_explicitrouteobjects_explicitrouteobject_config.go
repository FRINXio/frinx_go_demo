...
type FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedexplicitpathExplicitrouteobjectsExplicitrouteobjectConfig struct {
	// Optional[Index of this explicit route object to express the order of hops in the path] REF:Optional.empty
	Index int32 `json:"index,omitempty"`
	// Optional[strict or loose hop] REF:Optional.empty
	HopType *FrinxOpenconfigMplsMplsHopType `json:"hop-type,omitempty"`
	// Optional[router hop for the LSP path] REF:Optional.empty
