...
// frinx.openconfig.interfaces.Interfaces.response
type FrinxOpenconfigInterfacesInterfacesResponse struct {
	FrinxOpenconfigInterfacesinterfaces *FrinxOpenconfigInterfacesInterfaces `json:"interfaces,omitempty"`
}
