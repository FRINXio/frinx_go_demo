...
// frinx.openconfig.ospfv2.ospfv2areainterfacesstructure.interfaces.interface.mpls.Config.response
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMplsConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceMplsConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
