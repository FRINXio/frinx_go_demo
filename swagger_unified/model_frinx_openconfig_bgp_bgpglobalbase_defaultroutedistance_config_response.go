...
// frinx.openconfig.bgp.bgpglobalbase.defaultroutedistance.Config.response
type FrinxOpenconfigBgpBgpglobalbaseDefaultroutedistanceConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpglobalbaseDefaultroutedistanceConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
