...
// frinx.openconfig.mpls.p2psecondarypathstop.P2pSecondaryPaths.response
type FrinxOpenconfigMplsP2psecondarypathstopP2pSecondaryPathsResponse struct {
	FrinxOpenconfigNetworkInstancep2pSecondaryPaths *FrinxOpenconfigMplsP2psecondarypathstopP2pSecondaryPaths `json:"frinx-openconfig-network-instance:p2p-secondary-paths,omitempty"`
}
