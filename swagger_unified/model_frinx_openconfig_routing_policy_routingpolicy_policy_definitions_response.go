...
// frinx.openconfig.routing.policy.routingpolicy.PolicyDefinitions.response
type FrinxOpenconfigRoutingPolicyRoutingpolicyPolicyDefinitionsResponse struct {
	FrinxOpenconfigRoutingPolicypolicyDefinitions *FrinxOpenconfigRoutingPolicyRoutingpolicyPolicyDefinitions `json:"frinx-openconfig-routing-policy:policy-definitions,omitempty"`
}
