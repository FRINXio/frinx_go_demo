...
// frinx.openconfig.bgp.bgpglobalafisafilist.afisafi.Config.response
type FrinxOpenconfigBgpBgpglobalafisafilistAfisafiConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgpglobalafisafilistAfisafiConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
