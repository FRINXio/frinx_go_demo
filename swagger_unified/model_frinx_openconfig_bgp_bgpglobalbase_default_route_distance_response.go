...
// frinx.openconfig.bgp.bgpglobalbase.DefaultRouteDistance.response
type FrinxOpenconfigBgpBgpglobalbaseDefaultRouteDistanceResponse struct {
	FrinxOpenconfigNetworkInstancedefaultRouteDistance *FrinxOpenconfigBgpBgpglobalbaseDefaultRouteDistance `json:"frinx-openconfig-network-instance:default-route-distance,omitempty"`
}
