...
// frinx.openconfig.bgp.policy.setcommunityreferencetop.reference.Config.request
type FrinxOpenconfigBgpPolicySetcommunityreferencetopReferenceConfigRequest struct {
