...
type FrinxOpenconfigOspfv2IncludeIdentityref string

// List of frinx.openconfig.ospfv2.IncludeIdentityref
const (
	FrinxOpenconfigOspfv2IncludeIdentityref_OPENCONFIG_OSPF_TYPESMAX_METRIC_INCLUDE_STUB FrinxOpenconfigOspfv2IncludeIdentityref = "frinx-openconfig-ospf-types:MAX_METRIC_INCLUDE_STUB"
	FrinxOpenconfigOspfv2IncludeIdentityref_OPENCONFIG_OSPF_TYPESMAX_METRIC_INCLUDE_TYPE2_EXTERNAL FrinxOpenconfigOspfv2IncludeIdentityref = "frinx-openconfig-ospf-types:MAX_METRIC_INCLUDE_TYPE2_EXTERNAL"
	FrinxOpenconfigOspfv2IncludeIdentityref_OPENCONFIG_OSPF_TYPESMAX_METRIC_INCLUDE FrinxOpenconfigOspfv2IncludeIdentityref = "frinx-openconfig-ospf-types:MAX_METRIC_INCLUDE"
	FrinxOpenconfigOspfv2IncludeIdentityref_CISCO_OSPF_EXTENSIONMAX_METRIC_SUMMARY_LSA FrinxOpenconfigOspfv2IncludeIdentityref = "frinx-cisco-ospf-extension:MAX_METRIC_SUMMARY_LSA"
)
