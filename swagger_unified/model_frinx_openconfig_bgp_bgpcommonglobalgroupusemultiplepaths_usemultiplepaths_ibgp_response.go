...
// frinx.openconfig.bgp.bgpcommonglobalgroupusemultiplepaths.usemultiplepaths.Ibgp.response
type FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsIbgpResponse struct {
	FrinxOpenconfigNetworkInstanceibgp *FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsIbgp `json:"frinx-openconfig-network-instance:ibgp,omitempty"`
}
