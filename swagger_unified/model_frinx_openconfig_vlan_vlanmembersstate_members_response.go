...
// frinx.openconfig.vlan.vlanmembersstate.Members.response
type FrinxOpenconfigVlanVlanmembersstateMembersResponse struct {
	FrinxOpenconfigNetworkInstancemembers *FrinxOpenconfigVlanVlanmembersstateMembers `json:"frinx-openconfig-network-instance:members,omitempty"`
}
