...
// frinx.openconfig.qos.qosclassifiertermstop.terms.term.actions.Config.response
type FrinxOpenconfigQosQosclassifiertermstopTermsTermActionsConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosclassifiertermstopTermsTermActionsConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
