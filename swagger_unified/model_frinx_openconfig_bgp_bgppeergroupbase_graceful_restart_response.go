...
// frinx.openconfig.bgp.bgppeergroupbase.GracefulRestart.response
type FrinxOpenconfigBgpBgppeergroupbaseGracefulRestartResponse struct {
	FrinxOpenconfigNetworkInstancegracefulRestart *FrinxOpenconfigBgpBgppeergroupbaseGracefulRestart `json:"frinx-openconfig-network-instance:graceful-restart,omitempty"`
}
