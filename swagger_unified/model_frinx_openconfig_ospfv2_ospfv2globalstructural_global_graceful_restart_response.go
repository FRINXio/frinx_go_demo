...
// frinx.openconfig.ospfv2.ospfv2globalstructural.global.GracefulRestart.response
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalGracefulRestartResponse struct {
	FrinxOpenconfigNetworkInstancegracefulRestart *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalGracefulRestart `json:"frinx-openconfig-network-instance:graceful-restart,omitempty"`
}
