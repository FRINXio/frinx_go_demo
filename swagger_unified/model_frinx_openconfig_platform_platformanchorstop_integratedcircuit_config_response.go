...
// frinx.openconfig.platform.platformanchorstop.integratedcircuit.Config.response
type FrinxOpenconfigPlatformPlatformanchorstopIntegratedcircuitConfigResponse struct {
	FrinxOpenconfigPlatformconfig *FrinxOpenconfigPlatformPlatformanchorstopIntegratedcircuitConfig `json:"frinx-openconfig-platform:config,omitempty"`
}
