...
// frinx.openconfig.network.instance.networkinstances.networkinstance.mpls.SignalingProtocols.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingProtocolsResponse struct {
	FrinxOpenconfigNetworkInstancesignalingProtocols *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingProtocols `json:"frinx-openconfig-network-instance:signaling-protocols,omitempty"`
}
