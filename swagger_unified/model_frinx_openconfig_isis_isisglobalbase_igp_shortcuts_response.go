...
// frinx.openconfig.isis.isisglobalbase.IgpShortcuts.response
type FrinxOpenconfigIsisIsisglobalbaseIgpShortcutsResponse struct {
	FrinxOpenconfigNetworkInstanceigpShortcuts *FrinxOpenconfigIsisIsisglobalbaseIgpShortcuts `json:"frinx-openconfig-network-instance:igp-shortcuts,omitempty"`
}
