...
// frinx.openconfig.bgp.bgpcommonmpl2vpnvplsgroup.L2vpnVpls.response
type FrinxOpenconfigBgpBgpcommonmpl2vpnvplsgroupL2vpnVplsResponse struct {
	FrinxOpenconfigNetworkInstancel2vpnVpls *FrinxOpenconfigBgpBgpcommonmpl2vpnvplsgroupL2vpnVpls `json:"frinx-openconfig-network-instance:l2vpn-vpls,omitempty"`
}
