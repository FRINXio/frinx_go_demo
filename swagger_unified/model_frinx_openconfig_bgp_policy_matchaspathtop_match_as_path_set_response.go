...
// frinx.openconfig.bgp.policy.matchaspathtop.MatchAsPathSet.response
type FrinxOpenconfigBgpPolicyMatchaspathtopMatchAsPathSetResponse struct {
	FrinxOpenconfigBgpPolicymatchAsPathSet *FrinxOpenconfigBgpPolicyMatchaspathtopMatchAsPathSet `json:"frinx-openconfig-bgp-policy:match-as-path-set,omitempty"`
}
