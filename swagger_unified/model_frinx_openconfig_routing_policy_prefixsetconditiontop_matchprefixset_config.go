...
// Optional[Configuration data for a prefix-set condition] REF:Optional.empty
type FrinxOpenconfigRoutingPolicyPrefixsetconditiontopMatchprefixsetConfig struct {
	// Optional[References a defined prefix set] REF:Optional.empty
