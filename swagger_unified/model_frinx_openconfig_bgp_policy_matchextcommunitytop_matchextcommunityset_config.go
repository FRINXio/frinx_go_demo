...
// Optional[Configuration data for match conditions on extended communities] REF:Optional.empty
type FrinxOpenconfigBgpPolicyMatchextcommunitytopMatchextcommunitysetConfig struct {
	// Optional[Optional parameter that governs the behaviour of the match operation] REF:Optional.empty
	MatchSetOptions *FrinxOpenconfigPolicyTypesMatchSetOptionsType `json:"match-set-options,omitempty"`
	// Optional[References a defined extended community set] REF:Optional.empty
	ExtCommunitySet string `json:"ext-community-set,omitempty"`
}
