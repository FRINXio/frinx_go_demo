...
// Optional[Top-level container for the queue associated with this interface] REF:Optional.empty
type FrinxOpenconfigQosQosinterfacequeuetopQueuesQueue struct {
	// Optional[Reference to the name of the queue instantiated on the interface.] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Configuration data for the queue associated with the interface] REF:Optional.empty
	Config *FrinxOpenconfigQosQosinterfacequeuetopQueuesQueueConfig `json:"config,omitempty"`
}
