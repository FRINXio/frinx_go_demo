...
// frinx.openconfig.isis.isislevelgroup.RoutePreference.response
type FrinxOpenconfigIsisIsislevelgroupRoutePreferenceResponse struct {
	FrinxOpenconfigNetworkInstanceroutePreference *FrinxOpenconfigIsisIsislevelgroupRoutePreference `json:"frinx-openconfig-network-instance:route-preference,omitempty"`
}
