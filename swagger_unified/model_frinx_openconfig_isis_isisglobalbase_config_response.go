...
// frinx.openconfig.isis.isisglobalbase.Config.response
type FrinxOpenconfigIsisIsisglobalbaseConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisglobalbaseConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
