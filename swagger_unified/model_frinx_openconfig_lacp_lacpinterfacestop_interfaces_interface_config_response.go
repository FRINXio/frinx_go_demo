...
// frinx.openconfig.lacp.lacpinterfacestop.interfaces.interface.Config.response
type FrinxOpenconfigLacpLacpinterfacestopInterfacesInterfaceConfigResponse struct {
	FrinxOpenconfigLacpconfig *FrinxOpenconfigLacpLacpinterfacestopInterfacesInterfaceConfig `json:"frinx-openconfig-lacp:config,omitempty"`
}
