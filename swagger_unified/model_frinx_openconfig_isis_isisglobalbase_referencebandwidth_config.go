...
type FrinxOpenconfigIsisIsisglobalbaseReferencebandwidthConfig struct {
	// Optional[ISIS Reference Bandwidth value] REF:Optional.empty
	ReferenceBandwidth int64 `json:"reference-bandwidth,omitempty"`
}
