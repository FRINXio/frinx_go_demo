...
// frinx.openconfig.ospfv2.ospfv2areainterfacesstructure.interfaces.interface.lsafilter.Config.response
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceLsafilterConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceLsafilterConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
