...
type FrinxOpenconfigRoutingPolicyNeighborsettopNeighborsetsNeighborsetConfig struct {
	// Optional[name / label of the neighbor set -- this is used to reference the set in match conditions] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[List of IP addresses in the neighbor set] REF:Optional.empty
