...
// frinx.openconfig.platform.platformanchorstop.port.Config.response
type FrinxOpenconfigPlatformPlatformanchorstopPortConfigResponse struct {
	FrinxOpenconfigPlatformconfig *FrinxOpenconfigPlatformPlatformanchorstopPortConfig `json:"frinx-openconfig-platform:config,omitempty"`
}
