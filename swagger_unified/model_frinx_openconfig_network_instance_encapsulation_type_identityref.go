...
type FrinxOpenconfigNetworkInstanceEncapsulationTypeIdentityref string

// List of frinx.openconfig.network.instance.EncapsulationTypeIdentityref
const (
	FrinxOpenconfigNetworkInstanceEncapsulationTypeIdentityref_ENCAPSULATION FrinxOpenconfigNetworkInstanceEncapsulationTypeIdentityref = "frinx-openconfig-network-instance-types:ENCAPSULATION"
	FrinxOpenconfigNetworkInstanceEncapsulationTypeIdentityref_MPLS FrinxOpenconfigNetworkInstanceEncapsulationTypeIdentityref = "frinx-openconfig-network-instance-types:MPLS"
	FrinxOpenconfigNetworkInstanceEncapsulationTypeIdentityref_VXLAN FrinxOpenconfigNetworkInstanceEncapsulationTypeIdentityref = "frinx-openconfig-network-instance-types:VXLAN"
)
