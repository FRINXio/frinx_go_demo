...
// frinx.openconfig.network.instance.networkinstances.networkinstance.vlans.vlan.Config.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceVlansVlanConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceVlansVlanConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
