...
// frinx.openconfig.bgp.policy.aspathlengthtop.AsPathLength.response
type FrinxOpenconfigBgpPolicyAspathlengthtopAsPathLengthResponse struct {
	FrinxOpenconfigBgpPolicyasPathLength *FrinxOpenconfigBgpPolicyAspathlengthtopAsPathLength `json:"frinx-openconfig-bgp-policy:as-path-length,omitempty"`
}
