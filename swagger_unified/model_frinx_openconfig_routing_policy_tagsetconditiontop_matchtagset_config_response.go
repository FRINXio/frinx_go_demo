...
// frinx.openconfig.routing.policy.tagsetconditiontop.matchtagset.Config.response
type FrinxOpenconfigRoutingPolicyTagsetconditiontopMatchtagsetConfigResponse struct {
	FrinxOpenconfigRoutingPolicyconfig *FrinxOpenconfigRoutingPolicyTagsetconditiontopMatchtagsetConfig `json:"frinx-openconfig-routing-policy:config,omitempty"`
}
