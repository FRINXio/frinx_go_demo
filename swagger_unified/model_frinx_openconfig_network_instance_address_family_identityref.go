...
type FrinxOpenconfigNetworkInstanceAddressFamilyIdentityref string

// List of frinx.openconfig.network.instance.AddressFamilyIdentityref
const (
	FrinxOpenconfigNetworkInstanceAddressFamilyIdentityref_MPLS FrinxOpenconfigNetworkInstanceAddressFamilyIdentityref = "frinx-openconfig-types:MPLS"
	FrinxOpenconfigNetworkInstanceAddressFamilyIdentityref_IPV4 FrinxOpenconfigNetworkInstanceAddressFamilyIdentityref = "frinx-openconfig-types:IPV4"
	FrinxOpenconfigNetworkInstanceAddressFamilyIdentityref_IPV6 FrinxOpenconfigNetworkInstanceAddressFamilyIdentityref = "frinx-openconfig-types:IPV6"
	FrinxOpenconfigNetworkInstanceAddressFamilyIdentityref_ADDRESS_FAMILY FrinxOpenconfigNetworkInstanceAddressFamilyIdentityref = "frinx-openconfig-types:ADDRESS_FAMILY"
	FrinxOpenconfigNetworkInstanceAddressFamilyIdentityref_L2_ETHERNET FrinxOpenconfigNetworkInstanceAddressFamilyIdentityref = "frinx-openconfig-types:L2_ETHERNET"
)
