...
// frinx.openconfig.qos.qos.classifiers.classifier.terms.term.actions.remark.Config.request
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermActionsRemarkConfigRequest struct {
