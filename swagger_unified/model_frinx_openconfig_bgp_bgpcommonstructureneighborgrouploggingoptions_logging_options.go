...
type FrinxOpenconfigBgpBgpcommonstructureneighborgrouploggingoptionsLoggingOptions struct {
	// Optional[Configuration parameters enabling or modifying logging for events relating to the BGPgroup] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpcommonstructureneighborgrouploggingoptionsLoggingoptionsConfig `json:"config,omitempty"`
}
