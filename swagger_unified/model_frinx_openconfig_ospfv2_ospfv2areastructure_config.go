...
type FrinxOpenconfigOspfv2Ospfv2areastructureConfig struct {
	// Optional[An identifier for the OSPFv2 area - described as either a 32-bit unsigned integer, or a dotted-quad] REF:Optional.empty
