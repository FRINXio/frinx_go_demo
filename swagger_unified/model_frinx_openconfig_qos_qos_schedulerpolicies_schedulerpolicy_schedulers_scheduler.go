...
// Optional[List of defined QoS traffic schedulers.] REF:Optional.empty
type FrinxOpenconfigQosQosSchedulerpoliciesSchedulerpolicySchedulersScheduler struct {
	// Optional[Top-level container for scheduler output data] REF:Optional.empty
	Output *FrinxOpenconfigQosQosscheduleroutputtopOutput `json:"output,omitempty"`
	// Optional[Reference to the list key] REF:Optional.empty
	Sequence int64 `json:"sequence,omitempty"`
	// Optional[Enclosing container ] REF:Optional.empty
	Inputs *FrinxOpenconfigQosQosschedulerinputstopInputs `json:"inputs,omitempty"`
	// Optional[Top-level container for data related to a 1 rate, 2 color shaper.] REF:Optional.empty
	OneRateTwoColor *FrinxOpenconfigQosQosSchedulerpoliciesSchedulerpolicySchedulersSchedulerOneRateTwoColor `json:"one-rate-two-color,omitempty"`
	// Optional[Configuration data for QoS schedulers] REF:Optional.empty
	Config *FrinxOpenconfigQosQosschedulertopSchedulerpoliciesSchedulerpolicySchedulersSchedulerConfig `json:"config,omitempty"`
	// Optional[Top-level container for data for a 2 rate, 3 color policer.] REF:Optional.empty
	TwoRateThreeColor *FrinxOpenconfigQosQosscheduler2r3ctopTwoRateThreeColor `json:"two-rate-three-color,omitempty"`
}
