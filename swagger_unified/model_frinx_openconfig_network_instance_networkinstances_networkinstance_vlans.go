...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceVlans struct {
	// Optional[Configured VLANs keyed by id] REF:Optional.empty
	Vlan []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceVlansVlan `json:"vlan,omitempty"`
}
