...
type FrinxOpenconfigBgpBgpcommonmpipv4unicastgroupIpv4Unicast struct {
	// Optional[Configuration parameters for common IPv4 and IPv6 unicast AFI-SAFI options] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpcommonmpipv4ipv6unicastcommonConfig `json:"config,omitempty"`
	// Optional[Configure the maximum number of prefixes that will be accepted from a peer] REF:Optional.empty
	PrefixLimit *FrinxOpenconfigBgpBgpcommonmpallafisaficommonPrefixLimit `json:"prefix-limit,omitempty"`
}
