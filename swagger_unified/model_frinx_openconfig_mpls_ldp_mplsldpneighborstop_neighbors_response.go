...
// frinx.openconfig.mpls.ldp.mplsldpneighborstop.Neighbors.response
type FrinxOpenconfigMplsLdpMplsldpneighborstopNeighborsResponse struct {
	FrinxOpenconfigNetworkInstanceneighbors *FrinxOpenconfigMplsLdpMplsldpneighborstopNeighbors `json:"frinx-openconfig-network-instance:neighbors,omitempty"`
}
