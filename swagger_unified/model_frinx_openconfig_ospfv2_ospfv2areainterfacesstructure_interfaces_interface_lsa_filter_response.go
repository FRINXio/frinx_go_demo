...
// frinx.openconfig.ospfv2.ospfv2areainterfacesstructure.interfaces.interface.LsaFilter.response
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceLsaFilterResponse struct {
	FrinxOpenconfigNetworkInstancelsaFilter *FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceLsaFilter `json:"frinx-openconfig-network-instance:lsa-filter,omitempty"`
}
