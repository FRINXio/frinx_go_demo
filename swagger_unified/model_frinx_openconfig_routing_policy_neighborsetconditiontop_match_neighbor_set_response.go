...
// frinx.openconfig.routing.policy.neighborsetconditiontop.MatchNeighborSet.response
type FrinxOpenconfigRoutingPolicyNeighborsetconditiontopMatchNeighborSetResponse struct {
	FrinxOpenconfigRoutingPolicymatchNeighborSet *FrinxOpenconfigRoutingPolicyNeighborsetconditiontopMatchNeighborSet `json:"frinx-openconfig-routing-policy:match-neighbor-set,omitempty"`
}
