...
type FrinxOpenconfigPlatformPlatformsubcomponentreftopSubcomponentsSubcomponent struct {
	// Optional[Reference to the name list key] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Configuration data ] REF:Optional.empty
	Config *FrinxOpenconfigPlatformPlatformsubcomponentreftopSubcomponentsSubcomponentConfig `json:"config,omitempty"`
}
