...
// frinx.openconfig.network.instance.networkinstances.networkinstance.mpls.lsps.constrainedpath.Tunnels.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLspsConstrainedpathTunnelsResponse struct {
	FrinxOpenconfigNetworkInstancetunnels *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLspsConstrainedpathTunnels `json:"frinx-openconfig-network-instance:tunnels,omitempty"`
}
