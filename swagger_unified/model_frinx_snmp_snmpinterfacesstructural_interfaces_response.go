...
// frinx.snmp.snmpinterfacesstructural.Interfaces.response
type FrinxSnmpSnmpinterfacesstructuralInterfacesResponse struct {
	FrinxSnmpinterfaces *FrinxSnmpSnmpinterfacesstructuralInterfaces `json:"frinx-snmp:interfaces,omitempty"`
}
