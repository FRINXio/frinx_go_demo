...
// Optional[List of ACL sets, each comprising of a list of ACL entries] REF:Optional.empty
type FrinxOpenconfigAclAclAclsetsAclSet struct {
	// Optional[Reference to the name list key] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Access list entries container] REF:Optional.empty
	AclEntries *FrinxOpenconfigAclAclAclsetsAclsetAclEntries `json:"acl-entries,omitempty"`
	// Optional[Reference to the type list key] REF:Optional.empty
	Type_ string `json:"type,omitempty"`
	// Optional[Access list config] REF:Optional.empty
	Config *FrinxOpenconfigAclAclsettopAclsetsAclsetConfig `json:"config,omitempty"`
}
