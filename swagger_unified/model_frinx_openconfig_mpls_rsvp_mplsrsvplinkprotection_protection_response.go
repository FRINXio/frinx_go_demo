...
// frinx.openconfig.mpls.rsvp.mplsrsvplinkprotection.Protection.response
type FrinxOpenconfigMplsRsvpMplsrsvplinkprotectionProtectionResponse struct {
	FrinxOpenconfigNetworkInstanceprotection *FrinxOpenconfigMplsRsvpMplsrsvplinkprotectionProtection `json:"frinx-openconfig-network-instance:protection,omitempty"`
}
