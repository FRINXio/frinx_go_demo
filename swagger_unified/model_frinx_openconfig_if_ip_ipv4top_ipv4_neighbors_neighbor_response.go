...
// frinx.openconfig.if.ip.ipv4top.ipv4.neighbors.Neighbor.response
type FrinxOpenconfigIfIpIpv4topIpv4NeighborsNeighborResponse struct {
	FrinxOpenconfigIfIpneighbor []FrinxOpenconfigIfIpIpv4topIpv4NeighborsNeighbor `json:"frinx-openconfig-if-ip:neighbor,omitempty"`
}
