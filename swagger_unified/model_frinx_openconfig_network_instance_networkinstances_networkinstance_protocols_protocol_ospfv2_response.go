...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.Ospfv2.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2Response struct {
	FrinxOpenconfigNetworkInstanceospfv2 *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolOspfv2 `json:"frinx-openconfig-network-instance:ospfv2,omitempty"`
}
