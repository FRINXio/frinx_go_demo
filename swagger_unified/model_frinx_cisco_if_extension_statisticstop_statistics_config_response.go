...
// frinx.cisco.if.extension.statisticstop.statistics.Config.response
type FrinxCiscoIfExtensionStatisticstopStatisticsConfigResponse struct {
	FrinxCiscoIfExtensionconfig *FrinxCiscoIfExtensionStatisticstopStatisticsConfig `json:"frinx-cisco-if-extension:config,omitempty"`
}
