...
// frinx.hsrp.hsrpgroups.hsrpgroup.Config.response
type FrinxHsrpHsrpgroupsHsrpgroupConfigResponse struct {
	FrinxHsrpconfig *FrinxHsrpHsrpgroupsHsrpgroupConfig `json:"frinx-hsrp:config,omitempty"`
}
