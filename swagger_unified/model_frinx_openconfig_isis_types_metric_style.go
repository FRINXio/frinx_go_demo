...
type FrinxOpenconfigIsisTypesMetricStyle string

// List of frinx.openconfig.isis.types.MetricStyle
const (
	FrinxOpenconfigIsisTypesMetricStyle_NARROW_METRIC FrinxOpenconfigIsisTypesMetricStyle = "NARROW_METRIC"
	FrinxOpenconfigIsisTypesMetricStyle_WIDE_METRIC FrinxOpenconfigIsisTypesMetricStyle = "WIDE_METRIC"
)
