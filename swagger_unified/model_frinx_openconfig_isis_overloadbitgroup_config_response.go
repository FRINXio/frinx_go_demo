...
// frinx.openconfig.isis.overloadbitgroup.Config.response
type FrinxOpenconfigIsisOverloadbitgroupConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisOverloadbitgroupConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
