...
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorConformAction struct {
	// Optional[Configuration parameters for the conform action of a 2r3c policer.] REF:Optional.empty
	Config *FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorConformactionConfig `json:"config,omitempty"`
}
