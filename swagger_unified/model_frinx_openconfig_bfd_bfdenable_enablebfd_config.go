...
// Optional[Configuration parameters relating to enabling BFD.] REF:Optional.empty
type FrinxOpenconfigBfdBfdenableEnablebfdConfig struct {
	// Optional[When this leaf is set to true, BFD is used to detect the liveliness of the remote peer or next-hop.] REF:Optional.empty
