...
type FrinxOpenconfigNetworkInstancePolicyApiService service

/*
FrinxOpenconfigNetworkInstancePolicyApiService
...
*/
func (a *FrinxOpenconfigNetworkInstancePolicyApiService) DeleteFrinxOpenconfigRoutingPolicyRoutingPolicyPolicyDefinitionsPolicyDefinitionStatementsStatementConditionsMatchProtocolInstance(ctx context.Context, name string, statementName string, nodeId string) (*http.Response, error) {
	var (
...
*/
func (a *FrinxOpenconfigNetworkInstancePolicyApiService) DeleteFrinxOpenconfigRoutingPolicyRoutingPolicyPolicyDefinitionsPolicyDefinitionStatementsStatementConditionsMatchProtocolInstanceConfig(ctx context.Context, name string, statementName string, nodeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchProtocolInstanceResponse
*/
func (a *FrinxOpenconfigNetworkInstancePolicyApiService) GetFrinxOpenconfigRoutingPolicyRoutingPolicyPolicyDefinitionsPolicyDefinitionStatementsStatementConditionsMatchProtocolInstance(ctx context.Context, name string, statementName string, nodeId string) (FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchProtocolInstanceResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchProtocolInstanceResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchProtocolInstanceResponse
...
@return FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchprotocolinstanceConfigResponse
*/
func (a *FrinxOpenconfigNetworkInstancePolicyApiService) GetFrinxOpenconfigRoutingPolicyRoutingPolicyPolicyDefinitionsPolicyDefinitionStatementsStatementConditionsMatchProtocolInstanceConfig(ctx context.Context, name string, statementName string, nodeId string) (FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchprotocolinstanceConfigResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchprotocolinstanceConfigResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchprotocolinstanceConfigResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param name Id of policy-definition
 * @param statementName Id of statement
 * @param frinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchProtocolInstanceBodyParam frinx.openconfig.network.instance.policy.protocolinstancepolicytop.MatchProtocolInstance to be added or updated
 * @param nodeId


*/
func (a *FrinxOpenconfigNetworkInstancePolicyApiService) PutFrinxOpenconfigRoutingPolicyRoutingPolicyPolicyDefinitionsPolicyDefinitionStatementsStatementConditionsMatchProtocolInstance(ctx context.Context, name string, statementName string, frinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchProtocolInstanceBodyParam FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchProtocolInstanceRequest, nodeId string) (*http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &frinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchProtocolInstanceBodyParam
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
 ...
 * @param name Id of policy-definition
 * @param statementName Id of statement
 * @param frinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchprotocolinstanceConfigBodyParam frinx.openconfig.network.instance.policy.protocolinstancepolicytop.matchprotocolinstance.Config to be added or updated
 * @param nodeId


*/
func (a *FrinxOpenconfigNetworkInstancePolicyApiService) PutFrinxOpenconfigRoutingPolicyRoutingPolicyPolicyDefinitionsPolicyDefinitionStatementsStatementConditionsMatchProtocolInstanceConfig(ctx context.Context, name string, statementName string, frinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchprotocolinstanceConfigBodyParam FrinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchprotocolinstanceConfigRequest, nodeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// body params
	localVarPostBody = &frinxOpenconfigNetworkInstancePolicyProtocolinstancepolicytopMatchprotocolinstanceConfigBodyParam
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
