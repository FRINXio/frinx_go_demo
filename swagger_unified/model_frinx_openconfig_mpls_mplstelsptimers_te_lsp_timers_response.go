...
// frinx.openconfig.mpls.mplstelsptimers.TeLspTimers.response
type FrinxOpenconfigMplsMplstelsptimersTeLspTimersResponse struct {
	FrinxOpenconfigNetworkInstanceteLspTimers *FrinxOpenconfigMplsMplstelsptimersTeLspTimers `json:"frinx-openconfig-network-instance:te-lsp-timers,omitempty"`
}
