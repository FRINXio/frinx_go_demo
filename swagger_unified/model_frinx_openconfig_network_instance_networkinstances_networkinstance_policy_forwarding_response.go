...
// frinx.openconfig.network.instance.networkinstances.networkinstance.PolicyForwarding.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstancePolicyForwardingResponse struct {
	FrinxOpenconfigNetworkInstancepolicyForwarding *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstancePolicyForwarding `json:"frinx-openconfig-network-instance:policy-forwarding,omitempty"`
}
