...
// frinx.openconfig.ospfv2.ospfv2globalstructural.global.timers.LsaGeneration.response
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersLsaGenerationResponse struct {
	FrinxOpenconfigNetworkInstancelsaGeneration *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersLsaGeneration `json:"frinx-openconfig-network-instance:lsa-generation,omitempty"`
}
