...
// frinx.openconfig.mpls.p2pprimarypathstop.p2pprimarypath.P2pPrimaryPath.response
type FrinxOpenconfigMplsP2pprimarypathstopP2pprimarypathP2pPrimaryPathResponse struct {
	FrinxOpenconfigNetworkInstancep2pPrimaryPath []FrinxOpenconfigMplsP2pprimarypathstopP2pprimarypathP2pPrimaryPath `json:"frinx-openconfig-network-instance:p2p-primary-path,omitempty"`
}
