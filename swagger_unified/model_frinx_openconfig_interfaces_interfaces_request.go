...
// frinx.openconfig.interfaces.Interfaces.request
type FrinxOpenconfigInterfacesInterfacesRequest struct {
	FrinxOpenconfigInterfacesinterfaces *FrinxOpenconfigInterfacesInterfaces `json:"frinx-openconfig-interfaces:interfaces,omitempty"`
}
