...
// Optional[Configuration and operational state parameters for BFD.] REF:Optional[RFC5880, RFC5881]
type FrinxOpenconfigBfdBfd struct {
	// Optional[Interfaces on which BFD sessions are to be enabled.] REF:Optional.empty
	Interfaces *FrinxOpenconfigBfdBfdInterfaces `json:"interfaces,omitempty"`
}
