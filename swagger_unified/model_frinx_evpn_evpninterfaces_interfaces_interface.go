...
// Optional[List of interfaces] REF:Optional.empty
type FrinxEvpnEvpninterfacesInterfacesInterface struct {
	// Optional[Core isolation group of interface] REF:Optional.empty
	CoreIsolationGroup *FrinxEvpnEvpninterfacesInterfacesInterfaceCoreIsolationGroup `json:"core-isolation-group,omitempty"`
	// Optional[Reference to the list key] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Configuration data for EVPN on each interface] REF:Optional.empty
	Config *FrinxEvpnEvpninterfacepartConfig `json:"config,omitempty"`
	// Optional[Ethernet segment of EVPN interfaces] REF:Optional.empty
	EthernetSegment *FrinxEvpnEvpninterfacesInterfacesInterfaceEthernetSegment `json:"ethernet-segment,omitempty"`
}
