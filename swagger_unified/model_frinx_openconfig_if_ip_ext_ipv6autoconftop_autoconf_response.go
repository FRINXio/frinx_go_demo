...
// frinx.openconfig.if.ip.ext.ipv6autoconftop.Autoconf.response
type FrinxOpenconfigIfIpExtIpv6autoconftopAutoconfResponse struct {
	FrinxOpenconfigIfIpExtautoconf *FrinxOpenconfigIfIpExtIpv6autoconftopAutoconf `json:"frinx-openconfig-if-ip-ext:autoconf,omitempty"`
}
