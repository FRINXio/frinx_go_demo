...
// frinx.openconfig.mpls.rsvp.mplsrsvpauthentication.Authentication.response
type FrinxOpenconfigMplsRsvpMplsrsvpauthenticationAuthenticationResponse struct {
	FrinxOpenconfigNetworkInstanceauthentication *FrinxOpenconfigMplsRsvpMplsrsvpauthenticationAuthentication `json:"frinx-openconfig-network-instance:authentication,omitempty"`
}
