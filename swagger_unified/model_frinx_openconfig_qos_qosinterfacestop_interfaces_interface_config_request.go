...
// frinx.openconfig.qos.qosinterfacestop.interfaces.interface.Config.request
type FrinxOpenconfigQosQosinterfacestopInterfacesInterfaceConfigRequest struct {
