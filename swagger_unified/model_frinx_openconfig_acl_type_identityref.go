...
type FrinxOpenconfigAclTypeIdentityref string

// List of frinx.openconfig.acl.TypeIdentityref
const (
	FrinxOpenconfigAclTypeIdentityref_IPV4 FrinxOpenconfigAclTypeIdentityref = "frinx-openconfig-acl:ACL_IPV4"
	FrinxOpenconfigAclTypeIdentityref_IPV6 FrinxOpenconfigAclTypeIdentityref = "frinx-openconfig-acl:ACL_IPV6"
	FrinxOpenconfigAclTypeIdentityref_MIXED FrinxOpenconfigAclTypeIdentityref = "frinx-openconfig-acl:ACL_MIXED"
	FrinxOpenconfigAclTypeIdentityref_TYPE_ FrinxOpenconfigAclTypeIdentityref = "frinx-openconfig-acl:ACL_TYPE"
	FrinxOpenconfigAclTypeIdentityref_L2 FrinxOpenconfigAclTypeIdentityref = "frinx-openconfig-acl:ACL_L2"
)
