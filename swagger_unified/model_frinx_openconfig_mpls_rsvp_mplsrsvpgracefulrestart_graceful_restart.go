...
type FrinxOpenconfigMplsRsvpMplsrsvpgracefulrestartGracefulRestart struct {
	// Optional[Configuration parameters relating to graceful-restart] REF:Optional.empty
	Config *FrinxOpenconfigMplsRsvpMplsrsvpgracefulrestartGracefulrestartConfig `json:"config,omitempty"`
}
