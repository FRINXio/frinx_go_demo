...
// frinx.openconfig.acl.interfaceegressacltop.egressaclsets.EgressAclSet.response
type FrinxOpenconfigAclInterfaceegressacltopEgressaclsetsEgressAclSetResponse struct {
	FrinxOpenconfigAclegressAclSet []FrinxOpenconfigAclInterfaceegressacltopEgressaclsetsEgressAclSet `json:"frinx-openconfig-acl:egress-acl-set,omitempty"`
}
