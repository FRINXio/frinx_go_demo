...
// frinx.openconfig.mpls.p2pprimarypathstop.P2pPrimaryPath.response
type FrinxOpenconfigMplsP2pprimarypathstopP2pPrimaryPathResponse struct {
	FrinxOpenconfigNetworkInstancep2pPrimaryPath *FrinxOpenconfigMplsP2pprimarypathstopP2pPrimaryPath `json:"frinx-openconfig-network-instance:p2p-primary-path,omitempty"`
}
