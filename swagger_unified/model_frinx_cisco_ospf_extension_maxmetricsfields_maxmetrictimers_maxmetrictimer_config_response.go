...
// frinx.cisco.ospf.extension.maxmetricsfields.maxmetrictimers.maxmetrictimer.Config.response
type FrinxCiscoOspfExtensionMaxmetricsfieldsMaxmetrictimersMaxmetrictimerConfigResponse struct {
	FrinxCiscoOspfExtensionconfig *FrinxCiscoOspfExtensionMaxmetricsfieldsMaxmetrictimersMaxmetrictimerConfig `json:"frinx-cisco-ospf-extension:config,omitempty"`
}
