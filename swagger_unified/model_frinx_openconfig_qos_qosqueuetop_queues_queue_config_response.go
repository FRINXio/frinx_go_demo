...
// frinx.openconfig.qos.qosqueuetop.queues.queue.Config.response
type FrinxOpenconfigQosQosqueuetopQueuesQueueConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosqueuetopQueuesQueueConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
