...
// frinx.openconfig.if.ethernet.ethernettop.ethernet.Config.response
type FrinxOpenconfigIfEthernetEthernettopEthernetConfigResponse struct {
	FrinxOpenconfigIfEthernetconfig *FrinxOpenconfigIfEthernetEthernettopEthernetConfig `json:"frinx-openconfig-if-ethernet:config,omitempty"`
}
