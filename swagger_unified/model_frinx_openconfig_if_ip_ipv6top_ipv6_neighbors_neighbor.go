...
// Optional[List of IPv6 neighbors] REF:Optional.empty
type FrinxOpenconfigIfIpIpv6topIpv6NeighborsNeighbor struct {
	// Optional[Configuration data for each IPv6 address on the interface] REF:Optional.empty
	Config *FrinxOpenconfigIfIpIpv6topIpv6NeighborsNeighborConfig `json:"config,omitempty"`
	// Optional[References the configured IP neighbor address] REF:Optional.empty
