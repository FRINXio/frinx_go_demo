...
// frinx.openconfig.network.instance.networkinstances.networkinstance.vlans.Vlan.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceVlansVlanResponse struct {
	FrinxOpenconfigNetworkInstancevlan []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceVlansVlan `json:"frinx-openconfig-network-instance:vlan,omitempty"`
}
