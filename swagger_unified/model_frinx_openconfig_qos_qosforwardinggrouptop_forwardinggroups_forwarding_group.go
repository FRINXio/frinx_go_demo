...
// Optional[List of forwarding groups.  Forwarding groups are logical groups of traffic that will receive common forwarding treatment.] REF:Optional.empty
type FrinxOpenconfigQosQosforwardinggrouptopForwardinggroupsForwardingGroup struct {
	// Optional[Reference to name list key] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Configuration data for forwarding groups] REF:Optional.empty
	Config *FrinxOpenconfigQosQosforwardinggrouptopForwardinggroupsForwardinggroupConfig `json:"config,omitempty"`
}
