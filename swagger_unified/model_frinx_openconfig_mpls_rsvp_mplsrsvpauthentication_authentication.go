...
type FrinxOpenconfigMplsRsvpMplsrsvpauthenticationAuthentication struct {
	// Optional[Configuration parameters relating to authentication] REF:Optional.empty
	Config *FrinxOpenconfigMplsRsvpMplsrsvpauthenticationAuthenticationConfig `json:"config,omitempty"`
}
