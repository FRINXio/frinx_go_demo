...
// frinx.openconfig.isis.isisglobalbase.timers.Spf.response
type FrinxOpenconfigIsisIsisglobalbaseTimersSpfResponse struct {
	FrinxOpenconfigNetworkInstancespf *FrinxOpenconfigIsisIsisglobalbaseTimersSpf `json:"frinx-openconfig-network-instance:spf,omitempty"`
}
