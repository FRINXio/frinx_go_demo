...
// frinx.openconfig.qos.qos.classifiers.classifier.terms.term.Actions.request
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermActionsRequest struct {
