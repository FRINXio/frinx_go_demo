...
type FrinxOpenconfigBgpPolicySetextcommunityinlinetopInlineConfig struct {
	// Optional[Set the extended community values for the update inline with a list.] REF:Optional.empty
