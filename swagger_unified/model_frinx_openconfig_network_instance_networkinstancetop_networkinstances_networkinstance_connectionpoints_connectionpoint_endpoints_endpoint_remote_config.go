...
// Optional[Configuration parameters relating to a remote endpoint] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancetopNetworkinstancesNetworkinstanceConnectionpointsConnectionpointEndpointsEndpointRemoteConfig struct {
	// Optional[The virtual-circuit identifier that identifies the connection at the remote end-point] REF:Optional.empty
	VirtualCircuitIdentifier int64 `json:"virtual-circuit-identifier,omitempty"`
	// Optional[The IP address of the device which hosts the remote end-point] REF:Optional.empty
	RemoteSystem string `json:"remote-system,omitempty"`
}
