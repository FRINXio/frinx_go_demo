...
type FrinxOpenconfigIsisPolicyIsismatchconditionsIsisConditions struct {
	// Optional[Configuration parameters relating to IS-IS match conditions] REF:Optional.empty
	Config *FrinxOpenconfigIsisPolicyIsismatchconditionsIsisconditionsConfig `json:"config,omitempty"`
}
