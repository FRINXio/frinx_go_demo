...
type FrinxOpenconfigBgpPolicyAspathlengthtopAsPathLength struct {
	// Optional[Configuration data for AS path length condition] REF:Optional.empty
	Config *FrinxOpenconfigBgpPolicyAspathlengthtopAspathlengthConfig `json:"config,omitempty"`
}
