...
// frinx.openconfig.qos.qos.schedulerpolicies.SchedulerPolicy.response
type FrinxOpenconfigQosQosSchedulerpoliciesSchedulerPolicyResponse struct {
	FrinxOpenconfigQosschedulerPolicy []FrinxOpenconfigQosQosSchedulerpoliciesSchedulerPolicy `json:"frinx-openconfig-qos:scheduler-policy,omitempty"`
}
