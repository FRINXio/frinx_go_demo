...
// frinx.openconfig.isis.overloadbitgroup.ResetTriggers.response
type FrinxOpenconfigIsisOverloadbitgroupResetTriggersResponse struct {
	FrinxOpenconfigNetworkInstanceresetTriggers *FrinxOpenconfigIsisOverloadbitgroupResetTriggers `json:"frinx-openconfig-network-instance:reset-triggers,omitempty"`
}
