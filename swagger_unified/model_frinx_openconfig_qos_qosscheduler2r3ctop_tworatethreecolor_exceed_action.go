...
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorExceedAction struct {
	// Optional[Configuration parameters relating to the action applied to exceeding packets.] REF:Optional.empty
	Config *FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorExceedactionConfig `json:"config,omitempty"`
}
