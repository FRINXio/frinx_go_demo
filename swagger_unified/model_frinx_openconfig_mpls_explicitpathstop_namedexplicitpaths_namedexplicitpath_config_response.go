...
// frinx.openconfig.mpls.explicitpathstop.namedexplicitpaths.namedexplicitpath.Config.response
type FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedexplicitpathConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsExplicitpathstopNamedexplicitpathsNamedexplicitpathConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
