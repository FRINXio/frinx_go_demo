...
// frinx.openconfig.routing.policy.prefixtop.prefixes.prefix.Config.response
type FrinxOpenconfigRoutingPolicyPrefixtopPrefixesPrefixConfigResponse struct {
	FrinxOpenconfigRoutingPolicyconfig *FrinxOpenconfigRoutingPolicyPrefixtopPrefixesPrefixConfig `json:"frinx-openconfig-routing-policy:config,omitempty"`
}
