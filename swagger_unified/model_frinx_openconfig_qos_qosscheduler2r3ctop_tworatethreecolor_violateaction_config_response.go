...
// frinx.openconfig.qos.qosscheduler2r3ctop.tworatethreecolor.violateaction.Config.response
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorViolateactionConfigResponse struct {
	FrinxOpenconfigQosconfig *FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorViolateactionConfig `json:"frinx-openconfig-qos:config,omitempty"`
}
