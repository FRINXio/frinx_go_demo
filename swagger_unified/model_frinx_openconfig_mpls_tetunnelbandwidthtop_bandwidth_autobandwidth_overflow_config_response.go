...
// frinx.openconfig.mpls.tetunnelbandwidthtop.bandwidth.autobandwidth.overflow.Config.response
type FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthOverflowConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthOverflowConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
