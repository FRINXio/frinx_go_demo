...
// frinx.openconfig.bgp.bgpneighborbase.Transport.response
type FrinxOpenconfigBgpBgpneighborbaseTransportResponse struct {
	FrinxOpenconfigNetworkInstancetransport *FrinxOpenconfigBgpBgpneighborbaseTransport `json:"frinx-openconfig-network-instance:transport,omitempty"`
}
