...
type FrinxOpenconfigInterfacesInterfacerefInterfacerefConfigResponse3 struct {
	FrinxOpenconfigIfIpconfig *FrinxOpenconfigInterfacesInterfacerefInterfacerefConfig `json:"frinx-openconfig-if-ip:config,omitempty"`
}
