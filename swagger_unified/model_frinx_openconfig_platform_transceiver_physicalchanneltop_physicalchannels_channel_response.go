...
// frinx.openconfig.platform.transceiver.physicalchanneltop.physicalchannels.Channel.response
type FrinxOpenconfigPlatformTransceiverPhysicalchanneltopPhysicalchannelsChannelResponse struct {
	FrinxOpenconfigPlatformTransceiverchannel []FrinxOpenconfigPlatformTransceiverPhysicalchanneltopPhysicalchannelsChannel `json:"frinx-openconfig-platform-transceiver:channel,omitempty"`
}
