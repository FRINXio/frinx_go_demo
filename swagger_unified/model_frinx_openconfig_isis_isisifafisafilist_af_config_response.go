...
// frinx.openconfig.isis.isisifafisafilist.af.Config.response
type FrinxOpenconfigIsisIsisifafisafilistAfConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsisifafisafilistAfConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
