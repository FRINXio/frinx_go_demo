...
// frinx.openconfig.bfd.bfd.interfaces.interface.Config.response
type FrinxOpenconfigBfdBfdInterfacesInterfaceConfigResponse struct {
	FrinxOpenconfigBfdconfig *FrinxOpenconfigBfdBfdInterfacesInterfaceConfig `json:"frinx-openconfig-bfd:config,omitempty"`
}
