...
type FrinxOpenconfigPacketMatchTransportfieldstopTransport struct {
	// Optional[Configuration data] REF:Optional.empty
	Config *FrinxOpenconfigPacketMatchTransportfieldstopTransportConfig `json:"config,omitempty"`
}
