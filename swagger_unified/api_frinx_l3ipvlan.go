...
type FrinxL3ipvlanApiService service

/*
FrinxL3ipvlanApiService
...
*/
func (a *FrinxL3ipvlanApiService) DeleteFrinxOpenconfigInterfacesInterfacesInterfaceL3ipvlan(ctx context.Context, name string, nodeId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/config/network-topology:network-topology/network-topology:topology/unified/network-topology:node/{node-id}/yang-ext:mount/frinx-openconfig-interfaces:interfaces/frinx-openconfig-interfaces:interface/{name}/frinx-l3ipvlan:l3ipvlan/"
...
*/
func (a *FrinxL3ipvlanApiService) DeleteFrinxOpenconfigInterfacesInterfacesInterfaceL3ipvlanConfig(ctx context.Context, name string, nodeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/config/network-topology:network-topology/network-topology:topology/unified/network-topology:node/{node-id}/yang-ext:mount/frinx-openconfig-interfaces:interfaces/frinx-openconfig-interfaces:interface/{name}/frinx-l3ipvlan:l3ipvlan/frinx-l3ipvlan:config/"
	localVarPath = strings.Replace(localVarPath, "{"+"name"+"}", fmt.Sprintf("%v", name), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"node-id"+"}", fmt.Sprintf("%v", nodeId), -1)
...
@return FrinxL3ipvlanL3ipvlaninterfacetopL3ipvlanResponse
*/
func (a *FrinxL3ipvlanApiService) GetFrinxOpenconfigInterfacesInterfacesInterfaceL3ipvlan(ctx context.Context, name string, nodeId string) (FrinxL3ipvlanL3ipvlaninterfacetopL3ipvlanResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxL3ipvlanL3ipvlaninterfacetopL3ipvlanResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxL3ipvlanL3ipvlaninterfacetopL3ipvlanResponse
...
@return FrinxL3ipvlanL3ipvlaninterfacetopL3ipvlanConfigResponse
*/
func (a *FrinxL3ipvlanApiService) GetFrinxOpenconfigInterfacesInterfacesInterfaceL3ipvlanConfig(ctx context.Context, name string, nodeId string) (FrinxL3ipvlanL3ipvlaninterfacetopL3ipvlanConfigResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxL3ipvlanL3ipvlaninterfacetopL3ipvlanConfigResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxL3ipvlanL3ipvlaninterfacetopL3ipvlanConfigResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Id of interface
 * @param frinxL3ipvlanL3ipvlaninterfacetopL3ipvlanBodyParam frinx.l3ipvlan.l3ipvlaninterfacetop.L3ipvlan to be added or updated
 * @param nodeId


*/
func (a *FrinxL3ipvlanApiService) PutFrinxOpenconfigInterfacesInterfacesInterfaceL3ipvlan(ctx context.Context, name string, frinxL3ipvlanL3ipvlaninterfacetopL3ipvlanBodyParam FrinxL3ipvlanL3ipvlaninterfacetopL3ipvlanRequest, nodeId string) (*http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &frinxL3ipvlanL3ipvlaninterfacetopL3ipvlanBodyParam
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Id of interface
 * @param frinxL3ipvlanL3ipvlaninterfacetopL3ipvlanConfigBodyParam frinx.l3ipvlan.l3ipvlaninterfacetop.l3ipvlan.Config to be added or updated
 * @param nodeId


*/
func (a *FrinxL3ipvlanApiService) PutFrinxOpenconfigInterfacesInterfacesInterfaceL3ipvlanConfig(ctx context.Context, name string, frinxL3ipvlanL3ipvlaninterfacetopL3ipvlanConfigBodyParam FrinxL3ipvlanL3ipvlaninterfacetopL3ipvlanConfigRequest, nodeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// body params
	localVarPostBody = &frinxL3ipvlanL3ipvlaninterfacetopL3ipvlanConfigBodyParam
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
