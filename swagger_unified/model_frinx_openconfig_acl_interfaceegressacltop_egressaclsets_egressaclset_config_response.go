...
// frinx.openconfig.acl.interfaceegressacltop.egressaclsets.egressaclset.Config.response
type FrinxOpenconfigAclInterfaceegressacltopEgressaclsetsEgressaclsetConfigResponse struct {
	FrinxOpenconfigAclconfig *FrinxOpenconfigAclInterfaceegressacltopEgressaclsetsEgressaclsetConfig `json:"frinx-openconfig-acl:config,omitempty"`
}
