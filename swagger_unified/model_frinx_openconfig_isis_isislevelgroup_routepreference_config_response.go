...
// frinx.openconfig.isis.isislevelgroup.routepreference.Config.response
type FrinxOpenconfigIsisIsislevelgroupRoutepreferenceConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsislevelgroupRoutepreferenceConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
