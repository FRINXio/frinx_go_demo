...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstancePolicyForwarding struct {
	// Optional[Forwarding policies defined to enact policy-based forwarding on the local system.] REF:Optional.empty
	Policies *FrinxOpenconfigPolicyForwardingPfforwardingpolicystructuralPolicies `json:"policies,omitempty"`
	// Optional[Configuration and operational state relating policy forwarding on interfaces.] REF:Optional.empty
	Interfaces *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstancePolicyforwardingInterfaces `json:"interfaces,omitempty"`
	// Optional[Surrounding container for the path selection groups defined within the policy forwarding model.] REF:Optional.empty
	PathSelectionGroups *FrinxOpenconfigPolicyForwardingPfpathgroupsstructuralPathSelectionGroups `json:"path-selection-groups,omitempty"`
}
