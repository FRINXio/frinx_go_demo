...
// Optional[List of interfaces on which ACLs are set] REF:Optional.empty
type FrinxOpenconfigAclAclinterfacestopInterfacesInterface struct {
	// Optional[Enclosing container the list of egress ACLs on the interface] REF:Optional.empty
	EgressAclSets *FrinxOpenconfigAclInterfaceegressacltopEgressAclSets `json:"egress-acl-sets,omitempty"`
	// Optional[Enclosing container the list of ingress ACLs on the interface] REF:Optional.empty
	IngressAclSets *FrinxOpenconfigAclInterfaceingressacltopIngressAclSets `json:"ingress-acl-sets,omitempty"`
	// Optional[Reference to the interface id list key] REF:Optional.empty
	Id string `json:"id,omitempty"`
	// Optional[Configuration for ACL per-interface data] REF:Optional.empty
	Config *FrinxOpenconfigAclAclinterfacestopInterfacesInterfaceConfig `json:"config,omitempty"`
