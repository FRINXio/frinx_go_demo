...
type FrinxOpenconfigNetworkInstanceL2nimactabletopMacTable struct {
	// Optional[Enclosing container for list of MAC table entries] REF:Optional.empty
	Entries *FrinxOpenconfigNetworkInstanceL2nimactabletopMactableEntries `json:"entries,omitempty"`
}
