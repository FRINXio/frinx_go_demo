...
// frinx.openconfig.ospfv2.ospfv2globalstructural.global.timers.maxmetric.Config.response
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersMaxmetricConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalTimersMaxmetricConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
