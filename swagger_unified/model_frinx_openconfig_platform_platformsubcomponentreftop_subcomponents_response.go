...
// frinx.openconfig.platform.platformsubcomponentreftop.Subcomponents.response
type FrinxOpenconfigPlatformPlatformsubcomponentreftopSubcomponentsResponse struct {
	FrinxOpenconfigPlatformsubcomponents *FrinxOpenconfigPlatformPlatformsubcomponentreftopSubcomponents `json:"frinx-openconfig-platform:subcomponents,omitempty"`
}
