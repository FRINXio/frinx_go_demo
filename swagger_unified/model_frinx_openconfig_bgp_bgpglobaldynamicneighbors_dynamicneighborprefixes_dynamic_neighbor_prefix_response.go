...
// frinx.openconfig.bgp.bgpglobaldynamicneighbors.dynamicneighborprefixes.DynamicNeighborPrefix.response
type FrinxOpenconfigBgpBgpglobaldynamicneighborsDynamicneighborprefixesDynamicNeighborPrefixResponse struct {
	FrinxOpenconfigNetworkInstancedynamicNeighborPrefix []FrinxOpenconfigBgpBgpglobaldynamicneighborsDynamicneighborprefixesDynamicNeighborPrefix `json:"frinx-openconfig-network-instance:dynamic-neighbor-prefix,omitempty"`
}
