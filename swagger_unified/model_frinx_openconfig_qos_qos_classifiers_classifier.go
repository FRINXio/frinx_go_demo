...
// Optional[List of classifier elements] REF:Optional.empty
type FrinxOpenconfigQosQosClassifiersClassifier struct {
	// Optional[Reference to list key name] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Enclosing container for ths list of terms] REF:Optional.empty
	Terms *FrinxOpenconfigQosQosClassifiersClassifierTerms `json:"terms,omitempty"`
	// Optional[Configuration data for classifers] REF:Optional.empty
	Config *FrinxOpenconfigQosQosclassifiertopClassifiersClassifierConfig `json:"config,omitempty"`
}
