...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLsps struct {
	// Optional[statically configured LSPs, without dynamic signaling] REF:Optional.empty
	StaticLsps *FrinxOpenconfigMplsMplstopMplsLspsStaticLsps `json:"static-lsps,omitempty"`
	// Optional[LSPs that use the IGP-determined path, i.e., non traffic-engineered, or non constrained-path] REF:Optional.empty
	UnconstrainedPath *FrinxOpenconfigMplsMplstopMplsLspsUnconstrainedPath `json:"unconstrained-path,omitempty"`
	// Optional[traffic-engineered LSPs supporting different path computation and signaling methods] REF:Optional.empty
	ConstrainedPath *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLspsConstrainedPath `json:"constrained-path,omitempty"`
}
