...
// frinx.openconfig.bgp.bgppeergroupafisafilist.afisafi.gracefulrestart.Config.response
type FrinxOpenconfigBgpBgppeergroupafisafilistAfisafiGracefulrestartConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigBgpBgppeergroupafisafilistAfisafiGracefulrestartConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
