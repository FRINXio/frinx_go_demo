...
// Optional[Configuration data for scheduler input sources] REF:Optional.empty
type FrinxOpenconfigQosQosschedulerinputstopInputsInputConfig struct {
	// Optional[For priority schedulers, this indicates the priority of the corresponding input.  Higher values indicates lower priority.  For weighted round-robin schedulers, this leaf indicates the weight of the corresponding input.] REF:Optional.empty
	Weight int32 `json:"weight,omitempty"`
	// Optional[Describes the type of input source for the scheduler] REF:Optional.empty
	InputType *FrinxOpenconfigQosInputTypeEnumeration `json:"input-type,omitempty"`
	// Optional[User-defined identifier for the scheduler input] REF:Optional.empty
	Id string `json:"id,omitempty"`
	// Optional[Reference to a queue that is an input source for the scheduler] REF:Optional.empty
