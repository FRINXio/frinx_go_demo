...
type FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUseMultiplePaths struct {
	// Optional[Multipath parameters for eBGP] REF:Optional.empty
	Ebgp *FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsEbgp `json:"ebgp,omitempty"`
	// Optional[Multipath parameters for iBGP] REF:Optional.empty
	Ibgp *FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsIbgp `json:"ibgp,omitempty"`
	// Optional[Configuration parameters relating to multipath] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsConfig `json:"config,omitempty"`
}
