...
// frinx.openconfig.bgp.policy.aspathsettop.aspathsets.aspathset.Config.response
type FrinxOpenconfigBgpPolicyAspathsettopAspathsetsAspathsetConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicyAspathsettopAspathsetsAspathsetConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
