...
type FrinxNetflowInterfaceegressnetflowtopEgressFlows struct {
	// Optional[List of egress NetFlow flows on the interface] REF:Optional.empty
	EgressFlow []FrinxNetflowInterfaceegressnetflowtopEgressflowsEgressFlow `json:"egress-flow,omitempty"`
}
