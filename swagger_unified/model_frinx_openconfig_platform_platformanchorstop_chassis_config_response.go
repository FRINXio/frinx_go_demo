...
// frinx.openconfig.platform.platformanchorstop.chassis.Config.response
type FrinxOpenconfigPlatformPlatformanchorstopChassisConfigResponse struct {
	FrinxOpenconfigPlatformconfig *FrinxOpenconfigPlatformPlatformanchorstopChassisConfig `json:"frinx-openconfig-platform:config,omitempty"`
}
