...
// frinx.openconfig.qos.qosinterfacevoqstop.VirtualOutputQueues.response
type FrinxOpenconfigQosQosinterfacevoqstopVirtualOutputQueuesResponse struct {
	FrinxOpenconfigQosvirtualOutputQueues *FrinxOpenconfigQosQosinterfacevoqstopVirtualOutputQueues `json:"frinx-openconfig-qos:virtual-output-queues,omitempty"`
}
