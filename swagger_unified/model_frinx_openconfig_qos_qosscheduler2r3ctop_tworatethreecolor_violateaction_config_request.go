...
// frinx.openconfig.qos.qosscheduler2r3ctop.tworatethreecolor.violateaction.Config.request
type FrinxOpenconfigQosQosscheduler2r3ctopTworatethreecolorViolateactionConfigRequest struct {
