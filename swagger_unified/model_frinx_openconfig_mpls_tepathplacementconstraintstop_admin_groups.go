...
type FrinxOpenconfigMplsTepathplacementconstraintstopAdminGroups struct {
	// Optional[Configuration data ] REF:Optional.empty
	Config *FrinxOpenconfigMplsTepathplacementconstraintstopAdmingroupsConfig `json:"config,omitempty"`
}
