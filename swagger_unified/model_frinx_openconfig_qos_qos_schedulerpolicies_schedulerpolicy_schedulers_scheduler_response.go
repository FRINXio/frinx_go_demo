...
// frinx.openconfig.qos.qos.schedulerpolicies.schedulerpolicy.schedulers.Scheduler.response
type FrinxOpenconfigQosQosSchedulerpoliciesSchedulerpolicySchedulersSchedulerResponse struct {
	FrinxOpenconfigQosscheduler []FrinxOpenconfigQosQosSchedulerpoliciesSchedulerpolicySchedulersScheduler `json:"frinx-openconfig-qos:scheduler,omitempty"`
}
