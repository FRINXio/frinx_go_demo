...
// frinx.openconfig.network.instance.l2niinstance.Fdb.response
type FrinxOpenconfigNetworkInstanceL2niinstanceFdbResponse struct {
	FrinxOpenconfigNetworkInstancefdb *FrinxOpenconfigNetworkInstanceL2niinstanceFdb `json:"frinx-openconfig-network-instance:fdb,omitempty"`
}
