...
type FrinxOpenconfigQosQosqueuetopQueuesQueueConfig struct {
	// Optional[User-defined name of the queue] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Sets the type of the queue] REF:Optional.empty
	QueueType *FrinxOpenconfigQosQueueTypeIdentityref `json:"queue-type,omitempty"`
}
