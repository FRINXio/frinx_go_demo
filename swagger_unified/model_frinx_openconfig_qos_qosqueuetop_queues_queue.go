...
// Optional[List of defined queues] REF:Optional.empty
type FrinxOpenconfigQosQosqueuetopQueuesQueue struct {
	// Optional[Top-level container for data related to RED-managed queues] REF:Optional.empty
	Red *FrinxOpenconfigQosQosqueueredtopRed `json:"red,omitempty"`
	// Optional[Reference to the queue name list key.] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Top-level container for WRED data] REF:Optional.empty
	Wred *FrinxOpenconfigQosQosqueuewredtopWred `json:"wred,omitempty"`
	// Optional[Configuration data for queues] REF:Optional.empty
	Config *FrinxOpenconfigQosQosqueuetopQueuesQueueConfig `json:"config,omitempty"`
}
