...
type FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthUnderflow struct {
	// Optional[Config information for MPLS underflow bandwidth adjustment] REF:Optional.empty
	Config *FrinxOpenconfigMplsTetunnelbandwidthtopBandwidthAutobandwidthUnderflowConfig `json:"config,omitempty"`
}
