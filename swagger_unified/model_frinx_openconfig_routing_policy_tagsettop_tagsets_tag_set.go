...
// Optional[List of tag set definitions.] REF:Optional.empty
type FrinxOpenconfigRoutingPolicyTagsettopTagsetsTagSet struct {
	// Optional[Reference to the tag set name list key] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Configuration data for tag sets] REF:Optional.empty
	Config *FrinxOpenconfigRoutingPolicyTagsettopTagsetsTagsetConfig `json:"config,omitempty"`
}
