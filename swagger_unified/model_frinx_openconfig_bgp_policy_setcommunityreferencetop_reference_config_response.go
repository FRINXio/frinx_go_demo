...
// frinx.openconfig.bgp.policy.setcommunityreferencetop.reference.Config.response
type FrinxOpenconfigBgpPolicySetcommunityreferencetopReferenceConfigResponse struct {
	FrinxOpenconfigBgpPolicyconfig *FrinxOpenconfigBgpPolicySetcommunityreferencetopReferenceConfig `json:"frinx-openconfig-bgp-policy:config,omitempty"`
}
