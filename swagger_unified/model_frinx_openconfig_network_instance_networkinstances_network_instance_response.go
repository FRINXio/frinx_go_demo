...
// frinx.openconfig.network.instance.networkinstances.NetworkInstance.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkInstanceResponse struct {
	FrinxOpenconfigNetworkInstancenetworkInstance []FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkInstance `json:"frinx-openconfig-network-instance:network-instance,omitempty"`
}
