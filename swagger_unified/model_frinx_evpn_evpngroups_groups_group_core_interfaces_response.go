...
// frinx.evpn.evpngroups.groups.group.CoreInterfaces.response
type FrinxEvpnEvpngroupsGroupsGroupCoreInterfacesResponse struct {
	FrinxEvpncoreInterfaces *FrinxEvpnEvpngroupsGroupsGroupCoreInterfaces `json:"frinx-evpn:core-interfaces,omitempty"`
}
