...
// Optional[Configuration data for interface match conditions] REF:Optional.empty
type FrinxOpenconfigRoutingPolicyMatchinterfaceconditiontopMatchinterfaceConfig struct {
