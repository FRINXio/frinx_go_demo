...
// Optional[List of egress NetFlow flows on the interface] REF:Optional.empty
type FrinxNetflowInterfaceegressnetflowtopEgressflowsEgressFlow struct {
	// Optional[Configuration data ] REF:Optional.empty
	Config *FrinxNetflowInterfaceegressnetflowtopEgressflowsEgressflowConfig `json:"config,omitempty"`
