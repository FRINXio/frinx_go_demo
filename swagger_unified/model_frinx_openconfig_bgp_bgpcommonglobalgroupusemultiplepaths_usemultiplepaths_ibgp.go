...
type FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsIbgp struct {
	// Optional[Configuration parameters relating to iBGP multipath] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpcommonglobalgroupusemultiplepathsUsemultiplepathsIbgpConfig `json:"config,omitempty"`
}
