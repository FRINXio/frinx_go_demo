...
// frinx.openconfig.platform.platformanchorstop.Port.response
type FrinxOpenconfigPlatformPlatformanchorstopPortResponse struct {
	FrinxOpenconfigPlatformport *FrinxOpenconfigPlatformPlatformanchorstopPort `json:"frinx-openconfig-platform:port,omitempty"`
}
