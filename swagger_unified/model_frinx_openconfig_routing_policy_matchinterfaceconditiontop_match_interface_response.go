...
// frinx.openconfig.routing.policy.matchinterfaceconditiontop.MatchInterface.response
type FrinxOpenconfigRoutingPolicyMatchinterfaceconditiontopMatchInterfaceResponse struct {
	FrinxOpenconfigRoutingPolicymatchInterface *FrinxOpenconfigRoutingPolicyMatchinterfaceconditiontopMatchInterface `json:"frinx-openconfig-routing-policy:match-interface,omitempty"`
}
