...
type FrinxOpenconfigBgpBgpglobalbaseConfig struct {
	// Optional[Router id of the router - an unsigned 32-bit integer expressed in dotted quad notation.] REF:Optional[RFC4271 - A Border Gateway Protocol 4 (BGP-4), Section 4.2]
	RouterId string `json:"router-id,omitempty"`
	// Optional[Local autonomous system number of the router.  Uses the 32-bit as-number type from the model in RFC 6991.] REF:Optional.empty
