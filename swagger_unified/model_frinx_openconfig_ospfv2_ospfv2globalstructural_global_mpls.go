...
type FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMpls struct {
	// Optional[OSPFv2 parameters relating to LDP/IGP synchronization] REF:Optional.empty
	IgpLdpSync *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMplsIgpLdpSync `json:"igp-ldp-sync,omitempty"`
	// Optional[Configuration parameters relating to MPLS for OSPFv2] REF:Optional.empty
	Config *FrinxOpenconfigOspfv2Ospfv2globalstructuralGlobalMplsConfig `json:"config,omitempty"`
}
