...
type FrinxOpenconfigBgpBgpcommonrouteselectionoptionsRouteSelectionOptions struct {
	// Optional[Configuration parameters relating to route selection options] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpcommonrouteselectionoptionsRouteselectionoptionsConfig `json:"config,omitempty"`
}
