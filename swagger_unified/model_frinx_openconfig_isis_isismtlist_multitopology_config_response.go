...
// frinx.openconfig.isis.isismtlist.multitopology.Config.response
type FrinxOpenconfigIsisIsismtlistMultitopologyConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigIsisIsismtlistMultitopologyConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
