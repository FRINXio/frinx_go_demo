...
// frinx.openconfig.mpls.ldp.mplsldpneighborstop.neighbors.neighbor.Config.response
type FrinxOpenconfigMplsLdpMplsldpneighborstopNeighborsNeighborConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsLdpMplsldpneighborstopNeighborsNeighborConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
