...
type FrinxOpenconfigNetworkInstanceAssociatedAddressFamiliesIdentityref string

// List of frinx.openconfig.network.instance.AssociatedAddressFamiliesIdentityref
const (
	FrinxOpenconfigNetworkInstanceAssociatedAddressFamiliesIdentityref_MPLS FrinxOpenconfigNetworkInstanceAssociatedAddressFamiliesIdentityref = "frinx-openconfig-types:MPLS"
	FrinxOpenconfigNetworkInstanceAssociatedAddressFamiliesIdentityref_IPV4 FrinxOpenconfigNetworkInstanceAssociatedAddressFamiliesIdentityref = "frinx-openconfig-types:IPV4"
	FrinxOpenconfigNetworkInstanceAssociatedAddressFamiliesIdentityref_IPV6 FrinxOpenconfigNetworkInstanceAssociatedAddressFamiliesIdentityref = "frinx-openconfig-types:IPV6"
	FrinxOpenconfigNetworkInstanceAssociatedAddressFamiliesIdentityref_ADDRESS_FAMILY FrinxOpenconfigNetworkInstanceAssociatedAddressFamiliesIdentityref = "frinx-openconfig-types:ADDRESS_FAMILY"
	FrinxOpenconfigNetworkInstanceAssociatedAddressFamiliesIdentityref_L2_ETHERNET FrinxOpenconfigNetworkInstanceAssociatedAddressFamiliesIdentityref = "frinx-openconfig-types:L2_ETHERNET"
)
