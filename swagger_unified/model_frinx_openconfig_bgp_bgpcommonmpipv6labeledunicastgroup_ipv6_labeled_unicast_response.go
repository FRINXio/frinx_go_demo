...
// frinx.openconfig.bgp.bgpcommonmpipv6labeledunicastgroup.Ipv6LabeledUnicast.response
type FrinxOpenconfigBgpBgpcommonmpipv6labeledunicastgroupIpv6LabeledUnicastResponse struct {
	FrinxOpenconfigNetworkInstanceipv6LabeledUnicast *FrinxOpenconfigBgpBgpcommonmpipv6labeledunicastgroupIpv6LabeledUnicast `json:"frinx-openconfig-network-instance:ipv6-labeled-unicast,omitempty"`
}
