...
type FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceattributesInterfacesInterface struct {
	// Optional[Configuration of per-interface LDP parameters] REF:Optional.empty
	Config *FrinxOpenconfigMplsLdpMplsldpinterfaceattributestopInterfaceattributesInterfacesInterfaceConfig `json:"config,omitempty"`
