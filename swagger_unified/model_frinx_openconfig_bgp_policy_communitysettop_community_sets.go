...
type FrinxOpenconfigBgpPolicyCommunitysettopCommunitySets struct {
	// Optional[List of defined BGP community sets] REF:Optional.empty
	CommunitySet []FrinxOpenconfigBgpPolicyCommunitysettopCommunitysetsCommunitySet `json:"community-set,omitempty"`
}
