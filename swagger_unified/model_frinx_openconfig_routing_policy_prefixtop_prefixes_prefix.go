...
// Optional[List of prefixes in the prefix set] REF:Optional.empty
type FrinxOpenconfigRoutingPolicyPrefixtopPrefixesPrefix struct {
	// Optional[Reference to the ip-prefix list key.] REF:Optional.empty
	IpPrefix string `json:"ip-prefix,omitempty"`
	// Optional[Reference to the masklength-range list key] REF:Optional.empty
	...
	Config *FrinxOpenconfigRoutingPolicyPrefixtopPrefixesPrefixConfig `json:"config,omitempty"`
}
