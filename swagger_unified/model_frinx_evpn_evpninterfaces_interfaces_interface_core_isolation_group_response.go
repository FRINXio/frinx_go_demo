...
// frinx.evpn.evpninterfaces.interfaces.interface.CoreIsolationGroup.response
type FrinxEvpnEvpninterfacesInterfacesInterfaceCoreIsolationGroupResponse struct {
	FrinxEvpncoreIsolationGroup *FrinxEvpnEvpninterfacesInterfacesInterfaceCoreIsolationGroup `json:"frinx-evpn:core-isolation-group,omitempty"`
}
