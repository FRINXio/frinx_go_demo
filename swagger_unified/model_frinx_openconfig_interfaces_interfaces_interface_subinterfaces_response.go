...
// frinx.openconfig.interfaces.interfaces.interface.Subinterfaces.response
type FrinxOpenconfigInterfacesInterfacesInterfaceSubinterfacesResponse struct {
	FrinxOpenconfigInterfacessubinterfaces *FrinxOpenconfigInterfacesInterfacesInterfaceSubinterfaces `json:"frinx-openconfig-interfaces:subinterfaces,omitempty"`
}
