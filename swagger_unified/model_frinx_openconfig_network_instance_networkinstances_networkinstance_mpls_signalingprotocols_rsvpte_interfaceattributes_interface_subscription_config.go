...
// Optional[Configuration parameters relating to RSVP subscription options] REF:Optional.empty
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingprotocolsRsvpteInterfaceattributesInterfaceSubscriptionConfig struct {
	// Optional[Total reservable bandwidth] REF:Optional.empty
	FrinxMplsRsvpExtensionbandwidth string `json:"frinx-mpls-rsvp-extension:bandwidth,omitempty"`
	// Optional[percentage of the interface bandwidth that RSVP can reserve] REF:Optional.empty
	Subscription int32 `json:"subscription,omitempty"`
}
