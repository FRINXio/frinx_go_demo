...
// Optional[Configuration parameters relating to the label block.] REF:Optional.empty
type FrinxOpenconfigMplsMplslabelblockstopReservedlabelblocksReservedlabelblockConfig struct {
	// Optional[Lower bound of the global label block. The block is defined to include this label.] REF:Optional.empty
	LowerBound string `json:"lower-bound,omitempty"`
	// Optional[Upper bound for the global label block. The block is defined to include this label.] REF:Optional.empty
	UpperBound string `json:"upper-bound,omitempty"`
	// Optional[A local identifier for the global label block allocation.] REF:Optional.empty
