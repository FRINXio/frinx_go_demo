...
type FrinxOpenconfigBgpBgpneighborafisafilistAfisafiGracefulRestart struct {
	// Optional[Configuration options for BGP graceful-restart] REF:Optional.empty
	Config *FrinxOpenconfigBgpBgpneighborafisafilistAfisafiGracefulrestartConfig `json:"config,omitempty"`
}
