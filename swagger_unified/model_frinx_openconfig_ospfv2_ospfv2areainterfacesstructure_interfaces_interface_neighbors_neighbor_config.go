...
type FrinxOpenconfigOspfv2Ospfv2areainterfacesstructureInterfacesInterfaceNeighborsNeighborConfig struct {
	// Optional[The metric that should be considered to the remote neighbor over this interface. This configuration is only applicable for multiple-access networks] REF:Optional.empty
	Metric int32 `json:"metric,omitempty"`
	// Optional[The router ID of the remote system.] REF:Optional.empty
