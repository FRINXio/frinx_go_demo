...
// Optional[Configuration data for AS path sets] REF:Optional.empty
type FrinxOpenconfigBgpPolicyAspathsettopAspathsetsAspathsetConfig struct {
	// Optional[name of the AS path set -- this is used to reference the set in match conditions] REF:Optional.empty
	AsPathSetName string `json:"as-path-set-name,omitempty"`
	// Optional[AS path expression -- list of ASes in the set] REF:Optional.empty
	AsPathSetMember []string `json:"as-path-set-member,omitempty"`
}
