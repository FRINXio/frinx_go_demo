...
// Optional[Interfaces on which BFD sessions are to be enabled.] REF:Optional.empty
type FrinxOpenconfigBfdBfdInterfaces struct {
	// Optional[Per-interface configuration and state parameters for BFD.] REF:Optional.empty
	Interface_ []FrinxOpenconfigBfdBfdInterfacesInterface `json:"interface,omitempty"`
}
