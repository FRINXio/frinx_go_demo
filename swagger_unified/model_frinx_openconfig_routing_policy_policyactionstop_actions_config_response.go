...
// frinx.openconfig.routing.policy.policyactionstop.actions.Config.response
type FrinxOpenconfigRoutingPolicyPolicyactionstopActionsConfigResponse struct {
	FrinxOpenconfigRoutingPolicyconfig *FrinxOpenconfigRoutingPolicyPolicyactionstopActionsConfig `json:"frinx-openconfig-routing-policy:config,omitempty"`
}
