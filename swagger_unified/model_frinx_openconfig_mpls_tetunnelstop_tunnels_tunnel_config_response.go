...
// frinx.openconfig.mpls.tetunnelstop.tunnels.tunnel.Config.response
type FrinxOpenconfigMplsTetunnelstopTunnelsTunnelConfigResponse struct {
	FrinxOpenconfigNetworkInstanceconfig *FrinxOpenconfigMplsTetunnelstopTunnelsTunnelConfig `json:"frinx-openconfig-network-instance:config,omitempty"`
}
