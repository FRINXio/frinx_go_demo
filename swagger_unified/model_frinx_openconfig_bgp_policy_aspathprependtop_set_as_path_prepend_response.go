...
// frinx.openconfig.bgp.policy.aspathprependtop.SetAsPathPrepend.response
type FrinxOpenconfigBgpPolicyAspathprependtopSetAsPathPrependResponse struct {
	FrinxOpenconfigBgpPolicysetAsPathPrepend *FrinxOpenconfigBgpPolicyAspathprependtopSetAsPathPrepend `json:"frinx-openconfig-bgp-policy:set-as-path-prepend,omitempty"`
}
