...
// Optional[List of top-level policy definitions, keyed by unique name.  These policy definitions are expected to be referenced (by name) in policy chains specified in import or export configuration statements.] REF:Optional.empty
type FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicyDefinition struct {
	// Optional[Reference to the list key] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Enclosing container for policy statements] REF:Optional.empty
	Statements *FrinxOpenconfigRoutingPolicyRoutingpolicyPolicydefinitionsPolicydefinitionStatements `json:"statements,omitempty"`
	// Optional[Configuration data for policy defintions] REF:Optional.empty
	Config *FrinxOpenconfigRoutingPolicyPolicydefinitionstopPolicydefinitionsPolicydefinitionConfig `json:"config,omitempty"`
}
