...
type FrinxOpenconfigMplsIgplspsetupPathSetupProtocol struct {
	// Optional[LDP signaling setup for IGP-congruent LSPs] REF:Optional.empty
	Ldp *FrinxOpenconfigMplsLdpIgplspldpsetupLdp `json:"ldp,omitempty"`
}
