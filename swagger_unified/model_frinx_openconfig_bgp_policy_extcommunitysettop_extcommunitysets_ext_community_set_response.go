...
// frinx.openconfig.bgp.policy.extcommunitysettop.extcommunitysets.ExtCommunitySet.response
type FrinxOpenconfigBgpPolicyExtcommunitysettopExtcommunitysetsExtCommunitySetResponse struct {
	FrinxOpenconfigBgpPolicyextCommunitySet []FrinxOpenconfigBgpPolicyExtcommunitysettopExtcommunitysetsExtCommunitySet `json:"frinx-openconfig-bgp-policy:ext-community-set,omitempty"`
}
