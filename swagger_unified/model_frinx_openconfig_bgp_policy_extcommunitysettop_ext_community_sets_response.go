...
// frinx.openconfig.bgp.policy.extcommunitysettop.ExtCommunitySets.response
type FrinxOpenconfigBgpPolicyExtcommunitysettopExtCommunitySetsResponse struct {
	FrinxOpenconfigBgpPolicyextCommunitySets *FrinxOpenconfigBgpPolicyExtcommunitysettopExtCommunitySets `json:"frinx-openconfig-bgp-policy:ext-community-sets,omitempty"`
}
