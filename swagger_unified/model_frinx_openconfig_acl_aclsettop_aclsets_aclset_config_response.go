...
// frinx.openconfig.acl.aclsettop.aclsets.aclset.Config.response
type FrinxOpenconfigAclAclsettopAclsetsAclsetConfigResponse struct {
	FrinxOpenconfigAclconfig *FrinxOpenconfigAclAclsettopAclsetsAclsetConfig `json:"frinx-openconfig-acl:config,omitempty"`
}
