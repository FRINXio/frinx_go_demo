...
// Optional[Conditions for the classifier term. Packets must match all of the criteria specified within the match condition to be considered matching the term.] REF:Optional.empty
type FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditions struct {
	// Optional[Top level container for IPv4 match field data] REF:Optional.empty
	Ipv4 *FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv4 `json:"ipv4,omitempty"`
	// Optional[Top-level container for IPv6 match field data] REF:Optional.empty
	Ipv6 *FrinxOpenconfigQosQosClassifiersClassifierTermsTermConditionsIpv6 `json:"ipv6,omitempty"`
	// Optional[Ethernet header fields] REF:Optional.empty
	L2 *FrinxOpenconfigPacketMatchEthernetheadertopL2 `json:"l2,omitempty"`
	// Optional[MPLS header fields] REF:Optional.empty
	Mpls *FrinxOpenconfigPacketMatchMplsheadertopMpls `json:"mpls,omitempty"`
	// Optional[List of precedences valid for both ipv4 and ipv6] REF:Optional.empty
	FrinxQosExtensionprecedences []string `json:"frinx-qos-extension:precedences,omitempty"`
	// Optional.empty REF:Optional.empty
	FrinxQosExtensionqosGroup []string `json:"frinx-qos-extension:qos-group,omitempty"`
