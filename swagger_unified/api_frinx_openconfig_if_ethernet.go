...
type FrinxOpenconfigIfEthernetApiService service

/*
FrinxOpenconfigIfEthernetApiService
...
*/
func (a *FrinxOpenconfigIfEthernetApiService) DeleteFrinxOpenconfigInterfacesInterfacesInterfaceEthernet(ctx context.Context, name string, nodeId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/config/network-topology:network-topology/network-topology:topology/unified/network-topology:node/{node-id}/yang-ext:mount/frinx-openconfig-interfaces:interfaces/frinx-openconfig-interfaces:interface/{name}/frinx-openconfig-if-ethernet:ethernet/"
...
*/
func (a *FrinxOpenconfigIfEthernetApiService) DeleteFrinxOpenconfigInterfacesInterfacesInterfaceEthernetConfig(ctx context.Context, name string, nodeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return FrinxOpenconfigIfEthernetEthernettopEthernetResponse
*/
func (a *FrinxOpenconfigIfEthernetApiService) GetFrinxOpenconfigInterfacesInterfacesInterfaceEthernet(ctx context.Context, name string, nodeId string) (FrinxOpenconfigIfEthernetEthernettopEthernetResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxOpenconfigIfEthernetEthernettopEthernetResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxOpenconfigIfEthernetEthernettopEthernetResponse
...
@return FrinxOpenconfigIfEthernetEthernettopEthernetConfigResponse
*/
func (a *FrinxOpenconfigIfEthernetApiService) GetFrinxOpenconfigInterfacesInterfacesInterfaceEthernetConfig(ctx context.Context, name string, nodeId string) (FrinxOpenconfigIfEthernetEthernettopEthernetConfigResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FrinxOpenconfigIfEthernetEthernettopEthernetConfigResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FrinxOpenconfigIfEthernetEthernettopEthernetConfigResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Id of interface
 * @param frinxOpenconfigIfEthernetEthernettopEthernetBodyParam frinx.openconfig.if.ethernet.ethernettop.Ethernet to be added or updated
 * @param nodeId


*/
func (a *FrinxOpenconfigIfEthernetApiService) PutFrinxOpenconfigInterfacesInterfacesInterfaceEthernet(ctx context.Context, name string, frinxOpenconfigIfEthernetEthernettopEthernetBodyParam FrinxOpenconfigIfEthernetEthernettopEthernetRequest, nodeId string) (*http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &frinxOpenconfigIfEthernetEthernettopEthernetBodyParam
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name Id of interface
 * @param frinxOpenconfigIfEthernetEthernettopEthernetConfigBodyParam frinx.openconfig.if.ethernet.ethernettop.ethernet.Config to be added or updated
 * @param nodeId


*/
func (a *FrinxOpenconfigIfEthernetApiService) PutFrinxOpenconfigInterfacesInterfacesInterfaceEthernetConfig(ctx context.Context, name string, frinxOpenconfigIfEthernetEthernettopEthernetConfigBodyParam FrinxOpenconfigIfEthernetEthernettopEthernetConfigRequest, nodeId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// body params
	localVarPostBody = &frinxOpenconfigIfEthernetEthernettopEthernetConfigBodyParam
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, err
	}
