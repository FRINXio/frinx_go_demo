...
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMpls struct {
	// Optional[LSP definitions and configuration] REF:Optional.empty
	Lsps *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLsps `json:"lsps,omitempty"`
	// Optional[top-level signaling protocol configuration] REF:Optional.empty
	SignalingProtocols *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsSignalingProtocols `json:"signaling-protocols,omitempty"`
	...
	Global *FrinxOpenconfigMplsMplstopMplsGlobal `json:"global,omitempty"`
	// Optional[traffic-engineering global attributes] REF:Optional.empty
	TeGlobalAttributes *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsTeGlobalAttributes `json:"te-global-attributes,omitempty"`
	// Optional[traffic engineering attributes specific for interfaces] REF:Optional.empty
	TeInterfaceAttributes *FrinxOpenconfigMplsMplstopMplsTeInterfaceAttributes `json:"te-interface-attributes,omitempty"`
}
