...
// frinx.netflow.netflowinterfacestop.interfaces.interface.Config.response
type FrinxNetflowNetflowinterfacestopInterfacesInterfaceConfigResponse struct {
	FrinxNetflowconfig *FrinxNetflowNetflowinterfacestopInterfacesInterfaceConfig `json:"frinx-netflow:config,omitempty"`
}
