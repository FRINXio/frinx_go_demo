...
// frinx.openconfig.mpls.rsvp.mplsrsvphellos.Hellos.response
type FrinxOpenconfigMplsRsvpMplsrsvphellosHellosResponse struct {
	FrinxOpenconfigNetworkInstancehellos *FrinxOpenconfigMplsRsvpMplsrsvphellosHellos `json:"frinx-openconfig-network-instance:hellos,omitempty"`
}
