...
type FrinxOpenconfigIfIpIpv6topIpv6AddressesAddressConfig struct {
	...
	// Optional[[adapted from IETF IP model RFC 7277]  The IPv6 address on the interface.] REF:Optional.empty
