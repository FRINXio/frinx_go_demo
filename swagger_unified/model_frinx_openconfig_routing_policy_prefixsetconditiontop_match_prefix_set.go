...
type FrinxOpenconfigRoutingPolicyPrefixsetconditiontopMatchPrefixSet struct {
	// Optional[Configuration data for a prefix-set condition] REF:Optional.empty
	Config *FrinxOpenconfigRoutingPolicyPrefixsetconditiontopMatchprefixsetConfig `json:"config,omitempty"`
}
