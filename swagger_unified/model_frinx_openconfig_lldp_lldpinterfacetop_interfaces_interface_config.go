...
type FrinxOpenconfigLldpLldpinterfacetopInterfacesInterfaceConfig struct {
	// Optional[Reference to the LLDP Ethernet interface] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Enable or disable the LLDP protocol on the interface.] REF:Optional.empty
