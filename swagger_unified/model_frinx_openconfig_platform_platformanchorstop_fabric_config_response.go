...
// frinx.openconfig.platform.platformanchorstop.fabric.Config.response
type FrinxOpenconfigPlatformPlatformanchorstopFabricConfigResponse struct {
	FrinxOpenconfigPlatformconfig *FrinxOpenconfigPlatformPlatformanchorstopFabricConfig `json:"frinx-openconfig-platform:config,omitempty"`
}
