...
// frinx.openconfig.network.instance.networkinstances.networkinstance.mpls.Lsps.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLspsResponse struct {
	FrinxOpenconfigNetworkInstancelsps *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceMplsLsps `json:"frinx-openconfig-network-instance:lsps,omitempty"`
}
