...
// frinx.openconfig.bgp.bgpcommonmpl2vpnevpngroup.L2vpnEvpn.response
type FrinxOpenconfigBgpBgpcommonmpl2vpnevpngroupL2vpnEvpnResponse struct {
	FrinxOpenconfigNetworkInstancel2vpnEvpn *FrinxOpenconfigBgpBgpcommonmpl2vpnevpngroupL2vpnEvpn `json:"frinx-openconfig-network-instance:l2vpn-evpn,omitempty"`
}
