...
// Optional[List of system properties for the component] REF:Optional.empty
type FrinxOpenconfigPlatformPlatformcomponentpropertiestopPropertiesProperty struct {
	// Optional[Reference to the property name.] REF:Optional.empty
	Name string `json:"name,omitempty"`
	// Optional[Configuration data for each property] REF:Optional.empty
	Config *FrinxOpenconfigPlatformPlatformcomponentpropertiestopPropertiesPropertyConfig `json:"config,omitempty"`
}
