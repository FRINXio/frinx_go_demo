...
// frinx.openconfig.bgp.bgpcommonstructureneighborgroupaspathoptions.AsPathOptions.response
type FrinxOpenconfigBgpBgpcommonstructureneighborgroupaspathoptionsAsPathOptionsResponse struct {
	FrinxOpenconfigNetworkInstanceasPathOptions *FrinxOpenconfigBgpBgpcommonstructureneighborgroupaspathoptionsAsPathOptions `json:"frinx-openconfig-network-instance:as-path-options,omitempty"`
}
