...
// frinx.openconfig.network.instance.networkinstances.networkinstance.protocols.protocol.LocalAggregates.response
type FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolLocalAggregatesResponse struct {
	FrinxOpenconfigNetworkInstancelocalAggregates *FrinxOpenconfigNetworkInstanceNetworkinstancesNetworkinstanceProtocolsProtocolLocalAggregates `json:"frinx-openconfig-network-instance:local-aggregates,omitempty"`
}
